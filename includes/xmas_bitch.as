...
public function xmasBitchEncounter():void
{
	...
	if (player.cor >= 90 || monk >= 5 || player.hasStatusAffect(StatusAffects.Exgartuan) || amilyScene.amilyCorrupt() || flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00283] > 0 || flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0 || flags[kFLAGS.NIAMH_STATUS] > 0)
	{
