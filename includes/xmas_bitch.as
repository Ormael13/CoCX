...
function xmasBitchEncounter():void {
	...
	if(flags[34] > 0) outputText("nother");
	...
	if(player.cor >= 90 || monk >= 5 || player.hasStatusAffect("Exgartuan") >= 0 || amilyCorrupt() || flags[283] > 0 || flags[282] > 0 || flags[NIAMH_STATUS] > 0) {
