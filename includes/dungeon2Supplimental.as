...
function fightValaVictory():void {
	...
	if(player.gender > 0) {
		...
		simpleChoices("Fuck",2612,"",0,"",0,"",0,"Leave",5007);
	}
	else eventParser(5007);
...
function leftValaAlone():void {
	...
	simpleChoices("Fix Her",2615,"Use",Use,"Wake",Wake,"ShouldraVala",shouldra,"Leave",1);
}
...
function chooseValaInBar():void {
	...
	if(flags[121] == 0) {
	...
	else if(hours == 20 && rand(2) == 0 && player.hasCock()) {
		kinathisValaStuff();
		return;
	}
	else {
		...
		if(flags[120] == 0) {
			...
			//[Fairies][You][Leave]
			simpleChoices("Faeries",2626,"You",2625,"Cum Bath",cumBath,"",0,"Leave",2256);
		}
...
function cleansedFirstRemeet():void {
	...
	//[You][Leave]
	simpleChoices("You",2623,"",0,"",0,"",0,"Leave",2256);
}

//[You] 
function cleansedValaFuckHerBrainsOut():void {
	spriteSelect(60);
	outputText("", true);
...
//Part 2
function cleansedValaFuckHerBrainsOutPtII():void {
	spriteSelect(60);
	outputText("", true);
	//dicks + growth
	if(player.totalCocks() > 0) {
...
//[You]
function cleansedValaRepeatBrainFucking():void {
	spriteSelect(60);
	outputText("", true);
...
function faerieOrgyFuck():void {
	...
	if(player.gender == 3) {
		...
		simpleChoices("Male",2627,"Female",2628,"",0,"",0,"",0);
	}
	else if(player.gender == 2) doNext(2628);
	else if(player.gender == 1) doNext(2627);
}
	
//[Male]
function faerieOrgyFuckMaleContinue():void {
	spriteSelect(60);
	outputText("", true);
...
//[Female]
function faerieOrgyFuckFemaleContinue():void {
	spriteSelect(60);
	outputText("", true);
...
function defeatZetaz():void {
	...
	simpleChoices("Sexual",2636,"End Him",2633,"Safety",2637,"",0,"",0);
}

//[Release Zetaz 4 Info Win]
function releaseZForInfo():void {
	outputText("", true);
...
function sexualInterrogation():void {
	outputText("", true);
...
function femaleZetazOverPtII():void {
	outputText("", true);
	hideUpDown();
...
function zetazBadEndEpilogue():void {
	outputText("", true);
	if(player.gender == 2) {
...
function hermZetazOverPtII():void {
	hideUpDown();
	outputText("", true);
...
function malesZetazOverPtII():void {
	outputText("", true);
...
function theSeanShopOffer():void {
	spriteSelect(52);
	outputText("", true);
...
function bigValaLicksOffDudes():void {
	clearOutput();
...
function valaVapulaThreesome():void {
	//{First Meeting} 
...
function valaDommyVapula3Some():void {
	clearOutput();
	valaVapulaThreesome();
...
function valaLoveyVapula3Some():void {
	clearOutput();
	valaVapulaThreesome();
...
function kinathisValaStuff():void {
	clearOutput();
	...
	if(player.cocks[x].cockType == 1) outputText("Her tongue licks around the throbbing glands, the heady animal musk filling her nose and mind with sweet lust.  ");
	else if(player.cocks[x].cockType == 2) outputText("Her tongue licks around the hot building knot that gently throbs at your base.  ");
	//[anemone cock:
	else if(player.cocks[x].cockType == 7) outputText("Her tongue plays with the squirming tentacles that line the drone of your throbbing phallus.  She shivers and groans as the tentacles sting her full of pleasurable aphrodisiac.  ");
