...
public function wormsEntice():void {
	...
	if(player.lust < 50) {
		...
		dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", 10+player.lib/20+player.cor/20, "cor", 0);
	}
	else {
...
public function playerInfest():void {
	...
	if(monster.hasStatusAffect("Twu Wuv") >= 0) {
		...
		dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", 5 + player.sens/10, "cor", 0, "resisted", false);
		enemyAI();
		return;
	}
	fatigue(40,2);
