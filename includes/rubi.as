...
public function rubiCock():String {
	return NPCCockDescript(flags[kFLAGS.RUBI_COCK_TYPE], flags[kFLAGS.RUBI_COCK_SIZE], 50);
}
public function rubiBreasts():String {
	...
	else
	{
		...
		ret += " ";
		ret += npcBreastDescript(flags[kFLAGS.RUBI_BREAST_SIZE]);
	}
...
public function rubiIntros():Number {
	...
	if(flags[kFLAGS.RUBI_DISABLED] > 0 || flags[kFLAGS.RUBI_PROSTITUTION] == -2) return 0;
	outputText("\n");
	//(Haven't met yet)
...
public function approachRubiScenes():void {
	...
	simpleChoices("Milk",milk,"Tea",tea,"Chat",3897,"Rubi's Place",place,"Leave",telAdre.bakeryScene.bakeryuuuuuu);
}
...
public function rubisFuckingHouseYouPervert():void {
	...
	if(rubiAffection() >= 50 && !rubiBimbo() && flags[kFLAGS.RUBI_COCK_SIZE] > 0 && (!rubiBimbo() || flags[kFLAGS.RUBI_DEBIMBO] > 0) && flags[kFLAGS.RUBI_SHE] == 0) {
		//First Time:
...
public function rubiSexMenu():void {
	...
	if(flags[kFLAGS.RUBI_BLU_BALLS] > 0 && flags[kFLAGS.RUBI_ORGASM_DENIAL] > 0 && !rubiBimbo()) releas = 3902;
	...
	if(releas > 0 && flags[kFLAGS.RUBI_COCK_SIZE] > 0) 
...
public function getFuckedByRubi():void {
	...
	if(!player.hasVagina()) buttChange(flags[kFLAGS.RUBI_COCK_SIZE] * flags[kFLAGS.RUBI_COCK_SIZE]/6,true,true,false);
	else cuntChange(flags[kFLAGS.RUBI_COCK_SIZE] * flags[kFLAGS.RUBI_COCK_SIZE]/6,true,true,false);
...
public function giveRubiATFItem(short:String):void {
	...
	if(short == "SucMilk" || short == "P.S.Mlk") {
		...
		if(flags[kFLAGS.RUBI_FEET] == 0 && rand(3) == 0 && short == "SucMilk") {
		...
		//(If Rubi gets horns)
		if(rand(3) == 0 && flags[kFLAGS.RUBI_HORNTYPE] == 0 && short == "SucMilk") {
		...
		if(rand(3) == 0 && flags[kFLAGS.RUBI_SKIN] != 1 && short == "SucMilk") {
...
public function giveRubiClothes(short:String = ""):void {
	...
	else if(short == "TubeTop") flags[kFLAGS.RUBI_TUBE_TOP] = 1;
	else if(short == "T.BSuit") flags[kFLAGS.RUBI_BODYSUIT] = 1;
	else if(short == "B.Dress") flags[kFLAGS.RUBI_LONGDRESS] = 1;
	else if(short == "LthrPnt") flags[kFLAGS.RUBI_TIGHT_PANTS] = 1;
	else if(short == "NurseCl") flags[kFLAGS.RUBI_NURSE_CLOTHES] = 1;
	else if(short == "S.Swmwr") flags[kFLAGS.RUBI_SWIMWEAR] = 1;
	else if(short == "I.Corst") flags[kFLAGS.RUBI_INQUISITORS_CORSET] = 1;
	else if(short == "BonStrp") flags[kFLAGS.RUBI_BONDAGE_STRAPS] = 1;
	rubiAffection(20);
