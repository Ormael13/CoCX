...
public function akabalAttack():void
{
	...
	{
		if (player.spe - monster.spe < 8)
			outputText("You narrowly avoid " + monster.a + monster.short + "'s " + monster.weaponVerb + "!", false);
		if (player.spe - monster.spe >= 8 && player.spe - monster.spe < 20)
			outputText("You dodge " + monster.a + monster.short + "'s " + monster.weaponVerb + " with superior quickness!", false);
		if (player.spe - monster.spe >= 20)
			outputText("You deftly avoid " + monster.a + monster.short + "'s slow " + monster.weaponVerb + ".", false);
		combatRoundOver();
		return;
	}
	//Determine if evaded
...
public function akbalSpecial():void
{
	...
	else
	{
		...
		{
			if (player.spe - monster.spe < 8)
				outputText("You narrowly avoid " + monster.a + monster.short + "'s fire!", false);
			if (player.spe - monster.spe >= 8 && player.spe - monster.spe < 20)
				outputText("You dodge " + monster.a + monster.short + "'s fire with superior quickness!", false);
			if (player.spe - monster.spe >= 20)
				outputText("You deftly avoid " + monster.a + monster.short + "'s slow fire-breath.", false);
			combatRoundOver();
			return;
		}
		//Determine if evaded
