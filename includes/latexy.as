...
public function latexyEatsADickItem(item:String = ""):void {
	consumeItem(item,1);
	clearOutput();
...
public function gooTitClass(arg:int):int {
	if(arg >= 35) return 7;
...
public function changeLatexyTits(arg:int = 0):void {
	clearOutput();
...
public function minotaurCumFeedingGoo(nice:Boolean = false):void {
	clearOutput();
...
public function feedLatexyCumDirectly():void {
	...
	outputText("\n\nFeeling utterly empty, you sag back against a boulder.  The rough texture of the supporting stone keeps you upright, but there's next to no strength left in your [legs].  " + flags[GOO_NAME] + " is still down there, still slurping and sucking, probing the delicate entrance to your cumvein with gentle licks as she squeezes the last few drops from you.  The sensation feels far too good this soon after climax.  You wriggle and squirm, putting a hand to " + flags[GOO_NAME] + "'s forehead and commanding her to stop.");
	//{OBEDIENT:}
	if(gooObedience() >= 60) {
		outputText("\n\nAt the sound of your command, a whimper rolls over your [cock biggest], but the suckling heat that surrounds it withdraws, sliding off along with the succulent ring her glossy lips provide.  Your [cockHead biggest] pops free from the imprisoning puckers, trailing glossy black spit.  " + flags[GOO_NAME] + " breathes hard, as if she's been holding her breath all this time, and for all you know, she may have.  In any event, she mewls hungrily, licking her gooey liquids from your cock to clean it.  Again, it feels so good that it nearly saps your strength, but you hold tight while she finishes melting the latex free, leaving your dick completely clean.");
		//Happy: 
		if(gooHappiness() >= 66) outputText("\n\n\"<i>Thank you for the food, [Master],</i>\" " + flags[GOO_NAME] + " coos, \"<i>A pet like me only needs what you allow, isn't that right, [Master]?</i>\"");
		//Mediocre:
		else if(gooHappiness() >= 33) outputText("\n\n\"<i>Thanks for the food, I guess,</i>\" " + flags[GOO_NAME] + " mutters, \"<i>I guess you don't let your pets overindulge, huh?</i>\"");
		//Grumpy: 
		else outputText("\n\n\"<i>Really?  That's it?</i>\" " + flags[GOO_NAME] + " complains, \"<i>I thought you liked it, but I guess you're more concerned about obedience than my happiness, huh, [Master]?</i>\"");
		
		outputText("\n\nYou rise, giving your latex slave a knowing nod.  Her cunt");
		if(flags[GOO_DICK_LENGTH] > 0) outputText(" and " + gooCock() + " spatter");
...
public function maleDirectFeedLatexGooGoneWrong():void {
	...
	outputText(".  " + flags[GOO_NAME] + " looks up at your seizing body, smiling wide around her ");
	...
	outputText("\n\n" + flags[GOO_NAME] + " releases you from your oral imprisonment long enough to leak a few trailing strands of spunk from your [cockHead biggest].  ");
...
public function feedLatexyGirlCumDirect():void {
	...
	if(player.hasCock()) {
		outputText("  When " + flags[GOO_NAME] + " glances to your " + multiCockDescriptLight() + ", you tut and ");
		if(player.balls > 0) outputText("lift your [balls]");
		else outputText("shift position");
		outputText(" to show your [vagina].");
	}
	else outputText("  When " + flags[GOO_NAME] + " glances down, you sashay to better show your [vagina].");
	
	//HUNGRY: 
	if(gooFluid() < 33) {
		outputText("\n\nA rumble makes " + flags[GOO_NAME] + "'s tight belly tremble.  She brings a hand up to cover her featureless belly, giving you a nervous grin as she leans forward.  \"<i>How did you know I was so hungry");
		if(gooObedience() > 50) outputText(", [Master]");
		outputText("?</i>\"");
	}
	//INTERMEDIATE: 
	else if(gooFluid() < 66) {
		outputText("\n\nA smirk spreads over " + flags[GOO_NAME] + "'s visage.  She licks her lips and leans forward, saying, \"<i>Mmm...  I could go for a snack");
		if(gooObedience() > 50) outputText(", [Master]");
		outputText(".</i>\"");
	}
	//NOT HUNGRY:  
	else {
		outputText("\n\nA lazy smile reveals itself on " + flags[GOO_NAME] + "'s face.  She giggles, her lush body jiggling with liquid weight as she moves.  The latex woman comments, \"<i>Mmm...  I'm pretty full.</i>\"  She licks her lips and continues in a gluttonous purr, \"<i>You can always feed me more though");
		if(gooObedience() > 50) outputText(", [Master]");
		outputText(".</i>\"");
	}
	outputText("\n\nYou confidently approach, stopping just in front of your latex pet.  She immediately drops to her knees, placing her nose a scant few inches from your vulva.  Her " + flags[GOO_EYES] + " eyes lock onto the ");
	if(player.wetness() >= 3) outputText("glistening ");
	outputText("outer lips with excitement, dilating slightly as she leans closer.  " + flags[GOO_NAME] + "'s nostrils flare as she breathes deeply of your scent, inhaling thick lungfuls of your feminine odor, the heady musk of an aroused woman.  Her mouth hangs open slightly, as if in awe of what she sees, and undirected by her conscious mind, she lazily drifts closer.");
	outputText("\n\nA shiver of indecent pleasure writhes up your spine when her nose casually crashes into your slit.  Jolting slightly, " + flags[GOO_NAME] + " is roused from her cunt-induced stupor by the hot wetness on her proboscis.  She glances up at you, blushing just the slightest amount of violet, and hesitantly cranes her head to bring her lips in contact with your labia.  At first, she kisses and licks around the outer edges of your vulva, smearing their surface with her inky saliva.  The slick fluid thickens on contact with the air, even as she dives deeper into your [vagina], slowly spreading your inner lips with her exotic tongue.");
	outputText("\n\n" + flags[GOO_NAME] + " quickly loses herself in her own artful ministrations, her world narrowed down to the simmering cleft at the joint of your [hips] and [legs].  Slithering out, snakelike, her tongue burrows into your [vagina].  Its length is as large as it is slick, shiny and so smooth that it glides through your gates with ease.  " + flags[GOO_NAME] + " skillfully twists it around inside you, forcing more of her sable spit into your channel as her lubricated muscle squirms inside you, pressing hard against every tender area.  It's so smooth that if it weren't pushing so pleasantly against you, you'd barely feel it.  As it is, a slick snake is writhing in your cunt and it's set your loins afire.");
	...
	//{OBEDIENT:}
	if(gooObedience() >= 60) {
		outputText("\n\nAt the sound of your order, a whimper rolls over your [vagina], but the undulating pleasure of her glossy tongue inside you gradually recedes.  Your [clit] pops free from the imprisoning puckers, joined by a web of inky spit and lady-cum.  " + flags[GOO_NAME] + " breathes hard, as if she's been holding her breath all this time, and for all you know, she may have.  In any event, she mewls hungrily, licking her gooey liquids from your box to clean it.  Again, it feels so good that it nearly saps your strength, but you hold tight while she finishes lapping up the lubricants and saliva, leaving your entrance completely clean.")
		//Happy: 
		if(gooHappiness() >= 66) outputText("\n\n\"<i>Thank you for the food, [Master],</i>\" " + flags[GOO_NAME] + " coos, \"<i>A pet like me only needs what you allow, isn't that right, [Master]?</i>\"");
		//Mediocre:
		else if(gooHappiness() >= 33) outputText("\n\n\"<i>Thanks for the food, I guess,</i>\" " + flags[GOO_NAME] + " mutters, \"<i>I guess you don't let your pets overindulge, huh?</i>\"");
		//Grumpy: 
		else outputText("\n\n\"<i>Really?  That's it?</i>\" " + flags[GOO_NAME] + " complaints, \"<i>I thought you liked it, but I guess you're more concerned about obedience than my happiness, huh, [Master]?</i>\"");
		outputText("\n\nYou rise, giving your latex slave a knowing nod.  Her cunt");
		if(flags[GOO_DICK_LENGTH] > 0) outputText(" and " + gooCock() + " spatter");
		else outputText(" spatters");
		outputText(" oily wetness onto the ground below at your affirmation, and she shudders with a submissive thrill.  You pat her on the head for a job well done and depart, secure in her obedience.");
...
public function letLatexGooDrainCuntDry():void {
	clearOutput();
	outputText(flags[GOO_NAME] + "'s face remains firmly, stubbornly attached to your loins.  No matter how you writhe or push against her, she stays latched onto your [vagina].  The near supernatural pleasure has turned your arms to jello, and you slump back ineffectually after a few attempts at freedom.  The " + flags[GOO_EYES] + " of your hungry pet's eyes watches you, unblinking.  Mercilessly, she tongues your sodden slit to another orgasm.  The slippery latex lips slip and slide across your womanhood as sexual ecstasy subsumes your thoughts, eyes rolling back as your mind dedicates the whole of its power to simply experiencing the pleasure that's thrust upon you.");
	outputText("\n\nWordlessly, you writhe on " + flags[GOO_NAME] + " until the orgasm finally releases you from its grip.  Your pet goo pulls back, even withdrawing her tongue from your well-juiced box.  Her fist doesn't waste any time in replacing in.  In fact, as the smooth limb slides home, you can feel the bulkiest parts smoothing, shaping it into a cylindrical object with a noticeable ridge just above the 'wrist'.  " + flags[GOO_NAME] + " giggles, \"<i>Gosh, you taste good, and we goo girls... we love to drink.  Mmm...</i>\"  Her voice trails into a hum of delight as she digests your newest offering, eventually returning to say, \"<i>Your little slit here seems awful happy, [name]... I don't want to stop, and it's so sweet, so delectable...  Swallowing your cum makes my pussy gush and my stomach purr.  You don't mind if I sample a few more swallows do you?</i>\"");
	...
	outputText("\n\nA whimper of protest slips out of your mouth, your [vagina] cums again, and " + flags[GOO_NAME] + " drinks deeply once more.  With eyelids fluttering closed, you pass beyond conscious awareness, yielding your body to " + flags[GOO_NAME] + " to claim again and again.");
	menu();
	stats(0,0,0,0,.5,-3,-100,0);
...
public function assertControlOverCuntDrainingLatexGoo():void {
	...
	clearOutput();
	outputText("\n\n" + flags[GOO_NAME] + "'s face remains firmly, stubbornly attached to your loins.  You struggle under her relentless oral assault until you finally manage to get a good grip on the rebellious goo-slut. Putting your impressive strength to work, you flip yourself and the goo-girl over, straddling her shoulders and crushing her beneath your body.  " + flags[GOO_NAME] + " lets out a pathetic squeak as you assume command once again, pinning her onto the ground beneath you.  She's supposed to be the servile one here: it's time for this bitch to learn her place.  You grab her by her slick, latexy hair and mash her face into your twat, shuddering as her nose rubs against your [clit].  You snap a command to finish you a second time.  If she wants your fluids so bad, let her work for it the right way: meekly suckling from your cunt like a good little sub should.");
	outputText("\n\nPinned down as she is, " + flags[GOO_NAME] + " struggles against your powerful [legs] for a few moments before another forceful face-shove into your waiting cunt stops her, her intense craving for your femcum overpowering her desire to rebel.  \"<i>I-I'm sorry, ");
	...
	outputText("\n\n\"<i>Good girl,</i>\" you moan, arching your back as she slithers more and more of her long tongue into you, filling your [cunt] with black latex.  You run your fingers through her hair, urging " + flags[GOO_NAME] + " on as she begins to explore your passage, still delightfully sensitive and malleable after the recent face-fucking you just received from her.  More and more of her creeps into you, spreading your vaginal walls wide until the tip of her tongue tickles the mouth of your cervix, pleasantly circling it with slow, rhythmic motions.  You remind " + flags[GOO_NAME] + " that this is how it ought to be, with her meekly servicing your needy cunt as you desire; not her trying to dominate you. That isn't how this works, and she should know better by now.");
	outputText("\n\n\"<i>I'm sowwy, " + player.mf("Mashta","Mishtrish") + ",</i>\" she mumbles, her words slurred by her tongue being fully buried inside you.  She retracts herself from you, leaving you feeling empty and cold as she adds, \"<i>I didn't mean to, Master... I just, lose control...</i>\"  You smile down at the little latex girl and tell her that she doesn't need to worry.  You'll always be here to keep her nice and full with delicious femcum, so full that she's fit to burst with how much you've given her.  " + flags[GOO_NAME] + " squirms, stirred by your words, and looking over your shoulders, you can see a fresh sprout of liquid latex pouring down between her thighs.");
	outputText("\n\nYou release " + flags[GOO_NAME] + "'s head, leaving one hand to stroke her hair as your other plays down her slick, smooth skin, tracing along her shapely curves and huge, jiggling breasts until your fingertips brush along her thighs.  She gasps as a single digit plunges into her, sliding up to the knuckle into her ready cunt in one slow, languid motion.  Your other hand guides her head upwards, urging her back to her duties; she hesitates for a moment, but so do you, both still holding until she finally accepts your demand and resumes, her tongue flicking out to play along your [cunt].  \"<i>Good girl,</i>\" you say again, and start to move your hand, gently fingering her pussy as she tongues up the lubricant freely leaking from your loins.");
	outputText("\n\nBefore she can fall into a rhythm of tongue-fucking you, though, you decide to reward her newfound submissiveness: you twist around, leaving her pinned beneath your [legs] as you move your head between her shapely thighs.  You breathe in deep, reveling in the smell of her as " + flags[GOO_NAME] + " slips her long tongue back into you, filling your empty [cunt] with her oral appendage.  You return the favor, gently sliding your middle-three fingers into her eager twat, stretching her until you can slide the whole of your fist in.  She gasps, her breath hot on your sensitive box, but you don't skip a beat as you push your fist into her, sliding in until you run out of cunt to fill.  You start to move, fisting her with slow, gentle motions, enjoying the feeling of her slick passage desperately contracting around the huge block inside it, trying to push you out as you push in; trying to suck you in as you pull out to the knuckles.");
	outputText("\n\n\"<i>" + player.mf("Masterrrr","Mistriiiiissss") + "!</i>\"  " + flags[GOO_NAME] + " groans, rolling her head back as you fist-fuck her. She redoubles her oral ministrations, eagerly lapping at your sodden box, desperately trying to bring you to orgasm even as lube spurts liberally from between her legs, signaling her impending climax.  You're closer, though, so close to the edge that you'd cum even if she stopped.  But she wouldn't dare, instead grasping your thighs and shoving her face between your [legs], slurping her tongue through you with mind-wrecking speed.");
	outputText("\n\nYou jam your fist as far into " + flags[GOO_NAME] + " as you can before you cum, making her shriek in pleasure and sending reverberations through your cunt as you rocket over the edge.  Your [cunt] practically explodes with femcum, showering " + flags[GOO_NAME] + "'s face with it as your box squeezes down on her tongue, trapping her inside you as you pound her box, throwing her into orgasmic throes beneath you, her tongue writhing and squirming inside you to further your pleasure.");
	outputText("\n\nWhen your second orgasm passes, you roll limply off of " + flags[GOO_NAME] + ", utterly sated.  Your [chest] heaving, you sigh peacefully as you close your heavy lids, eager to rest.  A moment later, though, you feel slick skin press against your own as " + flags[GOO_NAME] + " curls up beside you, her face inches from your own.  With a wan smile, you reach out and run your fingers through her hair before pulling her into a long kiss that leaves the taste of womanhood on your lips.");
	//{Low happiness}
	if(gooHappiness() < 33) outputText("\n\n\"<i>If it's always going to be like that, maybe... being here with you isn't going to be so bad after all,</i>\" " + flags[GOO_NAME] + " whispers.");
	//{Moderate happiness}
	else if(gooHappiness() < 66) outputText("\n\n\"<i>I'm sorry I got so forceful, [name].  I enjoy serving you... I do.</i>\"");
	//{High happiness}
	else outputText("\n\n" + flags[GOO_NAME] + " nuzzles against you, her head coming to rest on your [chest].  \"<i>Sorry, [name]. I didn't mean to try and force you.  I love you when you're so assertive, so... dominant.</i>\"");
	stats(0,0,0,0,0,-2,-100,0);
...
public function tryToAssertMaleDomWhileLatexGooDrains():void {
	...
	outputText("\n\nBut this isn't how it's supposed to be!  You're supposed to be in control here, not " + flags[GOO_NAME] + ".  She's meant to serve you, not force herself on you like some goblin slut.  You struggle against her, grabbing " + flags[GOO_NAME] + "'s hair and pulling back, forcing her off your cock with all your strength.  She tumbles back, coughing and gagging, her mouth still locked in an 'O' meant for your [cock biggest].  You dust yourself off, struggling upright before standing, looming over " + flags[GOO_NAME] + " who looks meekly up at you.  \"<i>I... I...</i>\" she starts, but you cut her off, rolling her onto her belly and hiking her plump little ass up.  You sigh, starting to remind her of exactly who's in charge here, of how you're always here to feed her, and yet she tries to force herself on you like that...  Unacceptable. As you speak, you grab her plush buttcheeks, digging your fingers into her backside until a little moan escapes her lips.  \"<i>That's more like it,</i>\" you growl, flopping your [cock biggest] down between her cheeks, rubbing it across the smooth, yielding latex of her ass.");
	
	outputText("\n\n\"<i>I'm sorry, [Master],</i>\" " + flags[GOO_NAME] + " mewls meekly, but the slut inside her starts wiggling her rump, her cheeks gently squeezing around your manhood.  Still, you 'tsk' at her as you begin to slowly rock your [hips], hotdogging yourself between her gropable buttcheeks, enjoying the onahole-like feel, even as latex lube starts to drip to the ground from between " + flags[GOO_NAME] + "'s legs, her body desperately announcing its desire to fuck.  Despite the orgasm that just wracked your body, you can feel your lust stirring, too, spurred on by the oral onslaught " + flags[GOO_NAME] + " attempted to inflict on you.  You give your [cock biggest] one last, rough thrust between her cheeks before pulling back, stroking yourself until your [cockHead biggest] presses against her lube-slicked cunt.  You rub the shaft of your prick along her slick, eager fuckhole, letting her liquid latex lube slosh out onto you as " + flags[GOO_NAME] + " continues to whorishly wiggle her ass, trying to entice you to feed her.");
	outputText("\n\nOnce your [cock biggest] is nice and slick with her vaginal excretions, though, you pull back again and dig your fingers back into " + flags[GOO_NAME] + "'s ass, spreading her lush cheeks apart to reveal the tight little star of her backdoor.  " + flags[GOO_NAME] + " gasps as she feels your crown press against her asshole, her mouth opening wide as your oh-so-wet prick plunges the first inch into her without resistance.  You groan with satisfaction as her vice-tight hole squeezes down around your slick shaft, desperately, reflexively trying to repel the intruding cockmeat; but you're so slick, so covered in liquid latex that " + flags[GOO_NAME] + "'s stunned body can't resist you, and you begin to slide inch after inch into her, burying yourself to the hilt in a single long, painfully slow push.");
	outputText("\n\nYou pause once you've hilted her, breathing deeply as you enjoy the intense squeeze her anus is applying to you, reveling in the sensation of smooth latex rubbing harshly along your goo-covered shaft, unable to gain traction.  Your fingers knead into " + flags[GOO_NAME] + "'s supple assflesh, working her cheeks like dough in your hands, roughly massaging her backside until she starts to relax around you.  \"<i>Good girl,</i>\" you whisper, reaching forward to stroke " + flags[GOO_NAME] + "'s hair.  \"<i>That's a good girl, just relax.  Take it...  You wanted it so bad.</i>\"");
	outputText("\n\n\"<i>I-I'm sorry, [Master],</i>\" " + flags[GOO_NAME] + " repeats, her breath choking up as you grind your hips into her, pushing just a touch more prick into her ass.  \"<i>I didn't mean to...  I'll be a good girl, I promise,</i>\" she whines, groaning as you slowly pull out of her, retracting your cock until just the head remains.  \"<i>Fuck me, [Master], pleeeeaaaassssseeee,</i>\" she cries, \"<i>just fuck me, fuck me, fuck me!</i>\"");
	outputText("\n\nYou grab her hips and slam forward, hilting yourself again in a single thrust. " + flags[GOO_NAME] + " cries out, her voice echoing in the distance as you roughly pound her asshole, thrusting into her again and again until you can feel yourself approaching your limit, the near-frictionless hole you're hammering too good to pass up.  But " + flags[GOO_NAME] + " still hasn't been properly put in her place.  You're supposed to be in control here, not her.  You protect her, feed her, care for her, and she still thinks she can control you.  Unacceptable.  You push back into her, forcing yourself in to the hilt, and stop.  You hold yourself utterly still, simply enjoying the smooth liquid feel of her latex-coated ass.");
	outputText("\n\n\"<i>M-[Master]?  Please...</i>\" " + flags[GOO_NAME] + " begs, looking pleadingly over her shoulder.  \"<i>I'm still so hungry...</i>\"");
	outputText("\n\nAs soon as she says \"<i>hungry,</i>\" you strike. With palm open, you level a harsh stroke across " + flags[GOO_NAME] + "'s backside, sending her ass quivering.  You gasp with delight as the force of your spank carries right through her, making the latex inside her jiggle wildly around your [cock biggest].  " + flags[GOO_NAME] + " sucks in breath through her onyx teeth, but looks back at you with a look filled with lust, as if she can sense how close you are.  She wiggles her ass again, almost invitingly.  You lash out again, spanking her hard enough to nearly knock the two of you over; then again, and again, each time nearly pushed over the edge by the jiggle in her butt after your attack.");
	outputText("\n\nEventually, you can take no more.  You feel the rush of semen hurtling through your [cock biggest], and with one last smack, send yourself over the edge.  You throw your head back and roar your pleasure into the sky as cum pours out of your cock-slit and into " + flags[GOO_NAME] + "'s hungry ass, painting her ebony rectal walls white.  As spunk pours out of you, " + flags[GOO_NAME] + " moans lewdly, hungrily, an orgasmic look on her face as the pain of the spanking is replaced by the satisfaction of your seed flowing into her.");
	outputText("\n\nWhen your second orgasm passes, you roll limply off of " + flags[GOO_NAME] + ", utterly sated.  Your [chest] heaving, you sigh peacefully as you close your heavy lids, eager to rest.  A moment later, though, you feel slick skin press against your own as " + flags[GOO_NAME] + " curls up beside you, her face inches from your own.  With a wan smile, you reach out and run your fingers through her hair before pulling her into a long kiss that leaves your own taste on your lips.");
	//{Low happiness}
	if(gooHappiness() < 33) outputText("\n\n\"<i>If it's always going to be like that, maybe... being here with you isn't going to be so bad after all,</i>\" " + flags[GOO_NAME] + " whispers.");
	//{Moderate happiness}
	else if(gooHappiness() < 66) outputText("\n\n\"<i>I'm sorry I got so forceful, [name].  I enjoy serving you... I do.</i>\"");
...
public function femalePCDomFucksLatexGoo():void {
	clearOutput();
	outputText("You start to undress, remarking to " + flags[GOO_NAME] + " that you've got an itch she'd be great at scratching.  As if your language wasn't clear enough, you ");
	...
	if(gooObedience() < 60) {
		...
		if(flags[GOO_DICK_LENGTH] > 0) outputText(" and the rigidity of her " + gooCock() + " have");
		else outputText(" has");
	...
	outputText(".  Arching your back, you grab hold of " + flags[GOO_NAME] + " by the ankles and drag her against you.  She whimpers at the pressure on her nethers, too sensitive to endure what you're forcing her to experience.  A high-pitched trill of excitement splits the air.  " + flags[GOO_NAME] + " is cumming, hard by the sounds of it.  Hot, inky discharge splatters across your [clit] and into your [vagina].");
	...
	if(flags[GOO_DICK_LENGTH] > 0) outputText("  Her " + gooCock() + " practically bursts from within, distending to accommodate its lurid latex discharge.  Most of it splatters against " + flags[GOO_NAME] + "'s skin and rolls down her flesh in a march of onyx droplets.");
	...
	outputText("\n\nYou mash your [vagina] against " + flags[GOO_NAME] + "'s a few more times to savor the aftershocks of climax.  She grunts each time, her mouth widening into simple 'o's.  The sensuously skinned lady fails can't even scream any more.  The best she can do is moan, low and lewd as you finish using her.  As you slowly begin to separate, a tangle of sable webs hangs in the air, glittering with a coating of femcum.  Some of them are already semi-solid and snap at your withdrawal.  The others just come apart, wetly slapping against each twat as they separate.");
	...
	//{ALT:
		...
		outputText("\n\n" + flags[GOO_NAME] + " enthusiastically puts her tongue to work, and at her touch, the inky substance melts away.  The parting fluid washes you with warmth as it vanishes into your pet's mouth, one drop at a time.  She greedily devours her leavings along with your copious, post-orgasmic lubrication, hungrily devouring it all.  Her tongue dives inside you to clean out your passageway.  Pistoning back and forth, she fucks you with it, making a meal for herself and carrying the liquid latex away on waves of your own lady-lubricants.  " + flags[GOO_NAME] + " appears intent on slaking her unnatural thirst, and she continues to stimulate and drink long past when you think she'd be done.");
		//{FIRST TIME}
		if(flags[LATEX_GOO_TIMES_FEMDOMMED_BY_PC] == 0) {
			outputText("\n\n" + flags[GOO_NAME] + " will not relent.  You command her, \"<i>Stop, I'm clean!</i>\"  She doesn't.  You push her away with a [foot], nearly dropping as two feet of tongue unspool from your tongue-gaped vagina.   She pants up at you, then tries again.  You boot her back down, this time pinning her under a leg.  " + flags[GOO_NAME] + "'s tongue reaches out, but you grab it in your hand and push her forehead back down with her other.  She whimpers.  Calmly, you tell her that next time you request a cleaning, she had better stop on command.");
			outputText("\n\n" + flags[GOO_NAME] + " blinks raven-hued tears away, understanding at last.  You release her and step rise, feeling a twinge of fresh arousal.  Your pet appears humbled but sated.  Best of all, she's left a puddle of onyx cunt-juice below her, freshly excreted while she was restrained.  Good girl.");
		}
		//{REPEAT}
		else outputText("\n\n" + flags[GOO_NAME] + " obeys, remembering the last time.  Two feet of tongue unspool from your [vagina] as she retracts it.  Her shining face obediently lowers in a bow, but you swear you can see a smile twisting the corners of her mouth.  You tell her she's a good pet, and a fresh flow of wetness escapes from her nethers.");
		flags[LATEX_GOO_TIMES_FEMDOMMED_BY_PC]++;
	}
	stats(0,0,0,0,0,-2,-100,0);
...
public function femalePCDomFucksLatexGooFuta():void {
	clearOutput();
	outputText("You begin to remove your [armor] under " + flags[GOO_NAME] + "'s curious eye.  She asks, \"<i>[name], what are you doing?</i>\"");
	outputText("\n\nWith a salacious wiggle of your [hips], you tell her that you're going to fuck her - to ride her shining pole to orgasm after orgasm.  " + flags[GOO_NAME] + "'s " + gooCock() + " immediately stiffens, hard and proud.  ");
	//{NOT OBEDIENT ENOUGH}
	if(gooObedience() < 60) {
	...
	if(flags[GOO_DICK_LENGTH] * flags[GOO_DICK_LENGTH]/6 > player.vaginalCapacity()) outputText("  Of course, as gigantic as it is, you can't take all of it, but you do your damnedest to try.");
	else outputText("  Soon, your [butt] comes to rest against " + flags[GOO_NAME] + "'s oily skin, her erection nestled nicely inside you.");
	...
	cuntChange(flags[GOO_DICK_LENGTH] * flags[GOO_DICK_LENGTH]/6,true,true,false);
	...
	outputText("\n\n" + flags[GOO_NAME] + " begs, \"<i>May I kiss you, please [Master]?  I-I'm gonna cum soon!</i>\"");
	...
	outputText("\n\nYou clench down on the " + gooCock() + " without warning, immediately setting to massaging it with your velvety interior.  Your pussy seems to know just what to do in order to get what it wants, and " + flags[GOO_NAME] + " is no match.  She stutters, \"<i>G-g-g-onna... OHGODS!</i>\" and begins to spurt, sputtering streams of onyx goop straight into your womb.  Her lips crush back into place, silencing her whimpers of bliss");
...
public function malePCDomFucksLatexGoo():void {
	clearOutput();
	outputText("You open your [armor] to expose your " + multiCockDescriptLight() + " to your latex-based lover.  She eyes it with unabashed affection and licks her lips unthinkingly, already tasting the flavor of semen on her tongue.  " + flags[GOO_NAME] + " jolts out of her reverie to ask, \"<i>What are you doing");
	if(gooObedience() > 50) outputText(", [Master]");
	outputText("?</i>\"");
	outputText("\n\nYou take her chin in your palm and tilt her up to look at you as you explain.  You intend to fuck her nice and hard.  Then, you're going to blow a nice thick load in her stretchy, gooey little pussy until there's ribbons of white dripping out of her slit.  " + flags[GOO_NAME] + " blushes violet at your proclamation.  Between her knees, a few drops fall unbidden to the ground.  Solid black nipple");
	if(flags[GOO_NIPPLE_TYPE] == 1) outputText("-cock");
	...
	//{OBEDIENT ENOUGH}
	outputText("\n\nBlowing you a seductive kiss, " + flags[GOO_NAME] + " purrs, \"<i>And how would you like to take me today, [Master]?  In my ass?  In my pussy?  Or do you want to fuck my mouth?</i>\"");
	...
	outputText(".  Past her mouth, her insides become far less solid.  It feels like a mass of warm goo that deep inside her, and combined with the feel of her slippery tongue caressing the underside of your " + cockDescript(x) + ", you feel like you're in heaven.");
	if(player.cockTotal() > 1) {
	...
	outputText("\n\n" + flags[GOO_NAME] + "'s vibrant " + flags[GOO_EYES] + " eyes look up at you as her cheeks hollow to provide suction.  You groan again, this time slowly pulling her head back.  As she withdraws, her slick black spit drips from your dick, though much of it gradually hardens into a reflective sheath for your tool.  You draw her off until only your " + cockHead(x) + " remains inside that suckling pleasure-hole.  Then, you slam her down, fucking her mouth");
	...
	outputText("\n\nWith her looking at you like that, fuck... you're cumming!  You pull her lips tight into your abdominal " + player.skinFurScales() + " and release the boiling bliss within you.  Your jizz jumps out of you in thick ropes, as if it was seeking to escape all this time and just now found freedom.  " + flags[GOO_NAME] + " smiles around your " + cockDescript(x) + " as it pumps its virile goo down her throat, and she grabs hold of your [butt] to press herself against you harder.");
	if(player.cumQ() >= 500) outputText("  Squirts of spooge run out of her nostrils after a particularly potent blast, but " + flags[GOO_NAME] + " doesn't mind or even break her gaze.");
	...
	outputText("\n\n" + flags[GOO_NAME] + " licks her lips and admires the latex sheath her spit has molded around [oneCock].  \"<i>One hole down, [Master].</i>\"  She holds up a hand, fingertips lengthening as they grow razor-sharp nails.  Those prickly claws press into your ");
	if(player.balls > 0) outputText("[sack]");
	else outputText("[cock biggest]");
	outputText(" without warning, and you hold very, very still.  They stroke you with immaculate, teasing care, somehow feeling good in spite of the traceries of red irritation they leave in their wake.  " + flags[GOO_NAME] + " tickles them across your taint longingly before retracting them wistfully and asking, \"<i>Are you ready for my pussy?</i>\"");
	...
	if(flags[GOO_DICK_LENGTH] > 0) outputText("  The " + gooCock() + " below noisily fires inky loads into the dirt, where it's quickly absorbed.");
	
	outputText("\n\nStaggering back, you rest against a boulder.  In the process, your " + cockDescript(x) + " exits " + flags[GOO_NAME] + "'s swelteringly sticky slit.  Webs of glittering black lube dangle from your tip to her entrance, mixed with spermy strands of semen.  Transfixed, you watch them break, one by one snapping back to the closest set of genitals.  A bubbly voice cheers, \"<i>That's number two!");
	if(player.cumQ() >= 1000) outputText("  And so messy!  I don't know if I can hold any more!");
	outputText("</i>\"  A hand that appears to be wearing a latex glove smears the juices that hang from " + flags[GOO_NAME] + "'s mound up and through her crack, coating her asshole with your leftover sperm.");
	...
	outputText("\n\n" + flags[GOO_NAME] + " slides off you, going flat on the ground and into a puddle ");
...
public function feedLatexySomeMilk():void {
	clearOutput();
	outputText("You cup your hands under your milk-laden breasts and ask " + flags[GOO_NAME] + " if she's hungry.");
	//{Not hungry}
	...
	else outputText("  Before you've even completed your offer, " + flags[GOO_NAME] + " is on you like a moth to a flame, eagerly pulling at your clothes to try and free your teats.");
	outputText("\n\nYou lead " + flags[GOO_NAME] + " off to a nearby rock, and pull yourself up to a sitting position.  With a smile, your latex girl curls up on your lap, her soft, smooth arms affectionately wrapped around your shoulders.  You spare a moment to brush her long, sleek hair, running your fingers through the smooth strands as your other hand works to strip off your [armor].  Eventually, you disrobe, your milky teats popping free of your garments, [nipples] stiffening in the cool air.  " + flags[GOO_NAME] + " opens her mouth hungrily, but to your surprise, presses her lips to yours before she drinks, locking you in a long, loving kiss.  You return her affection, holding her tight against you, embracing the hungry goo before finally guiding her head down to your needy [chest].");
	outputText("\n\nA tiny gasp escapes your lips as " + flags[GOO_NAME] + "'s cool, smooth lips brush against your stiff nipple, the tip of her tongue just brushing against your sensitive flesh.  You moan as her full ebony lips finally lock around your teat, her long fingers holding your full breast as the first little suckle brings a drop of milk from within you, depositing it squarely into " + flags[GOO_NAME] + "'s waiting palate.  A moment later, a full stream is pouring forth from you, your latex goo's oral skill tapping deep into your lactic reserves.  You roll your head back and moan lustily as " + flags[GOO_NAME] + " suckles eagerly from you, her cheeks bulging slightly between each swallow, struggling to keep up with the flood of breastmilk she's taking from you.");
	outputText("\n\n\"<i>Delicious,</i>\" " + flags[GOO_NAME] + " says with a grin, popping off one of your teats to tend to the other, leaving thick trails of sable saliva connecting her lips to your nipple until you brush them away with your thumb, your finger caressing her chin and cheek.  She nuzzles your hand, a sound not unlike a purr escaping her lips before she slips down, rubbing her cheek against your other breast.  \"<i>Mmm, I love the taste,</i>\" she giggles girlishly, resting her head a moment on your chest.  \"<i>You're wonderful, [name].  So good.</i>\"");
	outputText("\n\nYou smile and ruffle " + flags[GOO_NAME] + "'s hair, giving her a gentle nudge toward your other needy tit.  Rather than suckle, she plants a quick kiss right on the tip of your [nipple], sending a shiver of pleasure rolling through you.  Before you've recovered, " + flags[GOO_NAME] + "'s attached herself to you, her hands wrapped tight around your breast as her tongue flicks across your teat, teasing the first droplets of milk from you.  As she urges your first drops into a proper stream of warm, wonderful milk, you curl your fingers through " + flags[GOO_NAME] + "'s hair and pull her tight against you, gently arching your back so that her face is wholly buried in your milky bosom.  She giggles into your titflesh, her laugh letting tiny rivulets of milk trickle down her chin and onto her own massive bosom, the contrast of white smearing onto black catching your eye even as her ebony tongue swirls around your sensitive bud.");
	//{elseif PC has both}
	if(player.hasCock() && player.hasVagina()) outputText("\n\nAs she suckles, " + flags[GOO_NAME] + "'s hands wander downward, her fingers brushing tantalizingly across your supple flesh until her smooth tips find your dual genitals.  One hand quickly wraps around your half-turgid shaft as the other plunges into your slick and eager fuckhole, both aroused and ready by the teasing and suckling you're getting.  " + flags[GOO_NAME] + " moves her hands in unison, one drawing up to the crown of your [cock biggest] as the other plunges deep into your vaginal depths before both release, pulling down to the base or withdrawing to the tips before going again and again.");
	//{If PC has a cock}
	else if(player.hasCock()) {
		outputText("\n\nAs she suckles, " + flags[GOO_NAME] + "'s hand wanders downward, her fingers brushing tantalizingly across your supple flesh until her smooth tips rub against the half-hard shaft of your [cock biggest].  You stifle a gasp as the latex girl wraps her fingers around your prick, needing only the slightest touch to get you nice and turgid.  She moves her hand in slow, languid motions, slowly drawing her unnaturally smooth hands up and down your shaft, from crown to base, giving gentle twists and squeezes in time with her suckling upon your teat.");
	}
	//{elseif PC has cunt}
	else if(player.hasVagina()) outputText("\n\nAs she suckles, " + flags[GOO_NAME] + "'s hand wanders downward, her fingers brushing tantalizingly across your supple flesh until her smooth tips rub against the outer folds of your [vagina].  You only just stifle a gasp as her long fingers slip into your ready hole, already aroused and eager to fuck.  Her hand moves into you, feeling like an unnaturally flexible dildo as she pushes inches of latex into you, each thrust in time with a suckle of your teat.");
	//{elseif PC ain't got shit, captain}
	else outputText("\n\nAs she suckles, " + flags[GOO_NAME] + "'s hands wander downward, her fingers brushing tantalizingly across your supple flesh until her smooth tips send a shiver up your spine, her knuckles running across your exposed [asshole] as she works her fingers into your [butt].  With no other genitalia on offer, you grit your teeth as " + flags[GOO_NAME] + " slithers a smooth finger into your rectum, pushing into your ass with agonizing slowness, tiny thrusts in and out timed with her suckling from your teat.");
	//{Combine, next paragraph}
	outputText("\n\nUnder the latex girl's combined milking and sexual advances, you feel an orgasm rising deep in your gut.  You steel yourself, trying to hold out a moment longer as " + flags[GOO_NAME] + " intensifies her assault, suckling every last drop from you as her fingers work wonders upon your ");
	...
	outputText(".  Suddenly, your teat pops free of her mouth, a streak of milk still spraying until " + flags[GOO_NAME] + " is liberally coated with your white orgasmic offering, laughing girlishly as she licks her fingers and brings her own breast to her mouth, trying to tongue off the milk splattered on her.");
