...
function faerieRAEP():void {
	...
	if(player.isTaur()) {
		...
		//[All other clits:
			...
			//[Small amount of cum:
			if(player.vaginas[0].vaginalWetness <= 2) outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid seeps about her and your " + vaginaDescript(0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a small puddle of femcum.\n\n", false);
			//[Normal amount of cum:
			else if(player.vaginas[0].vaginalWetness <= 4) outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid squirts around her and your " + vaginaDescript(0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a puddle of femcum.\n\n", false);
			//[Huge amount of cum:
	...
	//Non-Taurs
		...
		//(too big) (else – hump dat shit)
			...
			outputText("She jumps onto it, making it bounce in the air as it takes her relatively insubstantial weight.  Embracing it in a full-body hug, she starts grinding on it, smearing her thick faerie juices into the clit and giggling everytime you twitch from the feeling.  You squirm, sinking down from the raw sensation, your " + player.legs() + " giving out underneath you.   Grabbing hold of a stump, your try to steady yourself, but the faerie humping your " + clitDescript() + " is interfering with your motor ability, and you slump into the forest loam, happily twitching as orgasm washes over you.\n\n", false);
...
function faerieDoNothing():void {
	...
	if (player.clitLength >= 1.0 && player.clitLength <= 4.5 && player.hasVagina() && rand(2) == 0) {
		...
		if(player.vaginas[0].vaginalWetness >= 4) outputText("You drench the poor faerie completely in your female juices, soaking her hair and body. Overwhelmed and spent, you drop her to the ground and catch your breath. She licks up what's around her face, but is too weak to do anything else but lie in the dirt.\n\n", false);
...
function faerieCaptureHJ():void {
	...
	if(player.isTaur()) {
		...
		if(player.cockTotal() > 0) outputText("largest " + cockNoun(CockTypesEnum.HUMAN), false);
	...
	//Non-taurs
		...
		else if(player.cocks[0].cockType == CockTypesEnum.HUMAN) outputText("climbs atop your " + cockDescript(0) + ", hanging onto your ring of prepuce and wrapping her legs as far around your horse-like maleness as she can.  ", false);
