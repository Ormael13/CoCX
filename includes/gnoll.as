...
//Gnoll Description
public function gnollAttackText():void {
	var damage:Number = 0;
...
public function gnollTease():void {
	...
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", (bonus + 10 + player.lib/20 + rand(player.cor/20)), "cor", 0);
	outputText("\n", false);
}
...
public function yoDawgHyenaBallz3():void {
	...
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 2, "sen", -10, "lus", -100, "cor", 0);
	cleanupAfterCombat();
}
/*
--------------------
