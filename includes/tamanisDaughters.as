...
function legTamanisDaughtersRAEPYou():void {
	...
	//[NO FIT]
		...
		//[Tamani is There]
			...
			//(MULTI)
			if(cocks > 2) {
				outputText("Meanwhile your other " + cockNoun(0) + "s are wasting their spunk over your belly, so some of the waiting girls grab them and pull them aside, ramming their tips deep inside their seemingly bottomless fuck-holes.  They giggle and run their manicured nails over your ", false);
				if(player.biggestTitSize() < 1) outputText("chest", false);
				else outputText(allBreastsDescript(), false);
			...
			//(SINGLE EXTRA)
				...
				outputText("Meanwhile your other " + cockNoun(0) + " is wasting its spunk over your belly, so one of the waiting girls grabs it and pull it to the side, ramming its tip deep inside her seemingly bottomless fuck-hole.  She giggle and runs their manicured nails over your ", false);
				if(player.biggestTitSize() < 1) outputText("chest", false);
				else outputText(allBreastsDescript(), false);
				outputText(", circling your sensitive nipples", false);
				if(player.biggestLactation() >= 1) {
