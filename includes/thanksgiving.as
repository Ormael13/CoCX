...
public function tenderizeDatPigSloot():void {
	...
	if(player.tailType > classes.AppearanceDefs.TAIL_TYPE_NONE) outputText("You even bring your tail from behind your back to join in, the unfamiliar texture causing the sausage slut to let out surprised, high-pitched squeaks. ");
