...
public function datTurkeyRumpMeeting():void {
	...
	classes.EngineCore.simpleChoices("Let Approach", letZeTurkeyApproach, "Shoo Away", shooTurkeyAway, "", null, "", null, "", null);
}

//Shoo her Off -McGirt
public function shooTurkeyAway():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("You scowl and wave your arm at the strange turkey-girl, telling her to get lost.");
	...
	classes.EngineCore.doNext(classes.EventParser.playerMenu);
}
...
public function letZeTurkeyApproach():void {
	...
	classes.EngineCore.simpleChoices("Baste Her", basteThatTurkeyBooty, "No Thanks", noThanksTurkeyGal, "", null, "", null, "", null);
}
...
public function stuffDatTurkeyWithSpoo():void {
	...
	if(flags[kFLAGS.HEL_FUCKBUDDY] == 1 && flags[kFLAGS.HEL_REDUCED_ENCOUNTER_RATE] == 0) {
		...
		classes.EngineCore.simpleChoices("Spit-Roast", spitRoastThatTurkey, "", null, "", null, "", null, "That's Enough", thatllDoTurkey);
	}
	else classes.EngineCore.doNext(thatllDoTurkey);
}
...
public function femaleLetZeTurkeyGalApproach():void {
	...
	classes.EngineCore.simpleChoices("Appetizer", turkeyAppetizer, "Main Course", femaleAndTurkeyMainCourse, "Dessert", haveTurkeyGirlDesertInYourCunt, "", null, "", null);
}

//Appetiser:
public function turkeyAppetizer():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("Biting back a moan as the girl continues to tease you, your own hands reach out to her wrists, reluctantly pulling her hands away and placing them on her own thighs.  She seems disappointed as you shift in your seat, but before she can voice her displeasure you slide up to her, snaking an arm around her back as you start to play with her oversized rack.  She gasps slightly as you heft her plush breasts, kneading and squeezing them as your fingers circle around her hardening nipples.");
	...
	player.orgasm();
	classes.EngineCore.doNext(femaleAndTurkeyMainCourse);
}
...
public function femaleAndTurkeyMainCourse():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("Fully disrobed, the girl runs her hands down her chest, fingers clamping around her dribbling nipples once again.  With another squeeze, gravy is rolling down her chest once more, slathering her fingers with her own mouthwatering juices.  Unable to hold yourself back, your mouth clamps onto her breast, hands shooting to her soft, plush rear as you pull her bodily into your lap.  Her eyes almost light up in her new position, her hands running through your [hair] as you suck for all you're worth.  Her thick, rich gravy fills your mouth with its delicious mix of flavours.  There's so many different, wonderful tastes mixing together that you could almost believe you were back in Ingnam, gorging yourself on the gigantic spread that the village always strives to put on, regardless of how well the harvest went.");
	...
	classes.EngineCore.doNext(haveTurkeyGirlDesertInYourCunt);
}
	
//DESERT
public function haveTurkeyGirlDesertInYourCunt():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("Barely able to contain yourself, you nearly tear your [armor] from your burning body, desperate to feel the girl with your bare flesh.  She reclines lazily on the ground, legs spreading wide as a hand moves from her dribbling tits, sliding its way down her toned stomach to her swollen lips.  She continues to tease herself whilst you struggle with your clothes, little moans and grunts of pleasure leaving you weak at the knees as she dreamily circles her reddening snatch with a finger.  Her other hand busies itself with her chest, pinching and squeezing just hard enough to release another spurt of gravy that rolls its way down the curve of her breast, dripping onto her belly in a thick glob.");
...
public function turkeyGirlTwoTheTurkeningBySavinWhatADickInAButt():void {
	...
	classes.EngineCore.outputText("\n\n“<i>G-gobble?</i>”  she asks quietly, her big blue eyes pleading at you.");
	classes.EngineCore.awardAchievement("Gobble Gobble", kACHIEVEMENTS.HOLIDAY_THANKSGIVING_II, true, true, false);
	...
	if(player.hasCock())
	{
		if(player.hasKeyItem("Deluxe Dildo") >= 0 || player.hasItem(consumables.L_DRAFT) || player.hasItem(consumables.F_DRAFT)) {
			...
			classes.EngineCore.addButton(2,"Hello Again",helloAgain);
	...
	classes.EngineCore.addButton(0,"Shoo Off",shooTurkeyAway);
	classes.EngineCore.addButton(1,"Let Her Come",letZeTurkeyApproach);
}

public function helloAgain():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("\"<i>Oh, hey, you,</i>\" you say as the seasonal little near-harpy waddles up.  You pat your thigh invitingly, letting Gobbles approach.");
	...
	if(player.cockArea(0) <= 60) classes.EngineCore.outputText("and down to the base");
	else classes.EngineCore.outputText("and swallowing your shaft until her throat is bulging with your massive manhood");
	classes.EngineCore.outputText(".  She bobs up and down your length, hefting up her huge rack when she's at the peak to rub your sensitive underside, trying to titfuck you but just too damn big to get them into the action.  You suppose you'll have to take care of that...");
	classes.EngineCore.menu();
	classes.EngineCore.addButton(0,"Next",gravyBoatDatTurkturk);
	//Gravy boat?
}
...
public function gravyBoatDatTurkturk():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("You cup the turkey's chin, pulling her up off your cock enough to get her looking up at you with her big, questioning eyes.  \"<i>Gobble?</i>\" she ventures nervously, straining against your hand to get back at your shaft.");
	...
	if(player.cocks[0].cockThickness >= 5) classes.EngineCore.outputText(", her stomach bulging obscenely with your inhuman girth");
	classes.EngineCore.outputText(".");
...
public function seasonHerDatTurkeyBitch():void {
	...
	if(player.hasKeyItem("Deluxe Dildo") >= 0) classes.EngineCore.outputText("Tamani's dildo");
	else if(player.hasItem(consumables.L_DRAFT)) classes.EngineCore.outputText("a bottle of Lust draft");
	else if(player.hasItem(consumables.F_DRAFT)) classes.EngineCore.outputText("a bottle of Fuck draft");
	else classes.EngineCore.outputText("A FUCKIN ERROR");
	classes.EngineCore.outputText(".  You pull it out and squeeze a copious load of the bubblegum pink aphrodisiac out into your hand.  The second it touches your skin, you feel a palpable warmth spreading out through your nerves, skin burning with sensitivity as the roiling, viscous substance pools in your cupped hand.  You can't help but shudder as the pink veno's effect reaches out through your body, setting your whole person to tingling - and especially your [cocks], which rises to an almost painful hardness.");
	...
	classes.EngineCore.menu();
	classes.EngineCore.addButton(0,"Next",turkeyDesertBitches);
}

//Dessert
public function turkeyDesertBitches():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("\"<i>G-gobble!?</i>\" Gobbles whines at your moment of hesitation, wiggling her upraised botty at you enticingly, hot flesh jiggling just close enough to brush your [cocks] with her lust-coated cheeks.");
	...
	if(player.biggestTitSize() > 1) classes.EngineCore.outputText(", cupping a tit");
	classes.EngineCore.outputText(" as the venom takes control, flushing your skin and forcing out all thoughts but one: fuck that turkey! There's nothing for it, now: you grab Gobbles' hips and plunge in");
	if(player.cockTotal() == 2) classes.EngineCore.outputText(" with both cocks, one ramming into her abused cunny and the other right up her vulnerable little bumhole");
	else if(player.cockTotal() > 2) classes.EngineCore.outputText(" with every cock you've got, half in the pink and half in the stink, spreading her as wide as you are in both barrels");
	classes.EngineCore.outputText(", shocking her so much that she can't hold back, screaming and cumming on the spot! You groan, thrusting forward as her spasming muscles contract around your cock");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(", milking you as hard as she can while her orgasm overtakes her.  Gravy geysers out of her swollen tits as fem-cum splashes out around your deep-buried cock");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(", drenching your [hips] and [legs] in creamy girl-spunk, tinged pink by the poison you fist-fucked up her cunt.");
	
	classes.EngineCore.outputText("\n\nThe squawking turkey seems to be depthless, easily swallowing up every inch of your [cocks] until ");
	if(player.cockArea(0) >= 50) 
	{
		classes.EngineCore.outputText("her stomach is bulging obscenely with the sheer volume of cockflesh rammed up her cunt");
		if(player.cockTotal() > 1) classes.EngineCore.outputText("and ass");
	}
	else classes.EngineCore.outputText("your hips are slapping into hers, making her butt bounce with the impact");
	classes.EngineCore.outputText(".  She cries her one word to the heavens as you pound into her hole");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(", thrusting your cock");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(" deep inside.  Her avian legs break free of her hold, wrapping around your [hips] and pulling you in, locking you in her spasming hole");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(" as she cums and cums, pleading, \"<i>Gobble!</i>\" at the top of her lungs.  You switch your grip to her bountiful bosom, roughly squeezing her tits as you hump your cock");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(" in and out of her slick slit{and quivering behind}, pinching her nipples to give the squealing turkey just a little more pleasure.");
	...
	if(player.cockTotal() > 1) classes.EngineCore.outputText(" and ass");
	classes.EngineCore.outputText(", her legs spurring you on every time you withdraw, muscles clenching when you pause, never letting you rest.  Needy slut! But she's more than willing to do her part, thrusting her hips up to meet you, squeezing and milking your cock");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(" every time you pierce her, working your shaft");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(" so expertly that you know you won't be able to hold on for long - and neither will she, the way she's panting and gasping along with you!");
	
	classes.EngineCore.outputText("\n\nYou draw nearer to the breaking point, hips unrelentingly slamming your shaft");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(" deep into Gobbles' eager depths, urged on by her happy squawks and gleeful cries.  Lust-venom-addled as the two of you are, orgasm approaches like a wave of relief, crashing through your bodies in beautiful unison.  \"<i>Gobbles!</i>\" she cries as her cunt ");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("and ass ");
	classes.EngineCore.outputText("squirm around your cock");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(", wringing the cum from you with powerful spastic contraction.  Her arms pull you down into the valley of her gravy-laden bosom, squeezing your face between her massive mounds as she cums, drawing the spunk right out of you.  With a potent, feral roar, you cum, [cocks] blasting its salty load deep into Gobbles' womb");
	if(player.cockTotal() > 1) classes.EngineCore.outputText(" and bowels");
	classes.EngineCore.outputText("; her back arches, teats wobbling around your head as she takes your cum, squawking and gobbling gaily as more and more of your virile spunk pours into her, mixing with her own fem-cum and the remnants of the lusty draft your fucked into her.");
	
	classes.EngineCore.outputText("\n\n\"<i>Gobble!</i>\" she sighs happily as your cock");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s deposit the last of their");
	else classes.EngineCore.outputText(" deposits the last of its");
	classes.EngineCore.outputText(" cream into her, fully stuffing your turkey-girl.  Panting, you let your head rest between her tits a moment long, shaft");
	if(player.cockTotal() > 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(" wilting inside her until like a broken dam, her cunt");
	if(player.cockTotal() > 1) classes.EngineCore.outputText(" and ass");
	classes.EngineCore.outputText(" begin");
	if(player.cockTotal() == 1) classes.EngineCore.outputText("s");
	classes.EngineCore.outputText(" to drool spunk, pooling onto the hungry ground with the gallons of spilt gravy and fem-spooge.");
...
public function pigSlutRoastingGreet():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("As you enter The Wet Bitch you’re accosted by an incredibly busty waitress. You can’t really discern what exactly she is as your eyes are solely focused on the massive melons jutting out from her chest and jiggling proudly with mile deep cleavage to boot.");
	...
	classes.EngineCore.awardAchievement("Thankslutting", kACHIEVEMENTS.HOLIDAY_THANKSGIVING_I, true, true);
	//{Lust = lust + 10}
...
public function getARoastPiggueOinkOinkOinkMotherfucker():void {
	classes.EngineCore.clearOutput();
	player.gems -= 1;
	classes.EngineCore.outputText("You quickly approach the gooey bucket and toss a single, shiny gem inside. Another waitress winks at you, almost equally as busty, nodding her head in the direction of the back rooms.");
	...
	classes.EngineCore.outputText("\n\n");
	if(player.hasVagina()) classes.EngineCore.outputText("\n\nYour [vagina] drools pussy juice down your [legs] as y");
	else classes.EngineCore.outputText("Y");
	classes.EngineCore.outputText("our nostrils flare, taking in great amounts of the salacious stench.");
...
public function tenderizeDatPigSloot():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("\"<i>Turn over.</i>\" you say rather plainly, eager to see that jiggling booty of hers.");
	...
	if(player.tailType > classes.AppearanceDefs.TAIL_TYPE_NONE) classes.EngineCore.outputText("You even bring your tail from behind your back to join in, the unfamiliar texture causing the sausage slut to let out surprised, high-pitched squeaks. ");
	classes.EngineCore.outputText("You notice the pigslut moving backwards, her ass being pushed into the air as she attempts to feel the full power of your spanking, her pussy spraying juices onto the soaked sheets.");
	...
	//[ Hardcore ] [ Softcore ]
	classes.EngineCore.menu();
	classes.EngineCore.addButton(0,"Softcore",hamRoastTenderizeHerSoftcore);
	classes.EngineCore.addButton(1,"Hardcore",tenderizeHerHardcore);
}

//Ham Roast -> Tenderize Her -> Hardcore
public function tenderizeHerHardcore():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("You can't help but maliciously smirk, your eyes resting on a fetish whip and some bondage equipment. You give the piggy one last double-handed spank on her ample ass, leaving her a pitifully moaning and quivering wreck. You quickly snatch up the whip, some rope, and a kinky ballgag.");
	...
	//[ Next ]
	classes.EngineCore.menu();
	classes.EngineCore.addButton(0,"Next",spankEpilogueColonYoureAHorriblePersonForAbusingADumbPigGirl);
	//{Route to: here}
}
...
public function hamRoastTenderizeHerSoftcore():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("You can't help but let a salacious smile grace your lips, your eyes resting on a paddle in the corner. You give the piggy one last double-handed spank on her ample ass, leaving her a pitifully moaning and quivering wreck. You quickly snatch the somewhat heavy paddle, feeling its heft and grinning like a madman.");
...
public function spankEpilogueColonYoureAHorriblePersonForAbusingADumbPigGirl():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("Eventually you stop your ceaseless romping of her rear, the piggy whore blubbering into the now thoroughly torn pillow from her biting and tearing. Several strips of flesh from her reddened ass look practically raw from your activities. You lay an experimental finger on the tortured flesh, the blazing heat radiating from it telling you all you need to know.");
...
public function spankEpilogueForRizzles():void {
	...
	//[ Next ]
	classes.EngineCore.menu();
	classes.EngineCore.addButton(0,"Next",getDoneEatingOutPigSlut);
}

public function getDoneEatingOutPigSlut():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("Finally you remove yourself from the still slightly dribbling juicebox, giving the whore one last spank as she seems to have passed out from the bliss. The bed is entirely a mess, covered with her sticky juices and torn from the spanking.");
	...
	if(player.thickness < 100) {
		classes.EngineCore.outputText("  You notice that you seem a bit more... jiggly, a slight paunch in your stomach now as you grow a bit more plump than you once were.");
	...
	if(player.buttRating < 35) {
		classes.EngineCore.outputText("  You notice your ass filling out, gaining more mass as it visibly grows before your eyes.");
	...
	if(player.hipRating < 35) {
		classes.EngineCore.outputText(" Your hips grow too, widening and giving you more sexy curves.");
	...
	if(player.biggestTitSize() < 20) {
		classes.EngineCore.outputText(" Your boobs also grow, gaining size as it seems that every part of your body wants to join in on the growth.");
