...
public function helCleavage():void {
	...
	//Attack 3 – Lust – Cleavage (Failure)
		...
		dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", lust, "cor", 0);
		//Apply resistance
...
public function helFuckMenu():void {
	spriteSelect(68);
...
public function helTailPegging():void {
	spriteSelect(68);
	outputText("", true);
