...
public function mainMenu(e:MouseEvent = undefined):void 
{
	...
	addButton(1, "Settings", gameSettings.settingsScreenMain, null, null, null, "Configure game settings and enable cheats.");
	...
	if (CoC_Settings.debugBuild) addButton(8, "Debug Info", debugInfoMenu.debugPane, null, null, null, "View debug information.");
}
