...
public function helpBrookeOut():void {
	...
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", 15 + player.lib/20, "cor", 0, "resisted", false);
...
public function talkWithBrookeAboutWorkingOut():void {
	...
	if(player.inte < 50) dynStats("str", 0,"tou", 0, "spe", 0, "int", .5, "lib", 0, "sen", 0, "lus", 0, "cor", 0);
	brookeAffection(4);
	doNext(13);
}
...
public function talkToBrookeAboutGymFolks():void {
	...
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", 15, "cor", 0, "resisted", false);
	brookeAffection(4);
	doNext(13);
}
...
public function brookeSpecialMediumSceneContinued():void {
	...
	if (x >= 0 && !player.hasVagina()) {
		...
		dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0-2, "lus", -100, "cor", 0);
		fatigue(10);
	}
	//{Female only}
