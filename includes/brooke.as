...
function brookeAffection(arg:Number = 0):Number {
...
function brookeCapacity():Number {
	return 60;
}
...
function meetBrookeFirstTime():void {
	clearOutput();
	outputText("After yet another successful, and rewarding, workout, you begin your way down the hallways of the gym back to your favourite machine in the building.  Even after putting in so much effort, you’ve yet to finish – you still have to work <i>every</i> muscle, after all.  However, as you walk down the halls, breath still heavy and feeling the sweat drip off your brow, you pause, taking a few sniffs.  Once you’re out of the gym and into somewhat fresher air, you smell something, and it smells <i>rank</i>.  Smelling around a bit, you lift an arm and whiff your pit – it’s you!  Maybe, for once, you should actually have a wash; as you are now, the monsters would smell you long before they’d see you.");
...
//Third encounter; body tone 30 minimum
function brookeThirdEncounter():void {
	clearOutput();
...
function lowAffectionBrookeMeeting():void {
	clearOutput();
...
function mediumLowBrookeAffectionOneTime():void {
	clearOutput();
...
// [=Don't help=]
function dontHelpBrookeShower():void {
	clearOutput();
...
function mediumLowBrookeAffection():void {
	clearOutput();
...
function mediumBrookeAffectionMeetingAfterSex():void {
	clearOutput();
...
//[=Working Out=]
function talkWithBrookeAboutWorkingOut():void {
	clearOutput();
	...
	if(player.inte < 50) stats(0,0,0,.5,0,0,0,0);
	brookeAffection(4);
	doNext(13);
}
 
//[=Gym Members=]
function talkToBrookeAboutGymFolks():void {
	clearOutput();
	...
	stats(0,0,0,0,0,0,15,0,false);
	brookeAffection(4);
	doNext(13);
}
 
//[=Her Rockin Bod=]
function brookesRockinBod():void {
	clearOutput();
...
function doubleDicked():void {
	...
	outputText("\n\nAs ready as you are, you don't rush her.  You hold her by the ass once again, keeping her steady against your body, while she leans into your [chest], using one hand to stabilize herself and using the other to align your tools.  When they're both in position, she takes a deep breath, and starts to slide down.");
	...
	outputText("\n\nYou look down to her abdomen.  Her abs are plainly visible, as she flexes again and again, making tiny adjustments to her resting on your crotch, and you delightedly feeling each one.  ");
...
function mediumAffectionOneTimeEvent():void {
	clearOutput();
...
function brookeSpecialMediumSceneContinued():void {
	clearOutput();
	var x:int = player.cockThatFits(brookeCapacity());
	...
	if(x >= 0 && !player.hasVagina()) {
		...
		outputText("\n\nHer orgasm reminds you of your own, coming up very quickly.  She spends only a moment to herself as her world begins to calm down from the shattering orgasm you just gave her, and she resumes her rocking, intent on returning the favour.  <i>\"Come on, [name],\"</i> she practically growls at you.  <i>\"Give it to me.  Fuck me harder.  I want your cum, [name].  I want it all.  Make me your bitch, [name].  Fuck me like a whore.  Fuck me, you sexy fucking beast, <b>fuck me!</b>\"</i>");
	...
	//{Herms only}
		...
		outputText("\n\nYou pump your hips with Brooke's hands as one glides easily up and down your lubricated " + cockDescript(x) + " while the other begins to gently pump into your [vagina], all the while her tongue continues to bathe your [chest].  You cradle her head in your own hands, unable to do much else with how she's treating your body.  Finally, she gets down to business, dropping her to knees and bringing herself face-to-face with your equipment.");
		
		//[if (cocks = 1)]
		if(player.cockTotal() == 1) outputText("\n\nShe can hardly contain herself as she sets her tongue to work once again.  She opens wide and sucks you into her, clamping her mouth gently shut around your meat, minding her teeth.  She takes it slowly, contrast to her apparent eagerness: she eases her head down, slowly taking it more and more, until her nose presses against your pelvis and she slowly begins to rise back up.  However, all the while, her tongue is going a mile a minute, pressing and playing, teasing and tasting, working every nerve you have in your sensitive " + cockDescript(x) + ".  The attentions make you melt into her mouth, and the sounds of her 'mmm'ing with every pass just get you that much more excited.");
		//[if (cocks = 2)]
		...
		//[if (cumNormal = true)]
		if(player.cumQ() <= 250) outputText("  Your cum erupts into the Shepherd girl, pumping into her hard, and she continues to coax as much as she can with each ripple her orgasm gives her.  It's the grandest orgasm you've had some time, and it takes a good few moments before you finally calm down.");
		//[if (cumMedium = true)]
		...
		//[if (isSquirter = true)
		else outputText("  Whatever's left of your energy goes into your neglected cunt as it erupts itself, spraying its own juices down your legs and onto the shower floor.  Your pussy quivers and cums long and hard, squirting in time with [eachCock], the warm fluids mingling and contrasting with the cooling shower water.  As it winds down with the rest of you, you're conflicted with reaching down and giving your feminine half some special attention, and simply not touching anything, afraid that the sensations would be too much for your addled body.");
		...
		outputText("\n\nYou laugh, approaching Brooke and giving her a slap on her thigh.  Her skin doesn't yield at all and her body barely flinches from the strike.  Still, she plays along, 'ooh'ing after your playful slap.  <i>\"Alright, I'll be honest, [name], that was something else.\"</i>  She leans forward, wrapping herself lovingly around you once more.  <i>\"Next time I'll only put half as much effort into working out so I'll have more energy to fuck you with.  You better return the favour, you hot bitch, or I won't play nice next time.\"</i>");
...
function specialHeckelAndBrookeEncounter():void {
	clearOutput();
	...
	outputText("\n\nIn one of the corners of the room, you hear a bit of a commotion.  Despite the size of the room, the echoes of the commotion make it a bit confusing just where the noise is coming from.  Do you look to your left, towards the butterfly machines, or do you look to your right, towards the leg press?");
...
//[=Leave=]
function leaveHeckelEncounter():void {
	clearOutput();
...
//[=Butterfly=]
function butterflyMachinesGooooo():void {
	clearOutput();
...
function brookeAndHeckelStuffPartTwo():void {
	clearOutput();
...
function submitHeckelXBrookeThreesome():void {
	clearOutput();
	...
	if(!player.hasCock() && player.hasVagina()) outputText("burying her muzzle into your [vagina] and immediately gets to work digging and searching your tunnel with her warm, moist, energetic tongue.  She licks and kisses and worships everything from your vulva to your [clit] and when she gets bored of that, she thrusts her whole face into you once more, finding some new depth neither of you thought she could reach.  All the ");
...
function brookeAndHeckelStuffPartThree():void {
	clearOutput();
...
//[=Leg Press=]
function legPressInsteadOfThreesome():void {
	clearOutput();
...
function brookeVHeckelBrookeWins2():void {
	clearOutput();
...
function brookeVHeckelBrookeWins3():void {
	clearOutput();
