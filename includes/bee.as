...
function beeGirlRapeForTheDistinguishedGentleman():void {
	...
	//[(if dick)
	if(player.hasCock()) outputText("stroke your " + cockNoun(CockTypesEnum.HUMAN), false);
