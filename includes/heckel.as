...
function greetHeckel():void {
	...
	else if(brookeAffection() >= 70 && flags[BROOKE_MEDIUM_SCENE] > 0 && flags[MET_HECKEL] > 0 && this.model.time.hours >= 13 && this.model.time.hours <= 15 && (player.hasVagina() || player.cockThatFits(brookeCapacity()) >= 0)) {
...
function dominateHeckelConclusion():void {
	...
	if(flags[PC_FETISH] > 0) outputText("You grin and blush hotly, imagining the whole of the gym watching you fuck this hyena, their watchful eyes exciting you further.");
