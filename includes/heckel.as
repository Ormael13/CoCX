...
function heckelLovesAnal2():void {
	...
	//[<MALE PC>
	else if(player.hasCock()) outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your " + ballsDescriptLight() + " and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your " + ballsDescriptLight() + " get tight as your trapped " + cockNoun(CockTypesEnum.HUMAN) + " twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
	//[<FEMALE PC>
...
function dominateHeckel():void {
	clearOutput();
	outputText("Smirking, you fold your arms and tell her to bend over - ");
	if(flags[TIMES_DOMMED_HECKEL] == 0) outputText("there's a new top dog just waiting to claim the town bitch");
	else outputText("you're back for a taste of your favorite bitch");
	outputText(".  Heckel snorts, \"<i>Nice try, fuck-meat, but ");
	if(flags[TIMES_DOMMED_HECKEL] > 0) outputText("last time was a fluke");
	...
	if(flags[TIMES_LOST_HECKEL_DOM_CHALLENGE] > 0) outputText(" again");
	...
	if(player.str < 75) {
		...
		flags[TIMES_LOST_HECKEL_DOM_CHALLENGE]++;
	}
	//{Win}
	else {
