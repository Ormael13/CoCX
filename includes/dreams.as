		...
		//Scylla + dom + dong
			...
			if(player.gender <= 1) {
				...
				//Male Trap Dream #2: 
					...
					outputText("\n\n\"<i>Come on sis, hurry!</i>\"  The young girl pulls on you with surprising strength, you don't have any time to collect yourself as you are tugged along through some sort of mansion.  Various elaborately decorated hallways and rooms flash by you, only able to catch glimpses of each room's contents.  You try not to stumble and trip over your lovely dress as you follow the strange girl.  \"<i>They set everything up nearly an hour ago, but they have been waiting for you, of course.  I reminded you to set the alarm.</i>\" You say something of an apology to the young girl, she seemed so distressed at everything.  You couldn't help but feel guilty.");
