	...
	if(dreamtemp > 5) {
		...
		if(daydream == 0) {
			if(player.cor <= 33) { 
				...
				if(rand(2) == 0) classes.EngineCore.outputText("tender sex with a sweetheart back home.  ");
				else {
					classes.EngineCore.outputText("beautiful nude ");
					if(player.gender <= 1 || (player.gender == 3 && rand(2) == 0)) classes.EngineCore.outputText("women ");
					else classes.EngineCore.outputText("men ");
					classes.EngineCore.outputText("massaging you, slowly moving their hands over your most intimate places.  ");
				}
			}
			if(player.cor > 33 && player.cor <= 66) {
				classes.EngineCore.outputText("being violently raped and used by demons.  ");
			}
			if(player.cor > 66) {
				dreamtemp = rand(5);
				if(dreamtemp <= 3) classes.EngineCore.outputText("giving yourself to the demons fully, allowing yourself to be tied down and owned as your body is warped for their twisted pleasures.  ");
				else classes.EngineCore.outputText("being captured and taken to a rusted building with dark smokestacks that belch sweet purplish smoke.  Inside are rows of multi-dicked, huge breasted humans, approximately thirty of them.  Each is shackled with their legs spread and torso bent over, and each has tight fitting suction tubes fitting over their tits and cocks.  Every set of tubes is pulsing with suction, drawing rivers of sticky white fluids from its slave's over-endowed breasts and balls.  You shudder in horror and arousal as you realize the victims seem to be arranged by age, ending with an empty machine next to the youngest slut-cow.  The inhuman strength of your captors easily overpowers your struggles as you are forced into your shackles, the metal locks clicking with finality.  A funnel is forced into your mouth, force-feeding you slick corrupted fluids that taste like sex and make your head swim.  Your vision fades as you feel heat in your chest and groin, making you swoon from the drugged cocktail and pleasure of your new best friends – the suction tubes. All you can hear is your own desperate moans... no, wait... that was a dream... but it was so twisted and hot that you're still panting with lust.  ");
			}
		}
		//canine
		else if(daydream == 2) {
		...
		//Scylla + dom + dong
			...
			if(player.gender <= 1) {
				...
				//Male Trap Dream #2: 
					...
					if(player.hasCock()) classes.EngineCore.outputText("  [EachCock] is fully erect and throbbing.");
					else if(player.hasVagina()) classes.EngineCore.outputText("  Your [vagina] dripping wet with need.");
					classes.EngineCore.outputText("  You shudder as you recall the erotic dream you were just having, a hand caressing your aching loins.");
					//end dream
					//lust increase
				}
			...
			//Dream about living in a borrow and having lots and lots of kids.  Many furred, big eared bodies are running around and you feel the pregnant belly of your mate, or feel your own pregnant belly.
				...
				classes.EngineCore.outputText("finding yourself in an underground burrow, with many small furred bodies with large ears scurrying around all over.  The place is warm and cozy, while also filled with the smell of mice and sex.  You love it down here, and you love seeing all your energetic children running around and having fun.\n\n");
				classes.EngineCore.outputText("You have a great larder, able to feed everyone as much as they need.  It has never been a problem to keep it full.  It's a veritable paradise for a rodent such as yourself.  Then you find your way into the master bedroom and see its massive bed, the site where your great family was brought into existence.\n\n");
				
				if(player.gender == 1 || (player.gender ==3 && rand(2)==0)) {
					classes.EngineCore.outputText("Things blur for a moment, and you find your head resting against a pregnant belly, covered in fine fur.  The results of your virility as a father, and soon to be added to the great brood that you helped bring into this world...\n\n");
				} else {
					classes.EngineCore.outputText("Things blur for a moment, and you find yourself laying on the bed with your hands wrapped around your heavily pregnant belly.  The product of your fertility and the virility of your great mate, and soon to be added to the great brood you've already brought into the world...\n");
				}
			}
		}
...
public function dayTenDreams():void {
	...
	if(player.hasCock()) {
		if(player.cor < 50) {
			classes.EngineCore.outputText("Your task completed, you return through the portal to your home.  Exhausted but happy, the sight of your village fills you with a surge of emotions.  Most prominently, and perhaps most enjoyably: pride.  You did it.\n\n");

			classes.EngineCore.outputText("You drink and celebrate with your people long into the night, feasting and receiving accolades and praise.  It is a party the likes of which you have never seen, and rightfully so.  Never again will your village be threatened by the demons.  Late in the evening, you arrive at the home of your childhood and greet your mother.\n\n");

			classes.EngineCore.outputText("\"<i>Welcome back,</i>\" she smiles.\n\n");

			classes.EngineCore.outputText("\"<i>Thank you, Mom,</i>\" you respond, wrapping your arms around her and kissing her deeply.  Your hands take hold of her rear, gripping-\n\n");

			classes.EngineCore.outputText("Shocked awake, you blink as the light of your dying fire flickers dimly across the campsite.  That was...\n\n");

			classes.EngineCore.outputText("This place is getting to you.");
		}
		else {
			classes.EngineCore.outputText("Your task completed, you return through the portal to your home.  Exhausted but happy, the sight of your village fills you with a surge of emotions.  Most prominently, and perhaps most enjoyably: pride.  You did it.\n\n");
			...
			classes.EngineCore.outputText("\"<i>Thank you, Mom,</i>\" you respond, wrapping your arms around her and kissing her deeply.  Your hands take hold of her rear, gripping it in great handfuls and squeezing her possessively.  Nearly throwing her in the bed, you delight in her playful squeals.  Mounting her, you tear away her dress and plunge into her cunt.\n\n");

			classes.EngineCore.outputText("\"<i>Oooh, god!</i>\" she exclaims,  \"<i>Such a good boy!  Such a big boy!</i>\"\n\n");

			classes.EngineCore.outputText("\"<i>That's right, Mom,</i>\" you grunt, taking hold of her breast and sucking harshly on it.  \"<i>All grown up.</i>\"  You continue to grope her roughly as you pound into her cunt, slapping your balls into her thighs.  Her pussy squeezes you with a mother's love, and you soon find yourself dumping heaping loads of your spunk within her.  You rise, and bring your dick to her mouth so that she can clean you.\n\n");

			classes.EngineCore.outputText("As your mother laps at your shaft, coated in her juices, you look confidently down at her belly.  Though you love your mother, you're looking forward to having a daughter, and training her to love you just as much as a mother does. One day, perhaps even to replace her.\n\n");

			classes.EngineCore.outputText("You awaken in a sweat.  Fuck.");
		}
	}
	else {
		if(player.cor < 50) {
			...
			classes.EngineCore.outputText("\"<i>Welcome back,</i>\" he smiles.\n\n");

			classes.EngineCore.outputText("\"<i>Thank you, daddy,</i>\" you respond, wrapping your arms around him and kissing him deeply.  Your hands slip into his pants, lowering-\n\n");
			...
			classes.EngineCore.outputText("\"<i>Thank you, daddy,</i>\" you respond, wrapping your arms around him and kissing him deeply.  Your hands slip into his pants, lowering them and exposing his crotch.  Too excited to control yourself, you drag your lips down his chest before wrapping them around his cock and taking him into your mouth.  You pull him deep, teasing his balls with your lower lip.  Though it isn't necessary to gag - you could have swallowed him easily - you do anyway.  Daddy deserves a show.\n\n");

			classes.EngineCore.outputText("His cum splatters into your throat.\n\n");

			classes.EngineCore.outputText("You smile with glazed teeth as you straddle him in his bed and mount him.  Some disappointment lingers in you that you didn't just let daddy take your ass then and there, but the prospect of his cum flooding your womb and fertilizing you is too delightful to pass up.\n\n");

			classes.EngineCore.outputText("\"<i>Do you like it?</i>\" you ask, before moaning his name.\n\n");

			classes.EngineCore.outputText("\"<i>You're a good girl,</i>\" he answers.\n\n");

			classes.EngineCore.outputText("His balls gurgle as they fill you.  You squeal in delight and lick his chest, demonstrating your affection.  Clenching him tightly, you make sure not to spill daddy's seed, and imagine giving birth to a sexy, busty daughter, teaching her to love him.  One day, teaching her to replace you.\n\n");

			classes.EngineCore.outputText("You wake up in a sweat.  Fuck.");
		}
	}
...
public function displacerDreamII():void {
	...
	if(classes.EngineCore.silly()) classes.EngineCore.outputText("k");
	classes.EngineCore.outputText("not a drop of jism has escaped.");
	...
	classes.EngineCore.menu();
	classes.EngineCore.addButton(0,"Next",displacerDreamIII);
}

public function displacerDreamIII():void {
	classes.EngineCore.clearOutput();
	classes.EngineCore.outputText("The details of the dream immediately begin to slip away.  You strain your brain, trying to commit everything to memory, but it slips out of your mind like water through a sieve.");
