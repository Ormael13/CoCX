...
public function updatePregnancy():Boolean {
	...
	if (player.pregnancyIncubation > 1) {
		...
		if (player.pregnancyType == PregnancyStore.PREGNANCY_IMP) {			
			...
			if(player.pregnancyIncubation == 216) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("Considering the size of the creatures you've fucked, you hope it doesn't hurt when it comes out.</b>");
				if(player.cor >= 75) classes.EngineCore.outputText("You think dreamily about the monstrous cocks that have recently been fucking you, and hope that your offspring inherit such a pleasure tool.</b>");
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("making it difficult to function.</b>");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("and you wonder how much longer you have to wait.</b>");
				if(player.cor >= 75) classes.EngineCore.outputText("and you're eager to give birth, so you can get impregnated again by corrupted or monstrous cum filling out your eager womb.</b>");
				classes.EngineCore.outputText("\n");
			...
			if(player.pregnancyIncubation == 48) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("You estimate you'll give birth in the next few days.</b>\n");
				if(player.cor >= 75) classes.EngineCore.outputText("You find yourself daydreaming about birthing demons repeatedly, each time being re-impregnated by your hordes of lusty adolescent children.</b>\n");
				displayedUpdate = true;
			}
		}
		//Minotaur Pregnancy!
		if (player.pregnancyType == PregnancyStore.PREGNANCY_MINOTAUR) {			
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("making it difficult to function.</b>");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("and you wonder how much longer you have to wait.</b>");
				if(player.cor >= 75) classes.EngineCore.outputText("and you're eager to give birth, so you can get impregnated again by monstrous cocks unloading their corrupted seed directly into your eager womb.</b>");
				classes.EngineCore.outputText("\n");
				player.dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
			}
			if(player.pregnancyIncubation == 48) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("You estimate you'll give birth in the next few days.</b>\n");
				if(player.cor >= 75) classes.EngineCore.outputText("You find yourself daydreaming about birthing some huge monstrous beast, and raising it to fuck your wet pussy over and over.</b>\n");
			}
			if(player.pregnancyIncubation == 32 || player.pregnancyIncubation == 64 || player.pregnancyIncubation == 85 || player.pregnancyIncubation == 150) {
				displayedUpdate = true;
				//Increase lactation!
		...
		if (player.pregnancyType == PregnancyStore.PREGNANCY_BUNNY) {
			...
			if(player.pregnancyIncubation == 156) {
				classes.EngineCore.outputText("\n<b>The unmistakable bulge of pregnancy is visible in your tummy.  ");
				if(player.cor < 40) classes.EngineCore.outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("You find yourself wondering what giving birth to bunny-girls is like.</b>");
				if(player.cor >= 75) classes.EngineCore.outputText("You dreamily wonder if you could find a bunny willing to put more than two eggs inside you at once.</b>");
				player.dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
				classes.EngineCore.outputText("\n");
				displayedUpdate = true;				
			}
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("making it difficult to function.</b>");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("and you wonder how much longer you have to wait.</b>");
				if(player.cor >= 75) classes.EngineCore.outputText("and you're eager to give birth so you'll be able to get pregnant again.</b>");
				classes.EngineCore.outputText("\n");
				player.dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
			}
			if(player.pregnancyIncubation == 48) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("You estimate you'll give birth in the next few days.</b>\n");
				if(player.cor >= 75) classes.EngineCore.outputText("You find yourself daydreaming about birthing bunnies repeatedly, each time being re-impregnated with dozens of eggs from your lusty adolescent children.</b>\n");
				displayedUpdate = true;
			}
		}
		//Marblz Pregnancy!
		if (player.pregnancyType == PregnancyStore.PREGNANCY_MARBLE) {			
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("making it difficult to function.</b>");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("and you wonder how much longer you have to wait.</b>");
				if(player.cor >= 75) classes.EngineCore.outputText("and you're eager to give birth, so you can get fill your womb with a new charge.</b>");
				classes.EngineCore.outputText("\n");
				player.dynStats("spe", -3, "lib", 1, "sen", 1, "lus", 4);
				displayedUpdate = true;
			}
			...
			if(player.pregnancyIncubation == 85) {
				...
				if(player.biggestTitSize() <= 0) {
					classes.EngineCore.outputText("your chest has begun to feel a bit odd.  Your run your hands over it to find that your breasts have grown to around C-cups at some point when you weren't paying attention!  ");
					player.breastRows[0].breastRating = 3;
				}
				else if(player.biggestTitSize() <= 1 && player.mf("m", "f") == "f") {
					classes.EngineCore.outputText("your breasts feel oddly tight in your top.  You put a hand to them and are startled when you find that they've grown to C-cups!  ");
					player.breastRows[0].breastRating = 3;
				}
				else if(player.biggestTitSize() <= 10) {
					classes.EngineCore.outputText("your breasts feel oddly full.  You grab them with your hands, and after a moment you're able to determine that they've grown about a cup in size.  ");
					player.breastRows[0].breastRating++;
				}
				else {
					classes.EngineCore.outputText("your breasts feel a bit odd.  You put a hand on your chest and start touching them.  ");
				}
				if(player.biggestLactation() < 1) {
					classes.EngineCore.outputText("You gasp slightly in surprise and realize that you've started lactating.");
					player.boostLactation(player.breastRows.length);
				} 
				else {
					classes.EngineCore.outputText("A few drips of milk spill out of your breasts, as expected.  Though, it occurs to you that there is more milk coming out than before.");
		...
		if (player.pregnancyType == PregnancyStore.PREGNANCY_MOUSE || player.pregnancyType == PregnancyStore.PREGNANCY_JOJO) {
			...
			if (player.pregnancyIncubation == 120) {
				if (flags[kFLAGS.JOJO_BIMBO_STATE] >= 3 && player.pregnancyType == PregnancyStore.PREGNANCY_JOJO) { //Bimbo Jojo, stage 5
					...
					classes.EngineCore.outputText("\n");
					if (player.findPerk(PerkLib.Feeder) >= 0) classes.EngineCore.outputText("You grin at Joy's idea, but you can't simply mash her against your breasts and nurse her without some teasing first.");
					classes.EngineCore.outputText("You tell Joy that she can have some, but she has to ask nicely, like a good girl.\n");
			...
			if(player.pregnancyIncubation == 48) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("Afterwards you feel somewhat disgusted with yourself.</b>\n");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("You estimate you'll give birth in the next few days.</b>\n");
				if(player.cor >= 75) classes.EngineCore.outputText("You find yourself daydreaming about birthing hundreds of little babies, and lounging around while they nurse non-stop on your increasingly sensitive breasts.</b>\n");
			}
			if(player.pregnancyIncubation == 32 || player.pregnancyIncubation == 64 || player.pregnancyIncubation == 85 || player.pregnancyIncubation == 150) {
				//Increase lactation!
				if(player.biggestTitSize() >= 3 && player.mostBreastsPerRow() > 1 && player.biggestLactation() >= 1 && player.biggestLactation() < 2) {
		...
		if (player.pregnancyType == PregnancyStore.PREGNANCY_AMILY) {
			...
			if(player.pregnancyIncubation == 216) {
				...
				if(flags[kFLAGS.AMILY_FOLLOWER] == 1) classes.EngineCore.outputText("  Amily smiles at you reassuringly. \"<i>We do have litters, dear, this is normal.</i>\"");
				classes.EngineCore.outputText("</b>");
				classes.EngineCore.outputText("\n");
				player.dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
				displayedUpdate = true;				
		...
		if (player.pregnancyType == PregnancyStore.PREGNANCY_SPIDER || player.pregnancyType == PregnancyStore.PREGNANCY_DRIDER_EGGS) {	
			...
			if(player.pregnancyIncubation == 250) {
				...
				if(player.thickness > 60 && player.tone < 40) classes.EngineCore.outputText(" even for you");
				classes.EngineCore.outputText(", maybe you should cut back on all the food you've been consuming lately?</b>\n");
				displayedUpdate = true;	
			}
			if(player.pregnancyIncubation == 216) {
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.cor < 50) classes.EngineCore.outputText("  You shudder and shake your head, wondering why you're thinking such unusual things.");
				classes.EngineCore.outputText("</b>\n");
				displayedUpdate = true;
			}
			if(player.pregnancyIncubation == 32 || player.pregnancyIncubation == 64 || player.pregnancyIncubation == 85 || player.pregnancyIncubation == 150) {
		...
		if (player.pregnancyType == PregnancyStore.PREGNANCY_ANEMONE) {			
			...
			if(player.pregnancyIncubation == 185) {
				classes.EngineCore.outputText("\n<b>The unmistakable bulge of pregnancy is visible in your tummy.  ");
				if(player.cor < 40) classes.EngineCore.outputText("You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("Considering the possible fathers, you hope it isn't that big.</b>");
				if(player.cor >= 75) classes.EngineCore.outputText("You think dreamily about the cocks that have recently been fucking you, and hope that your offspring inherit such a divine pleasure tool.</b>");
				player.dynStats("spe", -1, "lib", 1, "sen", 1, "lus", 2);
				classes.EngineCore.outputText("\n");
				displayedUpdate = true;				
			}
			...
			if(player.pregnancyIncubation == 120) {
				...
				if(player.hasVagina()) classes.EngineCore.outputText(" and keeps your " + vaginaDescript(0) + " aroused from the constant tingling in your womb");
				classes.EngineCore.outputText(".</b>\n");
			...
			if(player.pregnancyIncubation == 72) {
				...
				if(player.cor < 40) classes.EngineCore.outputText("and constantly shifts and wriggles.  What manner of beast are you bringing into the world?</b>");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("and you wonder how much longer you have to wait.</b>");
				if(player.cor >= 75) classes.EngineCore.outputText("and you're eager to give birth, so you can get impregnated again by corrupted or monstrous cum filling out your eager womb.</b>");
				classes.EngineCore.outputText("\n");
			...
			if(player.pregnancyIncubation == 48) {
				classes.EngineCore.outputText("\n<b>You rub your hands over your bulging belly, lost in the sensations of motherhood.  ");
				if(player.cor < 40) classes.EngineCore.outputText("Afterwards you feel somewhat disgusted with yourself, but horny.</b>\n");
				if(player.cor >= 40 && player.cor < 75) classes.EngineCore.outputText("You estimate you'll give birth in the next few days.  You hope the birth is as erotically charged as the pregnancy has been.</b>\n");
				if(player.cor >= 75) classes.EngineCore.outputText("You find yourself daydreaming  about birthing cilia-covered worms, orgasming each time their thousands of stingers brush by your clit and fill it full of sensation-enhancing drugs.</b>\n");
		...
		//Frog Eggs
			...
			if(player.pregnancyIncubation == 8) {
				...
				if(player.hasVagina()) {
					...
					//pussy:
					if(player.hasVagina()) classes.EngineCore.outputText("  Against your [vagina], the slime feels warm and cold at the same time, coaxing delightful tremors from your [clit].");
					//[balls:
					else if(player.balls > 0) classes.EngineCore.outputText("  Slathered in hallucinogenic frog slime, your balls tingle, sending warm pulses of pleasure all the way up into your brain.");
					//genderless: 
					else classes.EngineCore.outputText("  Your [vagina] begins twitching, aching for something to push through it over and over again.");
					classes.EngineCore.outputText("  Seated in your own slime, you moan softly, unable to keep your hands off yourself.");
		...
		//Minerva Pregnancy
			...
			if (player.pregnancyIncubation == 216) {
				classes.EngineCore.outputText("<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>");
				displayedUpdate = true;
			}
			if (player.pregnancyIncubation == 144) {
				classes.EngineCore.outputText("<b>Your distended belly shows obvious signs of pregnancy.</b>");
				displayedUpdate = true;
			}
			if (player.pregnancyIncubation == 72) {
				classes.EngineCore.outputText("<b>Your belly is getting larger.  You feel like you're housing a twin.</b>");
				displayedUpdate = true;
			}
			if (player.pregnancyIncubation == 24) {
				classes.EngineCore.outputText("<b>Your belly is as big as it can get.  You have a feeling that you'll give birth to a twin soon.</b>");
				displayedUpdate = true;
			}
		...
		//Alraune Pregnancy
			...
			if (player.pregnancyIncubation == 120) {
				if (player.isAlraune()) classes.EngineCore.outputText("<b>You suddenly feel a change in the pitcher below your feet. It feels heavier than before.</b>");
				else classes.EngineCore.outputText("<b>Your belly increase in size as something not unlike pollen or nectar slowly drip out of your pussy.</b>");
				displayedUpdate = true;
			}
			if (player.pregnancyIncubation == 80) {
				if (player.isAlraune()) classes.EngineCore.outputText("<b>A delicious feeling of fullness originate from the bottom of your pitcher as you begin daydreaming about children.</b>");
				else classes.EngineCore.outputText("<b>Some fluids not unlike pollen or nectar flow out of your vagina and you can’t help but pat your inflating belly with motherly delight. Whatever is in there is growing nicely.</b>");
				displayedUpdate = true;
			}
			if (player.pregnancyIncubation == 40) {
				if (player.isAlraune()) classes.EngineCore.outputText("<b>Somehow due to the weight and delicious feeling in your pitcher you are certain you are pregnant with seeds. A soothing warmth fills you as you smile in delight of your motherhood.</b>");
				else classes.EngineCore.outputText("<b>Some fluids not unlike pollen or nectar flow out of your vagina and you can’t help but pat your inflating belly with motherly delight. Whatever is in there is growing nicely. Something tells you you will be giving birth soon.</b>");
				displayedUpdate = true;
			}
		}
		//Behemoth Pregnancy
			...
			if (player.pregnancyIncubation == 1152) {
				classes.EngineCore.outputText("<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.  However, you have a feel that it's going to be a very long pregnancy.</b>");
				displayedUpdate = true;
			}
			...
			if (player.pregnancyIncubation == 576) {
				classes.EngineCore.outputText("<b>Your belly is getting larger.</b>");
				displayedUpdate = true;
			}
			if (player.pregnancyIncubation == 288) {
				classes.EngineCore.outputText("<b>Your belly is as big as it can get.  You have a feeling that you'll give birth to a behemoth soon.</b>");
				displayedUpdate = true;
			}
	...
	if(player.buttPregnancyIncubation > 1) {
		if (player.buttPregnancyType == PregnancyStore.PREGNANCY_FROG_GIRL) {
			if(player.buttPregnancyIncubation == 8) {
				...
				//[cock:
				else if(player.hasCock()) classes.EngineCore.outputText("  Splashing against the underside of your [cocks], the slime leaves a warm, oozy sensation that makes you just want to rub [eachCock] over and over and over again.");
				//genderless: 
				else classes.EngineCore.outputText("  Your asshole begins twitching, aching for something to push through it over and over again.");
				classes.EngineCore.outputText("  Seated in your own slime, you moan softly, unable to keep your hands off yourself.");
				player.dynStats("lus=", player.maxLust(), "scale", false);
				displayedUpdate = true;
			}
		...
		if (player.buttPregnancyType == PregnancyStore.PREGNANCY_BEE_EGGS) {
			...
			if(player.buttPregnancyIncubation == 20) {
				...
				if(player.cockTotal() > 0) classes.EngineCore.outputText("The aroma seems to permeate your very being, slowly congregating in your ");
				if(player.cockTotal() == 1) {
					classes.EngineCore.outputText(cockDescript(0));
					if(player.horseCocks() == 1) classes.EngineCore.outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air, until your [cock] is twitching and dripping, the flare swollen and purple.  ");
					if(player.dogCocks() == 1) classes.EngineCore.outputText(", each inhalation making it thicker, harder, and firmer.  You suck in huge lungfuls of air, desperate for more, until your [cock] is twitching and dripping, its knot swollen to the max.  ");
					if(player.normalCocks() == 1) classes.EngineCore.outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air, until your [cock] is twitching and dripping, the head swollen and purple.  ");
					//FAILSAFE FOR NEW COCKS
					if(player.normalCocks() == 0 && player.dogCocks() == 0 && player.horseCocks() == 0) classes.EngineCore.outputText(", each inhalation making it bigger, harder, and firmer.  You suck in huge lungfuls of air until your [cock] is twitching and dripping.  ");
				}
				if(player.cockTotal() > 1) classes.EngineCore.outputText("groin.  Your [cocks] fill and grow with every lungful of the stuff you breathe in.  You suck in great lungfuls of the tainted air, desperate for more, your cocks twitching and dripping with need.  ");
				classes.EngineCore.outputText("You smile knowing you couldn't stop from masturbating if you wanted to.\n");
		...
		if (player.buttPregnancyType == PregnancyStore.PREGNANCY_SANDTRAP || player.buttPregnancyType == PregnancyStore.PREGNANCY_SANDTRAP_FERTILE) {
			if(player.buttPregnancyIncubation == 36) {
				...
				if(player.buttPregnancyType == PregnancyStore.PREGNANCY_SANDTRAP_FERTILE) classes.EngineCore.outputText(" bloated and full; the sensation isn't entirely unpleasant.");
				else {
					classes.EngineCore.outputText("increasingly empty, as though some obstructions inside you were being broken down.");
	...
	if (player.buttPregnancyIncubation == 1 && player.buttPregnancyType == PregnancyStore.PREGNANCY_BEE_EGGS) {
		classes.EngineCore.outputText("\n");
		classes.EngineCore.outputText("There is a sudden gush of honey-colored fluids from your ass.  Before panic can set in, a wonderful scent overtakes you, making everything ok.  ");
		if(player.cockTotal() > 0) classes.EngineCore.outputText("The muzzy feeling that fills your head seems to seep downwards, making your equipment hard and tight.  ");
		if(player.vaginas.length > 0) classes.EngineCore.outputText("Your " + vaginaDescript(0) + " becomes engorged and sensitive.  ");
		classes.EngineCore.outputText("Your hand darts down to the amber, scooping up a handful of the sticky stuff.  You wonder what your hand is doing as it brings it up to your mouth, which instinctively opens.  You shudder in revulsion as you swallow the sweet-tasting stuff, your mind briefly wondering why it would do that.  The stuff seems to radiate warmth, quickly pushing those nagging thoughts away as you scoop up more.\n\n");
		classes.EngineCore.outputText("A sudden slip from below surprises you; a white sphere escapes from your anus along with another squirt of honey.  Your drugged brain tries to understand what's happening, but it gives up, your hands idly slathering honey over your loins.  The next orb pops out moments later, forcing a startled moan from your mouth.  That felt GOOD.  You begin masturbating to the thought of laying more eggs... yes, that's what those are.  You nearly cum as egg number three squeezes out.  ");
		if(player.averageLactation() >= 1 && player.biggestTitSize() > 2) classes.EngineCore.outputText("Seeking even greater sensation, your hands gather the honey and massage it into your " + breastDescript(0) + ", slowly working up to your nipples.  Milk immediately begins pouring out from the attention, flooding your chest with warmth.  ");
		classes.EngineCore.outputText("Each egg seems to come out closer on the heels of the one before, and each time your conscious mind loses more of its ability to do anything but masturbate and wallow in honey.\n\n");
		classes.EngineCore.outputText("Some time later, your mind begins to return, brought to wakefulness by an incredibly loud buzzing...  You sit up and see a pile of dozens of eggs resting in a puddle of sticky honey.  Most are empty, but a few have hundreds of honey-bees emptying from them, joining the massive swarms above you.  ");
		if(player.cor < 35) classes.EngineCore.outputText("You are disgusted, but glad you were not stung during the ordeal.  You stagger away and find a brook to wash out your mouth with.");
		if(player.cor >= 35 && player.cor < 65) classes.EngineCore.outputText("You are amazed you could lay so many eggs, and while the act was strange there was something definitely arousing about it.");
		if(player.cor >= 65 && player.cor < 90) classes.EngineCore.outputText("You stretch languidly, noting that most of the drugged honey is gone.  Maybe you can find the Bee again and remember to bottle it next time.");
		if(player.cor >= 90) classes.EngineCore.outputText("You lick your lips, savoring the honeyed residue on them as you admire your thousands of children.  If only every night could be like this...\n");
		player.buttKnockUpForce(); //Clear Butt Pregnancy
		player.orgasm();
		player.dynStats("int", 1, "lib", 4, "sen", 3);
		if(player.buttChange(20, true)) classes.EngineCore.outputText("\n");
		if(player.buttRating < 17) {
			//Guaranteed increase up to level 10
			if(player.buttRating < 13) {
				player.buttRating++;
	...
	if (player.pregnancyType == PregnancyStore.PREGNANCY_BUNNY && player.pregnancyIncubation == 1) {
		...
		if(player.vaginas.length == 0) {
			classes.EngineCore.outputText("You feel a terrible pressure in your groin... then an incredible pain accompanied by the rending of flesh.  You look down and behold a vagina.  ");
			player.createVagina();
		}
		classes.EngineCore.outputText("A dangerous rumble comes from your womb, signaling that it's time to birth your body's cargo at last.  Your [legs] wobble unsteadily as your strength ebbs with every gush that erupts  from your now-broken water until you collapse on your " + buttDescript() + ", grunting and groaning.  At first it goes slow – there's just a few small contractions that are more strange than anything else, rippling down your " + vaginaDescript(0) + " and squirting out more of your pregnancy's fluid.  All too soon the tempo kicks up, and you feel something starting to stretch you wider and wider.\n\n");
		
		classes.EngineCore.outputText("You heave and push, instinctively driven to flex muscles you didn't even know you had to speed the super human labor you've entered into.  ");
		if(player.vaginalCapacity() < 60) classes.EngineCore.outputText("It hurts a little as your cervix starts to stretch wide");
		else classes.EngineCore.outputText("It actually feels kind of nice as your cervix is stretched wide");
		classes.EngineCore.outputText(", but somehow your body accommodates the forced dilation without too much discomfort.  It's soon forgotten as you feel your " + vaginaDescript(0) + " pushed into a large sphere, stretched around the inhuman form of your child as it squirms and writhes inside you on its path to freedom.  You grunt and flex, watching with disbelief as a tiny, rabbit-eared form slides from your slick canal into the grass, the process leaving your " + chestDesc() + " heaving with unexpected pleasure.\n\n");
		
		classes.EngineCore.outputText("The whole process starts over again – there's another one!  By now your well-stretched pussy is oozing both the birthing fluids and your own lubricants, and the second bunny-child slides down to bump into its sibling with ease.  You shake and shudder, groaning and spasming as you nearly cum from the stimulation, but in the end you're left panting and horny.  The two bunnies look like miniature people except for their ears, tails, and fuzzy legs.  Your children lick themselves clean before hopping up onto your " + chestDesc() + " and suckling your nipples for a while");
		if(player.lactationQ() > 500) classes.EngineCore.outputText(", growing fat from all the milk");
		classes.EngineCore.outputText(".  At last they finish, and with one last nuzzle, your strange bunny-children go hopping off, doubtless to find more of their own kind.\n\n");
		
		classes.EngineCore.outputText("You sink into restful unconsciousness, marveling at how stretchy and sensitive your " + vaginaDescript(0) + " feels now.");
	...
	if (player.pregnancyType == PregnancyStore.PREGNANCY_ANEMONE && player.pregnancyIncubation == 1) {
		...
		//[(if pc has 0-9 existing cocks)
			...
			//[(if cocks)
			if(player.cockTotal() > 0) classes.EngineCore.outputText(" below your " + player.multiCockDescriptLight());
			classes.EngineCore.outputText(". A sharp pinch lances through the nerves in your groin and sends your hands to it reflexively.  This smaller pain, coupled with the adrenaline and dopamine that have finally chased the fog from your head, is enough to pull your thoughts into focus for another attempt to remove your strange, parasitic offspring.  You shift your grip and pull a few more times, but the thing doesn't budge.  The handling of it only serves to make the stalk thicken and become stiff; gradually you notice that you're feeling the sensation of your own pulling not from the skin at the point of attachment but from the stalk itself, and this realization is accompanied by the ring of tentacles opening and pulling back to reveal the crown of a penis!  <b>You have a new anemone-penis!</b>");
			//[(dick slot 1 exists)
			if(player.cockTotal() > 0) classes.EngineCore.outputText("  The tentacles writhe around, rubbing against your " + player.multiCockDescriptLight());
			//(doesn't exist)
			else classes.EngineCore.outputText("  The tentacles curl inwards, rubbing on the head of your new blue pecker");
			player.createCock((4+rand(3)),1.2);
			player.cocks[player.cockTotal()-1].cockType = CockTypesEnum.ANEMONE;
			classes.EngineCore.outputText(" and you quickly become fully erect from the aphrodisiac they inject.  Over and over the tentacles caress [eachcock] sensually, leaving behind a tingling trail of vibrant pleasure");
			//[(if no dick1 and no balls)
			if(player.totalCocks() == 1 && player.balls == 0) classes.EngineCore.outputText("; you feel a pressure build below the shaft, near your asshole");
			classes.EngineCore.outputText(".  As the venom and the rubbing work you to the edge of climax, your muscles clench and a ");
			if(player.cumQ() < 100) classes.EngineCore.outputText("glob");
			else if(player.cumQ() < 500) classes.EngineCore.outputText("squirt");
			else classes.EngineCore.outputText("spray");
			classes.EngineCore.outputText(" of semen shoots from your new penis and lands on your ");
			//[(if boobs)
			if(player.biggestTitSize() >= 1) classes.EngineCore.outputText(allBreastsDescript() + " and ");
			classes.EngineCore.outputText("stomach");
			//[(dick1 exists)
			if(player.cockTotal() > 1) classes.EngineCore.outputText(", followed in short order by white squirts from [eachcock] remaining");
			classes.EngineCore.outputText(".  Your " + vaginaDescript(0) + " quivers and pulses as well, adding ");
			if(player.vaginas[0].vaginalWetness < classes.AppearanceDefs.VAGINA_WETNESS_SLICK) classes.EngineCore.outputText("a trickle");
			else if(player.vaginas[0].vaginalWetness < classes.AppearanceDefs.VAGINA_WETNESS_SLAVERING) classes.EngineCore.outputText("a squirt");
			else classes.EngineCore.outputText("nearly a cupful of fluid");
			classes.EngineCore.outputText(" from your female orgasm to the puddle on the ground below your ass.\n\n");
		...
		player.knockUpForce(); //Clear Pregnancy
		classes.EngineCore.outputText("Exhausted by the 'birth' and the climax, you slip into a doze.\n");
	}
	...
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyStore.PREGNANCY_IMP) {
		...
		classes.EngineCore.outputText("A sudden gush of fluids erupts from your vagina - your water just broke.  You grunt painfully as you feel wriggling and squirming inside your belly, muscle contractions forcing it downwards.  ");
		if(player.cor < 50) classes.EngineCore.outputText("You rue the day you encountered that hateful imp.  ");
		classes.EngineCore.outputText("The pain begins to subside as your delivery continues... replaced with a building sensation of pleasure.  Arousal spikes through you as the contractions intensify, and as you feel something pass you have a tiny orgasm.\n\nYet you feel more within you, and the contractions spike again, pushing you to orgasm as you pass something else.  It repeats, over and over, nearly a dozen times you birth and orgasm.  After an eternity of procreation and pleasure, you sense your ordeal is over and collapse, unconscious.");
		...
		if(player.averageLactation() > 0 && player.averageLactation() < 5) {
			classes.EngineCore.outputText("  Your breasts won't seem to stop dribbling milk, lactating more heavily than before.");
			player.boostLactation(.5);
		}
		//Lactate if large && not lactating
		if(player.biggestTitSize() >= 3 && player.mostBreastsPerRow() > 1 && player.averageLactation() == 0) {
			classes.EngineCore.outputText("  As you ponder the implications, <b>you realize your breasts have been slowly lactating</b>.  You wonder how much longer it will be before they stop.");
			player.boostLactation(1);
		}
		player.boostLactation(.01);
		//Enlarge if too small for lactation
		if(player.biggestTitSize() == 2 && player.mostBreastsPerRow() > 1) {
			classes.EngineCore.outputText("  <b>Your breasts have grown to C-cups!</b>");
			player.growTits(1, 1, false, 3);
		}
		//Enlarge if really small!
		if(player.biggestTitSize() == 1 && player.mostBreastsPerRow() > 1) {
			classes.EngineCore.outputText("  <b>Your breasts have grown to B-cups!</b>");
			player.growTits(1, 1, false, 3);
		}
	...
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyStore.PREGNANCY_MARBLE) {
		...
		if(flags[kFLAGS.MARBLE_NURSERY_CONSTRUCTION] < 100) {
			...
			classes.EngineCore.outputText("Marble seems to understand what happened, but is really disappointed with you, \"<i>Sweetie, why couldn't you wait until after I'd finished the nursery...?</i>\"");
			...
			//it's a boy!
			{
				...
				classes.EngineCore.outputText("The little boy is already starting to look like he is a few years old; he’s trotting around on his little hoofs.");
				//Increase the size of the PC’s hips, as per normal for pregnancies, increase birth counter
				if(player.hipRating < 10) {
					player.hipRating++;
					classes.EngineCore.outputText("After the birth your [armor] fits a bit more snugly about your " + hipDescript() + ".");
				}
				if (flags[kFLAGS.MARBLE_BOYS] == 0)
				//has Marble had male kids before?
				{
					classes.EngineCore.outputText("You notice that Marble seems to be deep in thought, and you ask her what is wrong.  She starts after a moment and says, \"<i>Oh sweetie, no, it's nothing really.  I just never thought that I'd actually be able to father a son is all.  The thought never occurred to me.");
				}
				//Add to marble-kids:
			...
			//it's a girl!
			{
				...
				classes.EngineCore.outputText("You give an almighty heave and finally manage to push the shoulders out. The rest is downhill from there.  Once you've pushed the child completely out, Marble lays you down on the ground.  You rest there for a few moments, trying to catch your breath after the relatively difficult birthing.  When you finally have a chance to get up, you see that Marble has a small cowgirl cradled in her arms, suckling on her nipple.  You can hardly believe that you managed to push out a girl that big!  Marble seems to understand and tells you that the child is actually a fair bit bigger now than when she came out.\n\n");
				classes.EngineCore.outputText("She helps you stand up and gives you the little girl to suckle for yourself.  ");
				if(player.statusEffectv4(StatusEffects.Marble) >= 20) {
					classes.EngineCore.outputText("As the child contentedly drinks from your " + nippleDescript(0) + ", Marble tells you, \"<i>Sweetie, somehow I know that our kids won't have to worry about the addictive milk.  It will only make them healthy and strong.</i>\"  You nod at her and put the child into the nursery.  ");
				} 
				else {
					classes.EngineCore.outputText("You put the child to your breast and let her drink down your milk.  You sigh in contentment and Marble says, \"<i>See sweetie?  It's a really good feeling, isn't it?</i>\"  You can't help but nod in agreement.  After a minute the little girl has had enough and you put her into the nursery.\n\n");
				}
				classes.EngineCore.outputText("The little girl is already starting to look like she is a few years old; she's trotting around on her little hooves.");
				//Add to marble-kids:
				flags[kFLAGS.MARBLE_KIDS]++;
			}
			//Increase the size of the PC's hips, as per normal for pregnancies, increase birth counter
	...
	if (player.pregnancyIncubation == 1 && player.pregnancyType == PregnancyStore.PREGNANCY_AMILY) {
		...
		classes.EngineCore.outputText("\n");
		if(player.vaginas.length == 0) {
			classes.EngineCore.outputText("You feel a terrible pressure in your groin... then an incredible pain accompanied by the rending of flesh.  <b>You look down and behold a new vagina</b>.  ");
			player.createVagina();
		}
	...
	if (player.pregnancyType == PregnancyStore.PREGNANCY_OVIELIXIR_EGGS && player.pregnancyIncubation > 0) {
		...
		if(player.pregnancyIncubation == 1) {
			...
			//Large egg scene
				...
				classes.EngineCore.outputText("A sudden shift in the weight of your pregnant belly staggers you, dropping you to your knees.  You realize something is about to be birthed, and you shed your [armor] before it can be ruined by what's coming.  A contraction pushes violently through your midsection, ");
				if(player.vaginas[0].vaginalLooseness < classes.AppearanceDefs.VAGINA_LOOSENESS_LOOSE) classes.EngineCore.outputText("stretching your tight cunt painfully, the lips opening wide ");
				if(player.vaginas[0].vaginalLooseness >= classes.AppearanceDefs.VAGINA_LOOSENESS_LOOSE && player.vaginas[0].vaginalLooseness <= classes.AppearanceDefs.VAGINA_LOOSENESS_GAPING_WIDE) classes.EngineCore.outputText("temporarily stretching your cunt-lips wide-open ");
				if(player.vaginas[0].vaginalLooseness > classes.AppearanceDefs.VAGINA_LOOSENESS_GAPING_WIDE) classes.EngineCore.outputText("parting your already gaping lips wide ");
				...
				if(player.clitLength > 5) classes.EngineCore.outputText("your massive cock-like clit, jacking it off with the slimy birthing fluids as lube.   It pulses and twitches in time with your heartbeats, its sensitive surface overloading your fragile mind with pleasure.  ");
				if(player.clitLength > 2 && player.clitLength <= 5) classes.EngineCore.outputText("your large clit like a tiny cock, stroking it up and down between your slime-lubed thumb and fore-finger.  It twitches and pulses with your heartbeats, the incredible sensitivity of it overloading your fragile mind with waves of pleasure.  ");
				if(player.clitLength <= 2) classes.EngineCore.outputText("your " + vaginaDescript(0) + " by pulling your folds wide and playing with your clit.  Another egg pops free from your diminishing belly, accompanied by an audible burst of relief.  You make wet 'schlick'ing sounds as you spread the slime around, vigorously frigging yourself.  ");
				classes.EngineCore.outputText("You cum hard, the big eggs each making your cunt gape wide just before popping free.  You slump down, exhausted and barely conscious from the force of the orgasm.  ");
				if(player.statusEffectv3(StatusEffects.Eggs) >= 11) classes.EngineCore.outputText("Your swollen belly doesn't seem to be done with you, as yet another egg pushes its way to freedom.   The stimulation so soon after orgasm pushes you into a pleasure-stupor.  If anyone or anything discovered you now, they would see you collapsed next to a pile of eggs, your fingers tracing the outline of your " + vaginaDescript(0) + " as more and more eggs pop free.  In time your wits return, leaving you with the realization that you are no longer pregnant.  ");
				classes.EngineCore.outputText("\n\nYou gaze down at the mess, counting " + eggDescript() + ".");
				player.orgasm();
				player.dynStats("scale", false);
			}
			classes.EngineCore.outputText("\n\n<b>You feel compelled to leave the eggs behind, ");
			if(player.hasStatusEffect(StatusEffects.AteEgg)) classes.EngineCore.outputText("but you remember the effects of the last one you ate.\n</b>");
			else classes.EngineCore.outputText("but your body's intuition reminds you they shouldn't be fertile, and your belly rumbles with barely contained hunger.\n</b>");
