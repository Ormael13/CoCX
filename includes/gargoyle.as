...
public function gargoyleConfidence(arg:Number = 0):Number {
	if(arg != 0) {
...
public function mindRitualPervy():void {
	...
	outputText("\n\n" + flags[GAR_NAME] + " lifts herself to perch atop the alter with a single beat of her wings, coming to rest cross-legged before you.  Grinning a sexy grin, she picks up the small waterbasin and lifts it up to her lips, taking a small drink of it.  \"<i>Blessed is " + player.mf("he","she") + " who seeks the pure,</i>\" she begins to chant, lowering the bowl from her thin lips. As she does so, she slowly raises her left leg, resting her toes upon your chin.  Locking eyes with you, " + flags[GAR_NAME] + " lowers the basin to her thigh and begins to pour, letting the water trickle sensually down her stone-smooth leg.  \"<i>Blessed is " + player.mf("he","she") + " who seeks wisdom,</i>\" she purrs as you instinctively open your mouth, allowing the holy water to trickle in from her foot.");
...
//[b]Talk[/b]
public function talkToGargoyle(output:Boolean = true):void {
	if(output) {
		clearOutput();
