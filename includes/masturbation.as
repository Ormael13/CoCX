...
public function onaholeUse():void
{
	...
	//If player is already flagged, show repeated use text!
		...
		dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", -.75, "lus", -100, "cor", 0);
		doNext(13);
		return;
	}
	//Multicock!
	if(player.cockTotal() > 1)  {
		...
		else dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", -.75, "lus", -100, "cor", 0);
		doNext(13);
	}
}
	...
	if(player.hasKeyItem("All-Natural Onahole") >= 0) {
		...
		//If player is already flagged, show repeated use text!
			...
			if(player.cor > 66) {
				...
				dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", -1.5, "sen", .75, "lus", -100, "cor", .5);
			}
	...
	if(player.hasKeyItem("All-Natural Self-Stimulation Belt") >= 0) {
		...
		//Multiple uses
			...
			if(player.cor < 50) {
				...
				dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", -1, "sen", .75, "lus", -100, "cor", 1);
				doNext(13);
			}
			//High corruption variant
			else {
				...
				dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", -.5, "sen", 1, "lus", -100, "cor", 1.5);
...
public function orgazmo(selfSucking:Boolean, nippleFuck:Boolean):void {
	...
	//DONE!
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", (-0.5), "lus", -100, "cor", 0);
...
public function meditate():void {
	...
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", -50, "cor", -.3);
	doNext(14);
}
...
public function getHugeEggsInCawk():void {
	...
	if(player.statusAffectv1("Exgartuan") == 1 && player.statusAffectv2("Exgartuan") == 0 && flags[kFLAGS.TIMES_EGGED_IN_COCK] == 0) {
		...
		if(followerShouldra()) outputText(", with Shouldra's assistance,");
		...
		outputText("\n\nYou struggle, ");
		if(followerShouldra()) outputText("ghost-assisted ");
...
public function tentacleSelfFuck():void {
	...
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", (-1*(1 + player.tentacleCocks())), "lus", -100, "cor", 0);
	doNext(13);
}
