...
function oasisTalkAccept():void {
	...
	if(player.lowerBody == 4) outputText("your rear legs losing their balance and sending you crashing on your flank.  ", false);
	...
	if(player.hasStatusAffect("Voluntary Demonpack") < 0) player.createStatusAffect("Voluntary Demonpack",0,0,0,0);
	else {
...
function oasisBadEnd():void {
	...
	outputText("After passing out from your latest orgy with the desert tribe, you wake up to find yourself still naked and laying on your back. ", false);
		//[If female/herm]
		if(player.lowerBody != 4) outputText("Your feet are locked up in shackles, though with a chain long enough to leave you room to move or walk without problems. ", false);
		if(player.lowerBody == 4) outputText("Your four legs are locked up in shackles, though with a chain long enough to leave you room to move or walk without problems. ", false);
