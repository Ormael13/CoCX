...
public function helpWithTheCandyCane():void {
	...
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 1, "sen", 1, "lus", 100, "cor", -5, "resisted", false);
	doNext(13);
}
...
public function KamiBlowJob():void {
	...
	dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", 20+player.lib/10+player.sens/10, "cor", 0);
...
public function lickNieve():void {
	...
	//Silly Mode:
		...
		dynStats("str", 0,"tou", 0, "spe", 0, "int", 0, "lib", 0, "sen", 0, "lus", -5-player.sens/5, "cor", 0);
	}
	doNext(13);
}
