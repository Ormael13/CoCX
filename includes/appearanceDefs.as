...
public static const TONGUE_ECHIDNA:int                                              =   4; //Literally unplayable. The other tongues are spelled incorrectly in code.
...
//public static const TAIL_TYPE_BEHEMOTH:int                                          =  18; //Mod only
public static const TAIL_TYPE_PIG:int                                               =  19;
//public static const TAIL_TYPE_SCORPION:int                                          =  20; //Mod only
...
//public static const TAIL_TYPE_SALAMANDER:int                                        =  25; //Mod only
...
//public static const LOWER_BODY_TYPE_RHINO:int                                       =  22; //Not used
