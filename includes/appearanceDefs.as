...
public static const PATTERN_TATTOO:int                                             =     1;
...
public static const TONUGE_CAT:int                               	                =   5;
...
public static const EYES_CAT_SLITS:int												=	3;
public static const EYES_GORGON:int													=	4;
public static const EYES_FENRIR:int													=	5;
...
public static const ARM_TYPE_MANTIS:int												=	3;
public static const ARM_TYPE_BEE:int												=	4;
public static const ARM_TYPE_SALAMANDER:int											=	5;
public static const ARM_TYPE_PHOENIX:int                                            =   6;
public static const ARM_TYPE_PLANT:int												=	7;
public static const ARM_TYPE_SHARK:int												=	8;
public static const ARM_TYPE_GARGOYLE:int											=	9;
public static const ARM_TYPE_WOLF:int												=  10;
public static const ARM_TYPE_LION:int												=  11;
public static const ARM_TYPE_KITSUNE:int											=  12;
public static const ARM_TYPE_FOX:int												=  13;
...
public static const TAIL_TYPE_KITSHOO:int											=  26;
public static const TAIL_TYPE_MANTIS_ABDOMEN:int                                    =  27;
...
public static const WING_TYPE_SHARK_FIN:int                                         =   8;// Nieużywane i zastąpione przez REAR_BODY_SHARK_FIN
...
public static const WING_TYPE_BAT_LIKE_LARGE_2:int									=  13;
public static const WING_TYPE_DRACONIC_HUGE:int										=  14;
public static const WING_TYPE_FEATHERED_PHOENIX:int									=  15;
public static const WING_TYPE_FEATHERED_ALICORN:int                                 =  16;
public static const WING_TYPE_MANTIS_LIKE_SMALL:int                                 =  17;
public static const WING_TYPE_MANTIS_LIKE_LARGE:int                                 =  18;
public static const WING_TYPE_MANTIS_LIKE_LARGE_2:int                               =  19;//niedokończone i użyte do soul evolved mantis TF (podwójne large wings) ^^
public static const WING_TYPE_GARGOYLE_LIKE_LARGE:int                               =  20;
...
public static const LOWER_BODY_TYPE_SCYLLA:int										=  26;
public static const LOWER_BODY_TYPE_MANTIS:int										=  27;
//public static const LOWER_BODY_TYPE_MANTIS:int - pewnie inne słowo niż mantis										=  28;//niedokończone i użyte do soul evolved mantis TF ^^
public static const LOWER_BODY_TYPE_SHARK:int										=  29;
public static const LOWER_BODY_TYPE_GARGOYLE:int									=  30;
public static const LOWER_BODY_TYPE_PLANT_HIGH_HEELS:int							=  31;
public static const LOWER_BODY_TYPE_PLANT_ROOT_CLAWS:int							=  32;
public static const LOWER_BODY_TYPE_WOLF:int										=  33;
...
public static const REAR_BODY_DRACONIC_MANE:int                                     =   1; // NYI
public static const REAR_BODY_DRACONIC_SPIKES:int                                   =   2; // NYI
public static const REAR_BODY_FENRIR_ICE_SPIKES:int                                 =   3;
...
//public static const VAGINA_TYPE_FOX:int												=   2;//niedokończone
//public static const VAGINA_TYPE_DRAGON:int											=   3;//niedokończone
//public static const VAGINA_TYPE_CAT:int												=   4;//niedokończone
public static const VAGINA_TYPE_BLACK_SAND_TRAP:int                                 =   5;
//public static const VAGINA_TYPE_PLANT_FLOWER:int									=   6;//niedokończone
//public static const VAGINA_TYPE_:int		=   7;
//public static const VAGINA_TYPE_:int		=   8;
//public static const VAGINA_TYPE_:int		=   9;
//public static const VAGINA_TYPE_:int		=   10;
