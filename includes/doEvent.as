...
public function doEvent(eventNo:Number):void
{
	...
	else if (eventNo == 2216)
	{
		dickPierce();
		return;
	}
	else if (eventNo == 2217)
	{
		earPierce();
		return;
	}
	else if (eventNo == 2218)
	{
		eyebrowPierce();
		return;
	}
	else if (eventNo == 2219)
	{
		lipPierce();
		return;
	}
	else if (eventNo == 2220)
	{
		nipplePierce();
		return;
	}
	else if (eventNo == 2221)
	{
		nosePierce();
		return;
	}
	else if (eventNo == 2222)
	{
		tonguePierce();
		return;
	}
	else if (eventNo == 2223)
	{
		vulvaPierce();
		return;
	}
	...
	else if (eventNo == 2242)
	{
		removeCockPierce();
		return;
	}
	else if (eventNo == 2243)
	{
		removeEarsPierce();
		return;
	}
	else if (eventNo == 2244)
	{
		removeEyebrowPierce();
		return;
	}
	else if (eventNo == 2245)
	{
		removeLipPierce();
		return;
	}
	else if (eventNo == 2246)
	{
		removeNipplesPierce();
		return;
	}
	else if (eventNo == 2247)
	{
		removeNosePierce();
		return;
	}
	else if (eventNo == 2248)
	{
		removeTonguePierce();
		return;
	}
	else if (eventNo == 2249)
	{
		removeVulvaPierce();
		return;
	}
	else if (eventNo == 2250)
	{
	...
	else if (eventNo == 2277)
	{
		shortName = "FullChn";
		armorBuy();
		return;
	}
	else if (eventNo == 2278)
	{
		shortName = "FullPlt";
		armorBuy();
		return;
	}
	else if (eventNo == 2279)
	{
		shortName = "IndecSt";
		armorBuy();
		return;
	}
	else if (eventNo == 2280)
	{
		shortName = "LthrRob";
		armorBuy();
		return;
	}
	else if (eventNo == 2281)
	{
		shortName = "ScaleMl";
		armorBuy();
		return;
	...
	else if (eventNo == 2557)
	{
		shortName = "Claymor";
		weaponBuy();
		return;
	}
	else if (eventNo == 2558)
	{
		shortName = "Warhamr";
		weaponBuy();
		return;
	}
	else if (eventNo == 2559)
	{
		shortName = "Katana ";
		weaponBuy();
		return;
	}
	else if (eventNo == 2560)
	{
		shortName = "Spear  ";
		weaponBuy();
		return;
	}
	else if (eventNo == 2561)
	{
		shortName = "Whip   ";
		weaponBuy();
		return;
	}
	else if (eventNo == 2562)
	{
		shortName = "S.Gaunt";
		weaponBuy();
		return;
