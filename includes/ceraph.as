...
public function loseFUCKME():void {
	...
	spriteSelect(7);
	if(flags[kFLAGS.PC_FETISH] == 0) eventParser(2320);
	else if(flags[kFLAGS.PC_FETISH] == 1) eventParser(2321);
	else if(flags[kFLAGS.PC_FETISH] == 2) eventParser(2322);
	else {
...
public function ceraphRapesYouBADDAWGYODIGGITY():void {
	...
	spriteSelect(7);
	outputText("", true);
	if((gameState < 1 || gameState > 2) && flags[kFLAGS.PC_FETISH] < 3) outputText("The demoness touches your forehead, and suddenly your mind is awash with fetishes!  Judging by the playful look she has, it's temporary, and you play along.  ", false);
...
public function runFromCeraphsNiceDeal():void {
	...
	stats(0,0,0,0,0,0,(10 + flags[kFLAGS.PC_FETISH] * 10),0);
	doNext(13);
}
