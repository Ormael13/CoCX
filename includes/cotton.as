...
function cottonPregUpdates():void {
	...
	//Increment kid age
	if(flags[COTTON_KID_COUNT] > 0 && this.model.time.hours == 23) flags[COTTON_OLDEST_KID_AGE]++;
}
