...
function impGangabangaEXPLOSIONS():void {
	...
	//NOT CENTAUR
		...
		if(rand(2) == 0 && (player.cockTotal() == 0 || player.gender == 3)) {
			...
			outputText("\n\n", false);
			outputText("Finally the big imp pulls back his " + cockNoun(1) + ", each ridge pulling on your pussy flesh as he slides out. An imp reaches out and slaps the bulge as it withdraws, making you yelp and buck.  ", false);
			//(If the character has a cock)
			...
			//(If the character has breasts)
			if(player.biggestTitSize() >= 3) outputText("Your " + allBreastsDescript() + " bounce and jiggle back and forth as the master imp roughly fucks you.  ", false);
			//(If the character has a dick)
			...
			outputText("The master imp pounds at you as hard as he can, driving his " + eCockDescript(1) + " deeper into you. His grunts come closer and closer together. Your head still held up, you watch as the imps around you start to cum. They spray your body with thick globs of cum, splattering it across your belly", false);
			//(If the character has breasts)
			if(player.biggestTitSize() >= 3) outputText(" and " + allBreastsDescript(), false);
			outputText(". The master imp pounds into you and you can see his " + eBallsDescriptLight() + " swell. Through the haze of your approaching orgasm you realize what's about to happen. Those oversized balls are about to pump more cum into you than any normal man could ever produce. They're going to pump demonic cum right into your womb.  ", false);
			//(Low Corruption)
			...
			//(High corruption)
			else outputText("The thought of all that demon-jism in your womb pushes you over the edge. You cum hard, bucking your hips against the " + cockNoun(1) + " pumping hot cum into your belly. Your eyes roll back in your head and you scream out your ecstasy as thick jets of cum fill your pussy. The imp keeps thrusting into his fuck-toy even as he fills your womb with his cum, forcing you to another peak before you've come down from the last one. The big imp is your master now.", false);
			...
			//(If the character has breasts)
			if(player.biggestTitSize() >= 3) outputText(", and bouncing " + allBreastsDescript(), false);
			...
			//(If the player has breasts)
			if(player.biggestTitSize() > 0) outputText("An imp mounts your chest and slaps his " + eCockDescript(0) + " between your " + allBreastsDescript() + ", squeezing them tight over his cock as he rubs back and forth.  ", false);
			//(If the player has a SINGLE cock)
			...
			if(player.biggestTitSize() > 0) {
				...
				outputText("  Suddenly you feel tiny needle-sharp teeth pierce your nipple. You scream as venom pumps into your tits, red-hot poison that makes your " + allBreastsDescript() + " feel as though they were being stung by bees. You moan in pain as your breasts start to swell, the imp rider biting into your other nipple to pump demon-taint into it.", false);
			...
			outputText("The master of this " + monster.short + " steps up between your " + player.legs() + ", leering down at your trapped body. Four feet tall and broader and stronger than any imp in the pack, with a face as much dog as imp, this new imp has grey fur, broad black demon wings, two long demon-horns on his head, and a " + cockNoun(2) + " big enough to choke a minotaur. Pre-cum drips from the broad tip of it, dripping down onto your ", false);
			//(If the player has a cock)
			...
			outputText(".  ", false);
			outputText("The heat stings your flesh. The imps licking your groin lap up the hot fluid, cooling you with their saliva. The big imp sneers as you whimper, and drags the head of his " + cockNoun(2) + " down to your ", false);
			//(If the player has a vagina)
			if(player.hasVagina()) outputText(vaginaDescript(0), false);
			//(If the player doesn't have a vagina)
			else outputText(assholeDescript(), false);
			outputText(".  He thrusts brutally, shoving the head of his " + eCockDescript(2) + " into your ", false);
			//(If the player has a vagina)
			if(player.hasVagina()) outputText(vaginaDescript(0), false);
			//(If the player doesn't have a vagina)" + 
			else outputText(assholeDescript(), false);
			outputText(". ", false);
			//(Low Corruption)
			if(player.cor < 50) outputText("You screech in agony as the big imp forces his mutated wolf-cock into your hole, brutally shoving thick inch after inch of painfully hot " + cockNoun(2) + " deeper into you than anything should ever go.  ", false);
			//(High Corruption)
			else outputText("The master imp's painfully hot " + cockNoun(2) + " stretches your hole wider than it ever should be, and you moan in perverse ecstasy.  ", false); 
			...
			//(If the character has breasts)
			if(player.biggestTitSize() > 0) outputText("The big imp reaches past your tit-rider and grabs one of your painfully distended breasts in each hand, mauling and bouncing the flesh as if weighing them. You gasp in pain as your " + allBreastsDescript() + " swell further at his touch.  ", false);
			...
			outputText(". ", false);
			//(If the character has breasts)
			if(player.biggestTitSize() > 1) outputText("The rough fucking shakes your breasts, and the imp sucking your nipples clings tightly to your monstrously swollen " + allBreastsDescript() + ". Your " + biggestBreastSizeDescript() + " have grown three cup sizes since the imp pumped his venom into you.  ", false);
			outputText("The imp fucking your face grabs your " + hairDescript() + " and jaw, forcing your head back so he can ram his cock into your throat. The obscene bulge sliding in your throat matches the bulge in your belly. The smaller imp pulls back just enough to let you gasp for air, then thrusts into your throat again. The big imp pounds the knot of his " + cockNoun(2) + " against your ", false);
			//(If the player has a vagina)
			if(player.hasVagina()) outputText(vaginaDescript(0), false);
			//(If the player doesn't have a vagina)
			else outputText(assholeDescript(), false);
			...
			outputText("\n\n", false);
			//(If the character has breasts)
			if(player.biggestTitSize() > 0) outputText("An ache starts deep in the base of your tits and works its way to your sore " + nippleDescript(0) + ". Your already bloated nipples swell as your rider suckles and you gasp as the first rush of milk spills into his mouth. Your rider milks your udders, moving his hands between your " + allBreastsDescript() + " and forcing out more milk than he could ever drink. Other imps lick the milk from the shiny skin of your swollen breasts.\n\n", false);
			
			outputText("The smaller imp slams his cock as deep into your throat as it will go, slapping his " + eBallsDescriptLight() + " against your face. He cums, balls twitching as they pump spunk down your throat. You can feel your stomach stretching, but you're more worried about breathing. The imp cums for an impossibly long time, streams of jism pouring into you. The edge of your vision starts to go red and your chest heaves as you fight for air. Finally the imp draws his cock out of your throat, spraying his last gobs of cum over your face as you gasp in huge lungfuls of air. The sudden rush of oxygen pushes you over the edge and you cum hard. Your body arches and your eyes roll back in your head as you twist around the demonic " + cockNoun(2) + " pounding into you. You shriek as your ", false);
			//(If the player has a vagina)
			if(player.hasVagina()) outputText(vaginaDescript(0), false);
			//(If the player doesn't have a vagina)
			else outputText(assholeDescript(), false);
			...
			if(player.biggestTitSize() > 0) {
				...
				if(player.hasFuckableNipples()) {
					...
					outputText("  Back and forth he begins fucking your tit as if it were a regular pussy, and it occurs to you that such a description isn't far from the truth. You gasp in pleasure as a strange kind of minor orgasm ripples through your tit and the taught skin of your mammary feels tighter as the " + biggestBreastSizeDescript() + " momentarily spasms around the imp's manhood. The horny little demon slaps your nipplecunt's clit in gleeful victory and jumps to the next breast to repeat his lewd fucking on a fresh hole.", false);
					outputText("\n\n", false);
				}

			}
			outputText("The imp-cock in your throat spasms and its owner rams as deep into you as he can get. He floods your already swollen stomach with inhuman amounts of cum. Again you feel yourself about to black out as the demon pumps jism into you. He pulls out and again you orgasm as you wheeze for air. Another imp forces his cock down your throat as you moan and gasp. Your body shakes in pleasure on the big imp's " + cockNoun(2) + ".  Tightening his grip on your " + hipDescript() + " the master imp howls and slams his shaft into your ", false);
			//(If the player has a vagina)
			if(player.hasVagina()) outputText(vaginaDescript(0),false);
			//If the player doesn't have a vagina)
			else outputText(assholeDescript(), false);
	...
	if(player.lust >= 100) {
		...
		if(player.gender == 2 || player.gender == 3) {
			...
			if(player.vaginalCapacity() < monster.cockArea(0)) {
				...
				outputText("  He plunges in violently, ramming his " + eCockDescript(0) + " in to the hilt, leaving you gasping in pain and surprise.  He leaves it there, giving you a second to get used to him, and then begins fucking you hard, slapping your ass every few thrusts to remind you who is in charge.", false);
				cuntChange(12,true,true,false);
			}
			...
			outputText("  The imp's " + eCockDescript(0) + " explodes inside you, pumping huge loads of hot demon-seed inside you with each eruption.  You swoon, feeling it fill your womb and distend your belly as the imp's orgasm fills you with an unnatural quantity of corrupted semen.\n\nWith a sigh, he pulls his dick free, and you flop back on your back, cum surging out onto the ground from your well-fucked hole.  ", false);
			if(player.pregnancyIncubation > 0 && player.pregnancyIncubation <= 216) {
				...
				if(player.hasStatusAffect("heat") >= 0) outputText("You find yourself hoping you're pregnant as you swiftly lose consciousness.", false);
		...
		if(player.gender == 0 || player.gender == 1) {
			...
			if(player.gender == 1 && rand(2) == 0) {
				...
				if(player.lowerBody == 4) outputText("hocks and knees, your " + cockDescript(0) + " hurting from the massive blood pressure caused by your unbridled lust.He approaches you and stops about two feet in front of you, watching with delight your helpless state", false);
				...
				if(player.lowerBody == 4) outputText("Dropping down to the ground, your " + cockDescript(0) + " trembles against your body to the rhythm of the imp's thrusts, leaving your underbelly smeared with its own pre-cum.\n\n", false);
				...
				if(player.lowerBody != 4) outputText("as you are disrobed", false);
				outputText(".  As the imp presses a large bulk against your backside, you realize he has a massive penis!\n\nThe imp pushes his " + eCockDescript(0) + " into your ass and fucks you hard, with little regard to your pleasure.  After a rough fucking, he cums, stuffing your ass full of hot demon cum.  His orgasm lasts far longer than any human's, leaving your belly slightly distended.", false);
				buttChange(monster.cockArea(0), true,true,false);
				stats(0, 0, 0, 0, 1, 1, 1, 1);
				if(player.sens > 40) {
...
function impLordLustAttack2():void {
	...
	outputText(" ("+damage+")");
	//[-HP(minor) // +Lust]
	stats(0,0,0,0,0,0,5+player.sens/4+player.cor/10,0);
	combatRoundOver();
}
...
function impLordAI():void {
	...
	choices[choices.length] = impLordLustAttack;
	choices[choices.length] = impLordHeavyEncounter;
...
function sexAnImpLord():void {
	...
	if(!player.isTaur()) outputText("  You grab his hands, removing them from his " + eCockDescript(0) + ", this gets his attention immediately, and you grin widely, pinning him to the ground.");
...
function impLordBumPlug():void {
	...
	outputText("  You pull the imp's head towards your [hips], forcing his lips against the base of your " + cockDescript(x) + ".  The imp quickly gets the idea and begins to lick and suckle at your " + cockHead(x) + " expertly.");
	...
	outputText("\n\nYou drape your " + cockDescript(x) + " between the imp's butt cheeks.  Teasingly you begin thrusting between the muscular cleft of his ass, much to the creature's dismay.  The greater imp whines submissively, desperate for you to enter him.  His " + eCockDescript(0) + " drools as you tease his ass, creating a small puddle of pre between his hooves.  The poor creature becomes so desperate that he reaches back and spreads his muscular cheeks with his hands.  You catch a small glimpse of his now gaping hole as your cock continues to slide between his cheeks.  You tease him with one last empty thrust, before grabbing his shoulders and forcing your " + cockDescript(x) + " deep inside the poor creature.");
	
	outputText("\n\nThe imp loses control immediately and nearly collapses from the massive orgasm.  His large, corruption-bloated balls clench up, and semen floods out of his " + eCockDescript(0) + " like a fountain.  The hot demon seed puddles around his feet, soaking the ground in his thick boy-goo.");
	...
	if(player.balls >= 4) {
		...
		//if(player is a herm)
		if(player.gender == 3) outputText("\n\nAs your " + cockDescript(x) + " erupts, your " + vaginaDescript(0) + " tenses up tightly, spasming, desperate to have been filled.  After a moment your girl juice begins to soak your inner thighs.  Your legs begin to tremble from the intensity of it all, and you question if you'll be able to make it back to your camp after this.");
	
		outputText("\n\nThe imp howls as his ass is flooded with cum.  His stomach begins to expand from the sheer amount of fluid you pump into him, and the sensation of being over filled causes the poor creature to cum a second time, spilling more semen, into the already massive puddle.  His " + eCockDescript(0) + " pumps wave after wave of corrupt seed onto the ground, soaking his hooves even further.");
	
		outputText("\n\nYou're sure you must have blacked out at some point as you feel the last of your seed force it's way out of your " + cockDescript(x) + " and into the imp's demon belly.  You wobble slightly and lean down, grabbing the ragged remains of the imp's loincloth.  Weakly you pull out of the demon's hole, and quickly stuff the cloth in it's place as a makeshift plug.");
...
function getBlownByAnImpLord():void {
	...
	if(player.cocks[player.biggestCockIndex()].cockThickness < 7) {
		...
		//else if(balls == 0)
		else outputText("The demon seems to be searching for your testicles, but when all he doesn't find anything, he moves his hand a bit further.\n\n");
	...
	//else if(cock thickness >= 7)
		...
		outputText("Though you're far to thick to fit any further into the imp's mouth, it doesn't stop him from trying.  The crimson demon works your length in every way he can.  His hands rub up and down your length.  You admire the effort as the little demon tries to fit more of your [cockHead biggest] into his mouth.  It soon becomes clear to the imp however that, that isn't possible.  He pulls back off your length, his hands still rubbing up and down your shaft.  He looks at your cock slit, and presses his lips to it, forcing his tongue into your leaking urethra.  You yelp in surprise as the wet muscle makes it's way shockingly deep into your [cock biggest].  His muscular hands work your length furiously while his tongue abuses your insides.  It doesn't take a lot of that treatment to have you teetering on the edge of orgasm.");
	}
...
function femaleVagRape():void {
	...
	if(player.cockTotal() == 1) {
		if(player.cocks[0].cockLength < 8) {
			outputText("\n\nThe intense stimulation causes your " + cockDescript(0) + " to begin leaking pre across the imp's stomach.  You remove one hand from the imp's nipples to pay attention to your aching " + cockNoun(0) + ".  As you begin jerking yourself off, more and more pre puddles on the imp's abs.  Your pre begins to pool in and over flow from the imp's tight belly button.");
		}
		else if(player.cocks[0].cockLength <= 16){
			outputText("\n\nThe intense stimulation causes your " + cockDescript(0) + " to begin leaking pre across the imp's chest.  You remove one hand from the imp's nipples to pay attention to your aching " + cockDescript(0) + ".  As you begin jerking yourself off, more and more pre drips across the imp's aching nipples.  Your pre a warm relieve for the tender abused teats.  The warmth of your juice across his chest makes the little demon moan and buck harder into your " + vaginaDescript(0) + ".");
		}
		else {
			outputText("\n\nAs your " + vaginaDescript(0) + " is pounded relentlessly, your rock hard " + cockDescript(0) + " slaps the imp in the face, each time leaving another trail of pre in it's wake.  The imp's arousal only intensifies from this, and he's soon lapping and suckling at your " + cockDescript(0) + ", expertly trying to get you off.");
...
function feederBreastfeedRape():void {
	...
	outputText("\n\nThe kick knocks the wind out of the little demon, causing him to gasp.  His mouth open just long enough and wide enough for the corrupt milk to go straight down his throat.  The reaction is almost instant, his eyes go wide with horror, and disgust, but quickly change to awe and desire.  The poor thing tries to get up from under you but can't escape.");
	
	if(player.tallness > 48 && player.tallness < 60 && player.lowerBody != 4) {
		...
		if(player.bRows() == 1) outputText("\n\nAs your second breast's milk flow begins to slow, the imp curls up against you contently.  You cradle him for a moment, before laying the creature down, where he burps and falls asleep.  You chuckle at how cute these creatures are when they're passive.");
			...
			outputText("\n\nYou moan softly as the imp continues his work, although you do notice that he's starting to have trouble keeping up with your flow, as a fair amount of your milk has ended up on your chest, and the ground, rather then the imp's belly.  Giving him a small swat on his bald head, you point to the milk on the ground, which causes him to whimper in apology.");
			outputText("\n\nNodding your acceptance, he continues his work much more carefully.  He's taking his time again instead of just sucking wildly.  You reach down curiously, and tug on the imp's " + eCockDescript(0) + " but find that it's shrinking.  As you hold it it shrinks more and more, you wonder what will happen to him if he continues to nurse.");
			...
			if(player.bRows() == 2) {
				...
				outputText("\n\nYou begin massaging your lowest row of breasts, fascinated by what will become of the imp when he milks you of all your corrupt milk.  You feel the fluid flow begin, and the imp moves on to your " + breastDescript(2) + ".  He nurses passionately at your " + nippleDescript(2) + ", slurping down every drop of your milk.");
...
function loseToImpLord():void {
	...
	outputText("\n\nYou cough and splutter, grabbing your gut, as a hot pain fills your stomach.  The imp laughs as you roll around in agony for several long moments, before the burning turns to an arousing warmth that spreads to your [hips] and [asshole].  Groaning you feel cheeks flush with arousal, and your eyes glaze over once more with insatiable lust.");
	if(player.cockTotal() == 1) {
		outputText("\n\nYou feel your " + cockDescript(0) + " grow harder then usual, and throb.  You go to stroke yourself but it's far to sensitive, any stroking you can do is far to little stimulation and anything else is to painful to withstand.  You whimper and curse in desperation.  Your lust clouded mind can only think of one solution, you bend over and reveal your [asshole] to the grinning imp.  The humiliation keeps you from looking back to see the imps reaction, but you can tell by his chuckle that this is exactly what he wanted.");
	}
	else if(player.cockTotal() > 1) {
		outputText("\n\nYou feel your " + multiCockDescriptLight() + " grow harder then usual, and throb.  You go to stroke yourself but they are far to sensitive, any stroking you can do is far to little stimulation and anything else is to painful to withstand.  You whimper and curse in desperation.  Your lust clouded mind can only think of one solution, you bend over and reveal your " + assholeDescript() + " to the grinning imp.  The humiliation keeps you from looking back to see the imps reaction, but you can tell by his chuckle that this is exactly what he wanted.");
	}
	outputText("\n\nThe imp gets behind you, his corrupt presence makes the air feel heavy and hard to breathe.  You notice his satchel and loincloth get carelessly tossed to the ground.  Chancing a glance back, you look in aroused horror at the " + eCockDescript(0) + " between the imp's legs as well as his matching cum-filled balls.  Two clawed, red hands spread your [butt] revealing your [asshole].  Mercifully, the demon decides you'll need some form of lubrication and relaxation before he continues.  He leans forward and presses his tongue between your [butt] and begins lapping at your [asshole] viciously.  You can't help but mewl from the merciless attack on your tender rectum.");
	...
	outputText("\n\nAfter longer then you'd have hoped for, the painful stretching sensation begins to disappear; and the pleasurable sensation of the imp's " + eCockDescript(0) + " thrusting in and out of your [asshole] becomes entirely pleasurable.  The way his " + eCockDescript(0) + " fills every inch of your ass, and rubs all your most sensitive spots.  The weird sensation his warm, demonic pre-cum coats your insides.  You find your lust-blinded mind has become lost in the sensations - so lost that you don't even notice the imp increasing his pace.");
	
	outputText("\n\nWithin moments the beast is wildly thrusting in and out of your [asshole].  Pre-cum is pumping out of his " + eCockDescript(0) + " like a faucet. The hot demon pre begins to spill back out of your abused [asshole], coating your [hips], and dripping to the ground beneath.  The imp gives you a few more rough thrusts before cumming hard into your [asshole].  The little demon's " + eCockDescript(0) + " spasms as he continues to roughly thrust and pump you full of his burning hot demon seed.");
...
function getRapedAsAGirl():void {
	...
	outputText("\n\nYou try to move, but before you can even begin to squirm a hoof presses hard between your " + breastDescript(0) + ".  Gasping as the air is temporarily knocked out of your lungs.  The demon chuckles at your last feeble attempt to free yourself.  He holds his " + eCockDescript(0) + " stroking it lewdly, a cruel smirk stretching across his face.  You watch as several beads of pre begin to drip from his tip onto your stomach.");
	...
	outputText("\n\nYou mewl softly as you're viciously fucked by the beast above you.  It doesn't take long before your [vagina] clenches tightly around the " + eCockDescript(0) + " as you orgasm.  You scream in pleasure as your inner walls begin to milk the imp's " + eCockDescript(0) + " of it's seed.  The imp quickly succumbs and cums, his swollen balls tightening up against his crotch.  The hot jizz continues to pump into you for what feels like several painfully long minutes, until your belly bulges slightly, and your " + vaginaDescript(0) + " begins to leak the white demonic fluid.");
...
function putBeeEggsInAnImpYouMonster():void {
	...
	outputText("\n\nYou and the imp shudder in tandem as your sweet honey smears between his cheeks, oozing down his crack as you squeeze your throbbing ovipositor further and further into him.  Buried deep in his bowels, you feel the first of your eggs push through your rubbery organ, stretching out your tube along with his his asshole.");
