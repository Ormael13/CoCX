	...
	public dynamic class StatsView extends Sprite {
		...
		public function StatsView( mainView :MovieClip, model :* ) {
			...
			var statsThingsNames :Array = [
					"strBar",     "strText",     "strNum",
					"touBar",     "touText",     "touNum",
					"sensBar",    "senText",     "senNum",
					"inteBar",    "inteText",    "inteNum",
					"speBar",     "speText",     "speNum",
					"libBar",     "libText",     "libNum",
					"corBar",     "corText",     "corNum",
					"fatigueBar", "fatigueText", "fatigueNum",
					"HPBar",      "HPText",      "HPNum",
					"lustBar",    "lustText",    "lustNum",
					"levelText",  "levelNum",
					"xpText",     "xpNum",
					"coreStatsText",
					"advancementText",
