...
//	}
    ...
    private static function impGangBangProgress():int {
        ...
        var player:Player = kGAMECLASS.player;
        kGAMECLASS.temp = player.statusEffectv1(StatusEffects.BirthedImps) * 2;
        ...
        if (flags[kFLAGS.CAMP_WALL_GATE] > 0) kGAMECLASS.temp /= 2;
    ...
    public static function growHair(amount:Number = .1):Boolean {
        //Grow hair!
        var player:Player = kGAMECLASS.player;
        kGAMECLASS.temp = player.hairLength;
        player.hairLength += amount;
        if (player.hairLength > 0 && kGAMECLASS.temp == 0) {
            EngineCore.outputText("\n<b>You are no longer bald.  You now have " + Appearance.hairDescription(player) + " coating your head.\n</b>");
            return true;
        }
        else if (player.hairLength >= 1 && kGAMECLASS.temp < 1) {
            EngineCore.outputText("\n<b>Your hair's growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairLength >= 3 && kGAMECLASS.temp < 3) {
            EngineCore.outputText("\n<b>Your hair's growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairLength >= 6 && kGAMECLASS.temp < 6) {
            EngineCore.outputText("\n<b>Your hair's growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairType == AppearanceDefs.HAIR_GORGON && player.hairLength >= 6 && kGAMECLASS.temp < 6) {
            EngineCore.outputText("\n<b>Your gorgon's hair growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairLength >= 10 && kGAMECLASS.temp < 10) {
            EngineCore.outputText("\n<b>Your hair's growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairType == AppearanceDefs.HAIR_GORGON && player.hairLength >= 10 && kGAMECLASS.temp < 10) {
            EngineCore.outputText("\n<b>Your gorgon's hair growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairLength >= 16 && kGAMECLASS.temp < 16) {
            EngineCore.outputText("\n<b>Your hair's growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairType == AppearanceDefs.HAIR_GORGON && player.hairLength >= 16 && kGAMECLASS.temp < 16) {
            EngineCore.outputText("\n<b>Your gorgon's hair growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairLength >= 26 && kGAMECLASS.temp < 26) {
            EngineCore.outputText("\n<b>Your hair's growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairType == AppearanceDefs.HAIR_GORGON && player.hairLength >= 26 && kGAMECLASS.temp < 26) {
            EngineCore.outputText("\n<b>Your gorgon's hair growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairLength >= 40 && kGAMECLASS.temp < 40) {
            EngineCore.outputText("\n<b>Your hair's growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairType == AppearanceDefs.HAIR_GORGON && player.hairLength >= 40 && kGAMECLASS.temp < 40) {
            EngineCore.outputText("\n<b>Your gorgon's hair growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairLength >= 40 && player.hairLength >= player.tallness && kGAMECLASS.temp < player.tallness) {
            EngineCore.outputText("\n<b>Your hair's growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        else if (player.hairType == AppearanceDefs.HAIR_GORGON && player.hairLength >= 40 && player.hairLength >= player.tallness && kGAMECLASS.temp < player.tallness) {
            EngineCore.outputText("\n<b>Your gorgon's hair growth has reached a new threshhold, giving you " + Appearance.hairDescription(player) + ".\n</b>");
            return true;
        }
        return false;
