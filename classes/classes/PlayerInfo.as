		...
		if (page == 1) {
			if (player.superPerkPoints > 0) {
				...
				if (player.hasPerk(PerkLib.MyBloodForBloodPuppies)) addButtonDisabled(2, "MBFBP", "You already have this super perk.");
					...
					if (player.hasPerk(PerkLib.YourPainMyPower)) addButton(3, "MBFBP", perkMyBloodForBloodPuppies).hint("Choose the 'My Blood for Blood Puppies' super perk. During fight small part of your blood from into blood puppies that can attack on your behalf with blood magic/soulskills. When you grow in mastery of blood they would grow stronger with you. (+5x Tou of OverMax HP, -10% blood spells cost, +20% blood spells power)");
