...
//		// bodyStats += cumCapExp.debug;
		...
		miscStats += "<i>Ascension points - Masteries Edition:</i> " + camp.possibleToGainAscensionPointsMasteries() + " (Dao of Elements: " + camp.possibleToGainAscensionPointsDaoOfElements() + " / 90)\n";
