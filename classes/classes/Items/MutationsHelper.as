...
/**
	...
	private const METAMORPH_ARMS:Object = createMapFromPairs([
		...
		[AppearanceDefs.ARM_TYPE_DEVIL, null],
		[AppearanceDefs.ARM_TYPE_ELF, null],
		...
		[AppearanceDefs.ARM_TYPE_MANTIS, null],
		[AppearanceDefs.ARM_TYPE_ONI, null],
		...
		[AppearanceDefs.ARM_TYPE_RAIJU, null],
	...
	private const METAMORPH_EARS:Object = createMapFromPairs([
		...
		[AppearanceDefs.EARS_WEASEL, null],
	...
	private const METAMORPH_EYES:Object = createMapFromPairs([
		...
		[AppearanceDefs.EYES_DEVIL, null],
		[AppearanceDefs.EYES_ELF, null],
		...
		[AppearanceDefs.EYES_ONI, null],
		[AppearanceDefs.EYES_RAIJU, null],
	...
	private const METAMORPH_FACES:Object = createMapFromPairs([
		...
		[AppearanceDefs.FACE_COW_MINOTAUR, null],
		...
		[AppearanceDefs.FACE_DEVIL_FANGS, null],
		...
		[AppearanceDefs.FACE_ONI_TEETH, null],
		...
		[AppearanceDefs.FACE_RAIJU_FANGS, null],
	...
	private const METAMORPH_HAIR_TYPES:Object = createMapFromPairs([
		...
		[AppearanceDefs.HAIR_SILKEN, null],
		[AppearanceDefs.HAIR_STORM, null],
	]);
	...
	private const METAMORPH_HORNS:Object = createMapFromPairs([
		...
		[AppearanceDefs.HORNS_COW_MINOTAUR, null],
		...
		[AppearanceDefs.HORNS_GOAT, null],
		[AppearanceDefs.HORNS_NONE, null],
		[AppearanceDefs.HORNS_OAK, null],
		[AppearanceDefs.HORNS_ONI, null],
		[AppearanceDefs.HORNS_ONI_X2, null],
	...
	private const METAMORPH_LOWER_BODIES:Object = createMapFromPairs([
		...
		[AppearanceDefs.LOWER_BODY_TYPE_CLOVEN_HOOFED, null],
		...
		[AppearanceDefs.LOWER_BODY_TYPE_ELF, null],
		...
		[AppearanceDefs.LOWER_BODY_TYPE_HOOFED, null],
		...
		[AppearanceDefs.LOWER_BODY_TYPE_MANTIS, null],
		[AppearanceDefs.LOWER_BODY_TYPE_NAGA, StatusEffects.UnlockedSnakeLowerBody],
		[AppearanceDefs.LOWER_BODY_TYPE_ONI, null],
		...
		[AppearanceDefs.LOWER_BODY_TYPE_RAIJU, null],
	...
	private const METAMORPH_REAR_BODIES:Object = createMapFromPairs([
		...
		[AppearanceDefs.REAR_BODY_RAIJU_MANE, null],
	...
	private const METAMORPH_TONGUES:Object = createMapFromPairs([
		...
		[AppearanceDefs.TONGUE_ELF, [null, "Elf Tongue"]],
	...
	private const METAMORPH_TAILS:Object     = createMapFromPairs([
		...
		[AppearanceDefs.TAIL_TYPE_COW, null],
		...
		[AppearanceDefs.TAIL_TYPE_GOAT, null],
		...
		[AppearanceDefs.TAIL_TYPE_MANTIS_ABDOMEN, null],
		...
		[AppearanceDefs.TAIL_TYPE_RAIJU, null],
	...
	private const METAMORPH_WINGS:Object = createMapFromPairs([
		...
		[AppearanceDefs.WING_TYPE_MANTIS_LIKE_LARGE, null],
		[AppearanceDefs.WING_TYPE_MANTIS_LIKE_LARGE_2, null],
		[AppearanceDefs.WING_TYPE_MANTIS_LIKE_SMALL, null],
