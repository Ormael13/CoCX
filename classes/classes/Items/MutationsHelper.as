package classes.Items {
	...
	private const METAMORPH_ARMS:Object = createMapFromPairs([
		...
		[ARM_TYPE_ONI, StatusEffects.UnlockedOniArms],
	...
	private const METAMORPH_EARS:Object = createMapFromPairs([
		[EARS_BUNNY, null],
		[EARS_CAT, null],
		[EARS_COW, StatusEffects.UnlockedCowEars],
		[EARS_DEER, null],
		[EARS_DOG, null],
		...
		[EARS_MOUSE, null],
		[EARS_ONI, StatusEffects.UnlockedOniEars],
	...
	private const METAMORPH_FACES:Object = createMapFromPairs([
		...
		[FACE_BUNNY, null],
		[FACE_CAT, null],
		[FACE_COW_MINOTAUR, StatusEffects.UnlockedCowMinotaurFace],
		[FACE_DEER, null],
		[FACE_DOG, null],
		[FACE_DRAGON, StatusEffects.UnlockedDraconicFace],
		[FACE_DRAGON_FANGS, StatusEffects.UnlockedDraconicFangs],
		[FACE_DEVIL_FANGS, StatusEffects.UnlockedDevilFangs],
		[FACE_ECHIDNA, null],
		[FACE_FERRET, null],
		...
		[FACE_MANTICORE, null],
		[FACE_MOUSE, null],
		[FACE_ONI_TEETH, StatusEffects.UnlockedOniFace],
	...
	private const METAMORPH_HORNS:Object = createMapFromPairs([
		[HORNS_ANTLERS, null],
		[HORNS_COW_MINOTAUR, StatusEffects.UnlockedCowMinotaurHorns],
		...
		[HORNS_GARGOYLE, null],
		[HORNS_GOAT, StatusEffects.UnlockedGoatHorns],
		[HORNS_NONE, null],
		[HORNS_OAK, null],
		[HORNS_ONI, StatusEffects.UnlockedOniSingleHorn],
		[HORNS_ONI_X2, StatusEffects.UnlockedOniTwinHorns],
		[HORNS_ORCHID, null],
		[HORNS_RHINO, null],
		[HORNS_UNICORN, null],
	]);
	...
	private const METAMORPH_LOWER_BODIES:Object = createMapFromPairs([
		...
		[LOWER_BODY_TYPE_CLOVEN_HOOFED, StatusEffects.UnlockedClovenHoofedLegs],
		...
		[LOWER_BODY_TYPE_HOOFED, StatusEffects.UnlockedHoofedLegs],
		...
		[LOWER_BODY_TYPE_ONI, StatusEffects.UnlockedOniLegs],
	...
	private const METAMORPH_TAILS:Object     = createMapFromPairs([
		...
		[TAIL_TYPE_CAT, null],
		[TAIL_TYPE_COW, StatusEffects.UnlockedCowTail],
		[TAIL_TYPE_DEER, null],
		...
		[TAIL_TYPE_GOAT, StatusEffects.UnlockedGoatTail],
