...
public final class HeadJewelryLib extends ItemConstants
	{
		...
		public const DRABLOH:HeadJewelry = new HeadJewelry("DraBloH", "DragonBloodHelmet", "Dragon Blood Helmet", "a Dragon Blood Helmet", 0, 0, 400, "An unassuming helm made of iron with goat horns the large opening at the mouth and nose level allows for using breath attack unimpeded. Those who wore this helmet in the days of the glorious dragon army where known to shout so loudly it would send people flying down cliffs and mountain alike.",HJT_HELMET);
		...
		public const CUNDKIN:HeadJewelry = new HeadJewelry("CUndKing", "CroUndefKing", "Crown of the Undefeated King", "a Crown of the Undefeated King", 0, 0, 6000, "This splendid crown, topped with many kinds of gems, once belonged to a king who claimed to be undefeated. But how did it end up in your hands?",HJT_CROWN);
		...
		public const EZEKIELC:HeadJewelry = new HeadJewelry("EzekielC", "EzekielCrown", "Ezekiel's Crown", "an Ezekiel's Crown", 0, 0, 400, "A crown rumored to be blessed by the Ezekiel himself. Is this real one or just another fake crown the merchant sold you? (-4 to internal chimerical disposition)",HJT_CROWN);
