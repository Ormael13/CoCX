...
import classes.ItemType;
	...
	public class MaraeArmor extends Armor
	{
		...
		{
			super("TB.Armr","T.B.Armor","tentacled bark armor","a suit of tentacled bark armor",55,6600,"This suit of armor is finely made from the white bark from corrupted Marae you've defeated. It comes with tentacles though.","Heavy");
		}
		...
		override public function useText():void
		{
            ...
            if (kGAMECLASS.player.cor < 33) outputText("You shudder at the idea of wearing armor that is infested with tentacles but you proceed anyway. ");
            if (kGAMECLASS.player.cor >= 33 && kGAMECLASS.player.cor < 66) outputText("You are not sure about the idea of armor that is infested with tentacles. ");
            if (kGAMECLASS.player.cor >= 66) outputText("You are eager with the idea of wearing tentacle-infested armor. ");
