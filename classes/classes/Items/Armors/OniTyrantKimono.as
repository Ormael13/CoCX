...
import classes.Player;
	...
	public class OniTyrantKimono extends Armor
	{
		...
		{
			super("OE Kimo", "OniEnlightenedKimono", "Oni Tyrant kimono", "a oni tyrant kimono", 0, 20, 160, "This deceptively sturdy kimono belonged to a tyrant amonst oni nobility. In their homeland oni rules over lesser race with an iron fist. Might makes right or so they say.", "Light");
		}
