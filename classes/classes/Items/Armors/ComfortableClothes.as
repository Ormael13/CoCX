...
package classes.Items.Armors
{
	...
	public class ComfortableClothes extends Armor {
		...
		public function ComfortableClothes() {
			super("C.Cloth", "C.Cloth", "comfortable clothes", "a set of comfortable clothes", 0, 1, "These loose fitting and comfortable clothes allow you to move freely while protecting you from the elements.", "Light", true);
		}
