...
import classes.PerkLib;
	...
	public class GoblinTechnomancerClothes extends Armor
	{
		...
		{
			super("GTechC", "GTechC", "Goblin Technomancer clothes", "a Goblin Technomancer outfit", 0, 0, 400, "These goblin technomancer clothes increase the effectiveness of all technology attacks. Too small for anyone but a goblin to wear. It features a pair of latex pants with a large opening at the right level in order to display whatever panties you may have on—if any. The outfit includes black latex shoes, black latex gloves, and a mechanist’s latex overcoat of matching color, generally kept open for a practical display of the user’s… assets. Oil, shock and stain-proof. These garbs also improve your skill at using technology.", "Light");
