...
package classes.Items.Armors
{
	...
	public class HBArmor extends Armor {
		...
		override public function get def():Number { 
			if (game.flags[kFLAGS.SOULFORCE_STORED_IN_AYO_ARMOR] > 0) return 50;
			else return 30;
		}
		
		override public function get mdef():Number { 
			if (game.flags[kFLAGS.SOULFORCE_STORED_IN_AYO_ARMOR] > 0) return 40;
			else return 24;
		}
		...
		override public function canUse():Boolean {
			if (game.player.str >= 20 && game.player.spe >= 20 && game.player.tallness >= 84) {
				return true;
			}
