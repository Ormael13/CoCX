...
package classes.Items
{
	...
	public final class UseableLib extends BaseContent
	{
		...
		public const D_SCALE:SimpleUseable = mk("D.Scale", "Dragonscale", "a freshly-shed dragonscale", m.toughDragonScale, "This sheet of dragon scale is incredibly strong and flexible.\n\nType: Material");
		//Ores
		...
		//Ingots
		//public const BRONBAR:SimpleUseable = mk("BronBar", "Bronze Bar", "a bronze ingot", m.examineBronzeBar, "A refined iron ingot ready to be used for crafting. \n\nType: Material", 30);
