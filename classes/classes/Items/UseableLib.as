...
use namespace CoC;
	...
	public final class UseableLib extends BaseContent
	{
		...
		public const GOLCORE:SimpleUseable = new SimpleUseable("GolCore", "GolemCore", "a golem core", 1, 
			...
			"You look at the undamaged golem core.  A simple small crystal sphere no larger than your fist that glows gently.  For those who know the art of golem-making, it will be of great use, but for others it's useless and it's better to sell it, preferably to a merchant that specificaly buys such items.");
