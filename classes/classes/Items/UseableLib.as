...
package classes.Items
{
	...
	public final class UseableLib extends BaseContent
	{
		...
		public const GLDSTAT:SimpleUseable = mk("GldStat","a golden statue",Utils.lazyCallIndex(getGame,"forest","kitsuneScene","kitsuneStatue"),"An intricate golden idol of an androgynous humanoid figure with nine long tails.  It probably had some spiritual significance to its owner.",600);
