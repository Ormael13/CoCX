...
public final class WeaponRangeLib extends ItemConstants
	{
		...
		public const BOWOLD_:WeaponRange = new WeaponRange("BowOld ", "BowOld ", "old bow", "an old bow", "shot", 1, 50, "This is an old bow. It's barely effective even at short range not to meantion its poor accuracy.", WT_BOW).withBuffs({'rangedaccuracy':-50}) as WeaponRange;
