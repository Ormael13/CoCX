...
public final class WeaponRangeLib extends ItemConstants
	{
		...
		public const BLUNDER:WeaponRange = new WeaponRange("Blunder", "Blunderbuss", "blunderbuss rifle", "a blunderbuss rifle", "shot", 16, 590, "This is a blunderbuss rifle. It's effective at short range but poor at long range.", WT_RIFLE);
		...
		public const BOWHUNT:WeaponRange = new WeaponRange("BowHunt", "BowHunt", "hunter bow", "a hunter bow", "shot", 10, 500, "This is a hunter bow. It allow to attain better accuracy of shooted arrows than long bow at the cost of slight lower damage.", WT_BOW);
		...
		//public const HARKON2:WeaponRange = new WeaponRange("Harkon2", "HarkonnenII", "Harkonnen II", "a Harkonnen II", "shot", 260, 5230, ".", WT_2H_FIREARM);
		public const HARPGUN:WeaponRange = new WeaponRange("HarpGun", "HarpoonGun", "Harpoon gun", "a Harpoon gun", "shot", 50, 1030, "Standard issue goblin weaponry for underwater combat.", WT_RIFLE);
		...
		public const IVIARG_:WeaponRange = new WeaponRange("IvIArq", "Iv.I.Arq", "ivory inlaid arquebus", "an ivory inlaid arquebus", "shot", 24, 840, "Gifted with a superb range and accuracy, this arquebus is truly a piece of art. Its stock has a gold trim and is inlaid with ivory in a pattern of wreath leaves. A layer of gold and ivory also runs through the barrel, giving the rifle a majestic look without compromising its functionality.", WT_RIFLE).withBuffs({'rangedaccuracy':+40}) as WeaponRange;
		...
		public const M1CERBE:WeaponRange = new WeaponRange("M1Cerbe", "M1Cerberus", "M1 Cerberus", "a M1 Cerberus", "shot", 45, 930, "A rifle prized for its precision and versatility, the Cerberus shoots multiple bullet in salvo ensuring that if one shot land all the others do with minimal recoil.", WT_2H_FIREARM);
