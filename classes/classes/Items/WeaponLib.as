...
package classes.Items
{
	...
	public final class WeaponLib
	{
		...
		public const KIHAAXE:Weapon = new Weapon("KihaAxe","Greataxe","double-bladed axe","a double-bladed axe","fiery cleave",20,1000,"This large, double-bladed axe matches Kiha's axe. It's constantly flaming. \n\nType: Weapon (Axe) \nAttack: 20 \nBase value: 1000", "Large");
		public const L__AXE :Weapon = new Weapon("L. Axe ","L. Axe","large axe","an axe large enough for a minotaur","cleave",15,100,"This massive axe once belonged to a minotaur.  It'd be hard for anyone smaller than a giant to wield effectively.  The axe is double-bladed and deadly-looking.  \n\nType: Weapon (Heavy) \nAttack: 15 \nBase value: 100 \nRequires height of 6'6\" or 90 strength.","Large");
		public const L_DAGGR:Weapon = new Weapon("L.Daggr","L.Daggr","lust-enchanted dagger","an aphrodisiac-coated dagger","stab",3,150,"A dagger with a short blade in a wavy pattern.  Its edge seems to have been enchanted to always be covered in a light aphrodisiac to arouse anything cut with it. \n\nType: Weapon (Dagger) \nAttack: 3 \nBase value: 150 \nInflicts lust damage on strike.","Aphrodisiac Weapon");
		...
		public const SCARBLD:Weapon = new Weapon("ScarBld", "ScarBlade", "scarred blade", "a scarred blade", "slash", 19, 1000, "This saber, made from lethicite-imbued metal, eagerly seeks flesh; it resonates with disdain and delivers deep, jagged wounds as it tries to bury itself in the bodies of others. \n\nType: Weapon (Sword) \nAttack: 19 \nBase value: 1,000");
