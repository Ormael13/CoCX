...
public final class WeaponLib extends ItemConstants
	{
		...
		public const S_SWORD:Weapon = new Weapon("S.Sword", "S.Sword", "Sorcerer sword", "a sorcerer sword", "slash", 15, 1500, "This weapon was forged by elves mage knights. It is both an excelent catalyst and a deadly blade.", "Sword, StaffPart").withBuff('spellpower', +0.8) as Weapon;
		public const A_WAND:Weapon = new Weapon("A.Wand", "A.Wand", "Apprentice wand", "an apprentice wand", "smack", 1, 1500, "A low quality wand. Light and cheap it is commonly used by young apprentices who have started learning magic. Seeing as beginners tend to cause their catalyst to explode this is the perfect weapon for them.", "Sword, StaffPart").withBuff('spellpower', +1) as Weapon;
		public const H_WAND:Weapon = new Weapon("H.Wand", "H.Wand", "hellcat wand", "an hellcat wand", "smack", 1, 1500, "A hellcat witch wand. Commonly used by hellcats to deliver their iconic fire magic.", "Sword, StaffPart").withBuff('spellpower', +1.5) as Weapon;
		public const WDAGGER:Weapon = new Weapon("WDagger","W.Dagger","witch dagger","a witch dagger","stab",3,240,"A dagger engraved with magical runes. While not the best catalyst around it is light, discreet and excelent for delivering spells.", "Small,Sword,StaffPart", "Dagger").withBuff('spellpower', +0.60) as Weapon;
