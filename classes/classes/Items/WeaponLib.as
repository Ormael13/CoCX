...
public final class WeaponLib extends ItemConstants
	{
		...
		public const H_WAND:Weapon = new Weapon("H.Wand", "H.Wand", "hellcat wand", "an hellcat wand", "smack", 1, 500, "A hellcat witch wand. Commonly used by hellcats to deliver their iconic fire magic.", "Sword, StaffPart").withBuff('spellpower', +1.5) as Weapon;
