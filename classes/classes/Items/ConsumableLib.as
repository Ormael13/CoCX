...
package classes.Items
{
	...
	public final class ConsumableLib extends BaseContent
	{
		...
		public const RAINDYE:SimpleConsumable = mk("RainDye","RainDye", "a vial of rainbow hair dye", curry(m.hairDye, "rainbow"),"This bottle of dye will allow you to change the color of your hair.  Of course if you don't have hair, using this would be a waste. \n\nType: Dye", 1000);
		...
		public const MINOCUM:SimpleConsumable = mk("MinoCum", "MinoCum", "a sealed bottle of minotaur cum", curry(m.minotaurCum, false), "This bottle of minotaur cum looks thick and viscous.  You know it has narcotic properties, but aside from that its effects are relatively unknown. \n\nType: Food & Beverages? \nBase value: 60", 60);
		...
		public const DRAKHRT:SimpleConsumable = mk("DrakHrt","DrakeHeart", "a drake's heart's flower", m.drakeHeart, "A rare, beautiful flower.  It could make an exquisite perfume.  According to a legend, dragons give this flower to the ones they intend to court. \n\nType: Transformative item", 50);
		...
		public const HUMMUS_:SimpleConsumable = mk("Hummus ","Hummus", "a blob of cheesy-looking hummus", m.Hummus, "This pile of hummus doesn't look that clean.  It looks bland.  So bland that you feel blander just by looking at it. \n\nType: Transformative item \nBase value: 100", 100);
		...
		public const WOLF_PP:SimpleConsumable = mk("Wolf Pp","WolfPepper", "a Wolf pepper", curry(m.caninePepper, 6), "The pepper is shiny and black, bulbous at the base but long and narrow at the tip.  It has a fuzzy feel to it and it smells spicy. \n\nType: Transformative item", 10);
