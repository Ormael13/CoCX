...
package classes.Items
{
	...
	public final class ConsumableLib extends BaseContent
	{
		...
		//Re-arranged by Kitteh6660. OCD FTW!
		...
		public const BIMBOCH:SimpleConsumable = mk("BimboCh","BimboCh", "a bottle of bimbo champagne \n\nType: Food & Beverages", curry(function(player:Player):void{getGame().telAdre.niamh.bimboChampagne(player,true,true)}), null, 1);
		...
		public const GODMEAD:SimpleConsumable = mk("GodMead","GodMead", "a pint of god's mead \n\nType: Food & Beverages", m.godMead,null);
		...
		public const SENSDRF:SimpleConsumable = mk("SensDrf","Sens. Draft", "a bottle of sensitivity draft", m.sensitivityDraft, "This carefully labelled potion is a 'Sensitivity Draft', and if the diagrams are any indication, it will make your body more sensitive. \n\nType: Consumable \nBase value: 15", 15);
