...
package classes.Items
{
	...
	/*	public const XXXXMAN:SimpleConsumable = mk("MAN", "Manual", "", m.xxx, ".", x);
		...
		public const GORGOIL:SimpleConsumable = mk("GorgOil","GorgonOil", "a vial of gorgon oil", m.gorgonOil, "A vial the size of your fist made of dark green glass. It contains what appears to be oily, greenish liquid. The odor is foul.", 20);
