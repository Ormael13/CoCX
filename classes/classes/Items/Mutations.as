...
/*
		...
		*/
		...
		public function salamanderfirewater(player:Player):void
		{
			...
			//clear screen
			clearOutput();
			outputText("You uncork the hip flash and drink it down.  The taste is actualy quite good, like an alcohol but with a little fire within.  Just as you ecxpected it makes you feel all hot and ready to take whole world head on.", false);
			...
			if (player.tailType != TAIL_TYPE_SALAMANDER && changes < changeLimit && rand(3) == 0) {
				//No tail
