...
//maybe some pregnancy-accelerating thing
		...
		public function ferretTF():void {
			...
			//BAD END:
			//- If you eat more Ferret Fruit after you have a full ferret score, you will receive a warning, as well as an intelligence drop:  “You find yourself staring off into the distance, dreaming idly of chasing rabbits through a warren.  You shake your head, returning to reality.  Perhaps you should cut back on all the Ferret Fruit?”
			...
			//- + Thin: 
			if(player.thickness > 15 && changes < changeLimit)
			{
			...
			if((!player.hasCock() && player.hipRating > 6) || (player.hasCock() && player.hipRating > 4))
			{
			...
			if(player.biggestTitSize() > 2 || (player.hasCock() && player.biggestTitSize() >= 1)) 
			{
			...
			if(player.hairType == HAIR_ANEMONE)
			{
			...
			if(player.faceType != FACE_FERRET_MASK && player.earType == EARS_FERRET && player.tailType == TAIL_TYPE_FERRET && player.lowerBody == LOWER_BODY_FERRET)
			{
			...
			//Face is not ferret, has ferret ears, tail, legs, and fur:
			//FURRY VERSION
			if(player.faceType == FACE_FERRET_MASK)
			{
			...
			//Tail TFs!
			if(player.tailType != TAIL_TYPE_FERRET && player.earType == EARS_FERRET)
			{
			...
			else if(player.isNaga() && player.earType == EARS_FERRET)
			{
			...
			if(player.lowerBody != LOWER_BODY_FERRET && player.earType == EARS_FERRET && player.tailType == TAIL_TYPE_FERRET)
			{
			...
			if(player.skinType != SKIN_TYPE_FUR && player.earType == EARS_FERRET && player.tailType == TAIL_TYPE_FERRET && player.lowerBody == LOWER_BODY_FERRET)
			{
