...
public class PrincessPucker extends Consumable 
	{
		...
		override public function useItem():Boolean
		{
			...
			outputText("You down the bottle, hiccuping a bit at the syrupy-sweet raspberry flavor.  Immediately following the sweet is a bite of sour, like sharp lime.  You pucker your lips, and feel your head clear a bit from the intensity of the flavor.  You wonder what Gwynn makes this out of.\n\n");
