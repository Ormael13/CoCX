...
import classes.Items.Consumable;
	...
	public class NumbingOil extends Consumable
	{
		...
		override public function useItem():Boolean
		{
			...
			if (player.sens < 20) {
				outputText("Your skin tingles slightly, and afterward, you feel less sensitive than before.");
			}
			...
			if (player.sens >= 40 && player.sens < 60) {
				outputText("Your skin burns and itches unbearably for several minutes, but it eventually returns to normal. You feel less sensitive than before.");
			}
			
			if (player.sens >= 60) {
				outputText("As you finish rubbing the oil into your skin, you fall gasping to your knees. It feels like someone lit you on fire, and that the fire is made of biting ants. You writhe in agony for a few minutes until the sensations fade. You feel slightly less sensitive than before.");
			}
