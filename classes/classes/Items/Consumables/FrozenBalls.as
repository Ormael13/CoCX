...
package classes.Items.Consumables 
{
	...
	public class FrozenBalls extends Consumable {
		...
		{
			super("FrozenB", "FrozenBalls", "a Frozen Balls", 60, "Three ball-shaped throwing weapons.  Though good for only a single use, they're guaranteed to do medium to high damage to solo or weak group of enemies if they hits.  Inflicts 1440 to 8640 ice damage.");
		}
		...
		override public function useItem():Boolean {
			...
			if (game.monster.spe - 320 > Utils.rand(100) + 1) { //1% dodge for each point of speed over 320
				...
				outputText(" incredible speed allows " + game.monster.pronoun2 + " to avoid the balls!  The deadly spheres shatters freezing area where they impacted somewhere in the distance.");
			}
			else { //Not dodged
				...
				outputText(game.monster.capitalA + game.monster.short + " is hit with the Frozen Balls!  They breaks apart as they freezes " + game.monster.pronoun2 + ". ");
