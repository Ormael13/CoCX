...
public class TatteredScroll extends Consumable {
	...
	override public function useItem():Boolean {
		...
		if (player.hairColor == "sandy blonde" && player.findPerk(PerkLib.TransformationImmunity) < 0 && player.findPerk(PerkLib.Undeath) < 0 && player.findPerk(PerkLib.WendigoCurse) < 0) {
