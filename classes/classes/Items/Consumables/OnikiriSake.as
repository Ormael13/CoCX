...
public class OnikiriSake extends Consumable {
	...
	override public function useItem():Boolean {
		...
		//Skin
		if (!InCollection(player.skinMaterialColor, "red", "reddish-orange", "purple", "blue") && changes < changeLimit && rand(4) == 0) {
			player.skinMaterialColor = randomChoice("purple","reddish-orange","red","blue");
			changes++;
