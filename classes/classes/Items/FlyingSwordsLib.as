...
public final class FlyingSwordsLib extends ItemConstants
	{
		...
		public const O_HALFM:FlyingSwords = new FlyingSwords("O.HalfM","Obsidian Half-Moon","Obsidian Half-Moon","Obsidian Half-Moon","slash",15,1500,"Sword that was forged from metal repeadly tempered deep in plantet crust.", "Large", 1, CombatAbility.TAG_EARTH);
