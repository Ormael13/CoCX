...
public final class FlyingSwordsLib extends ItemConstants
	{
		...
		public const MOONLGT2:FlyingSwords = new FlyingSwords("Moonlgt2","Moonlight Duo","Moonlight Duo","Moonlight Duo","slash",8,1600,"This pair of flying swords were specialy forged and enchanted to help with sneak attacks and posses increased chance to leave bleeding wounds.", "Small", 2);
		public const MOONLGT3:FlyingSwords = new FlyingSwords("Moonlgt3","Moonlight Quartet","Moonlight Quartet","Moonlight Quartet","slash",8,3200,"This set of four flying swords were specialy forged and enchanted to help with sneak attacks and posses increased chance to leave bleeding wounds.", "Small", 4);
