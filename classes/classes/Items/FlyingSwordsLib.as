...
public final class FlyingSwordsLib extends ItemConstants
	{
		...
		public const B_HALFM:FlyingSwords = new FlyingSwords("B.HalfM","Black Half-Moon","Black Half-Moon","Black Half-Moon","slash",6,600,"Sword that was forged from metal repeadly bathed in the liquid ice.", "Small", 1, CombatAbility.TAG_ICE);
		public const B_HALFM2:FlyingSwords = new FlyingSwords("B.HalfM2","Black Half-Moon Duo","Black Half-Moon Duo","Black Half-Moon Duo","slash",6,1200,"Pair of swords that were forged from metal repeadly bathed in the liquid ice.", "Small", 2, CombatAbility.TAG_ICE);
		...
		public const W_HALFM:FlyingSwords = new FlyingSwords("W.HalfM","White Half-Moon","White Half-Moon","White Half-Moon","slash",6,600,"Sword that was forged from metal repeadly bathed in the lava.", "Small", 1, CombatAbility.TAG_FIRE);
		public const W_HALFM2:FlyingSwords = new FlyingSwords("W.HalfM2","White Half-Moon Duo","White Half-Moon Duo","White Half-Moon Duo","slash",6,1200,"Pair of swords that were forged from metal repeadly bathed in the lava.", "Small", 2, CombatAbility.TAG_FIRE);
