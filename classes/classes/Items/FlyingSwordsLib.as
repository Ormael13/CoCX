...
public final class FlyingSwordsLib extends ItemConstants
	{
		...
		public const B_HALFM2:FlyingSwords = new FlyingSwords("B.HalfM2","Black Half-Moon Duo","Black Half-Moon Duo","Black Half-Moon Duo","slash",6,1200,"Pair of swords that were forged from metal repeadly bathed in the liquid ice.", "Small Two");
		...
		public const E_HALFM2:FlyingSwords = new FlyingSwords("E.HalfM2","Ebon Half-Moon Duo","Ebon Half-Moon Duo","Ebon Half-Moon Duo","slash",6,1200,"Pair of swords that were forged from metal repeadly infused with the darkness.", "Small Two");
		...
		public const S_HALFM2:FlyingSwords = new FlyingSwords("S.Half2M","Scarlet Half-Moon Duo", "Scarlet Half-Moon Duo", "Scarlet Half-Moon Duo", "slash",6,1200, "Pair of swords that were forged from metal repeadly tempered by the lightning.", "Small Two");
		...
		public const W_HALFM2:FlyingSwords = new FlyingSwords("W.HalfM2","White Half-Moon Duo","White Half-Moon Duo","White Half-Moon Duo","slash",6,1200,"Pair of swords that were forged from metal repeadly bathed in the lava.", "Small Two");
