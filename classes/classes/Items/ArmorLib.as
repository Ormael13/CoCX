...
//25 za 1 ptk robes, 20 dla light, 40 dla medium i 60 dla heavy, z perkiem/dod. efektem podwaja koszt za każdy
		public const ADVCLTH:Armor = new Armor("AdvClth","G. Clothes","green adventurer's clothes","a green adventurer's outfit, complete with pointed cap",2,50,"A set of comfortable green adventurer's clothes.  It even comes complete with a pointy hat!","Light");
		...
		public const EWPLTMA:ArmorWithPerk = new ArmorWithPerk("EWPltMa","E.W. Platemail","ebonweave platemail","an ebonweave platemail",36,4320,"The armor is ebonweave, created using refined ebonbloom petals. The armor consists of two layers, an outer layer of ebonweave playing, and an inner layer of arrowproof ebonweave cloth.","Heavy",
				PerkLib.WizardsEndurance,15,0,0,0);
		public const EWROBE_:ArmorWithPerk = new ArmorWithPerk("EWRobe","E.W. Robe","ebonweave robe","an ebonweave robe",12,600,"This robe is ebonweave, created using refined ebonbloom petals. This robe is as comfortable as cloth yet more protective than chainmail. The cloth has a mystic aura, helpful when working magic.","Light",
				PerkLib.WizardsEndurance,30,0,0,0);
		public const FULLCHN:Armor = new Armor("FullChn","Full Chain","full-body chainmail","a full suit of chainmail armor",8,320,"This full suit of chainmail armor covers its wearer from head to toe in protective steel rings.","Medium");
		...
		public const SS_ROBE:ArmorWithPerk = new ArmorWithPerk("SS.Robe","SS.Robes","spider-silk robes","a spider-silk robes",6,300,"This robe looks incredibly comfortable.  It's made from alchemically enhanced spider-silk, and embroidered with what looks like magical glyphs around the sleeves and hood.","Light",
				PerkLib.WizardsEndurance,30,0,0,0);
