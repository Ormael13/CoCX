...
package classes.Items
{
	...
	public final class ArmorLib
	{
		...
		public const LTHCARM:Armor = new Armor("LthcArm","Leth. Armor","lethicite armor","a suit of glowing purple lethicite armor",28,3000,"This is a suit of lethicite armor. It's all purple and it seems to glow. The pauldrons are spiky to give this armor an imposing appearance. It doesn't seem to cover your crotch though so you might want to wear undergarments. It appears to be enchanted to never break and you highly doubt the demons might be able to eat it! \n\nType: Heavy armor \nDefense: 28 \nBase value: 3000");
