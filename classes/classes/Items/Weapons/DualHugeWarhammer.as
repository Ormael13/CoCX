...
package classes.Items.Weapons 
{
	...
	public class DualHugeWarhammer extends Weapon {
		...
		override public function canUse():Boolean {
			...
			else if (game.player.hasPerk(PerkLib.GigantGrip) || gameplayer.hasPerk(PerkLib.AntyDexterity)) outputText("You aren't skilled in handling large weapons with one hand yet to effectively use those hammers. Unless you want to hurt yourself instead of your enemies when trying to use them...  ");
