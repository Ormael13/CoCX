	...
	public class DragonShellShield extends Weapon
	{
		...
		override public function equipEffect(user:Player):void
		{
			if(kGAMECLASS.flags[kFLAGS.TIMES_EQUIPPED_EMBER_SHIELD] == 0) {
				...
				if(user.str < 80) outputText("bits and pieces from the surface of the");
		...
		{
			super("DrgnShl","DrgnShl","a dragon-shell shield","smack",0,1500,"A durable shield that has been forged from the remains of the dragon egg you found in the swamp. Absorbs any fluid attacks you can catch, rendering them useless.","Large");
		}
	}
}
