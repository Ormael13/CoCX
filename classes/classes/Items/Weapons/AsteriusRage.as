	...
	public class AsteriusRage extends Weapon {
		...
		override public function canUse():Boolean {
			if (game.player.level >= 40){
				...
				else if (game.player.hasPerk(PerkLib.DualWield) || gameplayer.hasPerk(PerkLib.AntyDexterity)) outputText("You aren't skilled in handling large weapons with one hand yet to effectively use those axes. Unless you want to hurt yourself instead of your enemies when trying to use them...  ");
