...
package classes.Items.Weapons 
{
	...
	public class BlizzardClaws extends Weapon
	{
		...
		override public function equipText():void {
			if (!game.player.hasPerk(PerkLib.ColdMastery) && !game.player.hasPerk(PerkLib.ColdAffinity)) outputText("Is it just you or your hands are freezing? Without proper resistance to cold, the blizzard claws begins to sap your body warmth.\n\n");
