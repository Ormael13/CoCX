package classes.Items 
{
	...
	public final class JewelryLib
	{
		...
		public const SOULRNG:Jewelry = new Jewelry("SoulRng", "Soul Ring", "soulmetal ring", "a soulmetal ring", MODIFIER_SF, 20, 100, "This simple ring is made from low quality soulmetal. Despite it seemly simplicity it allow for slight compresion of it weaver soulforce allowing storing a little bit more of it. \n\nType: Jewelry (Ring) \nBase value: 100 \nSpecial: Increases maximum Soulforce by 20.","Ring");
		public const MANARNG:Jewelry = new Jewelry("ManaRng", "Mana Ring", "ring of mana", "an enchanted alexandrite ring of mana", MODIFIER_MP, 20, 1250, "This ring is topped with alexandrite gemstone. It is said that this will make you feel having a bit more mana. \n\nType: Jewelry (Ring) \nBase value: 1,250 \nSpecial: Increases maximum Mana by 20.","Ring");
		...
		public const TSRNG  :Jewelry = new Jewelry("TSRng  ", "T.S.Ring", "training soul ring", "a training soul ring", MODIFIER_SF, 20, 100, "This simple ring is made from special forged soulmetal. It help train soulforce to the uttermost limit for novice soul cultivator. \n\nType: Jewelry (Ring) \nBase value: 100.","Ring");
