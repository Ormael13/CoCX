package classes.Items 
{
	...
	public final class JewelryLib
	{
		...
		public const LIFERNG:Jewelry = mk("LifeRng", "Life Ring", "ring of life", "an enchanted emerald ring of life force", 5, 25, 1000, "This ring is topped with emerald gemstone. It is said that this will make you feel a bit healthier. \n\nType: Jewelry (Ring) \nBase value: 1,000 \nSpecial: Increases maximum HP by 25.","Ring");
		public const POWRRNG:Jewelry = mk("PowrRng", "Power Ring", "ring of power", "an enchanted ruby ring of power", 6, 10, 1500, "This ring is topped with ruby gemstone. It is said that this will make you feel a bit powerful. \n\nType: Jewelry (Ring) \nBase value: 1,500 \nIncreases damage by 10 percent.","Ring");
		public const MYSTRNG:Jewelry = mk("MystRng", "Mystic Ring", "ring of mysticality", "an enchanted sapphire ring of mysticality", 9, 25, 1500, "This ring is topped with sapphire gemstone. It is said that this will make your spells more powerful. \n\nType: Jewelry (Ring) \nBase value: 1,500 \nIncreases spellpower by 25 percent.","Ring");
		public const PURERNG:Jewelry = mk("PureRng", "Purity Ring", "purity ring", "an enchanted purity ring", 7, 10, 3000, "This ring symbolizes chastity and purity. When worn, it reduces minimum libido and makes it harder for you to get turned on. \n\nType: Jewelry (Ring) \nBase value: 3,000 \nSpecial: Slowly purifies the wearer over time. Reduces minimum libido by 10.","Ring");
		...
		public const DIAMRNG:Jewelry = mk("DiamRng", "Diam Ring", "gold and diamond ring", "a shining gold and diamond ring", 0, 0, 1000, "This shining ring is made of gold and topped with diamond. Truly expensive. \n\nType: Jewelry (Ring) \nBase value: 1,000","Ring");
