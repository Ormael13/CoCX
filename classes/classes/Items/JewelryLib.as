...
//		public static const MODIFIER_PHYS_R:int = 			;// add 'res_physical' buff
		...
		public const SOULRNG:Jewelry = new Jewelry("SoulRng", "Soul Ring", "soulmetal ring", "a soulmetal ring", MODIFIER_SF, 100, 1250, "This simple ring is made from low quality soulmetal. Despite its seeming simplicity it allows for slight compression of its wearer's soulforce allowing storing a little bit more of it.");
		public const MANARNG:Jewelry = new Jewelry("ManaRng", "Mana Ring", "ring of mana", "an enchanted alexandrite ring of mana", MODIFIER_MP, 200, 1250, "This ring is topped with alexandrite gemstone. It is said that this will make you feel like you have more mana.");
		...
		public const RPOWRNG:Jewelry = new Jewelry("RPowRng", "R. Power Ring", "ring of power (R)", "an enchanted ruby ring of power (R)", MODIFIER_R_ATTACK_POWER, 10, 1500, "This ring is topped with ruby gemstone. It is said that this will make your ranged attacks feel a bit more powerful.");
		...
		public const TSRNG  :Jewelry = new Jewelry("TSRng  ", "T.S.Ring", "training soul ring", "a training soul ring", 0, 0, 100, "This simple ring is made from special forged soulmetal. It helps train soulforce to the uttermost limit for novice soul cultivators.");
		...
		public const UNDKINS:Jewelry = new Jewelry("UndKinS", "UndefKingSignet", "Undefeated King's Signet", "an Undefeated King's Signet", MODIFIER_WR, 100, 2000, "A signet that belonged in the past to the king, which claimed to be undefeated. But then how did it get into your hands?");
		public const FLLIRNG:Jewelry = new Jewelry("FlLiRng", "FlameLizardRing", "Flame Lizard ring", "a Flame Lizard ring", MODIFIER_WR, 75, 3200, "This ring is encrusted with a few small emeralds, peridots, and carnelians gemstones. Useful for using Lustzerker or boosting it.", "Special: Generate 2/1 wrath per turn/hour. Allow to use Lustzerker.");
		public const INMORNG:Jewelry = new Jewelry("InMoRng", "InfernalMouseRing", "Infernal Mouse ring", "an Infernal Mouse ring", MODIFIER_WR, 75, 3200, "This ring is encrusted with a few small emeralds, peridots and sunstone gemstones. Useful for using Blazing battle spirit or boosting it.", "Special: Generate 2/1 wrath per turn/hour. Allow to use Blazing battle spirit.");
		...
		public const EZEKIELS:Jewelry = new Jewelry("EzekielS", "EzekielSignet", "Ezekiel's Signet", "an Ezekiel's Signet", 0, 0, 100, "A signet rumored to be blessed by the Ezekiel himself. Is that the real one or just another fake signet the merchant sold you?", "Special: -1 to internal chimerical disposition");
