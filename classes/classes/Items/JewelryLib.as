package classes.Items 
{
	...
	public final class JewelryLib
	{
		...
		public const LIFERNG:Jewelry = mk("LifeRng", "Life Ring", "ring of life", "an enchanted ruby ring of life force", 5, 25, 1000, "This ring is topped with emerald gemstone. It is said that this will make you feel a bit healthier. \n\nType: Jewelry (Ring) \nBase value: 1,000 \nSpecial: Increases maximum HP by 25.","Ring");
		public const POWRRNG:Jewelry = mk("PowrRng", "Power Ring", "ring of power", "an enchanted emerald ring of power", 6, 10, 1500, "This ring is topped with ruby gemstone. It is said that this will make you feel a bit powerful. \n\nType: Jewelry (Ring) \nBase value: 1,500 \nIncreases damage by 10 percent.","Ring");
