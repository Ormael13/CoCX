package classes.Items 
{
	...
	public final class JewelryLib
	{
		...
		public const LTHCRNG:Jewelry = new Jewelry("LthcRng", "Lethic.Ring", "lethicite ring", "a glowing lethicite ring", CORRUPTION, 1, 5000, "This ring appears to be made of platinum with some lethicite crystal. Very expensive as lethicite is rare. \n\nType: Jewelry (Ring) \nBase value: 5,000 \nSpecial: Slowly corrupts the wearer over time.","Ring");
