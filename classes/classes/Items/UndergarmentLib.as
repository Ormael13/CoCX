package classes.Items 
{
	...
	public final class UndergarmentLib 
	{
		...
		public const DS_BRA:Undergarment = new Undergarment("DS. Bra ", "D.Scale Bra", "dragon-scale bra", "a pair of dragonscale bra", TYPE_UPPERWEAR, 600, "This bra appears to be made of dragon scale. \n\nType: Undergarment (Upper)");
		...
		public const DS_LOIN:Undergarment = new Undergarment("DS.Loin", "D.Scale Loin", "dragon-scale loincloth", "a pair of dragonscale loincloth", TYPE_LOWERWEAR, 600, "This loincloth appears to be made of dragonscale. Great for those on the wild side! \n\nType: Undergarment (Lower)");
		public const DSPANTY:Undergarment = new Undergarment("DSPanty", "D.Scale Panties", "dragon-scale panties", "a pair of dragonscale panties", TYPE_LOWERWEAR, 600, "These panties appear to be made of dragonscale. Great for those on the wild side! \n\nType: Undergarment (Lower)");
