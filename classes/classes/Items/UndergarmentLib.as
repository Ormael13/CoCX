package classes.Items 
{
	...
	public final class UndergarmentLib 
	{
		...
		public const F_B_TOP:Undergarment = new Undergarment("F.B.Top", "F.Bikini Top", "Fur bikini top", "a pair of Fur bikini top", TYPE_UPPERWEAR, 600, "This white fur bikini made from a material similar to yeti fur helps reduce the effect of cold environments. (+10% ice resistance) \n\nType: Undergarment (Upper)");
		...
		public const COW_BRA:Undergarment = new Undergarment("Cow Bra", "Cow Bra", "cow girl bra", "a cow girl bra", TYPE_LOWERWEAR, 1000, "This bra look like ordinary panty at a first glance save for the cow fur like motif. They increase lacta bovina lactation rate. Comes with the bonus of accomodating just any breast size! \n\nType: Undergarment (Upper)");
		...
		public const F_LOIN_:Undergarment = new Undergarment("F. Loin", "Fur Loin", "Fur loincloth", "a Fur loincloth", TYPE_LOWERWEAR, 600, "This white fur loincloth made from a material similar to yeti furs help reduce the effect of cold environments. (+10% ice resistance) \n\nType: Undergarment (Lower)", "NagaWearable");
		public const F_PANTY:Undergarment = new Undergarment("F.Panty", "Fur Panty", "Fur panty", "a pair of Fur panty", TYPE_LOWERWEAR, 600, "This white fur panty made from a material similar to yeti fur helps reduce the effect of cold environments. (+10% ice resistance) \n\nType: Undergarment (Lower)");
