...
public final class UndergarmentLib extends ItemConstants
	{
		...
		public const COW_BRA:Undergarment = new Undergarment("Cow Bra", "Cow Bra", "cow girl bra", "a cow girl bra", UT_TOP, 1000, 1, 1, 3, "This bra looks like an ordinary panty at first glance save for the cow-fur-like motif. They increase lacta bovina lactation rate as well as the efficiency of Milk blast. Comes with the bonus of accomodating just any breast size and letting milk flow through! \n\nType: Undergarment (Upper)");
