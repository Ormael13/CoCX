...
package classes.Items.Undergarments 
{
	...
	public class TechnomancerPanties extends Undergarment
	{
		...
		{
			super("T.Panty", "T.Panties", "Technomancer panties", "a pair of Technomancer panties", TYPE_LOWERWEAR, 600, "A black latex panty to match with the technomancer clothes, it is decorated with a gears motif and is oil, shock and stainproof. This item also improve your aptitude at using technology. \n\nType: Undergarment (Lower)");
		}
