...
public class Face extends SaveableBodyPart {
	...
	EnumValue.add(Types, SHARK_TEETH, "SHARK_TEETH", {name: "shark"});
	public static const SNAKE_FANGS:int      = 5;
	EnumValue.add(Types, SNAKE_FANGS, "SNAKE_FANGS", {name: "snake"});
	...
	EnumValue.add(Types, SPIDER_FANGS, "SPIDER_FANGS", {name: "spider"});
	...
	EnumValue.add(Types, BUCKTEETH, "BUCKTEETH", {name: "buckteeth"});
	...
	EnumValue.add(Types, SALAMANDER_FANGS, "SALAMANDER_FANGS", {name: "salamander"});
	public static const YETI_FANGS:int       = 27;
	EnumValue.add(Types, YETI_FANGS, "YETI_FANGS", {name: "yeti"});
	...
	EnumValue.add(Types, PLANT_DRAGON, "PLANT_DRAGON", {name: "plant dragon"});
	public static const DRAGON_FANGS:int	 = 30;
	EnumValue.add(Types, DRAGON_FANGS, "DRAGON_FANGS", {name: "dragon fangs"});
	public static const DEVIL_FANGS:int 	 = 31;
	EnumValue.add(Types, DEVIL_FANGS, "DEVIL_FANGS", {name: "devil fangs"});
	public static const ONI_TEETH:int   	 = 32;
	EnumValue.add(Types, ONI_TEETH, "ONI_TEETH", {name: "oni teeth"});
	...
	EnumValue.add(Types, BUCKTOOTH, "BUCKTOOTH", {name: "jabberwocky bucktooth"});
	public static const JABBERWOCKY:int 	 = 36;
	EnumValue.add(Types, JABBERWOCKY, "JABBERWOCKY", {name: "jabberwocky"});
	...
	EnumValue.add(Types, CAT_CANINES, "CAT_CANINES", {name: "cat canines"});
	public static const CHESHIRE:int    	 = 39;
	EnumValue.add(Types, CHESHIRE, "CHESHIRE", {name: "cheshire"});
	public static const CHESHIRE_SMILE:int	 = 40;
	EnumValue.add(Types, CHESHIRE_SMILE, "CHESHIRE_SMILE", {name: "cheshire"});
	...
	EnumValue.add(Types, WOLF_FANGS, "WOLF_FANGS", {name: "wolf fangs"});
	public static const ORC_FANGS:int		 = 43;
	EnumValue.add(Types, ORC_FANGS, "ORC_FANGS", {name: "orc fangs"});
	public static const ANIMAL_TOOTHS:int	 = 44;
	EnumValue.add(Types, ANIMAL_TOOTHS, "ANIMAL_TOOTHS", {name: "animal teeth"});
