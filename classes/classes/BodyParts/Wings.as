...
public class Wings extends BodyPart {
	...
	EnumValue.add(Types, BEE_LIKE_LARGE, "BEE_LIKE_LARGE", {name:"large bee-like"});
	//unused yet nr 3 wing type
	public static const HARPY:int                = 4;
	EnumValue.add(Types, HARPY, "HARPY", {name:"harpy", wingSlap: true});
	...
	EnumValue.add(Types, BAT_LIKE_LARGE, "BAT_LIKE_LARGE", {name:"large bat-like", wingSlap: true});
	...
	EnumValue.add(Types, FEATHERED_LARGE, "FEATHERED_LARGE", {name:"large feathered", wingSlap: true});
	...
	EnumValue.add(Types, DRACONIC_LARGE, "DRACONIC_LARGE", {name:"large draconic", wingSlap: true});
	public static const GIANT_DRAGONFLY:int      = 12;
	EnumValue.add(Types, GIANT_DRAGONFLY, "GIANT_DRAGONFLY", {name:"giant dragonfly"});
	public static const BAT_LIKE_LARGE_2:int     = 13;
	EnumValue.add(Types, BAT_LIKE_LARGE_2, "BAT_LIKE_LARGE_2", {name:"two large pairs of bat-like", wingSlap: true});
	public static const DRACONIC_HUGE:int        = 14;
	EnumValue.add(Types, DRACONIC_HUGE, "DRACONIC_HUGE", {name:"large majestic draconic", wingSlap: true});
	public static const FEATHERED_PHOENIX:int    = 15;//button 0 on 2nd page of metamorph
	EnumValue.add(Types, FEATHERED_PHOENIX, "FEATHERED_PHOENIX", {name:"phoenix", wingSlap: true});
	public static const FEATHERED_ALICORN:int    = 16;
	EnumValue.add(Types, FEATHERED_ALICORN, "FEATHERED_ALICORN", {name:"alicorn", wingSlap: true});
	...
	EnumValue.add(Types, MANTIS_LIKE_LARGE, "MANTIS_LIKE_LARGE", {name:"large mantis-like"});
	public static const MANTIS_LIKE_LARGE_2:int  = 19;
	EnumValue.add(Types, MANTIS_LIKE_LARGE_2, "MANTIS_LIKE_LARGE_2", {name:"two large pairs of mantis-like"});
	public static const GARGOYLE_LIKE_LARGE:int  = 20;
	EnumValue.add(Types, GARGOYLE_LIKE_LARGE, "GARGOYLE_LIKE_LARGE", {name:"large stony", wingSlap: true});
	...
	EnumValue.add(Types, MANTICORE_LIKE_LARGE, "MANTICORE_LIKE_LARGE", {name:"large manticore-like", wingSlap: true});
	public static const BAT_ARM:int              = 24;
	EnumValue.add(Types, BAT_ARM, "BAT_ARM", {name:"bat", wingSlap: true});
	public static const VAMPIRE:int              = 25;
	EnumValue.add(Types, VAMPIRE, "VAMPIRE", {name:"large bat", wingSlap: true});
	public static const FEY_DRAGON_WINGS:int     = 26;
	EnumValue.add(Types, FEY_DRAGON_WINGS, "FEY_DRAGON_WINGS", {name:"large majestic fey draconic", wingSlap: true});
	public static const FEATHERED_AVIAN:int      = 27;
	EnumValue.add(Types, FEATHERED_AVIAN, "FEATHERED_AVIAN", {name:"avian", wingSlap: true});
	public static const NIGHTMARE:int    		 = 28;
	EnumValue.add(Types, NIGHTMARE, "NIGHTMARE", {name:"leathery", wingSlap: true});
	public static const FEATHERED_SPHINX:int     = 29;//button 0 on 3rd page of metamorph
	EnumValue.add(Types, FEATHERED_SPHINX, "FEATHERED_SPHINX", {name:"sphinx", wingSlap: true});
	public static const ETHEREAL_WINGS:int    	 = 30;
	EnumValue.add(Types, ETHEREAL_WINGS, "ETHEREAL_WINGS", {name:"ethereal tendrils"});
	public static const THUNDEROUS_AURA:int    	 = 31;
	EnumValue.add(Types, THUNDEROUS_AURA, "THUNDEROUS_AURA", {name:"thunderous aura"});
	public static const LEVITATION:int    		 = 32;
	EnumValue.add(Types, LEVITATION, "LEVITATION", {name:"non-existant"});
	public static const DEVILFEATHER:int       	 = 33;
	EnumValue.add(Types, DEVILFEATHER, "DEVILFEATHER", {name:"devil"});
	public static const FAIRY:int     			 = 34;
	EnumValue.add(Types, FAIRY, "FAIRY", {name:"fairy"});
	public static const WINDY_AURA:int    	 	 = 35;
	EnumValue.add(Types, WINDY_AURA, "WINDY_AURA", {name:"windy aura"});
