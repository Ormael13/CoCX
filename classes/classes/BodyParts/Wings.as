...
public class Wings extends BodyPart {
	...
	EnumValue.add(Types, BAT_LIKE_LARGE, "BAT_LIKE_LARGE", {name:"large bat-like"});
	...
	EnumValue.add(Types, FEATHERED_LARGE, "FEATHERED_LARGE", {name:"large feathered"});
	...
	EnumValue.add(Types, DRACONIC_LARGE, "DRACONIC_LARGE", {name:"large draconic"});
	...
	EnumValue.add(Types, BAT_LIKE_LARGE_2, "BAT_LIKE_LARGE_2", {name:"two large pairs of bat-like"});
	public static const DRACONIC_HUGE:int        = 14;
	EnumValue.add(Types, DRACONIC_HUGE, "DRACONIC_HUGE", {name:"large majestic draconic"});
	public static const FEATHERED_PHOENIX:int    = 15;//button 0 on 2nd page of metamorph
	EnumValue.add(Types, FEATHERED_PHOENIX, "FEATHERED_PHOENIX", {name:"phoenix"});
	public static const FEATHERED_ALICORN:int    = 16;
	EnumValue.add(Types, FEATHERED_ALICORN, "FEATHERED_ALICORN", {name:"alicorn"});
	...
	EnumValue.add(Types, GARGOYLE_LIKE_LARGE, "GARGOYLE_LIKE_LARGE", {name:"large stony"});
	...
	EnumValue.add(Types, MANTICORE_LIKE_LARGE, "MANTICORE_LIKE_LARGE", {name:"large manticore-like"});
	public static const BAT_ARM:int              = 24;
	EnumValue.add(Types, BAT_ARM, "BAT_ARM", {name:"bat"});
	public static const VAMPIRE:int              = 25;
	EnumValue.add(Types, VAMPIRE, "VAMPIRE", {name:"large bat"});
	public static const FEY_DRAGON_WINGS:int     = 26;
	EnumValue.add(Types, FEY_DRAGON_WINGS, "FEY_DRAGON_WINGS", {name:"large majestic fey draconic"});
	public static const FEATHERED_AVIAN:int      = 27;
	EnumValue.add(Types, FEATHERED_AVIAN, "FEATHERED_AVIAN", {name:"avian"});
	public static const NIGHTMARE:int    		 = 28;
	EnumValue.add(Types, NIGHTMARE, "NIGHTMARE", {name:"leathery"});
	public static const FEATHERED_SPHINX:int     = 29;//button 0 on 3rd page of metamorph
	EnumValue.add(Types, FEATHERED_SPHINX, "FEATHERED_SPHINX", {name:"sphinx"});
