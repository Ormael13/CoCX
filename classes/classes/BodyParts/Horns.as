...
public class Horns extends BodyPart {
	...
	EnumValue.add(Types, BICORN, "BICORN", {name:"bicorn"});
	...
	EnumValue.add(Types, GOATQUAD, "GOATQUAD", {name:"4 goat"});
