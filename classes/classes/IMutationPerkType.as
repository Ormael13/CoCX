...
public class IMutationPerkType extends BaseContent
	{
		private static var MUTATIONS_LIBRARY:Dictionary = new Dictionary();

		public static function lookupMutation(id:String):IMutationPerkType{
			return MUTATIONS_LIBRARY[id];
		}

		public static function getMutationLibrary():Dictionary
		{
			return MUTATIONS_LIBRARY;
		}
		 ...
		 */
		public function name(params:IMutationPerkClass=null):String {
			return _name
		}
		 ...
		 */
		public function desc(params:IMutationPerkClass=null):String
		{
			return _desc;
		}
		...
		/**
		 * Max level Mutation can be acquired from.
		 */
		...
		public function IMutationPerkType(id:String, name:String, maxLvl:int, desc:String, longDesc:String = null)
		{
			this._id = id;
			this._name = name;
			this._maxLvl = maxLvl;
			...
			if (MUTATIONS_LIBRARY[id] != null) {
				CoC_Settings.error("Duplicate Mutations id "+id+", old Mutation is "+(MUTATIONS_LIBRARY[id] as IMutationPerkType)._name);
			}
			MUTATIONS_LIBRARY[id] = this;
		}
		...
		public function requireCustomFunction(playerToBoolean:Function, requirementText:String, internalType:String = "custom"):IMutationPerkType {
			requirements.push({
				fn  : playerToBoolean,
		...
		public function requireLevel(value:int):IMutationPerkType {
			requirements.push({
		...
		public function requireStr(value:int):IMutationPerkType {
			requirements.push({
		...
		public function requireTou(value:int):IMutationPerkType {
			requirements.push({
		...
		public function requireSpe(value:int):IMutationPerkType {
			requirements.push({
		...
		public function requireInt(value:int):IMutationPerkType {
			requirements.push({
		...
		public function requireWis(value:int):IMutationPerkType {
			requirements.push({
		...
		public function requireLib(value:int):IMutationPerkType {
			requirements.push({
		...
		public function requireSen(value:int):IMutationPerkType {
			requirements.push({
		...
		public function requireCor(value:int):IMutationPerkType {
			requirements.push({
		...
		//Don't think I'll need these, so these will be commented out for sanity.
		/*
		public function requireLibLessThan(value:int):MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requireNGPlus(value:int):MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requireAdvancedJobSlot():MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requireHiddenJobSlot():MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requirePrestigeJobSlot():MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireHeartMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireMusclesMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireMouthMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireAdrenalGlandsMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireBloodsteamMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireFatTissueMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireLungsMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireMetabolismMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireOvariesMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireBallsMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireEyesMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requirePeripheralNervSysMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireBonesAndMarrowMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireThyroidGlandMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireParathyroidGlandMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireAdaptationsMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireDragonMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireKitsuneMutationSlot():IMutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		//Don't think I'll need these, so these will be commented out for sanity.
		/*
		public function requireHungerEnabled():MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requireMinLust(value:int):MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requireMinSens(value:int):MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requireMaxSoulforce(value:int):MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requireMaxMana(value:int):MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		/*
		public function requireMaxVenom(value:int):MutationPerkType {
			requirements.push({
				fn  : function(player:Player):Boolean {
		...
		public function requireStatusEffect(effect:StatusEffectType, text:String):IMutationPerkType {
			requirements.push({
				fn  : function (player:Player):Boolean {
		...
		public function requirePerk(perk:PerkType):IMutationPerkType {
			requirements.push({
				fn  : function (player:Player):Boolean {
		...
		public function requireAnyPerk(...perks:Array):IMutationPerkType {
		...
		public function requirePerks(...perks:Array):IMutationPerkType {	//As opposed to requirePerk or requireAnyPerk, this checks for if player has all required perks instead of any of them or just the one.
		...
		public function withBuffs(buffs:Object, showText:Boolean = true):IMutationPerkType {
			this.buffs = buffs
			var tempText:String = "";
			if(showText) {
				var key:String;
