...
public function savePermObject(isFile:Boolean):void {
	...
	try {
		...
		saveFile.data.flags[kFLAGS.CHARVIEW_ARMOR] = flags[kFLAGS.CHARVIEW_ARMOR];
...
public function loadPermObject():void {
	...
	if (saveFile.data.exists)
	{
		...
		if (saveFile.data.flags) {
			...
			if (saveFile.data.flags[kFLAGS.CHARVIEW_ARMOR] != undefined) flags[kFLAGS.CHARVIEW_ARMOR] = saveFile.data.flags[kFLAGS.CHARVIEW_ARMOR];
