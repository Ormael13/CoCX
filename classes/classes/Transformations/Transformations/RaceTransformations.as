...
public class RaceTransformations extends MutationsHelper {
    ...
    */
    ...
    public static const KitsuneRaceBody:/*String*/Array = 		["Human",	"Kitsune",	"Human",	"Human",	"Human",	"Fox",		"Fox",		"Fox",			"None",		"Kitsune",	"Human",   		"Fox",		"Human",    "Kitsune",	"Human",		"Human",		"Human",		"Kitsune",	"Human",	"Human",	"Human",	"Human", "Kitsune"];	public static const AlicornRaceBody:/*String*/Array = 		["Human",	"Human",	"Human",	"Normal",	"Human",	"Horse",	"Alicorn",	"Human",		"None",		"Alicorn",	"Unicorn",		"Horse",	"Human",    "Alicorn",	"Human",		"Human",		"Human",		"Horse",	"Human",	"Alicorn",	"Horse",	"Horse"];
