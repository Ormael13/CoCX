...
/*
	*/
	...
	private const wyrmCoatColor: Array = ["bluish black", "dark gray", "black", "midnight black", "midnight"];
	    ...
	    function(doOutput: Boolean): void {
	        ...
	        if (player.lowerBody == LowerBody.SCYLLA) {
              ...
              if (player.lowerBody == LowerBody.MELKIE) {
                  ...
                  desc += "However this doesnt last long as changes begins to overcome your legs again.";
              }
