...
public static const DISCOVERED_DUNGEON_3_LETHICE:int                                = 2108;
public static const LETHICE_CASTLE_SUCCUBUS_DEFEATED:int                            = 2109; //1 if defeated, 2 if killed
public static const LETHICE_CASTLE_STATUE_DEFEATED:int                              = 2110; //1 if statue is destroyed
public static const LETHICE_CASTLE_CENTAUR_DEFEATED:int                             = 2111; //1 if defeated, 2 is killed
public static const LETHICE_CASTLE_INCUBUS_GREETED:int                              = 2112; //1 if you've met him the first time.
public static const LETHICE_CASTLE_INCUBUS_DEAL:int                             	= 2113; //1 if paid by gems, 2 if you agree to blow him.
public static const LETHICE_CASTLE_INCUBUS_DEFEATED:int                             = 2114; //1 if defeated, 2 if killed, 3 if sexed
public static const LETHICE_CASTLE_LETHICE_DEFEATED:int                             = 2115; //Will alter scenes for post-game.
