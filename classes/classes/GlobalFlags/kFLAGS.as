...
public static const UNKNOWN_FLAG_2109:int                            				= 2109; //1 if defeated, 2 if killed
public static const UNKNOWN_FLAG_2110:int                              				= 2110; //1 if statue is destroyed
public static const UNKNOWN_FLAG_2111:int                             				= 2111; //1 if defeated, 2 is killed
public static const UNKNOWN_FLAG_2112:int                              				= 2112; //1 if you've met him the first time.
public static const UNKNOWN_FLAG_2113:int                             				= 2113; //1 if paid by gems, 2 if you agree to blow him.
public static const UNKNOWN_FLAG_2114:int                             				= 2114; //1 if defeated, 2 if killed, 3 if sexed
public static const UNKNOWN_FLAG_2115:int                             				= 2115; //Will alter scenes for post-game.
