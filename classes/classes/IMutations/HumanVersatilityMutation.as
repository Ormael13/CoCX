...
public class HumanVersatilityMutation extends IMutationPerkType
    {
        ...
        override public function mDesc(params:PerkClass, pTier:int = -1):String {
            ...
            if (pTier == 3){
                descS = "Mastery gains increased by 3 point or in case of multiplier +3 to multiplier. Decrease needed exp to lvl up weapon/lifeskill masteries.  (if PC have Hunger bar active) (+45% of max core Tou as phantom Tou)";
            }
            return descS;
        }
