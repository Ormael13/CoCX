...
//*Victory Rape: PC Penis goes in Vagina (done)
		private function winDriderPCDickInSpiderCunt():void
		{
			...
			outputText("Still fondling one of the four nicely-sized tits, you push the spider-bitch back, admiring the drider's flexibility as she leans back over her inhuman lower body, giving you an even better view of her intoxicatingly sweet-smelling pussy.  You take " + oMultiCockDesc() + " in hand and rub the " + cockHead(x) + " along the slick lips of her pussy, shuddering slightly as her wetness rubs the sensitive glans.  Gasping, you slowly spread her molten-hot pussy around your girth, reveling in the tight embrace of her slick walls.  The drider squirms in your grip with her breasts bouncing deliciously and whole body trembling.  Spreading as easily as her cunt, the drider's venom-glossed lips slowly open into a wordless 'o' of rapturous pleasure.\n\n", false);
...
//*Victory Rape: Ride Ovi Vaginal (done)
		private function victoryVSDriderRideOviVaginal():void
		{
			...
			outputText("Like this, you're treated to a perfect view of ALL of the web-woman's endowments.  Her four D-cup tits flatten slightly against her torso now that she's on her back, hanging slightly to the side.  At her crotch, you can see her glistening, black-lipped sex puffing up, the tip of her large button already peaking out of her tempting box.  Just below that, the black and " + monster.hairColor + "-striped exoskeleton of her spider-half starts, merging down into an bulbous, arachnid shape.  At the very bottom of it all is the huge bulk of her abdomen, covered with numerous spinnerets and with a wide, mostly-retracted organ near the back.\n\n", false);
...
//(please view the spinneret as a spider-horsecock because for all intents and purposes that is really what it is) - shambadibs (1.5-inch width max because i'm racist against buur-bous american penis) (also probably a corruption minimum this is a pretty dick move) (I GET IT)
		private function victoryVSDriderStickDickInSpinneret():void
		{
			...
			outputText("Any satisfaction the drider could have gleaned is quickly replaced with complete trepidation as you swivel her spinneret toward you, grabbing your " + cockDescript(x) + " and lining it up with the onyx protrusion.  She manages to choke out a protest before you plunge into the depths, the tight recesses squeezing you wonderfully.  A strangled, gurgly scream peals from the oversensitized girl, both her arms and legs flailing about.  You push up to your pelvis into her spinneret, then slowly—so slowly—draw back, the sensation leaving the drider to claw deep divots into the mossy ground.  You draw out to the " + cockHead(x) + ", then thrust back in, taking your sweet time with the motions.  Her eyes roll back into her head, and another gurgle rumbles in her throat.  You have to wonder if she can even form coherent thoughts, in this state.  No matter; she insulted you, after all.  She begins hissing something through her clenched teeth, and while unintelligible at first, you can eventually make out, \"<i>Fuck you... fuck you... fuck you...</i>\" like some sort of vulgar mantra.\n\n", false);
...
//*Loss Ride & Impregnate Butt (done)
		private function loseVSDriderAndGetFuckedANDAnalImpreggegity():void
		{
			...
			outputText("You look at her with fear, but your " + hipDescript() + " start to twitch against her, rubbing your " + cockHead(x) + " up and down the slippery slit.  A slow exhale of pleasure escapes the spider's purple lips while her legs squeeze tighter against you, trying to push your " + cockDescript(x) + " home.  The drider gasps when at last, you slip between her juicy outer labia, slurping deep into her cunny with a lurid squelch.  Finally held within her depths, your muscles all slacken, save for those you need to pump your hips against her, futilely trying to fuck her hot quim even though you have zero leverage.\n\n", false);
			...
			outputText("Wait, eggs?  While you try to chew over the thought, you're battling with your raging, venom-enhanced libido to think about something other than how good her pussy feels.  Fuck it!  You go back to grinding against your mistress, nuzzling at her neck while she twists her spider-half around you, holding you tightly in her chitin and bringing her abdomen up behind you.  A weird, wet appendage rubs over your exposed " + buttDescript() + ", slapping at your cheeks until it finds the cleft between them.  Sliding deeper, it bumps into your sphincter, spurts something warm, wet, and sticky against it, then pushes through.", false);
			player.buttChange(8, true, true, false);
			outputText("  You shudder from the anal violation and twist against the legs holding you in place, but with your " + cockDescript(x) + " locked inside her, it's a useless endaevor.  It isn't shaped like a dick, and besides, that's currently dripping on your belly.  Oh gods... she mentioned eggs.\n\n", false);
...
//Summary: what goes up must come down
		...
		public function driderPregVagBirth():void
		{
			...
			outputText("  As you lie panting, your revery is interrupted by a small cracking noise.  You sit up with a start and scan the area for someone approaching.  The cracking noise begins to multiply and you realize that it's coming the pile of eggs nearby.  You begin watching with interest as your eggs start to hatch.\n\n", false);
...
//[No] 
		...
		private function driderTiedUpPartTwo(useItem:Boolean):void
		{
			...
			outputText("\n\nShe inhales sharply as you find your target, fingertips brushing against her throbbing, erect clit.  You trail your hand down her slit, feeling how wet and ready she's getting for you.  You dip two fingers into her, sliding them past her puffy lips with ease, drawing out a flurry of uncontrolled cries as you wiggle them against her sensitive walls.  As you tease the woman, you realise that her arms have stopped struggling against their bonds, apparently she's putting all her effort into not crying out at your assault on her engorged sex.");
		...
		private function driderTiedUpPartThree():void
		{
			...
			outputText("\n\nOnce you are sure the gag is secure you jump to your feet abruptly, leaving the drider to splash back into the shallow water of the swamp floor, her hair and chest becoming drenched once again as water cascades over her struggling form.  You loom over the trapped girl, your cock twitching in the air as your eyes drink in her completely exposed form, the sight compelling you to start removing your armour as quickly as possible.  She seems to be having trouble with her new facial wear, you can see her mouth moving through the wet material and it looks as if she is trying to keep the silk away from her lips by pushing at it with her tongue.  It looks as though she isn't a big fan of the taste that you \"infused\" it with and she starts to whip her head left and right, trying to wash the silk in the water that she's lying in.");
			...
			outputText("\n\nYou moan as she writes beneath you, her passage gripping and touching you in ways you never thought possible whilst she breathlessly whines at your aggressive overstimulation, each brush against her clit quickening your thrusts as her her insides grow ever wetter.  Her voice fails her long before she stops convulsing, body still wracked with bolts of pleasure as you hump into her unceasingly, drawing out pleasure-filled grunts as you push into her pleasure-wracked walls again and again, her tired body twitching as it lies in the mire beneath you, unable to do much more than pant and groan after her impossibly long orgasm.");
