...
//(should probably add a cock-limit of like, whatever you want, cuz you're fucking her butt)
		private function sweetieNOOOO():void
		{
			...
			if (flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00295] == 1) doNext(postUdderChoice);
				...
				//[yep] [no way jose]
				simpleChoices("Udder", yesUdderPWEASE, "No Udder", noUdderPlz, "Never Udder", noUdderPlz, "", 0, "", 0);
			}
		}
...
//After that is a scene tailored more specifically for the PC. Intention is to give nagas and centaurs and all that their own scene. Currently only scene is for PCs with a dick - should be naga-compatible.
		private function cerminika():void
		{
			...
			if (player.hasCock()) {
				...
				outputText(".  \"<i>Hey,</i>\" she gasps, \"<i>Don't you want to savour it?</i>\"\n\n", false);
				...
				outputText("Under most circumstances you would have no opposition to denying a slut like her an orgasm, but considering the precipice she dangles over, you don't feel bad giving her a push.  Your " + cockDescript(0) + " continues its obscene assault on her backside, splitting her juicy cheeks to either side as you bend her guts to your dick's will.  Dominika lets out a moan that seems as though she may have intended it to be a a scream of frustration, but her body is too far gone into pleasure to protest.  Like ink running through paper a deep dark purple begins to spread from her tattoos.  The colour runs into itself and grows larger, leaving behind no lines where it joins.  The tan of her skin begins to disappear under the corruption.  \"<i>You " + player.mf("bastard", "bitch") + ",</i>\" she pants, shuddering as the horns grow larger.  \"<i>You would destroy my humanity... just for your pleasure?</i>\"\n\n", false);

				outputText("\"<i>Yes,</i>\" you answer calmly.\n\n", false);

				outputText("She wails in mixed frustration and pleasure, juices splattering against the ground as her hungry cunt grows hornier.  A darkness overtakes her eyes, and her nails grow long and sharp, and through it all your " + cockDescript(0) + " continues to degrade her ass.  As though a heartbeat pumping blood through her body, each thrust spreads the colour over her skin a little more.  Her feet push and scrabble lightly against the ground in tormented frustration, but she is helpless beneath you.  You go without stopping, only slowing when wings unexpectedly burst from her shoulder blades, dark and starry.\n\n", false);
...
//▶[GetTongued] requires vagina
		private function getTonguedByZetsuko():void
		{
			...
			outputText("Grabbing hold of her thighs, you begin to rock yourself back and forth across her tongue, moaning powerfully as you feel it begin to thrust in and out of you now.  The numerous studs that line the center of the organ begin to press firmly agains the roof of your " + vaginaDescript(0) + ", stimulating your G-spot and flicking your " + clitDescript() + " each time her tongue dives back inside you.  Your fingers dig into her flesh like a vice now as you grind yourself down on the indecent tendril, moaning salaciously as the waves of your climax begin to overtake you.\n\n", false);
...
//▶[Banana?] silly mode
		...
		private function giveFollowerBodyBits():void
		{
			...
			if (player.gender > 0 || player.biggestTitSize() > 0) {
				...
				if (player.hasVagina()) {
					outputText("\nYour vagina would probably give the most amazing sensations while being used in Ceraph's orgies.");
...
//NippleCunt Stuffing (Ceraph grows dick-nipples to plow your lusty twats!)
		private function stuffSomeNippleCunts():void
		{
			...
			if (flags[kFLAGS.CERAPH_HIDING_DICK] == 0) outputText(", her cock spouting it's own ivory wetness onto your belly in sympathetic release.");
...
//[Either Once]
		private function barkToCeraphOnce(dog:Boolean = true):void
		{
			...
			else if (player.ass.analLooseness >= 4) outputText("The cunt-slick tool has no problem wiggling inside your well-used and abused asshole, hilted in a split second, the hundreds of nubs gently caressing your anal ring like a lover as the nestle inside you.");
			...
			outputText(" and start to push back against her before long.  Those nodules rub your insides so good, and they keep you dripping wasted ");
			...
			outputText("\n\nCeraph moans out loud and suddenly rams herself into you brutally hard, hard enough to make you feel like your guts being smushed into each other and your ");
			if (player.hasCock()) outputText("prostate");
			else outputText("vaginal walls");
			outputText(" smashed flat.  Warmth explodes inside your intestines, slowly spreading out around the flaring, demonically enhanced dick as it orgasms.  You can hear your owner's lady-spunk splattering into the ground behind you as she whimpers, \"<i>G-g-good... " + player.mf("boy", "girl") + "...</i>\", her dick firmly spraying its thick, tainted milk ");
