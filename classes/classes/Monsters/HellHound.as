package classes.Monsters
{
	...
	public class HellHound extends Monster
	{
		...
		override public function defeated(hpVictory:Boolean):void
		{
			if (hpVictory) {
				...
				if (player.hasVagina() && player.lust >= 33 && !player.isNaga()) {
					...
					game.simpleChoices("Fuck it", game.hellHoundPropahRape, "", 0, "", 0, "", 0, "Leave", game.cleanupAfterCombat);
				} else {
				...
				if (player.gender > 0 && player.lust >= 33) {
					...
					game.simpleChoices("Lick", 5068, "Fuck", temp2, "", 0, "", 0, "Leave", game.cleanupAfterCombat);
				}
				else {
		...
		public function HellHound(game:CoC)
		{
			super(game);
