	...
	public class AnzuScene extends BaseContent// implements TimeAwareInterface
	{
		...
		private function catchAnalPart1():void {
			...
			if (flags[kFLAGS.ANZU_ANAL_CATCH_COUNTER] == 0) {
				...
				outputText("\n\nAfter tossing his robes and other clothes to the armchair, he starts undressing you. Far from his nervous initial state, the aroused avian is clearly happy to share his bed with you again. His hands " + player.clothedOrNaked("eagerly take of the upper and lower parts of your [armor] and") + " start caressing your " + player.skin() + ". You display your " + player.clothedOrNaked("almost ") + "naked form on the bed, and shake your " + (player.tailType > 0 ? "wagging your " + player.tailDescript() : "[butt] in the air") + " to entice him.  Your reaction isn’t left unnoticed, as he gropes your " + (player.balls > 0 ? "[balls]" : player.hasCock() ? "cock" : "nipples") + player.clothedOrNaked(" when he takes off your underwear, leaving your nude body to his sight", " when he takes advantage of your already-naked state") + ". Finally, he removes his underwear too, dropping it in the floor and leaving his huge avian manhood exposed.");
		...
		private function catchAnalPart2():void {
			...
			else outputText("\n\n\"<i>Hey, little friend.</i>\" Anzu says, caressing again the " + player.skinFurScales() + " of your chest. You look back at him, to find the avian almost as red and flushed as you. </i>\" [name], better get ready for me...</i>\"");
			if (player.gender > 0) {
		...
		private function getBlown():void {
			...
			if (flags[kFLAGS.ANZU_BLOWN_YOU_COUNTER] == 0) {
				...
				outputText("\n\nNow that he asked, you tell him that you have an uncomfortable pressure " + (player.balls > 0 ? " on your balls" : "on your loins") + " and this time you’re in the mood for having some oral attention again, if he is okay with that.");
				outputText("\n\n\"<i>You already lost the fear to my beak, or my last tongue work was good enough to leave you wanting another blowjob?</i>\"");
				outputText("\n\nA mix of the two. The last beakjob wasn’t painful in any way, and you feel adventurous enough to repeat the experience today. Of course, if he keep his promise to make sure of your skin will be intact by the time you finish. Pleased by your answer, Anzu lets out his long tongue and licks your cheek with it, and, after fondling your crotch teasingly, says.");
		...
		/*private function diningSexGoodness():void {
			if (model.time.hours < 8) {
				if (flags[kFLAGS.ANZU_TIMES_HIGH_REL_BREAKFAST] == 0) {
					...
					outputText("\n\nWhile your fingers run across his cock, you explain that you had enough of reindeer milk, and now you’re craving a taste of that he has to offer. The flustered avian finally gets your idea.");
		...
		private function anzuBathTimeAccept():void {
			...
			outputText("\n\nYou place yourself on the pool as gingerly as you can, " + (player.tallness >= 120 ? "sitting" : "standing") + " on the tiles no too far away from him. The water itself is pleasantly warm, and the relaxing scents of oils mixed with the soap perfumed scent soon get to your body, as you start feeling your mind calmer and your body more relaxed.");
			...
			outputText("\n\nLooking at your smaller body at his side, he suggests: " + (player.tallness < 120 ? "\"<i>I'll be more comfortable for you if you sit down while I take care of you," : "\"<i>Well, I'll be better if I go closer to take care of you, and...if you're okay with it...you could sit on my lap...while I...you know.") + "</i>\" Anzu says nervously.");
			outputText("\n\nSeeming no harm on his offering you sit on his lap, and he, faithful to his word, starts scrubbing softly your body with the soap, then massaging your back and shoulders working tenderly each sore muscle. While you enjoy his ministrations, you sit better, resting your legs over their own while he carefully rubs the soap on your [skin], " + (player.tallness >= 100 ? "aided for his larger frame" : "aided by his towering frame") + ". As he does that, you realize that your butt is resting pretty close of the avian crotch, and that your close contact is making the big avian more than a bit flustered, if his erect cock is proof of anything.");
		...
		private function anzuBathTimeRelax():void {
			...
			outputText("\n\nAfter he’s assured that every bit on your body has been thoroughly massaged and cleaned, he takes some clean water and start pouring it over you, wiping away the soap from your " + player.skinFurScales() + ", carefully cleaning with his fingers every bit of you.");
		...
		private function sleepingWithAnzuBlowjob():void {
			...
			outputText("\n\nOnce all his pre has been licked from the hard rod, you proceed to give slobbery licks along all its surface with your " + (player.tongueType == TONGUE_SNAKE ? "forked" : player.hasLongTongue() ? "long" : "") + " tongue, the salty taste of his exhilarating your body, your " + (player.hasCock() ? "hard [cock] leaking over his lower belly" : player.hasVagina() ? "pussy leaking over his lower belly" : "featureless crotch tingling with sensation") + ".");
