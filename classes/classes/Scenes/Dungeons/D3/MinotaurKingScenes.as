package classes.Scenes.Dungeons.D3
{
	...
	public class MinotaurKingScenes extends BaseContent
	{
		...
		private function buttufucku():void
		{
			...
			{
				outputText(" until his belly bulges with the clear outline of your [cockBiggest], displaying just how fully he has been taken to the entire assemblage. You’ve claimed this once noble beast, turned his body into a fuzzy, pleasant-smelling condom for your excessively-large cock.");
			}
			...
			{
				outputText(" until you’ve buried the entirety of your [cockBiggest] inside his snugly squeezing intestines, repurposing his digestive system into your own personal, phallus playground.");
			}
		...
		private function sloppySeconds():void
		{
			...
			outputText("\n\n");
			if(player.hasKnot() && player.cumQ() >= 5000)
			{
