	...
	public class DopplegangerScenes extends BaseContent
	{
		...
		public function fuckYourself():void
		{
			...
			else if (player.hasVagina() && !player.hasCock())
			{
				...
				else if (player.hasFullCoatOfType(SKIN_COAT_FUR)) outputText("  You clamber on top of her, the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your [vagina] presses into her digitigrade thigh and she groans raggedly in response.");
