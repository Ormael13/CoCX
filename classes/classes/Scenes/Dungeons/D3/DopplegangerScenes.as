	...
	public class DopplegangerScenes extends BaseContent
	{
		...
		public function fuckYourself():void
		{
			...
			if (player.cocks.length >= 1 && !player.hasVagina())
			{
				...
				else if (player.skinType == SKIN_TYPE_FUR && player.tailType != CoC.TAIL_TYPE_NONE) outputText("  You clamber on top of him, the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your hardening dick presses against his [tail] and he groans raggedly in response.");
