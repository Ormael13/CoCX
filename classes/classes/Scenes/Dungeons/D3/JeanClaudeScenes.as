package classes.Scenes.Dungeons.D3 
{
	...
	public class JeanClaudeScenes extends BaseContent
	{
		...
		private function regularBadEnd():void
		{
			...
			if (player.hasStatusAffect(StatusAffects.RemovedArmor)) outputText("  You realize vaguely you already have taken your clothes off, undoubtedly your own subconscious preparing you for this moment.");
		...
		private function bwombBadEnd():void
		{
			...
			if (player.hasStatusAffect(StatusAffects.RemovedArmor))
			{
