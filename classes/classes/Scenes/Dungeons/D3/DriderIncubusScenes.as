package classes.Scenes.Dungeons.D3
{
	...
	public class DriderIncubusScenes extends BaseContent
	{
		...
		public function spooderbuttGetsANewCockSleeve(hpVictory:Boolean, pcCameWorms:Boolean) : void
		{
			...
			menu();
			addButton(0,"Next",this.spooderbuttGetsANewCockSleeveII);
		}
		...
		public function spooderbuttGetsANewCockSleeveII():void
		{
			...
			menu();
			addButton(0,"Next",this.spooderbuttGetsANewCockSleeveIII);
		}
		...
		public function spooderbuttGetsANewCockSleeveIII():void
		{
			...
			menu();
			addButton(0,"Next",this.spooderbuttGetsANewCockSleeveIV);
		}
		...
		public function spooderbuttGetsANewCockSleeveIV():void
		{
			...
			menu();
			addButton(0,"Next",this.spooderbuttGetsANewCockSleeveV);
		}
		...
		public function spooderbuttGetsANewCockSleeveV():void
		{
			...
			menu();
			addButton(0,"Next",this.spooderbuttGetsANewCockSleeveVI);
		}
		...
		public function driderDefeatMenu():void
		{
			...
			{
				addButton(0,"Kill Drider",this.killDrider);
				if(player.vaginas.length > 0)
				{
					addButton(1,"Ride Drider",this.rideDrider);
				}
				if(player.cocks.length > 0)
				{
					addButton(2,"Buttfuck Drider",this.buttfuckDrider);
				}
			}
			else
			{
			...
			if(flags[kFLAGS.MITZI_RECRUITED] != 1)
			{
				if(flags[kFLAGS.MITZI_FUCKED] != 1)
				{
					if(player.cocks.length > 0)
					{
						addButton(5,"Fuck Goblin",this.fuckMitzi);
						addButton(6,"Goblin Tittyfuck",this.titfuckMitzi);
					}
					if(player.vaginas.length > 0)
					{
						addButton(7,"Goblin Licks",this.mitziEatsPussy);
					}
				}
				addButton(8,"Recruit Goblin",this.recruitMitzi);
				if(doneDriderbus)
				{
					addButton(9,"Leave Goblin",this.afterDriderbuttFight);
				}
			}
			else
			{
			...
			if(doneDriderbus && doneGoblin)
			{
				this.afterDriderbuttFight();
			}
		}
		...
		public function fuckMitzi():void
		{
			...
			menu();
			addButton(0,"Recruit Mitzi",this.recruitMitzi);
			addButton(1,"Next",this.driderDefeatMenu);
		}
		...
		public function mitziEatsPussy():void
		{
			...
			menu();
			addButton(0,"Next",this.mitziEatsPussyII);
		}
		...
		public function titfuckMitzi():void
		{
			...
			menu();
			addButton(0,"Quick",this.titfuckMitziQuick);
			addButton(1,"Slow",this.titfuckMitziSlow);
		}
		...
		public function titfuckMitziSlow():void
		{
			...
			menu();
			addButton(0,"Next",this.titfuckMitziSlowII);
		}
		...
		public function rideDrider():void
		{
			...
			menu();
			addButton(0,"Fuck Him",this.actuallyRideDriderDick);
			addButton(1,"Use Goblin",this.rideDriderToGoblin);
			addButton(2,"Nevermind",this.driderDefeatMenu);
		}
		...
		public function rideDriderToGoblin():void
		{
			...
			if(player.cocks.length > 0)
			{
				addButton(5,"Fuck Mitzi",this.fuckMitzi);
				addButton(6,"MitziTitfuck",this.titfuckMitzi);
			}
			if(player.vaginas.length > 0)
			{
				addButton(7,"Mitzi Licks",this.mitziEatsPussy);
			}
		}
		...
		public function actuallyRideDriderDick():void
		{
			...
			if(flags[kFLAGS.PC_FETISH] < 1 || player.hasVirginVagina() || player.cor <= 33)
			{
		...
		public function buttfuckDrider():void
		{
			...
			if(player.cor > 75)
			{
				outputText(" What a magnificent creature. You look forward to seeing what this... Kinarial can do.");
			}
