...
public class ProjectNightwalker extends Monster {
    ...
    public function struggleFaceSitting(wait:Boolean):void {
        ...
        if (player.isGargoyle()) {
            ...
            outputText("You bring down your [weapon], ending the woman’s pain for good[if (hasvagina)\", shuddering at the thought of how that must have felt. It was her fault, but… Still… Your own quim itches in sympathy\").[pg]");
    ...
    public function ProjectNightwalker(inDungeon:Boolean) {
        ...
        this.hairLength = 16;
        this.level = 85;
        initStrTouSpeInte(700, 450, 750, 420);
