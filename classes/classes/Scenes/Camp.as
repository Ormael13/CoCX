...
//		fixHistory();
		...
		if ((player.isRaceCached(Races.FMINDBREAKER, 1) || player.isRaceCached(Races.MMINDBREAKER, 1)) && player.cor < 100) player.cor = 100;
...
//-----------------
	public function campActions():void {
		...
		addButton(9, "Quest Loot", questItemsBag).hint("Manage your bag with quest items.").disableIf(AdventurerGuild.Slot01Cap <= 0, "Join the Adventure Guild for a quest bag!");
