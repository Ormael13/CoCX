...
public function siegweirdFirstEncounter():void
{
	...
	menu();
	addButton(1, "Help him", siegweirdFirstEncounterHelpHim).hint("Helping him may lead to recruitment (if all went according to the plan), which will lock out the chance to get Alvina. Think carefully if you are sure you want get him over Alvina.");
	addButton(3, "Do not help him", siegweirdFirstEncounterDoNotHelpHim).hint("Later on, PC will be still able to meet him and get the offer to help.");
}
