...
public function urtaBarApproach():void {
	...
	if(flags[kFLAGS.URTA_PC_LOVE_COUNTER] == 1)
	{
		...
		if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00146] == -1 || !urtaDrunk()) {
			...
			//if (player.hasCock() && !player.isTaur()) addButton(3, "Vixen & Cream", vixenAndCreamPart1, null, null, null, "Try something special! \n\nNOTE: This is very long! Don't select this if you have ADHD.");
...
private function urtaTakesPCOnWalkies():void {
	...
	//Vixen & Cream (NOT YET IMPLEMENTED)
	private function vixenAndCreamPart1():void {
		clearOutput();
		...
		//LUST: "You're here to enjoy a few drinks and chat}{ELSE // TEASE SCENE LINK: "You want to have a few drinks } with the love of your life { if hadChildrenWUrta: "and the {if (UrtasKids: "mother"}{both: "and"}{PCsKids: "father"} of your children}. You deliberately announce this out loud and cause her to flush as people look over. In response, she digs her claws pointedly into your back, though not hard enough to actually hurt.");
		outputText("\n\n");
		outputText("\n\n");
		outputText("\n\n");
		outputText("\n\n");
...
Filled with thoughts of Urta's pent up taste, you can't help but smile as you walk back to your vixen lover. In the end you didn't need to pay for the drinks at all - {the bartender/Aunt Nancy} was quite happy to give a freeby to the esteemed guard captain and and her 'enviable {boyfriend/girlfriend}'.
...
Trying to stifle her cries, Urta reaches up and bites down on one of her fingers. You give a little grin and know that you have her on the ropes, just inches away from crying out.
...
Urta shoots you a wicked little grin and takes full advantage of your stunned state. She {strips you of your lower garments and} slinks down between your spread thighs. Her body is now almost completely naked, her dress doing little more than covering her midsection. 
...
The voluminous vixen applies so much pressure to your pole that when she removes her tongue it snaps back as if released from a spring. She secures it with one of her hands and looks up at you adoringly, {if (pc.hasBalls = true) "all the while kissing down your slickened shaft."}{else: "all the while pointedly squeezing your shaft."}

if (pc.hasBalls = true)
{
<i>\"I think your balls need some attention, my love.</i> Urta breathily purrs, struggling to contain her own excitement. Your ball{s} are soon being lavished in loving licks and kisses by your black lipped lover

Each kiss is a sweet tribute to your glorious [ballSizeAdjective] orb{s}, a sign of her affection and devotion, both to you and them. She suckles on the sensitive flesh of your scrotum and teases it in her mouth, making <i>sure</i> to leave her mark.

Her brilliant green eyes stare up at you from {between your spread thighs/below your cock}, filled to the brim with love. At the same time she tenderly smooches your sensitive spheres, showing her utter adoration for you in every way she can.
...
Her hands reach up and stroke the base of your {long} shaft. All the while her black lips clamp gently around the tip of your sensitive glans, suckling it hungrily like a sipping straw, hungry for it to deliver the naughty cream she craves.
//(Part 2)
You groan and let your head rest back, your hips lightly jerking as your furry lover wonderously sucks you off. Each twitch of your lower body is met with a moan of satisfaction from your tentative lover, the vibrations of which travel through your bliss-filled shaft.

if (pc.hasBalls)
{
From below, her soft, furry fingers reach up and cradle your [pc.ballSize] balls, even as she sensuously sucks you off. Soon she is squeezing and massaging your sensitive sack, shaking up your semen-filled milkshake before it spills between her lips.
...
At first she gags a little, but after a few more stubborn tries you feel her throat finally yield and your [pc.cockHead] slip into her gullet. She immediately brings her jet black lips flush with the base of your member, looking up with you with pride in her striking green eyes.

// Brackets below weren't covered by [race], so wrote custom descriptive words. Figured they could be covered by 'if racial score = x (blurb)". If no racial descriptor fits, return no words.

You tremble with delight as she lovingly slides your [pc.cockNoun] back and forth in her throat. She gurgles noisily around your length and uses every trick she knows to secure your delicious (If this race: "equine/feline/lizan/draconic/'coon/canine/vulpine/kitsune/minotaur/bovine/bee/goblin/mutant/demon/shark/bunny/avian/spider/mouse/kanga/human"} cream, including stroking your sensitive scrotum and perineum.
...
if (Normalish cums)
{
Urta shivers with pleasure as a geyser of your virile spunk erupts in her muzzle. Like an erupting volcano, your [pc.cockHeadNoun] keeps shooting 
filling it to the brim with your gooey spunk. She swallows it eagerly only to have it replaced by another gooey load. 

Unwilling to let any go to waste, your vixen lover buries it deep down her gullet and lets your [cockNoun] pulse and spasm inside her throat. She nurses it deep in her neck and caresses your pulsing nuts, almost as if coaxing out your delicious cream.
...
Struggling to reign in your raging beast, your experienced vulpine lover secures your [cockLight] in her hand. She squeezes it and forces your gelatinous gism to come out in powerful, controlled bursts, clearly a trick she learned from dealing with her own potent phallus. 
...
{Large Cums: Taking advantage of your post-orgasmic paralysis}{Else: Seizing her chance}, your buxom lover slides cutely into your lap and wraps her arms around your neck. You can see pearly streaks smeared on her lips, face, and breasts, and the most beautiful, glittering look in her eyes. It's as if you have given her the most magnificent gift in the whole wide world.

<i>\"I simply adore the taste of your spunk. I was a good girl and lapped it all up{./- and there was a LOT of it!} Are you proud of me...?\"</i> Urta cutely asks, nuzzling your cheek. It seems she's seeking your approval.
...
The world seems to stop as you both share in the taste of each other's sweet saliva as well as your own deliciously unrefined seed. Not only does it feel loving and lewd, but also indescribably profound.

When you both pull back, there is a thin sticky strand linking your lips. Your eyes are lovingly locked together, simply gazing into each other's eyes. The soft string breaks and collects on her already {if large: "well"} battered breasts.
...
As if to find another place to escape, she suddenly squirts and sprays your face with her warm girl juice. She marks your [faceNoun] like an animal, all the while gloriously arching in release.
...
<i>\"You did, my love. Twice.\"</i> You happily inform her. She snuggles into you and presses her muzzle against your neck - it's hard to tell if she's delighted, embarrassed, or both!
 ...
 <i>\"{That's the first time I've ever done that./You're the only one who can get me to do that.}You're... you're just amazing.\"</i> Urta bashfully whispers, then lovingly kisses your neck. It's a little funny considering how incredibly loud and shameless she was not long ago.

She kisses you, and you can feel her naughty puss and hefty balls rubbing against your naked crotch. At the same time, her sticky equine length is caressing your stomach. It begins to get you quite hot and bothered.
 
[EachCock] spring{s} up and rub{s} against her sex from below. Your lover moans and wiggles with delight; her snatch still slick and sensitive from her climax. <i>\"Oh! Quite a go getter, aren't you? How lucky of me to have a lover with as much stamina as I do,\"</i> Urta purrs out. Her compliment is followed by a soft suckling bite of your neck. You tell her you need a lot of stamina to keep up with her 'little stallion'.
...
Both of you then begin to kiss each other with overwhelming need. It's as if you have both been seized by a maddening need for each other's taste, yet are unable to quench it. Your bodies needily rub against each other and create delicious friction. You can feel both [eachCockNoun] and hers rubbing and pressing achingly hard against each other.

// if Urta can get pregnant 
{
Urta breathily slips out words between each kiss, unwilling to part her lips from yours for more than an instant. <i>"I want."</i> Kiss. <i>"You."</i> Kiss. <i>"Inside of me."</i> Kiss. <i>"And I want."</i> Kiss. <i>"You"</i> Kiss. <i>"To give me your child."</i.> Your vulpine lover rubs your [pc.cockHead] against her slick velvety lips. You can feel her desperate yearning for you inside of her and your [cockNoun] filling her with your virile seed. 
}
 
Unable to restrain yourself a second longer, you grab her curvy thighs firmly between your hands, and lift her above your [cockHead]. She moans as it rubs against her slick velvety lips, and her slick wetness drools down your [sheathe].
...
Her spasmic clenching and delirious look pushes you over the edge. You grab her waist and thrust your [cockHead] right up to the mouth of her {not fertile: welcoming/fertile: fertile} womb. With a carnal cry, you liberally unload and fill her up with your virile spunk, claiming your lover’s pussy as your own.
...
You passionately kiss each other, and then you pull out your [cock]. As you do, a flood of your [cum] comes pouring out of her parted black lips, and drools down between her furry buttocks.
  
You passionately kiss each other, and then you pull out your [cock]. As you do, a flood of your [cum] comes pouring out of her parted black lips, and stream down her furry buttocks. Urta lets out a bittersweet sigh as you pull out, and dreamily looks up at you. Her delicious cream is pooled on her flat equine glans like a cock cup.
