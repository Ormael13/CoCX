...
private function crushUrtasHeart():void {
	...
	doNext(camp.returnToCampUseOneHour);
		...
		public function chastityBeltFun(cameFromSexMenu:Boolean = true):void
		{
			...
			outputText("You take the mug and tip on your mouth, purposely letting some spill, forming rivulets of water across your [skin base], " + (player.hasBreasts() ? "past your breasts and down" : "down your chest and over ") + " your belly.  With a look of mock disappointment, you tell Urta you seem to have spilled some water, maybe she should take care of it?  Urta nods her head and immediately starts to head for a closet to fetch you a towel.  But you quickly stop her, by telling her that you want her to lick you clean.\n\n");
