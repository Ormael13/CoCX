...
//End of Round, if no Jojo Fire -Z
		public function holliBonusHealing():void
		{
			...
			if (hasStatusAffect("Jojo Is Assisting") >= 0) {
				if (hasStatusAffect("Holli Burning") >= 0) {
				...
				else if (hasStatusAffect("Jojo Pyre") < 0) {
				...
				//End of Round, Rounds 2 and 3 with Jojo Helping - light a spark
					...
					//Round 3:
						...
						createStatusAffect("Holli Burning", 0, 0, 0, 0);
					}
...
//fuckin' Jumanji flower darts -Z
		private function fuckinJamanjiFlowerDarts():void
		{
			...
			if (hasStatusAffect("Blind") >= 0) outputText("  Though the demon herself is blinded, the fresh eye on the flower seems more than capable of aiming for her!");
...
//constrict -Z
		private function holliConstrictAttack():void
		{
			...
			if (hasStatusAffect("Blind") >= 0 && rand(6) == 0) {
