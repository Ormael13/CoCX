...
private function PCCarriedGooBackHome():void {
	...
	else if(player.cor < 33) outputText("that you'll be a good [master] for her.  You'll keep her healthy and satisfied, so long as she's obedient.");
...
private function nameZeLatexGoo():void
{
	...
	if(player.cor < 0) outputText("Patiently");
...
public function encounterLeftBehindGooSlave():void {
	...
	if(flags[kFLAGS.GOO_TFED_NICE] > 0) {
		...
		else if(player.cor < 33) outputText("Frowning");
...
private function feedLatexyCumDirectly():void {
	...
	outputText("\n\n" + flags[kFLAGS.GOO_NAME] + " has the sense to look up and give you a wink.  Then, she reveals her tongue - an ebony protrusion that spools without end.  A gleeful smile spreads over " + flags[kFLAGS.GOO_NAME] + "'s raven-hued mouth while her spit-glossed tongue wraps [cock biggest] up tight.  Once satisfied, she stretches her jaw downward in order to fully open her mouth.  The puckered lips morph into a distended 'o' and advance, marching down the length of your [cock biggest] with unceasing determination, gleefully devouring your erection.");
...
private function femalePCDomFucksLatexGoo():void {
	...
	if(player.hasCock()) outputText("  Some of it even splats onto your [cocks], leaving tight black spots on your maleness.");
...
private function femalePCDomFucksLatexGooFuta():void {
	...
	if(player.hasCock()) outputText("  White erupts from your [cocks] with abandon.  You don't even care that it stains " + flags[kFLAGS.GOO_NAME] + "'s " + gooTits() + ".  It feels so good and she looks so pretty with strands of icing spattering over top of her.");
...
private function malePCDomFucksLatexGoo():void {
	clearOutput();
	outputText("You open your [armor] to expose your [cocks] to your latex-based lover.  She eyes it with unabashed affection and licks her lips unthinkingly, already tasting the flavor of semen on her tongue.  " + flags[kFLAGS.GOO_NAME] + " jolts out of her reverie to ask, \"<i>What are you doing");
	if(gooObedience() > 50) outputText(", [Master]");
	outputText("?</i>\"");
	...
	else if(player.cor < 33) outputText("Smiling knowingly");
	...
	outputText(".  Past her mouth, her insides become far less solid.  It feels like a mass of warm goo that deep inside her, and combined with the feel of her slippery tongue caressing the underside of your [cock], you feel like you're in heaven.");
	if(player.cockTotal() > 1) {
	...
	outputText("\n\nWith her looking at you like that, fuck... you're cumming!  You pull her lips tight into your abdominal " + player.skinFurScales() + " and release the boiling bliss within you.  Your jizz jumps out of you in thick ropes, as if it was seeking to escape all this time and just now found freedom.  " + flags[kFLAGS.GOO_NAME] + " smiles around your [cock] as it pumps its virile goo down her throat, and she grabs hold of your [butt] to press herself against you harder.");
	...
	outputText("\n\nStaggering back, you rest against a boulder.  In the process, your [cock] exits " + flags[kFLAGS.GOO_NAME] + "'s swelteringly sticky slit.  Webs of glittering black lube dangle from your tip to her entrance, mixed with spermy strands of semen.  Transfixed, you watch them break, one by one snapping back to the closest set of genitals.  A bubbly voice cheers, \"<i>That's number two!");
