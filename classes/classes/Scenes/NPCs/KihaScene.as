...
private function kihaRapesMen():void {
	...
	if(player.balls > 0) outputText(", resting the heel of her foot against the swell of your " + ballsDescriptLight() + " and applying just enough pressure to feel the cum churning within");
	...
	if(player.balls > 0) outputText(", your " + ballsDescriptLight() + " practically leaping in over-burdened joy as their heavy load rushes through your flesh");
...
private function victoryDickKiha():void {
	...
	outputText("Pausing for a moment, you set to removing your " + player.armorName + " and unleashing " + sMultiCockDesc() + " ");
...
private function kihaRapesLittleGirlsISawItOnTheNews():void {
	...
	if(player.tongueType == TONUGE_SNAKE) outputText("  You are grateful for your forked tongue, which allows you to cover more of her pussy at once.");
...
private function analRapuzulaKiha():void {
	...
	outputText("As soon as your fingers touch her skin, her tail whips around your " + multiCockDescriptLight() + ", wrapping up your groin");
