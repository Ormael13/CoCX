...
public var pregnancy:PregnancyStore;
	...
	public function timeChange():Boolean {
		...
		if (pregnancy.isPregnant && ElectraPregProgression()) needNext = true;
		return needNext;
	}
	...
	switch (pregnancy.eventTriggered()) {
		case 1:
			if (ElectraTotalKidsNum == 0) {
				outputText("\nAs you return to camp, you notice Electra sitting by your [cabin]. As she notices you, she stands. You notice, to your discomfort, she has an imp tied up at her feet. Upon further inspection, her hands are sparking, and that the imp’s cock is ramrod straight, despite the small pool of cum around him.\n\n");
				...
				outputText("\nYou find Electra waiting for you at the entrance to camp. She sees you, sparks flying from her claws as you approach.\n\n");
		...
		case 3:
			if (ElectraTotalKidsNum == 0) {
				...
				//Subsequent times
				outputText("\nYou see Electra as she exits the \"<i>charging booth</i>\", a tired smile on her face and one hand on her clearly pregnant stomach. As you get closer, her stomach moves, and she winces as electric sparks play across her claws.\n\n");
			...
			return true;
		case 4:
			outputText("\nElectra's rubbing her stomach, which has grown significantly. You notice, however, that your Raiju lover seems more tired than usual. She waves at you weakly, smiling despite her weakened state. As you turn away, she looks down at her stomach, a dreamy expression on her face.\n");
			return true;
		case 3:
			outputText("\nElectra stands in front of "+(ElectraTotalKidsNum == 0?"a small wooden building":"the charging hut")+", looking up at its roof and lightning rod with more than a little nervousness. Seeing her, you walk over, wrapping an arm around her waist.\n\n"); 
