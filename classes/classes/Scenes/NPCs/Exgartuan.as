...
private function drinkFountainEndowment():void {
	...
	if(rand(3) == 0 && player.biggestTitSize() > 1) {
		outputText("\n\nYour " + allBreastsDescript() + " balloon, each growing about four bra-sizes larger... they feel so... jiggly and sensitive.  Even your nipples seem to grow with them!  Your " + player.armorName + " feels tighter than ever!");
	...
	if(rand(3) == 0 && player.totalCocks() > 0) {
		outputText("\n\nYour " + multiCockDescriptLight() + " feels tighter inside your " + player.armorName + ", even when flaccid.  You shudder and realize you've probably gained more than a few inches in total length, and who knows how your thickness has changed.");
...
private function exgartuanInfestDick():void {
	...
	//(+Demon dick possession – not demondicked)
		...
		outputText("\n\nYour " + cockDescript(0) + " puffs up, growing even larger as it absorbs the fountain's essence.  It dribbles pre-cum and twitches about as if sniffing the air, feeling very warm and sensitive.");
		outputText("\n\nA voice suddenly splits the air, demanding, \"<i>Satiate me mortal, or I'll make you find someone who will!</i>\"");
		outputText("\n\nWhat the hell was that?  You look around, but cannot find the source of the voice.  It speaks again, \"<i>Down here.  What are you, deaf!?</i>\"");
		outputText("\n\nYou look down, and find your demonic cock pointing directly at you, and shaking with... indignation?  The ground hits your " + buttDescript() + " hard as you fall backwards, too surprised to maintain your footing.  Is your dick talking to you?");
		outputText("\n\n\"<i>Yes I am.  You should consider yourself lucky – you're now the host of the great demon Exgartuan, and you'd best please me every few hours, or I'll make sure your body finds someone to relieve my building pressure.  But I think you'll do fine.  Come now, I can see a wonderful camp in your mind that we can paint white,</i>\" it suggests.");
...
private function exgartuanInfestTits():void {
	outputText("\n\nYour " + allBreastsDescript() + " jiggle as they grow MUCH larger, turning into obscene mounds that shake with every motion of your body.  All your " + nippleDescript(0) + "s puff up with them, gaining volume to match their new, larger homes.  They feel hot and ache to be touched.");
	temp = player.breastRows.length;
	while(temp > 0) {
		temp--;
...
public function exgartuanMasturbation():void {
	...
	if(player.statusEffectv1(StatusEffects.Exgartuan) == 1) {
		...
		//Medium corruption characters
			...
			if(player.biggestTitSize() >= 5) outputText("shove the bloated demon between your " + allBreastsDescript() + ", surrounding it in a home of jiggling flesh.  The wet demon-pre soaks into the skin of your tits, lubricating the passage as you mash them around, vigorously tit-fucking the source of your unholy desires.");
		...
		//high corruption characters
			...
			if(player.biggestTitSize() >= 5) outputText("your hands smashing your " + allBreastsDescript() + " around the " +cockDescript(0) + " and vigorously titfucking it.");
			else outputText("your hands repositioning your " + cockDescript(0) + " so it lays against your chest.");
...
public function exgartuanBored():void {
	...
	if(player.statusEffectv1(StatusEffects.Exgartuan) == 1 && player.cockArea(0) >= 100) {
		...
		if(select == 0) {
		...
		else if(select == 4) outputText("You feel your " + cockDescript(0) + " slowly expand and contract, air escaping its urethra and tickling your nether regions.  Did... did your dick just sigh?  Your demon is growing impatient.");
			...
			outputText("Your " + cockDescript(0) + " has started rubbing against your thighs as a familiar voice chimes in, \"<i>I've got a hot, steaming batch of cum ");
			if(player.balls > 0) outputText("boiling in your " + ballsDescriptLight() + ".");
		...
		switch(select) {
			case 0:
			 	outputText("You feel an ominous jiggling in your " + breastDescript(0) + " as the demon inside you stirs back to wakefulness.  The sound of a yawn being muffled by your " + player.armorName + " confirms it.");
				break;
			case 1:
				outputText("After a few hours of peace, Exgartuan begins to stir.  You can feel a desire to be touched building within your " + allBreastsDescript() + ".  What a needy demon.");
				break;
			case 2:
...
public function exgartuanCombatUpdate():Boolean {
	...
	if(player.statusEffectv1(StatusEffects.Exgartuan) == 1) {
		...
		//(+Lust in combat) for girls
			...
			switch(select) {
				...
				case 2:
					...
					break;
				case 3:
					outputText("You really want to end this fight and bend " + monster.a + monster.short + " over... Why is this taking so long, your " + cockDescript(0) + " does NOT want to wait!");
					if(player.cor < 50) outputText("  You snap back to reality and curse yourself for falling to the demon's desires.");
					break;
				case 4:
					outputText("This fight has gone on long enough; all you really want is to shove your " + cockDescript(0) + " into the " + monster.a + monster.short + "'s... Wait, what? Your possessed pecker is getting the better of you.");
					break;
				case 5:
					outputText("For a moment, you find it hard to concentrate, visions of impaling the " + monster.a + monster.short + " with your " + cockDescript(0) + " etching their way into your mind.  Curse this horny demon!");
					break;
				case 6:
				...
				case 7:
					...
					break;
				case 8:
					outputText("Tight loving assholes and gaping vaginas, slick long red tongues and breasts like fine china.  Succubi and the hot sexings they bring, these are a few of your favorite things!  ...Wait, what?  Was that musing your own?  And why are you absently stroking your " + cockDescript(0) + "?");
					break;
				case 9:
		...
		//(Taunts Male Foes -enemy lust)
			...
			switch(select) {
				case 0:
					outputText("Without any control over it, your hands undo your " + player.armorName + " and reveal your " + cockDescript(0) + ".  Somehow it launches into a tirade all its own, \"<i>You call that a cock?  Seriously?  And do the girls actually like that?  I can't imagine why.  That's right bub, keep wilting, you've got nothing on me!</i>\"");
					break;
				case 1:
					...
					break;
				case 2:
					outputText("Your " + cockDescript(0) + " squirms around, pushing your " + player.armorName + " out of the way.  Exgartuan barks, \"<i>Why are you bothering my host, fool?  Can't you see my magnificence?  You're nothing compared to me.  Go wank in shame and get out of our way.  We have cunts to fill.</i>\"");
					break;
				case 3:
					outputText("The waist of your " + player.armorName + " expands as your " + cockDescript(0) + " flies skyward fully erect, \"<i>Tremble in fear, peon! My " + num2Text(player.cocks[0].cockLength) + " inches of might shame that feeble nub between your legs.  We've no time for your slack-jawed awe; go home and be a family man.</i>\"");
					break;
				case 4:
...
public function exgartuanArmorShift():void {
	...
	if(player.armor == armors.BEEARMR) {
		...
		outputText("The green gel-plate protecting your groin thins and presses tightly against you, molding around your " + cockDescript(0) + " in an incredibly lewd way.");
		player.modArmorName = "crotch-hugging glistening gel-armor plates";
		changed = true;
	}
	else if(player.armor == armors.LEATHRA) {
		outputText("Your leather armor shifts, pressing tightly against your upper " + player.legs() + " and molding itself around your " + cockDescript(0) + " to prominently display it.");
		player.modArmorName = "crotch-hugging leather armor segments";
		changed = true;
	}
	else if(player.armor == armors.INDECST){
		outputText("The chainmail bikini of your indecent steel armor rearranges and bends its interlocking rings to best shape itself around your " + cockDescript(0) + ", leaving very little else to the imagination.");
		player.modArmorName = "crotch-hugging practically indecent steel armor";
		changed = true;
	}
	else if(player.armor == armors.R_BDYST){
		outputText("The thin, transparent material of your red bodysuit begins to firmly press against your groin, perfectly shaping to your " + cockDescript(0) + " and every last one of its nubs and nodules.");
		player.modArmorName = "crotch-hugging red, high-society bodysuit";
		changed = true;
	}
	else if(player.armor == armors.SSARMOR){
		outputText("The fine silk that makes up your armor suddenly undoes itself around your crotch, exposing your " + cockDescript(0) + " to the open air. The thin strands in the air begin to re-weave themselves around your enormous member, forming a prominent new addition to your protection.");
		player.modArmorName = "crotch-hugging spider-silk armor";
		changed = true;
	}
	else if(player.armor == armors.S_SWMWR){
		outputText("The miniscule piece of swimwear that doubles as a tent to your " + cockDescript(0) + " begins to grow and encapsulate it, molding itself perfectly to your manhood.");
		player.modArmorName = "crotch-hugging slutty swimwear";
		changed = true;
	}
	else if(player.armor == armors.FULLCHN){
		outputText("You\'re taken by surprise as the binds of your chainmail begin to flatten and rearrange themselves, doing their best to match the curves of your " + cockDescript(0) + " and make its presence known.");
		player.modArmorName = "crotch-hugging full-body chainmail";
		changed = true;
	}
	else if(player.armor == armors.CHBIKNI){
		outputText("Your chainmail bikini rearranges and bends its interlocking rings to best shape itself around your " + cockDescript(0) + ", leaving very little else to the imagination.");
		player.modArmorName = "crotch-hugging revealing chainmail bikini";
		changed = true;
	}
	else if(player.armor == armors.FULLPLT){
		outputText("You begin to clench your fists as your steel platemail heats up around your " + player.legs() + " and crotch. Slowly it begins to press itself against your " + cockDescript(0) + " and match its every feature.");
		player.modArmorName = "crotch-hugging full platemail";
		changed = true;
	}
	else if(player.armor == armors.SCALEML){
		outputText("The steel scales that make up your armor begin to flap wildly around your crotch. They bend and shift as they attempt to match the profile of your " + cockDescript(0) + ".");
		player.modArmorName = "crotch-hugging scale-mail armor";
		changed = true;
	}
	else if(player.armor == armors.LTHRROB){
		outputText("Your leather armor shifts, pressing tightly against your upper " + player.legs() + " and molding itself around your " + cockDescript(0) + " to prominently display it through your robes.");
		player.modArmorName = "crotch-hugging black leather armor surrounded by voluminous robes";
		changed = true;
	}
	else if(player.armor == armors.RBBRCLT){
		outputText("You begin to feel your rubber outfit compressing itself against your upper " + player.legs() + " and " + cockDescript(0) + ", eliminating any pockets of air or wrinkles that may have existed before.");
		player.modArmorName = "crotch-hugging rubber fetish clothes";
		changed = true;
	}
	else if(player.armor == armors.ADVCLTH){
		outputText("The layer beneath your tunic begins to compress against your " + cockDescript(0) + ", highlighting every curve and nodule while lifting your package to be clearly visible beneath your outer layers.");
		player.modArmorName = "crotch-hugging green adventurer's clothes";
		changed = true;
	}
	else if(player.armor == armors.OVERALL){
		outputText("The denim of your overalls begins to press tightly against your " + cockDescript(0) + ", molding itself around your member and its every facet.");
		player.modArmorName = "crotch-hugging white shirt and overalls";
		changed = true;
	}
	else if(player.armor == armors.C_CLOTH) {
		outputText("Your clothing shifts, tightening up about your crotch until every curve and nodule of your " + cockDescript(0) + " is visible through the fabric.");
...
public function exgartuanLactationAdjustment():void {
	...
	if(player.biggestLactation() > 1) {
		...
		//(Stops) 
			...
			outputText("Your " + nippleDescript(0) + "s tighten up.  What's that demon up to?  Realization dawns on you when you realize your " + allBreastsDescript() + " no longer feel so 'full'.  Your lactation has stopped!");
	...
	//(Not lactating)
		...
		//(START)
		if(rand(2) == 0) {
			outputText("Your chest feels cold.  You touch your " + player.armorName + " experimentally and discover a few drops of milk have leaked from your " + nippleDescript(0) + "s!  The demon has made you start lactating!");
			player.boostLactation(player.breastRows.length);
		}
		//Nipple stuff
		else {
			//(Bigger Nipples!)
			if(rand(2) == 0) {
				outputText("The inner surface of your " + player.armorName + " arouses you as it rubs against your " + nippleDescript(0) + "s.  You think about it and realize they've never been like this before.  A quick check reveals each nipple has grown about a half inch longer.  Damn demons.");
...
private function exgartuanSleepSurprise():void {
	...
	if(player.cor <= 20 && player.findPerk(PerkLib.BulgeArmor) >= 0) {
		...
		if(player.cor < 33) {
			...
			if(player.biggestTitSize() >= 2) outputText(" and bouncing your " + allBreastsDescript() + " around it");
			...
			if(flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] < 5) {
				...
				if(player.biggestTitSize() >= 2) outputText("you squeeze your tits around your " + cockDescript(0) + " with your biceps");
			...
			//(MED+COR, DONE A LOT:
				...
				if(player.biggestTitSize() >= 2) {
					outputText("  Your biceps squeeze around your " + allBreastsDescript() + ", mashing them into your " + cockDescript(0) + " and adding to the pleasure.");
		...
		if(player.gender == 3) {
			...
			if(player.balls == 0) {
				...
				outputText(" surrounding your sex, teasing you with the barest hint of sensation while your ignorant hands maul your " + cockDescript(0) + " at Exgartuan's behest.  If only you had taken care of yourself earlier, you might have had the control to slip a digit into your " + vaginaDescript(0));
		...
		if(player.balls > 0) outputText(" and your " + ballsDescriptLight() + " pull tight against your groin from the effort");
		outputText(".");
		temp = player.cumQ();
		if(temp > 500) {
			...
			if(temp > 2500) outputText("  Back-pressure blasts your " + cockDescript(0) + " free from your imprisoning oral cavity along with a fountain of seed while you weakly try to cough out enough spooge to breathe.");
		}
		outputText("\n\n");
...
private function exgartuanBulgeTortureII():void {
	...
	outputText("  A little more pushing, pulling, knocking, groping, and stroking confirms what you feared: your " + cockDescript(0) + " has been cordoned off from you");
...
private function exgartuanBulgeTortureIII():void {
	...
	//[if scrotum present]
	if(player.balls > 0) outputText("  Your " + ballsDescriptLight() + " churn with mighty force, roiling in anticipation.");
	outputText("\n\n");
...
private function boobgartuanSurprise3():void {
	...
	//[if occurrence ≥8]
	else outputText("Before another thought can cross your mind, your " + chestDesc() + " fly up and smack you in the gob! \"<i>" + player.short + ", it's that time again,</i>\" the eager demoness teases you.  You think she's grown to enjoy the torture she puts you through.  \"<i>If you insist on going day in and day out without spending quality time with these tits, then I'll just insist on instructing you otherwise.</i>\" Your beautiful bosom launches forward, throwing your mug right back in the dirt.");
