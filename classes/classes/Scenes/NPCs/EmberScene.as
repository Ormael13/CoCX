...
//Talk about Dragons (Z)
		private function talkToEmberAboutDragonzzz():void
		{
			...
			if (choice == 0) {
				...
				//Low affection:
				if (emberAffection() <= 25) outputText("\n\nSnorting, Ember cracks an amused smile as " + emberMF("he", "she") + " chuckles. \"<i>What, does the 'Champion' think [him]self worthy of courting me?  That's a good one!</i>\"  " + emberMF("He", "She") + " giggles openly to make " + emberMF("his", "her") + " lack of interest in you known... yet, it seems rather forced.");
