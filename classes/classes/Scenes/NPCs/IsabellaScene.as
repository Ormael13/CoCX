...
public function isabellaGreeting():void {
	...
	if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00257] == 0) {
		...
		if(player.hasStatusAffect(StatusAffects.Marble)) outputText("She's like Marble - she has a human face with horns and cow-like ears.", false);
...
public function victoryAgainstIzzzzzySixtyNine():void {
	...
	if(!player.hasStatusAffect(StatusAffects.Edryn)) outputText("plumpest, juiciest set of pussy lips you've ever had the chance to lick.", false);
