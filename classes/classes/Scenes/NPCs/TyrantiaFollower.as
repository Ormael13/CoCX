...
public function TyrantiaHugFuck():void {
	clearOutput();
	tyraniaAffection(5);
	outputText("You tell the giantess that you want to have some fun, but you want to mix it up a bit. Tyrantia tilts her head, nodding appreciatively as you strip. Your [cock] is already upright, raring to go "+ if player.hasVagina(", your cooter dripping with arousal") +". \n\n");
