...
use namespace CoC;
	...
	public class Zenji extends Monster
	{
		private function zenjiSpearThrust():void {
			outputText("The troll charges at you with a spear, ");
		...
		private function zenjiFeint():void {
			outputText("The troll charges at you with a spear, but he feints and attempts to bash your face with his tusks");
			if (player.spe - spe > 0 && int(Math.random() * (((player.spe - spe) / 4) + 80)) > 80) {
		...
		private function zenjiEnrage():void {
			...
			if (flags[kFLAGS.ZENJI_PROGRESS] == -1) outputText("The troll yells with primal wrath, he's fully intent on killing you as he leaps toward you with tremendous force, you cannot dodge his oncoming attack as he's too fast and strikes you for");
			else outputText("The troll yells with primal wrath, he's fully intent on decimating you as he leaps toward you with tremendous force, you cannot dodge his oncoming attack as he's too fast and strikes you for ");
			damage = player.takePhysDamage(damage, true);
			outputText(".");
			this.lust = 0;
		...
		private function zenjiPiercingBlow():void {
			outputText("The troll readies himself, aiming, then throws his spear like a javelin");
			if (player.spe - spe > 0 && int(Math.random() * (((player.spe - spe) / 4) + 80)) > 80) outputText(". You dodge the incoming spear, but you notice him charging at you, he rams into your midriff, knocking the wind out of you. You struggle to regain your composure and are having trouble concentrating on spells for a moment.");
			else {
				var damage:Number = 0;
				var boost:Number = 0.4;
				if (this.level > 49) boost += 0.4;
