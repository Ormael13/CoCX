...
import classes.internals.SaveableState;
	...
	public class WaizAbiFollower extends NPCAwareContent implements SaveableState
	{
		...
		public function bimboMonkeyFight():void {
			...
			outputText("\"<i>But why can't I even fight? No fucks, no fights... You're supposed to be my servant, not my nanny.</i>\" Bimbo monkey pouts but still obeys, jumping toward the nearby stands. \"<i>This time, perhaps. But next time you won;t interrupt my fight...</i>\"\n\n");
