...
public class BelisaFollower extends NPCAwareContent implements TimeAwareInterface, SaveableState
{
		...
		public function subsequentEncounters():void {
			...
			else if (BelisaAffectionMeter >= 20) outputText(" Belisa, kicks off, ascending quickly to the surface of the water. She seems less nervous around you, and she steps onto the beach, shaking the water out of her hair. Her silken house bobs to the surface, but she doesn't seem to mind. <i>\"So, what brings you here, [name]?\"");
		...
		public function BelisaTalk():void {
			...
			/*if (BelisaQuestComp && BelisaAffectionMeter >= 80) {
				addButton(5, "ComeW/Me", BelisaComeCamp);
			}
			else */addButtonDisabled(5, "ComeW/Me", "NYI");
		}
		...
		public function BelisaTalkYou():void {
			...
			/*if (!BelisaToldTyrantia || !TyraniaIsRemovedFromThewGame) {
		...
		public function BelisaTalkHerNohermLeave():void {
			clearOutput();
			outputText("You apologize to the Drider-girl, and she nods, acknowledging your apology. You turn and walk away, but you hear her crying as you leave, little \"Tk-tk-tk\" noises occasionally coming with the sobs.\n\n");
			doNext(camp.returnToCampUseOneHour);
		}
		...
		public function BelisaHangSpar():void {
			clearOutput();
			if (BelisaAffectionMeter < 30) outputText ("<i>\"You want to fight...ME?!\"</i> she seems rather angry...and afraid. <i>\"was this just your way of getting me to lower my guard? To be able to fight me, 'for fun' or 'for training', and weaken me so I can't run?\"</i> without listening to your denials, she immediately sinks to the bottom of the lake.\n\n");
			else {
		...
		public function BelisaHangMagic():void {
			clearOutput();
			outputText("\"Oh, you want to learn the mystic arts?\" She gives you a smile. \"Well, I’m not the most accomplished mage outside of enchantments, but...If it’ll help you, then I can help you along the path.\"  \n\n");
			outputText(" \n\n");
		}
		...
		private function BelisaShop():void {
			clearOutput();
			outputText("\"Oh...You want to buy something?\" Belisa blinks her two large eyes, somewhat surprised. \"I-I mean, sure. I’m not sure what you want, but…I have some things for sale, if you want them\". The little Drider-girl runs to her silk orb, and comes back with a number of boxes attached to her Drider half. \"I have silk for sale. It’s raw, but someone could make it into armor for you...I also have...Underwear\". She blushes a little at that. \"There's also these bands I've been working on and enchanting. They really could be useful to an adventurer like you!\" \n\n");
			menu();
			var button:int = 0;
			...
			addButton(button++, "Nevermind", Encounterback);
		}
