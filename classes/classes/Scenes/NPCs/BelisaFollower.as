...
public class BelisaFollower extends NPCAwareContent implements SaveableState// implements TimeAwareInterface
	{
		...
		public static var BelisaRalthPotionGet:Boolean;
		...
		public function saveToObject():Object {
			return {
				...
				"BelisaRalthPotionGet":BelisaRalthPotionGet,
		...
		addButton (4, "Injuries", BelisaTalkInjuries);
			}
		if (BelisaQuestComp = true() && BelisaAffectionMeter >= 80()) {
		addButton (5, "ComeW/Me", BelisaComeCamp);
			}
		}
		...
		if (BelisaAffectionMeter >= 50() && (BelisaQuestOn = false) && (BelisaQuestComp = false)) addButton (4, "Injuries", BelisaTalkInjuries);
		if (BelisaRalthPotionGet = true) addbutton (5, "Cure", BelisaTalkCure);
		}
		...
		public function BelisaTalkInjuriesHeal():void {
			...
			outputText("Diana should be able to heal such a curse. You make a note to ask her.  \n\n"); 
			BelisaQuestOn (true);
			BelisaAffectionMeter(10);
			doNext(camp.returnToCampUseOneHour);
		}
		
		public function BelisaTalkCure():void {
		clearoutput();
		outputText(" \n\n"); 
		outputText("You sit down on a nearby log, asking your Drider friend if she remembers the promise you made. She sighs, shaking her head, her back four legs twitching nervously. “If you couldn’t find anything…Then It’s alright.” Belisa says sadly. “It hurts, but it’s not like I haven’t had the time to-” You stand, taking her soft cheeks in your palms, and you tell her to stop that moping. Starting with the good news, you tell Belisa that you have a mixture that may cure her of the curse, and heal her tooth. \n\n"); 
		outputText("Belisa’s warm eyes light up, and she forgets to hide her face, letting you see the injury. Then she winces, covering back up, diverting her gaze. “May?” You tell her that the alchemist you spoke to told you how a stronger succubus may have thought of this form of removal. You tell her that the treatment also…won’t be pleasant. The wound needs to be covered in the solution for a while, and it will hurt.  \n\n"); 
		outputText("“Whatever it takes, it’ll be worth it.” Belisa’s eyes shine with determination. She looks back at her spinnerets, and she leans back, taking a few strands and weaving them tightly. Her hands glow, and Belisa squints as the silk begins to take shape. You ask what she’s doing, and Belisa shakes her head.  \n\n"); 
		outputText("A few minutes later, she looks up. “Sorry, but I had an idea.” She holds out an odd silk contraption. “You said the mixture needed time, right? So I made a catch for it. Since the curse is on my upper teeth, we can store the mixture in my silk, put that on, then tie it off, leaving the solution time to work.” You admit, you’re impressed. It’s a rather ingenious way to deliver the mixture.  \n\n"); 
		...
		outputText("“Good Gods, that was disgusting.” Belisa complains, her voice pained. “Like…teeth and cherries, blended in the jaws of a sharkgirl, swallowed, then passed through a still.” You laugh, telling Belisa that she has no idea how close she just came to what it was. This gets you a nauseous face from Belisa…and you gasp, a smile growing on your face. “What?” Belisa asks, then blinks, remembering why she’d put that disgusting mixture in her mouth to begin with. “Oh, RIGHT!” She runs outside, and you follow her as she leans over the lake, examining her face in the glassy surface. \n\n");
		outputText("“You…Did it…” Belisa touches her once-injured tooth with one finger, then opens her mouth further, running a finger along each of her teeth. “[name]…” She lets out a gleeful cheer, running at you full speed. She bowls you over by accident, and you both fall, her humanoid upper body landing on top of you, her face inches apart from yours. \n\n");
		outputText("“I…I…” Belisa blushes, scrabbling to get off you. “I’m so sorry! I just…I got so excited! I…really…!” She hides her face behind her sunhat, and you chuckle, standing back up. You tell Belisa that it’s okay. You understand her being excited…but…You take the brim of her sunhat, gently lifting it off her head. Belisa blushes, but as you put a hand on her chin, she lets you guide her chin, turning it back towards you. \n\n");
		outputText("You tell Belisa that she doesn’t need to hide her pretty face anymore. This gets more of a blush, but she seems to take this to heart. You stay with her for a little while longer, but eventually excuse yourself. You tell Belisa that you need to head back to camp. She seems a little saddened, but she nods. “I will never forget what you’ve done for me today. Never.” Belisa clasps her hands together as you leave. “Stay safe!” \n\n");
		BelisaAffectionMeter(30);
		BelisaQuestOn (false);
		...
		clearoutput();
		outputText(" <i>\"Oh, is that all?”</i> Belisa pops down under the water, then into her silk orb. <i>\"A-ha!”</i> She comes out with two odd, hooked spears. <i>\"If you want to fish with me, I’ll teach you how we Driders do it!”</i> \n\n");
		if (player.HasGills {
		...
		clearoutput();
		outputText("<i>\"Oh, you want to learn the mystic arts?”</i> She gives you a smile. <i>\"Well, I’m not the most accomplished mage outside of enchantments, but...If it’ll help you, then I can help you along the path.”</i>  \n\n");
		outputText("You spend an hour training your mind with Belisa, focusing on white magic and how to keep your lusts at bay. You excuse yourself, and she smiles, nodding respectfully. Without another word, you head back to camp. \n\n"); 
		BelisaAffectionMeter(5);
		}
		...
		addButton(button++, "Nevermind" doNext(Encounterback);
		}
		...
		menu();
		var button:int = 0; 
		addButton(button++, "Crimson", BuyCrimsonBand);
		addButton(button++, "Pink",BuyPinkBand );
		addButton(button++, "Yellow",BuyYellowBand );
		addButton(button++, "Turqouise", BuyTurquoiseBand );
		addButton(button++, "Crossed", BuyCrossedBand );
		addButton(button++, "R.Blue", BuyBlueBand );
		addButton(button++, "Back", BelisaShop);
		}
		...
		clearoutput();
		outputText("<i>\"When you need a bit of extra speed, this little guy’s the best!” Belisa bobs up and down, showing off her left arm, where one of her yellow bands rests snug against the flesh. “For every band like this you have, it’ll make your muscles faster, your strikes swifter, and your runs shorter!”</i>  \n\n"); 
		...
		public function BelisaSex():void {
			...
			if (BelisaAffectionMeter < 20) {
				...
				ouputText("You apologize, and Belisa nods, accepting your apology. She heads back inside, and you back away, leaving her in peace to do…whatever she’s doing now. \n\n"); 
				doNext(camp.returnToCampUseOneHour);
			}
		...
		menu();
		if (player.hasCock()) {
		addButton (1, "Fuck", BelisaSex);
		addButton (2, "Anal", BelisaAnal);
		addButton (3, "Silkjob", BelisaSilkjob);
		}
		if (player.hasPussy()) {
		addButton (4, "69", BelisaFunnyNumber);
		addButton (5, "Dildo Fun", BelisaDildo);
		}
		if (player.gender == 0()) {
			clearoutput(); 
		...
		if (player.uppergarment = true){ //Need the command for if player is wearing uppergarment
		...
		if (player lowergarment = true){ //again, I need the correct command here
		...
		clearoutput();
		outputText("clearoutput();
		if (player.hasCock()) {
		outputText("“Not to be...rude, [name], but...wouldn’t you rather use...your…?” She gently nudges your [cock]. You shake your head, and she looks at you, shrugging her shoulders. \n\n");
		}
		outputText("“Honestly...I want kids.” She admits. “I know it won't happen like this, but… It still feels good.” You give your bashful lover a reassuring smile, kissing her on the cheek. You assure her that you'll have lots of time...For now, you just want to enjoy her. Belisa blushes, a small smile forming on her face. “Okay, [name]. Let's enjoy what we have.” \n\n");
		...
		outputText("You look deep into Belisa’s eyes, rubbing her cheek with one hand. She pulls back from the kiss, chittering nervously. “I-is it always like this? If we’re…?” You ask her if she’s enjoying the moment, and she nods once.  \n\n");
		...
		outputText("After a few minutes of teasing your Drider lover, you stop, her slick passage quivering. “Why did you...Stop?” Belisa asks, worried. “D-Did I-?” You assure her that nothing’s wrong, that she’s just nice and slick, and so she’s ready. You tell your little Drider girl that you don’t want her first time to hurt, after all.  \n\n");
		...
		if (player.hasCock()) {
		outputText("She brings her hand to your [cock]. “I wish this were in here…But it’s nice to see…even without it in me, you still…” She pumps your tool, her soft, slippery hand working your shaft. “Want to cum for me.”  \n\n");
			}
		...
		outputText("“[name]!” Belisa wails, her lower-half bucking, almost throwing you off. “[name], don’t stop!” Her spider-legs tighten around you, one chitin-covered limb running down the crack of your [ass]. You take one of her C-cups in your palm, slamming the dildo linking you and your Drider-lover home. Belisa wails even louder, closing her eyes. You feel the quivering of Belisa’s pussy, your lover spraying your [legs] and stomach with sticky, clear fluids. \n\n"); 
		outputText("Her orgasm, shaking the dildo inside you, brings you agonizingly close. Grinding your hips against hers, you bear down on Belisa, your well-fucked Drider’s eyes slightly crossing. “O-oh…Fuck me…I’m so…Please…!”  \n\n"); 
		...
		*/
		...
		menu();
		if (player.hasCock()) {
		addButton (1, "VirgFuck", BelisaVirginMFuck)
		}
		
		if (player.hasPussy()) {
			addButton (2, "LesSpood", BelisaVirginLesbian)
		}
		...
		outputText("YOU HAVE TAKEN BELISA’S VIRGINITY \n\n"); 
		...
		public function BelisaAfterSex1():void {
		clearoutput();
