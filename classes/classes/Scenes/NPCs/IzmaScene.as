...
private function readSharkCuntManual2():void {
	...
	if (flags[kFLAGS.IZMA_FOLLOWER_STATUS] != 1) outputText("head back to your camp.", false);
...
private function readSharkgirlPornzYouFuckingPervertAsshole():void {
	...
	if (player.cor < 33) {
		...
		if (flags[kFLAGS.IZMA_FOLLOWER_STATUS] != 1) outputText(" back to your camp", false);
		outputText(".", false);		
	}
	//(31-69 Corruption)
		...
		if (flags[kFLAGS.IZMA_FOLLOWER_STATUS] != 1) outputText("you head back to camp.", false);
...
private function loseToIzma():void {
	...
	//Loss Scene- Herm 
		...
		outputText("\"<i>Dirty little minx, ain't ya?  You wanted this, didn't you...</i>\" Izma teases, shoving two fingers into your moist nether-lips, to test the waters.  The penetration of your needy cunt does serve to make you whimper softly, almost begging to just be filled.  ", false);
		//(Tight/Virgin vagina)
		if (player.vaginalCapacity() < 26) {
