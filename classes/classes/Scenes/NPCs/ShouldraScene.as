...
private function littlePigLittlePigLetMeIn():void {
	...
	if(player.gender > 0 && ((player.hasStatusEffect(StatusEffects.BoatDiscovery) && flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00230] > 0) || flags[kFLAGS.TIMES_MET_OOZE] > 0)) {
...
private function nowOnVickiLake():void {
	...
	if(player.hasStatusEffect(StatusEffects.BoatDiscovery) && flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00230] > 0)
...
private function sharkbustersVictory():void {
	...
	if(player.biggestTitSize() >= 1) outputText(", " + allBreastsDescript() + " squishing and squashing against her own barely-clad bosom");
...
private function ghostIzmaPenis():void {
	spriteSelect(67);
	clearOutput();
	outputText("You swiftly disrobe and lay your " + player.armorName + " to the side, revealing your stiffening " + multiCockDescriptLight() + " in all of its glory. The ghost-girl's eyes brighten at the sight, and she even allows herself a little swoon (which looks absolutely silly, given her current tough shark-like vessel) as she regards your manhood.  ");
	outputText("She staggers forward, dropping to her knees in front of you");
	//[if testicles present] 
	if(player.balls > 0) outputText(" and cradling your " + ballsDescriptLight() + " with almost reverent gentleness, running her coarse shark-skinned fingers across your sack as gently as she can manage");
	outputText(".\n\n");
...
private function ghostGooGurlzDuckfaces():void {
	...
	//([if penis present] 
	if(player.hasCock() && !player.hasVagina()) outputText(" presenting your " + multiCockDescriptLight() + " to the spectral slime.");
...
private function slimeGinaFlation():void {
	...
	else outputText("Your frame is jostled about as the slime under you shrinks, your goo-filled gut pushing your " + allBreastsDescript() + " up into your overburdened jaw.");
	outputText("\n\n");
	...
	else outputText("see your " + allBreastsDescript() + " trembling, " + nippleDescript(0) + " twitching eagerly.");
...
private function genderlessGhostBuster():void {
	...
	else if(player.biggestTitSize() <= 8) outputText("your " + allBreastsDescript() + " begin to bounce all around.");
	else outputText("your " + allBreastsDescript() + " swell slightly to make room for a sudden increase in milk production.");
...
private function hermaphroditeGhostsCumEctoplasm():void {
	...
	if(player.balls > 0) outputText("Stopping her double-handed stroke technique, she slips your hand under your obtrusive " + ballsDescriptLight() + " and gently pushes them aside to get a better look at your previously unnoticed female sex.  ");
...
private function genderlessShouldrasLossRapes():void {
	...
	else outputText("your " + allBreastsDescript() + " swells slightly to make room for a sudden increase in milk production.");
	outputText("  As the ghost continues darting around the room, ");
	if(player.biggestTitSize() <= 8) outputText("your new EE-cup breasts settle");
