...
public function SpooderBang():void {
	...
	outputText("Her scaled underwear follows, until all three of your spidery women are naked.\n\n"+(player.upperGarment != UndergarmentLib.NOTHING?"Tyrantia and Lily saunter up to you, the giantess taking your [uppergarment], sliding it over your head and chucking it to one side.\n\n":"")+"");
	if (player.lowerGarment != UndergarmentLib.NOTHING) outputText("Lily goes to work on your downstairs, pulling your [lowergarment] down and away.\n\n"); 
