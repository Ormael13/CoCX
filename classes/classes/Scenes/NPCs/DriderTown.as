...
public function DriderTownEnter():void {
		...
		if (BelisaFollower.BelisaKids > 0 ) {
		...
		if (TyrantiaFollower.TyrantiaKids > 0 ) {
...
menu();
addButton (1, "Belisa", BelisaFollower.BelisaTown);
addButton (2, "Lily", LilyFollower.LilyTown);
addButton (3, "Tyrantia", TyrantiaFollower.TyrantiaTown);
}
