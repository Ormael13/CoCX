...
private function snipermanders():void {
	...
	//If Rath is @ camp:
	if(player.hasStatusAffect(StatusAffects.CampRathazul)) outputText("  You hear your old alchemist friend suddenly putting up a ruckus as the sounds of breaking glass echo throughout camp.  " + flags[kFLAGS.HELSPAWN_NAME] + " looks up at you nervously, but you ruffle her fiery hair and tell her to try again. Rath is probably just fine.");
...
private function talkToHelspawn():void {
	...
	//Talk 3
	//{Needs Rath at camp]
	else if(temp <= 1 && player.hasStatusAffect(StatusAffects.CampRathazul)) {
