...
private function aikoSexDoggy():void {
	...
	var z:Number = y + 1;
	if (z > player.cocks.length) z = player.cocks.length;
	...
	+(y != 0 && player.cocks.length >1 ?"While you passionately fuck her pussy, your [cock "+z+"] slides between her buttocks, significantly lubed up by the seemingly never-ending gush of fluids. Whenever you take a particularly long draw, it occasionally presses up against her pursed anus for a moment before moving along. Aiko looks back at you with a deep blush on her face and says, <i>\"NN… ah! You can… Ooh! … If…. youuuUAuuh… want… F-fuck… my… a-ass, I m-meeeeeaAAhhn….\"</i>"+"With her permission, you draw back and press up against her tight pucker, leaning forward to pierce her ass with your [cock "+z+"]! Aiko lets out a deep moan, wincing a little at first, but her warm innards are quite receptive to your shaft and her pain turns into pleasure within moments. Her anus begins to squeeze and suck you further in with every push, and the dual sensations of her holes drives you mad with pleasure.\n\n":"")
