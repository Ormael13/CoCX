...
private function aikoSexKitsuneTailjob():void {
	...
	outputText("You ask her to come sit besides you, "+((player.tailCount==9)?"which she promptly does, ":"")+"and turn around. Curiosity gets the better of her, so she does so, albeit slowly, with furtive glances back towards you. You tell her to calm down, and that she will enjoy this as much as you.\n\n"
			...
			+"Coming down from the high takes a while, and you both cuddle each other, arms and tails surround and covering you both like a makeshift blanket on the cool ground. When you wake up, you see that she is still slightly out of it, and attribute your slightly better state to your extra "+ ((flags[kFLAGS.AIKO_BOSS_COMPLETE] >0)?"tail":"tails")+". As you leave, she quietly whispers behind you <i>" + ((flags[kFLAGS.AIKO_FIRST_CHOICE] == 6)? "":"My first time")+ " ...that...was something...elszzzz </i> as she falls asleep once more, utterly drained from the exitement, tails limply splayed.");
	flags[kFLAGS.AIKO_SEXED]++;
	flags[kFLAGS.AIKO_AFFECTION] += 5;
	if (flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] > 0 && flags[kFLAGS.AIKO_CORRUPTION] >= 50 && player.cor <= flags[kFLAGS.AIKO_CORRUPTION]) {
		player.cor += 3;
