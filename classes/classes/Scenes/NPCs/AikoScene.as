		...
		if (flags[kFLAGS.AIKO_BOSS_INTRO] > 0) {
			...
			if (player.kitsuneScore() >= 6 && player.tailType == 13) {
				...
				outputText("You ask what the big deal is, if it was another kitsune that found it.\n\n"
						+"<i>“It’s a BIG FUCKIN’ DEAL!”</i> she snarls, snapping her fingers. Her bill-hook wobbles a bit in its place, but stays where it is, refusing to return to her hand. <i>“She drained my magic, and she’s using it to fuck up my village now! I could care less what happens to them, but I WANT MY STAR SPHERE BACK!”</i>\n\n"
...
private function  talkNineTails():void {
	...
	+"You nod as you see her lips stop moving. You ask if she has ever became a retainer, noting that she has "+ ((flags[kFLAGS.AIKO_BOSS_COMPLETE] >0)?"eight":"seven")+" tails. You see her with an irritated grin immediately after you finished talking, it's clear something is up.\n\n"
...
private function aikoSexBJ():void {
	...
	if (player.cockArea(x) < 40) {
		...
		+"Letting out an obscene moan, you lose yourself in pleasure as your [cock] shoots out hot ropes of semen all over Aiko’s face and chest, twitching like mad. Stream after stream spills out, several orgasms’ worth of cum finally allowed to fly free, making a thick, warm mess all over her face and breasts. "+(player.cumQ() >350 ?"Your orgasm seems to go on forever, and by the time it is all over, Aiko’s face is almost unrecognizable, hidden under a sticky mask of your cum.":"")+"\n\n"
...
private function aikoSexTailjob():void {
	...
	+"As the kitsune continues to torment your rod, you notice that a second tail has joined the action, encircling the tip of your [cock] while the other one firmly remains wrapped around the base[if (player.balls > 0), caressing your balls]. "
...
private function aikoSexKitsuneTailjob():void {
	...
	outputText("You ask her to come sit besides you, "+((player.tailCount==9)?"which she promptly does, ":"")+"and turn around. Curiosity gets the better of her, so she does so, albeit slowly, with furtive glances back towards you. You tell her to calm down, and that she will enjoy this as much as you.\n\n"
			...
			+"Slowly, they resume their ministrations, "+((player.tailCount==9)?"the extra "+((flags[kFLAGS.AIKO_BOSS_COMPLETE] >0)?"tail":"tails"):"")+" twirling around, gliding across her soft fur... wait, since when did your clothes get remo... ohhh that feels warm, as your extra "+ ((flags[kFLAGS.AIKO_BOSS_COMPLETE] >0)?"tail":"tails")+" suddenly finds her box, and plunge into her, elicting a shriek and then a long moan from your partner as your "+ ((flags[kFLAGS.AIKO_BOSS_COMPLETE] >0)?"floof":"floofs")+"  start to work their magic, spearing her open while only stretching her out just enough to contain it. \n\n"
			+"Your lust addled mind continues to shut down, going to basic mode when you suddenly feel something around your "+ ((flags[kFLAGS.AIKO_BOSS_COMPLETE] >0)?"tail":"tails")+", and are shocked to realise that you reached the entrance of her womb, lightly tickling the cervix causes stars to burst out of her eyes, and the ghostly flames surrounding the place to flare up, glowing immensely brighter than they were before. You are further spooked when the same flames start to envelop your tails, both cool to the touch while fanning your own flames even higher.\n\n"
			+"Aiko grins, and with noticable effort (and a lot of whimpering in between,) says <i>Heh.. This is a trick that only we..hahh.. kitsunes can do..ahh!.. when we are engaging in such lewd.. gahhh.. acts! </i> she shouts, fluids gushing out of her box, soaking your lower half. You weren't going to last much longer, the flames doing a number on your sex-charged nerves, when she pulls one final trick,"+player.mf("and wraps your neglected but rock solid shaft with her foxfire inside and out","and shunts a few of her foxfire up your drooling cunt")+ ", pushing you over the edge and inducing one of the largest climaxes you've ever had.\n\n"
			+"Coming down from the high takes a while, and you both cuddle each other, arms and tails surround and covering you both like a makeshift blanket on the cool ground. When you wake up, you see that she is still slightly out of it, and attribute your slightly better state to your extra "+ ((flags[kFLAGS.AIKO_BOSS_COMPLETE] >0)?"tail":"tails")+". As you leave, she quietly whispers behind you <i>" + ((flags[kFLAGS.AIKO_FIRST_CHOICE] == 6 || flags[kFLAGS.AIKO_DONE_KITSUNETJ] == 1)? "":"My first time")+ "...that...was something...elszzzz </i> as she falls asleep once more, utterly drained from the excitement, tails limply splayed.");
	flags[kFLAGS.AIKO_SEXED]++;
	flags[kFLAGS.AIKO_AFFECTION] += 5;
	if (flags[kFLAGS.AIKO_CORRUPTION_ACTIVE] > 0 && flags[kFLAGS.AIKO_CORRUPTION] >= 50 && player.cor <= flags[kFLAGS.AIKO_CORRUPTION]) {
		player.cor += 3;
