...
public function encounterAiko():void {
	...
	// Second encounter with Aiko
		...
		+(player.isRace(Races.DOG, 1, false) ? "Your canine chase instinct overrides your previous sentiments of paranoia, and you dash headlong through" : "You hesitate at first, but then decide to give chase, dashing into") +" the bushes after it.\n\n"
