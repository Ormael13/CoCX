...
public class Changelog extends BaseContent
	{
		...
		private function Changelog46():void {
			...
			outputText("-Dual Wield (Massive) perk can be picked when having Dual Wierld perk and one of two other perks: Titan's Grip or Gigant's Grip (Su).\n");
			...
			outputText("-\n");
			outputText("-Fixed bugs: Two of human mutations checking for wrong mutation slot, Sorcerer sword covering Flying Claw buy option in Eraendir shop\n");
