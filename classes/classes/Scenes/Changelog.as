...
public class Changelog extends BaseContent
	{
		...
		private function Changelog47():void {
			...
			outputText("-New item set perk: Bestial Blademaster. Gained when equipping 2 pieces of Bestial Blademaster set. Effects: Allows for the wearer to better make use of their beast form to increase effectiveness of weapon strikes. (weapon base attack increased by 10% while chrinos shape is active)\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
