...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog35():void {
			...
			outputText("-New magical soulskill: Storm of Sisterhood (Basic Rank). Req. buying manual from golem merchant for 20 spirit stones. Deal lighting damage, against group enemies deal 2x more damage, using ~90% of current PC wrath creates flames that deals 200% dmg of used wrath. (1 wrath used = 2 pts of lighting dmg) Cooldown: 1 turn.\n");
			outputText("-New magical soulskill: Night of Brotherhood (Basic Rank). Req. buying manual from golem merchant for 20 spirit stones. Deal darkness damage, against group enemies deal 2x more damage, using ~90% of current PC wrath creates flames that deals 200% dmg of used wrath. (1 wrath used = 2 pts of darkness dmg) Cooldown: 1 turn.\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
