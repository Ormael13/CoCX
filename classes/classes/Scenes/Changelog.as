...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog28():void {
			clearOutput();
			outputText("(Part 2/2) <b>Version 0.8n:</b>\n\n");
			...
			outputText("-New consumable (by Liadri): scroll with Polar Midnight spell - gained form last advanced stufy session with Alvina. Costs 200 gems and teach PC Polar Midnight spell.\n");
			...
			outputText("-New Grey Spell: Polar Midnight - learned form scroll given by Alvina. Cost 250 mana and deal AoE ice dmg and stun enemies for 5 turns. Have 1 cturn channel time and cooldown of 12 turns.\n");
			...
			outputText("-(Heavy WIP) Raging Inferno now boost by 10% fire spells/attacks damage and each turn spend without casting fire spell lower that bonus damage by 5% till it return to 100%.\n");
			outputText("-\n");
			...
			outputText("\n");
			outputText("\n");
			outputText("-Added in current version race effects to Metamorph perk: \n");Goo, Siren, Avian-morph(what about Centaur race? need rework still or nah? or just adding to Metamorph menu but how i mean with what bodyparts?)
			outputText("\n");
			outputText("\n");
			outputText("\n");
			outputText("\n");
		...
		private function Changelog27():void {
			...
			outputText("(Part 1/2) <b>Version 0.8n:</b>\n\n");
