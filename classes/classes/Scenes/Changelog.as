...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog15():void {
			...
			outputText("-New tier 1 misc lvl-up perk: Job: Golemancer Req. 25+ int and 25+ wis. Effect: +5 max Int, +5 max Wis, allow to make temporal golems using golem core and stones. Allows to store up to 3 golems and 6 golem cores\n");
			outputText("-New tier 1 misc lvl-up perk: BeginnerGolemMaker Req.  Effect: \n");
			...
			outputText("-New tier 2 misc lvl-up perk: ApprenticeGolemMaker Req.  Effect: \n");
			outputText("-New tier 2 misc lvl-up perk: ChargedCore Req.  Effect: \n");
			outputText("-New tier 3 misc lvl-up perk: ExpertGolemMaker Req.  Effect: \n");
			outputText("-New tier 3 misc lvl-up perk: SuperChargedCore Req.  Effect: \n");
