...
public class Changelog extends BaseContent
	{
		...
		private function Changelog42():void {
			clearOutput();
			//outputText("(Part 2/x) <b>Version 0.8s5 ():</b>\n\n");
			outputText("(Part 1/x) <b>Version 0.8s5 ():</b>\n\n");
			...
			outputText("-Removed Sapphire/Onyx requirements from Forgefather encounter. Added low standards for Uma. Niamh unfinished corruption option (with SucMilk) disabled. (Svalkash)\n");
			...
			outputText("-Demon tfs and Feeder perk use Corruption Tolerance now, Oni horn wont choose same horns. (EragonX)\n");
			...
			//outputText("-Wendigo check for blocking TF before proc event, Staff Channeling now toggleable, Ember egg description. Imp scene parsers and check for vagina. Fix perm metamorph loading, Kiha Electra interaction. (EragonX)\n");
			...
			outputText("-Changes to HornsTF - Uni- and Bicorn and Kirin horns can now grow with MM. (EragonX)\n");
			outputText("-Metamorph add QuadGoat horns. (EragonX)\n");
			outputText("-Add Active Pregnancies to the Children stats page. (EragonX)\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
