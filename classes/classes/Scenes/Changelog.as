...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog15():void {
			...
			outputText("-New tier 1 wisdom lvl-up perk: Elemental Bond: Flesh Req.  Effect: \n");
			outputText("-New tier 2 wisdom lvl-up perk: Elemental Bond: Urges Req.  Effect: \n");
			...
			outputText("-New tier 0 sensitivity lvl-up perk: Eyes of the Hunter (Novice) Req.  Effect: \n");
			outputText("-New tier 1 intelligence lvl-up perk: ArcaneRegenerationMinor Req.  Effect: \n");
			outputText("-New tier 1 sensitivity lvl-up perk: Eyes of the Hunter (Adept) Req.  Effect: \n");
			outputText("-New tier 4 misc lvl-up perk: EnableCriticals Req. nothing aside min level. Effect: PC can score crits on all naturaly immune to them enemies like constructs, goo or plants.\n");
			outputText("-New tier 2 intelligence lvl-up perk: ArcaneRegenerationMajor Req.  Effect: \n");
			outputText("-New tier 3 intelligence lvl-up perk: ArcaneRegenerationEpic Req.  Effect: \n");
			outputText("-New tier 4 intelligence lvl-up perk: ArcaneRegenerationLegendary Req.  Effect: \n");
			outputText("-New tier 2 sensitivity lvl-up perk: EyesOfTheHunterMaster Req.  Effect: \n");
			outputText("-New tier 2 wisdom lvl-up perk: StrongElementalBond Req.  Effect: \n");
			outputText("-New tier 4 wisdom lvl-up perk: StrongerElementalBond Req.  Effect: \n");
			outputText("-New tier 6 wisdom lvl-up perk: StrongestElementalBond Req.  Effect: \n");
			outputText("-New tier 6 wisdom lvl-up perk: ElementalConjurerSacrifice Req.  Effect: \n");
			outputText("-New tier 2 intelligence lvl-up perk: High Voltage\n");
			outputText("-New tier 2 intelligence lvl-up perk: Eclipsing Shadow\n");
			outputText("-New tier 3 misc lvl-up perk: SuperChargedCore\n");
			outputText("-New tier 1 misc lvl-up perk: JobGolemancer\n");
			outputText("-New tier 1 misc lvl-up perk: BeginnerGolemMaker\n");
			outputText("-New tier 1 misc lvl-up perk (multi-rank): BiggerGolemBag1-6\n");
			outputText("-New tier 1 misc lvl-up perk (multi-rank): ArcanePoolI-VI\n");
			outputText("-New tier 2 misc lvl-up perk: ApprenticeGolemMaker\n");
			outputText("-New tier 2 misc lvl-up perk: ChargedCore\n");
			outputText("-New tier 3 misc lvl-up perk: ExpertGolemMaker\n");
			outputText("-New tier 3 misc lvl-up perk: SuperChargedCore\n");
			outputText("-New tier 3 misc lvl-up perk: MakeItDouble\n");
			outputText("-New tier 1 misc lvl-up perk: ImprovingNaturesBlueprintsNaturalWeapons\n");
			outputText("-New tier 3 misc lvl-up perk: ImprovingNaturesBlueprintsNaturalArmor\n");
			outputText("-New tier 2 misc lvl-up perk: ImprovedCrinosShape\n");
			outputText("-New tier 4 misc lvl-up perk: GreaterCrinosShape\n");
			outputText("-New tier 6 misc lvl-up perk: MasterCrinosShape\n");
