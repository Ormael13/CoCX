...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog35():void {
			...
			//outputText("-New tier 1 str lvl-up perk: Adrenaline Rush. Req. Job: Warrior perk. Effect: Always start combat with 100 more points of wrath.\n");//maybe switch order of boths and reduce this one bonus to 50+ not 100+
			//outputText("-New tier 2 str lvl-up perk: Furious strikes. Req. Adrenaline Rush perk. Effect: Wrath generated by abilities increases by 100% of base amount.\n");
			outputText("-\n");
			outputText("-\n");//  - req. Adrenaline Rush?
			...
			outputText("-\n");
			outputText("-\n");
			outputText("-Fixed bugs: Dual wield firearms mastery granted when using any firearms, imp food affecting PC with tf immunity, multiple 3rd Zenji perk form training with him, some aoe attacks not avialable for underwater pack of sharks, dual small weapons not blocking ability to put on shield\n");/*ostatni punkt changelogu
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
