...
public class Changelog extends BaseContent
	{
		...
		private function Changelog51():void {
			...
			outputText("-Fixed: True Dragon Breath Bug, bug where Flying Swords could independently attack even without the needed perk at the start of the game, Goodra's wrong nail count display for carpenters store. (Demojay)\n");
