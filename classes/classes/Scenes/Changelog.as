...
public class Changelog extends BaseContent
	{
		...
		private function Changelog49():void {
			...
			outputText("-True damage attacks that PC deal to enemeis should be now... not be affected by enemy defenses. Otherwise why would it be true damage over phys/mag damage?\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
