...
public class Changelog extends BaseContent
	{
		...
		private function Changelog41():void {
			...
			outputText("-Multiattacks aren't costless now. All large and massive weapons req. 10 wrath per attack beyond 1st and others 50 fatigue. If PC lacks wrath or fatigue it would only reduce in that turn amount of multiattacks to 1 (2).\n");
