...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog35():void {
			...
			outputText("-Setting menu small changes that makes seeing changes in some setting happening without need to return 1-2 menu up.\n");
			...
			outputText("-Fixed bugs: Dual wield firearms mastery granted when using any firearms\n");/*ostatni punkt changelogu
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
