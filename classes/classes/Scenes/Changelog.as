...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog15():void {
			...
			outputText("-New tier 1 misc lvl-up perk: ImprovingNaturesBlueprintsNaturalWeapons Req.  Effect: \n");
			outputText("-New tier 3 misc lvl-up perk: ImprovingNaturesBlueprintsNaturalArmor Req.  Effect: \n");
			outputText("-New tier 2 misc lvl-up perk: ImprovedCrinosShape Req.  Effect: \n");
			outputText("-New tier 4 misc lvl-up perk: GreaterCrinosShape Req.  Effect: \n");
			outputText("-New tier 6 misc lvl-up perk: MasterCrinosShape Req.  Effect: \n");
