...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog29():void {
			...
			outputText("\n");
			outputText("\n");
			outputText("-Added in current version race effects to Metamorph perk: \n");Goo, Siren, Avian-morph, Cave Wyrm, Hinezumi(what about Centaur race? need rework still or nah? or just adding to Metamorph menu but how i mean with what bodyparts?)
			outputText("\n");
			outputText("\n");
			outputText("\n");
			outputText("\n");
