...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog39():void {
			...
			outputText("-New armor (by Canadian Snas): Green Diving Suit - buyable at Belisa shop. Cost 2,160 gems, 20 armor, 34 magic resistance, +30% magic power.\n");
			outputText("-New armor (by Canadian Snas): Green Diving Suit - buyable at Belisa shop. Cost 13,200 gems, 8 armor, 58 magic resistance, 50% slutty seduction, Wizard’s endurance 60%, does tease damage when casting.\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
