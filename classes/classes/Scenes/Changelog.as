...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog33():void {
			...
			outputText("-New tier 0 misc lvl-up perk: Drake Lungs. Req. Free lungs mutation slot, one of the dragon breaths and 10+/10+/11+ pts in frost wyrm/jabberwocky/vouivre score. Effect: Increases the power of dragon breath attack. (+200% to dragon breath damage that race is using)\n");
			outputText("-New tier 2 misc lvl-up perk: Drake Lungs (Evolved). Req. Drake Lungs perk and 12+/11+/12+ pts in frost wyrm/jabberwocky/vouivre score. Effect: Further increases increases dragon breath attack power. (+200% to dragon breath damage that race is using)\n");
