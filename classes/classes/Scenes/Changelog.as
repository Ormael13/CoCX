...
package classes.Scenes 
{
	...
	public class Changelog extends BaseContent
	{
		...
		private function Changelog35():void {
			...
			outputText("-Attacking with melee, range base attacks, using some specials or other ways of attack like using mech melee weapon would generate small fixed amount of wrath.\n");
			...
			outputText("200 / 250 / 300, Lia broken succubus special no longer affecting lust immune enemies, many smol fixes\n");/*ostatni punkt changelogu
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
			outputText("-\n");
