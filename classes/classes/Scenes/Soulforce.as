...
public class Soulforce extends BaseContent
{
	...
	public function Contemplations(page:int = 1):void {
		...
		if (page == 2)  {
			...
			if (flags[kFLAGS.SOUL_CULTIVATION] == 24 && player.level >= 69 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(10, "M.S.E.", Contemplations2, 16).hint("Attempt breakthrou to Middle Soul Exalt stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 25) addButtonDisabled(10, "M.S.E.", "You already reached Middle Soul Exalt.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 25 && player.level >= 72 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(11, "L.S.E.", Contemplations2, 17).hint("Attempt breakthrou to Late Soul Exalt stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 26) addButtonDisabled(11, "L.S.E.", "You already reached Late Soul Exalt.");
			addButton(12, "-1-", Contemplations, page - 1);
			addButton(13, "-3-", Contemplations, page + 1);
		}
		if (page == 3) {
			if (flags[kFLAGS.SOUL_CULTIVATION] == 26 && player.level >= 75 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(0, "P.S.E.", Contemplations2, 18).hint("Attempt breakthrou to Peak Soul Exalt stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 27) addButtonDisabled(0, "P.S.E.", "You already reached Peak Soul Exalt.");
			...
			if (flags[kFLAGS.SOUL_CULTIVATION] == 28 && player.level >= 81 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(2, "M.S.O.", Contemplations2, 19).hint("Attempt breakthrou to Middle Soul Overlord stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 29) addButtonDisabled(2, "M.S.O.", "You already reached Middle Soul Overlord.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 29 && player.level >= 84 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(3, "L.S.O.", Contemplations2, 20).hint("Attempt breakthrou to Late Soul Overlord stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 30) addButtonDisabled(3, "L.S.O.", "You already reached Late Soul Overlord.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 25 && player.level >= 87 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(4, "P.S.O.", Contemplations2, 21).hint("Attempt breakthrou to Peak Soul Overlord stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 26) addButtonDisabled(4, "P.S.O.", "You already reached Peak Soul Overlord.");
			...
			if (flags[kFLAGS.SOUL_CULTIVATION] == 27 && player.level >= 93 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(6, "M.S.T.", Contemplations2, 22).hint("Attempt breakthrou to Middle Soul Tyrant stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 28) addButtonDisabled(6, "M.S.T.", "You already reached Middle Soul Tyrant.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 28 && player.level >= 96 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(7, "L.S.T.", Contemplations2, 23).hint("Attempt breakthrou to Late Soul Tyrant stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 29) addButtonDisabled(7, "L.S.T.", "You already reached Late Soul Tyrant.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 29 && player.level >= 99 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(8, "P.S.T.", Contemplations2, 24).hint("Attempt breakthrou to Peak Soul Tyrant stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 30) addButtonDisabled(8, "P.S.T.", "You already reached Peak Soul Tyrant.");
			...
			if (flags[kFLAGS.SOUL_CULTIVATION] == 31 && player.level >= 105 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(10, "M.S.K.", Contemplations2, 25).hint("Attempt breakthrou to Middle Soul King stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 32) addButtonDisabled(10, "M.S.K.", "You already reached Middle Soul King.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 32 && player.level >= 108 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(11, "L.S.K.", Contemplations2, 26).hint("Attempt breakthrou to Late Soul King stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 33) addButtonDisabled(11, "L.S.K.", "You already reached Late Soul King.");
			addButton(12, "-2-", Contemplations, page - 1);
			addButton(13, "-4-", Contemplations, page + 1);
		}
		if (page == 4) {
			if (flags[kFLAGS.SOUL_CULTIVATION] == 33 && player.level >= 111 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(0, "P.S.K.", Contemplations2, 27).hint("Attempt breakthrou to Peak Soul King stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 34) addButtonDisabled(0, "P.S.K.", "You already reached Peak Soul King.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 30 && player.level >= 114 && player.wis >= 230 && player.soulforce >= player.maxSoulforce()) addButton(1, "E.S.E.", Contemplations1, 8).hint("Attempt breakthrou to Early Soul Emperor stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 2) addButtonDisabled(1, "E.S.E.", "You already reached Early Soul Emperor.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 33 && player.level >= 117 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(2, "M.S.E.", Contemplations2, 28).hint("Attempt breakthrou to Middle Soul Emperor stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 2) addButtonDisabled(2, "M.S.E.", "You already reached Middle Soul Emperor.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 33 && player.level >= 120 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(3, "L.S.E.", Contemplations2, 29).hint("Attempt breakthrou to Late Soul Emperor stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 2) addButtonDisabled(3, "L.S.E.", "You already reached Late Soul Emperor.");
			if (flags[kFLAGS.SOUL_CULTIVATION] == 33 && player.level >= 123 && player.soulforce >= Math.round(player.maxSoulforce() * 0.3)) addButton(4, "P.S.E.", Contemplations2, 30).hint("Attempt breakthrou to Peak Soul Emperor stage.");
			else if (flags[kFLAGS.SOUL_CULTIVATION] >= 2) addButtonDisabled(4, "P.S.E.", "You already reached Peak Soul Emperor.");
