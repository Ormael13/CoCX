...
package classes.Scenes
{
	...
	public class UniqueSexScenes extends BaseContent
	{
		...
		public function manticoreTailRapeScene():void {
			...
			outputText("Kicking " + monster.pronoun2 + " on " + monster.pronoun3 + " back you proceed to sit on " + monster.pronoun3 + " legs to prevent " + monster.pronoun2 + " from moving. You push everything out of the way as your eyes zero in on the target, his " + monster.cockDescriptShort(0) + ". You sting [themonster] a few times, injecting " + monster.pronoun2 + " with a pint worth of aphrodisiac. For several seconds, your toy tries to get you off of " + monster.pronoun2 + " but your poison eventually kicks in and " + monster.pronoun1 + " falls limp on the ground at your it’s " + monster.cockDescriptShort(0) + " is standing throbbing and erect. Licking your lips, you take it upon yourself to relieve your victim of its pent-up lust, opening your tail and swallowing its entire length inside.\n\n");
		...
		public function hinezumiTailpegScene():void {
			...
			outputText("You walk over [themonster] and wrap your tail around " + monster.pronoun3 + " neck tightening until " + monster.pronoun1 + " gasps for air and threateningly adding your next sentence.\n\n");
			...
			outputText("Most creatures on Mareth cares little for being raped, but pain and suffering is a whole different concept. At first [themonster] tenses up in shock then stops struggling not to further incur your wrath. In response to " + monster.pronoun3 + " you sarcastically taunt " + monster.pronoun2 + ".\n\n");
			outputText("\"<i>That's a good buttslut right there. Now let's have a look at the material I will be having my fun with.</i>\"\n\n");
			outputText("You force [themonster] on " + monster.pronoun3 + " belly as you sit on " + monster.pronoun3 + " back releasing " + monster.pronoun3 + " neck from your tail noose and aiming your now still burning whip-like appendage for a new destination. Your ride shakes a little and you decide to properly tell it to stay still by wiping your tail across " + monster.pronoun3 + " ass cheeks. [Themonster] screams in pain as your tail leaves a pair of red marks across " + monster.pronoun3 + " flesh then finally gets the point.\n\n");
			outputText("Once you're well aligned your tail darts in and forces its way through [themonster] welcoming ass hole. You gasp as inch after inch of your tail fills your partner all the way up the bowels. You could even see the bumps of your tail in " + monster.pronoun3 + " stomach if you wanted to. Now well inside you begin to work that hole, stretching it on your passage. While you rape that anus with your tail your hands aren’t left idle and you use them to fiercely masturbate, well intent on covering the back of your unwilling partner with your own personal markings. You feel [themonster] moan, " + monster.pronoun3 + " anal ring tightening around your tail, ");
			...
			outputText(" make a fine mess on [themonster]'s back. You pull your tail out of " + monster.pronoun3 + " abused hole utterly satisfied before wiping " + monster.pronoun3 + " ass once or twice as a parting gift, making " + monster.pronoun2 + " double in pain. Gosh, it feels so good to put those freaks in their place.\n\n");
		...
		public function strangleAndRapeScene():void {
			clearOutput();
			outputText("As you wonder what to do, you suddenly catch sight of [themonster] attempting to flee. You swiftly wrap your tail around " + monster.pronoun2 + " neck like a noose and forcefully pull " + monster.pronoun2 + " back to you.\n\n");
			outputText("You ask where does " + monster.pronoun1 + " think  " + monster.pronoun1 + "'s going, as you still have to claim your prize.\n\n");
			outputText("You can see some fear blossom in " + monster.pronoun3 + " eyes as you begin to choke " + monster.pronoun2 + " until " + monster.pronoun1 + " begins gasping pitifully for air, and then you have an idea. You forcefully shove [themonster] on " + monster.pronoun3 + " back and expose your ");
			if (player.hasCock()) outputText("[cock]");
			if (player.hasVagina()) outputText("[pussy]");
			outputText(" with clear intent.\n\n");
			outputText("When [themonster] does nothing but stare for a few seconds, you ask what " + monster.pronoun1 + "'s waiting for, lightly tightening your tail around " + monster.pronoun3 + " neck as a warning to start working or else.\n\n");
			outputText("[Themonster] finally seems to realize " + monster.pronoun3 + " predicament and panics, immediately moving to lick your");
			if (player.hasCock()) outputText(" [cock]");
		...
		public function raijuVoltTransfer():void {
			...
			outputText("[Themonster] trembles as you kiss " + monster.pronoun2 + ", your static starting to jolt along " + monster.pronoun3 + " skin. As you vent out your electiricity, you can only feel the squirms of pleasure mixed with arousal beneath you.\n\n");
			...
			outputText(" and spreading across the rest of " + monster.pronoun3 + " skin. You smile, contended as the haze of lust progressively dissipates from your mind. Unfortunately, your victim will not have the same pleasure you do from release. The excess of your static slowly passes into [themonster] prone form and you almost achieve climax from the relief as you purge all of this bad energy out of yourself.\n\n");
			outputText("Your victim, however, is not so lucky. As you pour in your lust " + monster.pronoun1 + " begins to completely lose control, attempting to fiercely masturbate this excess of desire out, to no avail. As you are close to done your partner is a wrecked mess on the floor, desperate to gain release but unable to achieve it fully as the supernatural electricity keeps building " + monster.pronoun3 + " desire way beyond normal, obliterating self-restraint and pride along the way. You move away from [themonster] just as " + monster.pronoun3 + " hands begin to draw fluids out of " + monster.pronoun3 + " lust filled endowment. ");
		...
		public function EasterBunnyLayEggsRape():void {
			...
			outputText("Your [cock] still hard, you keep bucking inside -opponent- name relentlessly until you cum not once not twice but three times, tongues out, caring little for the destroyed hole of your partner. Only caring for your own satisfaction you stop fucking only once [themonster] faint from exhaustion. " +
					...
					" Without anything to plug it the excessive load of cum stashed in your victim's stomach surges out and dye the ground beneath " + monster.pronoun3 + " white. For good measure you clean your dripping penis on [themonster] ass and hops off back to camp.\n\n");
		...
		public function gobomechFillTheReservoir():void {
			...
			outputText("Having made your intentions obvious, you get under your mech and pull out the reservoir tube, paying no heed to your confused victim, " + monster.pronoun1 + "'s going to find out soon enough anyway. You run back to [themonster], tube in hand, and plug it on " + monster.pronoun3 + " " + monster.cockDescriptShort(0) + " fastening it in place with straps. Satisfied with the result, you run back to your mech and press the start button activating the vacuum.\n\n");
			outputText("[Themonster]’s eyes widen as your engine forcely starts milking " + monster.pronoun3 + " dick. Of course " + monster.pronoun1 + " struggles for a bit against the pleasure inducing contraption but the aphrodisiac dripping syringes you added in the fastening make short work of any resistance " + monster.pronoun1 + " has left, causing " + monster.pronoun2 + " to jerk up and down on the ground in unwanted, yet forced consecutive orgasms. You watch with keen interest as the tube fills up with a constant flow of freshly harvested cum, smiling at the fluctuation of the volume needle on your motherboard. ");
			outputText("Since you have nothing to do but wait, you slowly enjoy a coffee, laid back in your driver’s seat and whistling, as the engine’s cum-o-meter fills up. Soon [themonster] eyes rolls in their socket as " + monster.pronoun1 + " completely lose control of " + monster.pronoun3 + " body, " + monster.pronoun3 + " sexual organ taking over for " + monster.pronoun3 + " brain. The needle finally reaches ");
		...
		public function yukionnaStealWarmthScene():void {
			clearOutput();
			outputText("You eye your defeated opponent’s form with delight. " + monster.Pronoun1 + "'s so warm and full of life, certainly sharing some of it with you should be no problem? Yet the greedy creature squirms and crawl away in a vain attempt to escape you and this angers you to no end. Even worse this thing is a guy. You freeze [themonster] limbs in place, trapping them with ice, and approach him.\n\n");
