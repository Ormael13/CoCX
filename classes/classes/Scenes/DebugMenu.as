...
//			addButton(12,"HairStyle",);
		...
		*/
		...
		private static const EYE_TYPE_CONSTANTS:Array = [
			[Eyes.EYES_HUMAN, "0 HUMAN"],
			[Eyes.EYES_FOUR_SPIDER_EYES, "1 FOUR_SPIDER_EYES"],
			[Eyes.EYES_BLACK_EYES_SAND_TRAP, "2 BLACK_EYES_SAND_TRAP"],
			[Eyes.EYES_CAT_SLITS, "3 CAT_SLITS"],
			[Eyes.EYES_GORGON, "4 GORGON"],
			[Eyes.EYES_FENRIR, "5 FENRIR"],
			[Eyes.EYES_MANTICORE, "6 MANTICORE"],
			[Eyes.EYES_FOX, "7 FOX"],
			[Eyes.EYES_REPTILIAN, "8 REPTILIAN"],
			[Eyes.EYES_SNAKE, "9 SNAKE"],
			[Eyes.EYES_DRAGON, "10 DRAGON"],
			[Eyes.EYES_DEVIL, "11 DEVIL"],
			[Eyes.EYES_ONI, "12 ONI"],
			[Eyes.EYES_ELF, "13 ELF"],
			[Eyes.EYES_RAIJU, "14 RAIJU"],
			[Eyes.EYES_VAMPIRE, "15 VAMPIRE"],
		];
