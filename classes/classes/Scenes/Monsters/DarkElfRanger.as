...
public class DarkElfRanger extends DarkElfs
	{
		override public function DarkElfBowShooting():void
		{
			...
			if (Acc < 0) Acc = 0;
			outputText("The black skinned elf aims her crossbow at you, drawing several bolts and firing with expert precision.\n\n");
			PoisonedBowShoot();
		...
		public function DarkElfRanger()
		{
			...
			this.long = "This woman is a Dark elf. She's slender and elegant, with dark skin and long pointed ears. The look in her eyes, a mixture of bloodlust and greed, give her intentions away...as does her equipment. Ropes, poisoned bolts, she's come to the surface to capture slaves.";
