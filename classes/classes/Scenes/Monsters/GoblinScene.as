...
public class GoblinScene extends BaseContent {
    ...
    private function goblinClassName():String {
        return monster.short.slice(7, monster.short.length);
    }

    private function goblinClass(assassin:String = "assassin", shaman:String = "shaman", warrior:String = "warrior"):String { //Allows for variants.
    ...
    public function gobboSpecialBeatYaUp():void {
        ...
        if (monster is GoblinAdventurers) {
            ...
            if(player.lust < player.maxLust()) outputText("You collapse, utterly beaten. To make sure you'll be easier to handle, the victorious shaman saunters up, pink arousing flames glow in her left hand. She exposes your nether regions and throws the pink flames right into your groin! You are unable to fight back.\n\n");
        ...
        function dickFitF():void {
            ...
            outputText("\n\nThe goblin " + goblinClassName() + " watches impassively for a moment, but as your need intensifies, her attitude softens while your member hardens.  \"<i>Oh, I think I’m gonna regret this, but ");
            ...
            outputText("\n\nShe explains, \"<i>I won’t help with that until you give me an answer.  Be honest with yourself - you don’t care about other girls at all.  You just came up here to fuck a goblin " + goblinClassName() + ".  Am I right?</i>\"");
            ...
            outputText("</i>\"  The emerald " + goblinClassName() + " glances over her shoulder at you and urges, \"<i>Come on now.  Fill me up.  Let out all that spunk I’ve been making build up ");
        ...
        function dickNofitF():void {
            ...
            outputText("\n\nLubricated as they are by the copious vaginal drippings, the " + goblinClassName() + "'s feet have an easy time bringing you to the very edge of orgasm.  Every squishy, delicate step she takes brings you closer and closer, and soon you are trembling beneath her sweat and fem-spunk lubricated soles.  ");
            ...
            outputText("  \"<i>It won’t be long now.  Yeah, I’m an " + goblinClassName() + ", but I take care of myself too.  I keep these puppies nice and moisturized, just in case I need to use them on a freak-cock like yours.</i>\"");
        ...
        function vagF():void {
            outputText("Defeated by your own needs, your fingers dart to your [armor], rapidly disassembling it in your hurry to expose your aching, tender puss to the goblin’s eyes.  The " + goblinClassName() + " watches you with an unimpressed, bemused expression, though she remains rooted in place, her gaze locked onto you as you succumb to your lusts.  Knowing that you have an audience, you twist and contort your body to present your [chest] and [vagina] to the petite greenskin.  Glistening moisture forms on your exposed nether-lips, tempting you to slide your fingers into their slick warmth.  As if you could resist.");
    ...
    public function gobboRapeIntro():void {
        ...
        if (monster is GoblinAdventurers) {
            ...
            if (monster.HP < 1) {
                outputText("The shaman falls to her feet, smashing her titties against the ground while her wooden staff slips from her grasp, clattering against the ground. She looks up at you and sniffles.");
            } else {
