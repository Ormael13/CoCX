		...
		public function impGangabangaEXPLOSIONS():void {
			...
			if(player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
				if(rand(2) == 0 && (player.cockTotal() == 0 || player.gender == 3)) {
					...
					//(If the character has breasts)
					if(player.biggestTitSize() >= 2) outputText("The slow fucking shakes your breasts, and the imps sucking at your nipples cling tightly to your monstrously swollen " + player.allBreastsDescript() + ". Your " + biggestBreastSizeDescript() + " have grown three cup sizes since the imps pumped their venom into you. An ache starts deep in the base of your tits and works its way to your sore " + nippleDescript(0) + ". Your already bloated nipples swell as the imps suckle and you gasp as the first rush of milk spills into their mouths. Your rider reachs around and starts to milk your udders, moving his hands between your " + player.allBreastsDescript() + " and forcing out more milk for his  gangmates.\n\n", false);
				...
				//Scene number 2 - male possible.
					...
					//(If the player has breasts)
					if(player.biggestTitSize() > 2) outputText("An imp mounts the log and slaps his " + eCockDescript(0) + " between your " + player.allBreastsDescript() + ", squeezing them tight over his cock as he rubs back and forth. He mauls your breasts cruelly, squeezing his fingers deep into your soft flesh.  ", false);
			...
			//NOT CENTAUR
				...
				if(rand(2) == 0 && (player.cockTotal() == 0 || player.gender == 3)) {
					...
					//(If the player has breasts)
					if(player.biggestTitSize() > 0) outputText("Imps surround your chest, slapping their " + eCockDescript(0) + "s on your " + player.allBreastsDescript() + " and rubbing their slippery pre-cum into your " + nippleDescript(0) + ".  ", false);
					...
					//(If the player has breasts)
					if(player.biggestTitSize() > 0) outputText("An imp mounts your chest and slaps his " + eCockDescript(0) + " between your " + player.allBreastsDescript() + ", squeezing them tight over his cock as he rubs back and forth.  ", false);
					//(If the player has a SINGLE cock)
		...
		private function femaleVagRape():void {
			...
			if(player.cockTotal() == 1) {
				if(player.cocks[0].cockLength < 8) {
					outputText("\n\nThe intense stimulation causes your " + cockDescript(0) + " to begin leaking pre across the imp's stomach.  You remove one hand from the imp's nipples to pay attention to your aching " + Appearance.cockNoun(CockTypesEnum.HUMAN) + ".  As you begin jerking yourself off, more and more pre puddles on the imp's abs.  Your pre begins to pool in and over flow from the imp's tight belly button.");
				}
