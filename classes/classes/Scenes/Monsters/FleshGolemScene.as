...
package classes.Scenes.Monsters 
{
	...
	public class FleshGolemScene extends BaseContent
	{
		...
		public function introCorruptedBasicFleshGolemS():void {
			clearOutput();
			if (rand(2) == 0) {
				outputText("Your wanderings bring you past an old outpost. Several tents, canvas rotten and wood splintered, sit around a broken flagpole. As you stop, this sight catching your attention, several mounds nearby erupt, tossing dirt every which way. Golems force their way out from the ground, odd-colored flesh partly covered by white shards, bits of armour either hanging from, or embedded into the creatures' flesh. They turn towards you, and to your disgust, they have genitalia, and functioning ones at that! You ready your [weapon] for a fight, as the creatures stagger towards you.");
