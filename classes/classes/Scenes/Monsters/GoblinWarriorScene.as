	...
	public class GoblinWarriorScene extends BaseContent
	{
		...
		public function goblinWarriorEncounter():void {
			...
			//Repeat Intro - Cell Chambers
				...
				outputText("As you walk, the familiar sight of an armored goblin catches your eye.  You ready your " + player.weaponName + " for a fight!");
				outputText("\n\n\"<i>I'm going to beat you just so I can fuck you,</i>\" she says.");
				//[Initiate combat encounter – goblin warrior]
			}
		...
		public function gobboWarriorBeatYaUp():void {
			...
			else if(player.biggestCockArea() > monster.vaginalCapacity() && player.hasCock() && (!player.hasVagina() || rand(2) == 0))
			{
				...
				if(player.biggestCockLength() < player.tallness/2) outputText("sitting on your face, the " + cockHead(x) + " of your maleness jutting against her drooling lips.");
				else outputText("sitting on the ground ‘above’ you, your " + cockHead(x) + " reaching all the way up to spear her moist box, judging by what you’re feeling anyway.");
