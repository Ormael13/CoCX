...
public class Achievements extends BaseContent
	{
		...
		public function addAchievement(title:String, achievement:*, descLocked:String, descUnlocked:String = "", isShadow:Boolean = false):void {
			...
			if (achievements[achievement] > 0) {
				if (!silent) outputText("<font color=\"#008000\">Unlocked</font> - " + descUnlocked);
				achievementsTotalCurrentlyUnlocked++;
				achievementsEarned++;
			}
			else if (!silent) outputText("<font color=\"#800000\">Locked</font> - " + descLocked);
			if (isShadow) {
				if (!silent) outputText(" - <font color=\"#660066\">Shadow Achievement</font>");
				achievementsTotalCurrentlyUnlocked++;
		...
		public function checkAll(silent:Boolean = false):void {
			...
			//addAchievement("", kACHIEVEMENTS., "Fully clear the 3rd mainstoryline dungeon.");
			//addAchievement("", kACHIEVEMENTS., "Fully clear the 4th mainstoryline dungeon.");
			//addAchievement("", kACHIEVEMENTS., "Fully clear the 5th mainstoryline dungeon.");
			...
			addAchievement("Virility God", kACHIEVEMENTS.GENERAL_VIRILITY_GOD, "Turned Zenji into a freak by increasing his cum volume above 1 million.", "", true);
			...
			addAchievement("The end and the beginning", kACHIEVEMENTS.THE_END_AND_THE_BEGINNING, "Defeat Archmage Alvina");
			addAchievement("Beyond gods and mortals", kACHIEVEMENTS.BEYOND_GODS_AND_MORTALS, "Defeat Alvina at the peak of her power on Xianxia Difficulty");
			addAchievement("Dawn chasing away the night", kACHIEVEMENTS.DAWN_CHASING_AWAY_THE_NIGHT, "Successfully redeem the broken soul who lost everything. This is the dawn of a new era for Mareth.");
