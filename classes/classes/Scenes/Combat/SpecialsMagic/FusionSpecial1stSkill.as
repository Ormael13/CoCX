...
public class FusionSpecial1stSkill extends AbstractMagicSpecial {
    ...
    override public function doEffect(display:Boolean = true):void {
        ...
        switch(ElementalRace.getElement(player)) {
            case ElementalRace.ELEMENT_GNOME:   doEarthDamage(damage, true, display);
                                                ...
                                                break;
            case ElementalRace.ELEMENT_IGNIS:   doFireDamage(damage, true, display);
                                                if (player.isFistOrFistWeapon() && player.hasPerk(PerkLib.ElementalTouch)) {
                                                ...
                                                break;
            case ElementalRace.ELEMENT_SYLPH:   doWindDamage(damage, true, display);
                                                if (player.isFistOrFistWeapon() && player.hasPerk(PerkLib.ElementalTouch)) {
                                                ...
                                                break;
            case ElementalRace.ELEMENT_UNDINE:  doWaterDamage(damage, true, display);
                                                if (player.isFistOrFistWeapon() && player.hasPerk(PerkLib.ElementalTouch)) {
