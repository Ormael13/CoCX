...
private function accessHairMenu():void {
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedElfHair) && player.hairType != HAIR_SILKEN && player.soulforce >= 100) addButton(9, "Elf", metamorphElfHair);
...
private function accessPage1FaceMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurFace) && player.faceType != FACE_COW_MINOTAUR && player.soulforce >= 100) addButton(2, "Cow/Mino", metamorphCowMinotaurFace);
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurFace) && player.faceType == FACE_COW_MINOTAUR) addButtonDisabled(2, "Cow/Mino", "You already have cow/minotaur face.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurFace) && player.faceType != FACE_COW_MINOTAUR && player.soulforce < 100) addButtonDisabled(2, "Cow/Mino", "You not have enough Soulforce for this metamorphosis.");
...
private function accessPage3FaceMenu():void {
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedDevilFangs) && player.faceType != FACE_DEVIL_FANGS && player.soulforce >= 100) addButton(2, "Devil", metamorphDevilFangs);
	else if (player.hasStatusEffect(StatusEffects.UnlockedDevilFangs) && player.faceType == FACE_DEVIL_FANGS) addButtonDisabled(2, "Devil", "You already have devil fangs.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedDevilFangs) && player.faceType != FACE_DEVIL_FANGS && player.soulforce < 100) addButtonDisabled(2, "Devil", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniFace) && player.faceType != FACE_ONI_TEETH && player.soulforce >= 100) addButton(3, "Oni", metamorphOniFace);
...
private function accessTongueMenu():void {
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedSnakeTongue) && player.tongueType == TONGUE_SNAKE) addButtonDisabled(0, "Snake", "You already have snake tongue.");
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDemonTonuge) && player.tongueType == TONGUE_DEMONIC) addButtonDisabled(1, "Demon", "You already have demon tongue.");
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicTongue) && player.tongueType == TONGUE_DRACONIC) addButtonDisabled(2, "Dragon", "You already have dragon tongue.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedElfTongue) && player.tongueType != TONGUE_ELF && player.soulforce >= 100) addButton(5, "Elf", metamorphElfTongue);
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfTongue) && player.tongueType == TONGUE_ELF) addButtonDisabled(5, "Elf", "You already have elf tongue.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedElfTongue) && player.tongueType != TONGUE_ELF && player.soulforce < 100) addButtonDisabled(5, "Elf", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessEyesMenu():void {
	...
	else if (player.hasStatusEffect(StatusEffects.UnlockedDraconicEyes) && player.eyeType == EYES_DRAGON) addButtonDisabled(9, "Dragon", "You already have dragon eyes.");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedDevilEyes) && player.eyeType != EYES_DEVIL && player.soulforce >= 100) addButton(10, "Devil", metamorphDevilEyes);
	else if (player.hasStatusEffect(StatusEffects.UnlockedDevilEyes) && player.eyeType == EYES_DEVIL) addButtonDisabled(10, "Devil", "You already have devil eyes.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedDevilEyes) && player.eyeType != EYES_DEVIL && player.soulforce < 100) addButtonDisabled(10, "Devil", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniEyes) && player.eyeType != EYES_ONI && player.soulforce >= 100) addButton(11, "Oni", metamorphOniEyes);
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniEyes) && player.eyeType == EYES_ONI) addButtonDisabled(11, "Oni", "You already have oni eyes.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniEyes) && player.eyeType != EYES_ONI && player.soulforce < 100) addButtonDisabled(11, "Oni", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfEyes) && player.eyeType != EYES_ELF && player.soulforce >= 100) addButton(12, "Elf", metamorphElfEyes);
...
private function accessPage1EarsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedCowEars) && player.earType != EARS_COW && player.soulforce >= 100) addButton(2, "Cow", metamorphCowEars);
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowEars) && player.earType == EARS_COW) addButtonDisabled(2, "Cow", "You already have cow ears.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowEars) && player.earType != EARS_COW && player.soulforce < 100) addButtonDisabled(2, "Cow", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
...
private function accessPage2EarsMenu():void {
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedGoatEars) && player.earType != EARS_GOAT && player.soulforce >= 100) addButton(9, "Goat", metamorphGoatEars);
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatEars) && player.earType == EARS_GOAT) addButtonDisabled(9, "Goat", "You already have goat ears.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatEars) && player.earType != EARS_GOAT && player.soulforce < 100) addButtonDisabled(9, "Goat", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(9, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniEars) && player.earType != EARS_ONI && player.soulforce >= 100) addButton(10, "Oni", metamorphOniEars);
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniEars) && player.earType == EARS_ONI) addButtonDisabled(10, "Oni", "You already have oni ears.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniEars) && player.earType != EARS_ONI && player.soulforce < 100) addButtonDisabled(10, "Oni", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(10, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfEars) && player.earType != EARS_ELVEN && player.soulforce >= 100) addButton(11, "Elf", metamorphElfEars);
...
private function accessHornsMenu():void {
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurHorns) && player.hornType != HORNS_COW_MINOTAUR && player.soulforce >= 100) addButton(1, "Cow/Mino", metamorphCowMinotaurHorns);
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurHorns) && player.hornType == HORNS_COW_MINOTAUR) addButtonDisabled(1, "Cow/Mino", "You already have cow/minotaur horns.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowMinotaurHorns) && player.hornType != HORNS_COW_MINOTAUR && player.soulforce < 100) addButtonDisabled(1, "Cow/Mino", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedGoatHorns) && player.hornType != HORNS_GOAT && player.soulforce >= 100) addButton(5, "Goat", metamorphGoatHorns);
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatHorns) && player.hornType == HORNS_GOAT) addButtonDisabled(5, "Goat", "You already have goat horns.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatHorns) && player.hornType != HORNS_GOAT && player.soulforce < 100) addButtonDisabled(5, "Goat", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniSingleHorn) && player.hornType != HORNS_ONI && player.soulforce >= 100) addButton(11, "Oni", metamorphOniSingleHorn);
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniSingleHorn) && player.hornType == HORNS_ONI) addButtonDisabled(11, "Oni", "You already have oni horn.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniSingleHorn) && player.hornType != HORNS_ONI && player.soulforce < 100) addButtonDisabled(11, "Oni", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniTwinHorns) && player.hornType != HORNS_ONI_X2 && player.soulforce >= 100) addButton(12, "OniX2", metamorphOniDualHorns);
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniTwinHorns) && player.hornType == HORNS_ONI_X2) addButtonDisabled(12, "OniX2", "You already have oni horns.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniTwinHorns) && player.hornType != HORNS_ONI_X2 && player.soulforce < 100) addButtonDisabled(12, "OniX2", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(12, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage1MetamorphMenu);
}
private function accessAntennaeMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisAntennae) && player.antennae != ANTENNAE_MANTIS && player.soulforce >= 100) addButton(0, "Mantis", metamorphMantisAntennae);
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisAntennae) && player.antennae == ANTENNAE_MANTIS) addButtonDisabled(0, "Mantis", "You already have mantis antennaes.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisAntennae) && player.antennae != ANTENNAE_MANTIS && player.soulforce < 100) addButtonDisabled(0, "Mantis", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
...
private function accessPage1ArmsMenu():void {
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisArms) && player.armType != ARM_TYPE_MANTIS && player.soulforce >= 100) addButton(2, "Mantis", metamorphMantisArms);
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisArms) && player.armType == ARM_TYPE_MANTIS) addButtonDisabled(2, "Mantis", "You already have mantis arms.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisArms) && player.armType != ARM_TYPE_MANTIS && player.soulforce < 100) addButtonDisabled(2, "Mantis", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(2, "???", "You not yet unlocked this metamorphosis!");
...
private function accessPage2ArmsMenu():void {
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedDevilArms) && player.armType != ARM_TYPE_DEVIL && player.soulforce >= 100) addButton(4, "Devil", metamorphDevilArms);
	else if (player.hasStatusEffect(StatusEffects.UnlockedDevilArms) && player.armType == ARM_TYPE_DEVIL) addButtonDisabled(4, "Devil", "You already have devil arms.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedDevilArms) && player.armType != ARM_TYPE_DEVIL && player.soulforce < 100) addButtonDisabled(4, "Devil", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniArms) && player.armType != ARM_TYPE_ONI && player.soulforce >= 100) addButton(5, "Oni", metamorphOniArms);
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniArms) && player.armType == ARM_TYPE_ONI) addButtonDisabled(5, "Oni", "You already have oni arms.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniArms) && player.armType != ARM_TYPE_ONI && player.soulforce < 100) addButtonDisabled(5, "Oni", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfArms) && player.armType != ARM_TYPE_ELF && player.soulforce >= 100) addButton(6, "Elf", metamorphElfArms);
...
private function accessPage1TailMenu():void {
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedCowTail) && player.tailType != TAIL_TYPE_COW && player.soulforce >= 100) addButton(3, "Cow", metamorphCowTail);
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowTail) && player.tailType == TAIL_TYPE_COW) addButtonDisabled(3, "Cow", "You already have cow tail.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedCowTail) && player.tailType != TAIL_TYPE_COW && player.soulforce < 100) addButtonDisabled(3, "Cow", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(3, "???", "You not yet unlocked this metamorphosis!");
...
private function accessPage3TailMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedGoatTail) && player.tailType != TAIL_TYPE_GOAT && player.soulforce >= 100) addButton(1, "Goat", metamorphGoatTail);
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatTail) && player.tailType == TAIL_TYPE_GOAT) addButtonDisabled(1, "Goat", "You already have goat tail.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedGoatTail) && player.tailType != TAIL_TYPE_GOAT && player.soulforce < 100) addButtonDisabled(1, "Goat", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisTail) && player.tailType != TAIL_TYPE_MANTIS_ABDOMEN && player.soulforce >= 100) addButton(7, "Mantis", metamorphMantisTail);
...
private function accessPage2WingsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsSmall) && player.wingType != WING_TYPE_MANTIS_LIKE_SMALL && player.soulforce >= 100) addButton(0, "Mantis(S)", metamorphMantisWingsSmall);
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsSmall) && player.wingType == WING_TYPE_MANTIS_LIKE_SMALL) addButtonDisabled(0, "Mantis(S)", "You already have mantis small wings.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsSmall) && player.wingType != WING_TYPE_MANTIS_LIKE_SMALL && player.soulforce < 100) addButtonDisabled(0, "Mantis(S)", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsLarge) && player.wingType == WING_TYPE_MANTIS_LIKE_SMALL && player.soulforce >= 200) addButton(1, "Mantis(L)", metamorphMantisWingsLarge);
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsLarge) && player.wingType == WING_TYPE_MANTIS_LIKE_LARGE) addButtonDisabled(1, "Mantis(L)", "You already have large mantis wings.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsLarge) && player.wingType != WING_TYPE_MANTIS_LIKE_LARGE && player.soulforce < 200) addButtonDisabled(1, "Mantis(L)", "You not have enough Soulforce for this metamorphosis.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisWingsLarge) && player.wingType != WING_TYPE_MANTIS_LIKE_SMALL) addButtonDisabled(1, "Mantis(L)", "You not have proper type of wings for this metamorphosis.");
	else addButtonDisabled(1, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}
private function accessPage1LegsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedHoofedLegs) && player.lowerBody != LOWER_BODY_TYPE_HOOFED && player.soulforce >= 100) addButton(0, "Hoofed", metamorphHoofedLegs);
	else if (player.hasStatusEffect(StatusEffects.UnlockedHoofedLegs) && player.lowerBody == LOWER_BODY_TYPE_HOOFED) addButtonDisabled(0, "Hoofed", "You already have hoofed legs.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedHoofedLegs) && player.lowerBody != LOWER_BODY_TYPE_HOOFED && player.soulforce < 100) addButtonDisabled(0, "Hoofed", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(0, "???", "You not yet unlocked this metamorphosis!");
...
private function accessPage2LegsMenu():void {
	...
	if (player.hasStatusEffect(StatusEffects.UnlockedClovenHoofedLegs) && player.lowerBody != LOWER_BODY_TYPE_CLOVEN_HOOFED && player.soulforce >= 100) addButton(5, "ClovenHoofed", metamorphClovenHoofedLegs);
	else if (player.hasStatusEffect(StatusEffects.UnlockedClovenHoofedLegs) && player.lowerBody == LOWER_BODY_TYPE_CLOVEN_HOOFED) addButtonDisabled(5, "ClovenHoofed", "You already have cloven hoofed legs.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedClovenHoofedLegs) && player.lowerBody != LOWER_BODY_TYPE_CLOVEN_HOOFED && player.soulforce < 100) addButtonDisabled(5, "ClovenHoofed", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(5, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderLegs) && player.lowerBody != LOWER_BODY_TYPE_SALAMANDER && player.soulforce >= 100) addButton(7, "Salamander", metamorphSalamanderLegs);
	else if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderLegs) && player.lowerBody == LOWER_BODY_TYPE_SALAMANDER) addButtonDisabled(7, "Salamander", "You already have salamander lower body.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedSalamanderLegs) && player.lowerBody != LOWER_BODY_TYPE_SALAMANDER && player.soulforce < 100) addButtonDisabled(7, "Salamander", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(7, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedMantisLegs) && player.lowerBody != LOWER_BODY_TYPE_MANTIS && player.soulforce >= 100) addButton(9, "Mantis", metamorphMantisLegs);
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisLegs) && player.lowerBody == LOWER_BODY_TYPE_MANTIS) addButtonDisabled(9, "Mantis", "You already have mantis lower body.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedMantisLegs) && player.lowerBody != LOWER_BODY_TYPE_MANTIS && player.soulforce < 100) addButtonDisabled(9, "Mantis", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(9, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedSharkLegs) && player.lowerBody != LOWER_BODY_TYPE_SHARK && player.soulforce >= 100) addButton(11, "Shark", metamorphSharkLegs);
	else if (player.hasStatusEffect(StatusEffects.UnlockedSharkLegs) && player.lowerBody == LOWER_BODY_TYPE_SHARK) addButtonDisabled(11, "Shark", "You already have shark lower body.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedSharkLegs) && player.lowerBody != LOWER_BODY_TYPE_SHARK && player.soulforce < 100) addButtonDisabled(11, "Shark", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(11, "???", "You not yet unlocked this metamorphosis!");
	addButton(14, "Back", accessPage2MetamorphMenu);
}
private function accessPage3LegsMenu():void {
	menu();
	if (player.hasStatusEffect(StatusEffects.UnlockedOrcaLegs) && player.lowerBody != LOWER_BODY_TYPE_ORCA && player.soulforce >= 100) addButton(4, "Orca", metamorphOrcaLegs);
	else if (player.hasStatusEffect(StatusEffects.UnlockedOrcaLegs) && player.lowerBody == LOWER_BODY_TYPE_ORCA) addButtonDisabled(4, "Orca", "You already have orca lower body.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedOrcaLegs) && player.lowerBody != LOWER_BODY_TYPE_ORCA && player.soulforce < 100) addButtonDisabled(4, "Orca", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(4, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedOniLegs) && player.lowerBody != LOWER_BODY_TYPE_ONI && player.soulforce >= 100) addButton(6, "Oni", metamorphOniLegs);
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniLegs) && player.lowerBody == LOWER_BODY_TYPE_ONI) addButtonDisabled(6, "Oni", "You already have oni lower body.");
	else if (player.hasStatusEffect(StatusEffects.UnlockedOniLegs) && player.lowerBody != LOWER_BODY_TYPE_ONI && player.soulforce < 100) addButtonDisabled(6, "Oni", "You not have enough Soulforce for this metamorphosis.");
	else addButtonDisabled(6, "???", "You not yet unlocked this metamorphosis!");
	if (player.hasStatusEffect(StatusEffects.UnlockedElfLegs) && player.lowerBody != LOWER_BODY_TYPE_ELF && player.soulforce >= 100) addButton(7, "Elf", metamorphElfLegs);
...
private function metamorphOniFace():void {
	...
	player.faceType = FACE_ONI_TEETH;
	doNext(accessMetamorphMenu);
}
private function metamorphOniEars():void {
	...
	player.earType = EARS_ONI;
	doNext(accessMetamorphMenu);
}
private function metamorphOniEyes():void {
	clearOutput();
	player.soulforce -= 100;
	player.eyeType = EYES_ONI;
...
private function metamorphOniLegs():void {
	...
	player.lowerBody = LOWER_BODY_TYPE_ONI;
	player.legCount = 2;
	doNext(accessMetamorphMenu);
}
...
private function metamorphDevilFangs():void {
	...
	player.faceType = FACE_DEVIL_FANGS;
	doNext(accessMetamorphMenu);
}
