	...
	public class DemonScene extends BaseContent
	{
		...
		public function OmnibusGetsRapedByMale():void {
			...
			if (player.cockArea(0) <= monster.vaginalCapacity()) {
				...
				outputText("Omnibus squirms in the dirt as you bring your " + cockDescript(0) + " closer and closer to her female hole, her cock twitching with need like some kind of perverse, mutant clit.  Her hips twitch at you, as if eager to devour your maleness.  You don't keep her waiting, ", false);
				...
				outputText("Her purple-hued pussy spasms around you, its oddly textured interior rippling and sucking in time with your ejaculations, drinking down your cum.  Omnibus squirms happily while her body absorbs your jizz with her impossibly pleasurable hole.", false);
				...
				outputText("Underneath your own mammoth erection, you can feel omnibus's smaller cock twisting and squirming, unloading its own hot fluids onto her sweat-slicked belly.  She wriggles and twitches under you, her thigh muscles clenching and releasing in time with her spurts as they push you beyond your limit.  You watch your " + cockDescript(0) + " as it strains and squirts, dumping your thick load into the demon's ", false);
		...
		public function loseToAOmnibus():void {
			...
			if(player.hasFuckableNipples() && player.lust >= player.maxLust()) {
				...
				if(player.totalNipples() > 4) outputText("  They continue dividing until his wriggling mass is sufficient to penetrate every single nipple and then some.", false); 
				outputText("\n\n", false);
				outputText("A pleading moan escapes your lips and your captor obliges you, the cocks wriggling forward under their own power and sliding into your slippery " + nippleDescript(0) + "s with ease.  Each member is perfectly sized to stimulate you without over-stretching your tender breast-flesh.  You barely stifle a giggle, drunk on enough pleasure to shatter a lesser mind.  Your giggling is rudely interrupted by something hard and slick forcing itself between your lips.  You smile and slurp on it like a pacifier, swallowing droplets of pre-cum as her tentacle-like pricks fuck your breasts hard and fast, ", false);
				if(player.biggestLactation() > 1) outputText("splattering milk and pre everywhere.\n\n", false);
				else outputText("splattering your tits with escaped sexual fluids.\n\n", false);
		...
		//Tentacle gangbang
				...
				outputText("lowering your eyes and fixating on her now-rigid demonic member.  Right before your eyes, it begins splitting and dividing into thinner prehensile penises that squirm about in the air, each one reminding you of a snake on the prowl.  ", false);
				if(player.cor < 80) outputText("In a disgusting display", false);
				else outputText("As you grope yourself noisily with your hand into your undergarments, a salacious smile on your lips", false);
				outputText(", you watch as her pricks pulse and thicken out until their masses are as wide as her original dick.\n\n", false);
				if(player.cor >= 80) outputText("As you realize their size and number, you open your eyes wide and smile broadly, reflexively spreading your legs wide, practically begging her to fuck you.  ", false);
				outputText("In a flash, each fat tentacle-cock whips out and surrounds your body in slick demon-flesh.  The tentacles constrict, working in pairs to take off every piece of your " + player.armorName + ".  ", false);
				if(player.biggestTitSize() >= 2) outputText("They make sure to rub each of your breasts, spending a few seconds smearing slick pre-cum into your " + nippleDescript(0) + ".  ", false);
				outputText("A pair of them slides into your undergarments, pressing against your needy crotch and teasing your " + assholeDescript() + " with more slick demonic cum.  ", false);
				if(player.cor < 80) outputText("You wriggle and whine,", false);
				...
				//Female paragraph
				if(player.vaginas.length > 0 && (player.cocks.length == 0 || rand(2))) {
					outputText("The omnibus at last decides to tend to your over-aroused body and pulls you off the ground with her tentacles, suspending you in mid-air.  ", false);
					if(player.cor < 80) outputText("You feel your " + player.legs() + " lifted and pulled tight as countless demonic cocks encircle your body, binding and constraining you further.  You whimper as a demonic tentacle probes your back door while a thicker one lines itself up just below your " + clitDescript() + ".  ", false);
					...
					outputText("You then giggle and try to wiggle your " + hipDescript() + " forward, begging for her to take you and quench the fire burning in your " + vaginaDescript(0) + ".  The omnibus obliges, pressing forth with both drooling members and simultaneously plugging your front and back doors.  ", false);
					if(player.cor < 80) outputText("You gasp from pleasure and surprise, ", false);
					...
					outputText("enjoying the knobbed texture of her shafts as you're double-penetrated by a single demon. The omnibus smirks as another cock-tentacle wraps itself up around your neck like a shiny student collar and plugs your noisy little mouth.  You groan into his member as you're ", false); 
					if(player.cor < 80) outputText("squeezed and caressed by the writhing tentacle-pricks in and around your body, lost in the pleasure and taste of demonic pre-cum.\n\n", false);
					else outputText("getting roughly fucked by the two tentacle-cocks at the same time.  Taking the tentacle-cock in your mouth with both hands, you eagerly swallow every bit of demonic pre-cum, then suckle on the huge cock-slit. \n\n", false);	
				...
				//Male/Genderless
						...
						if(player.cocks.length > 0) {
							...
							if(player.cumQ() < 50) outputText("You groan and orgasm with enough force to splatter a few ropes of cum into the sea of demon-spunk that soaks you from head to toe.  ", false);
							//Big cum
							if(player.cumQ() >= 50 && player.cumQ() < 400) outputText("Your orgasm goes off like a shotgun blast, splattering the omnibus with a huge wad of cum.  It's but the first of many, and though each load of jizz is of comparable size, the force behind them diminishes until the last few blasts drip down your body and soak your " + player.legs() + " and " + player.feet() + ".  ", false);
							//Huge cum
							if(player.cumQ() >= 400) outputText("Your orgasm goes off like a volcano, visibly distending your " + cockDescript(0) + " as a huge wave of cum erupts from your groin, painting the omnibus and floor with your spoo.  You cry from the sheer pleasure as the next wave builds and erupts, nearly as large as the last.  The demon-cock controlling your prick aims this blast up, forcing you to soak your " + hairDescript() + " and face with slick goo. The orgasming drags on and on while you slowly turn blue from oxygen deprivation. Before long, both you and the omnibus are buried under a wave of white.  ", false);
							}
							outputText("The feeling is so intense that your " + hipDescript() + " twitch and move of their own volition while your eyes roll back in pleasure.\n\n", false);
							outputText("You black out just as you feel the cock-tentacle in your throat retracting. You dully feel your body drop to the ground, your pregnant-looking belly sloshing with demon jizz.", false);
							player.refillHunger(100);
		...
		public function SuccubusGetsRapedByMale():void {
			...
			outputText("\n\nThe succubus licks her fingers clean, looking totally recovered.  In the blink of an eye, she dashes out and disappearing in the distance.", false);
			player.orgasm();
			dynStats("cor", 5);
			cleanupAfterCombat();
		}
		...
		public function loseToASuccubus():void {
			...
			if(player.cocks.length > 0) {
				...
				outputText("\n\n\"<i>Good boy,</i>\" she croons, but you don't have time to ponder the meaning of that as you lose consciousness.", false);
				player.orgasm();
				dynStats("cor", 5);
				cleanupAfterCombat();
			}
