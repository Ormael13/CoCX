...
//use namespace CoC;
	...
	public class DemonScene extends BaseContent
	{
		...
		public function lustyPaizuri():void {
			clearOutput();
			outputText("You make sure [themonster] is comfortably lying down, " + monster.pronoun3 + " " + monster.cockDescriptShort(0) + " exposed to the air");
			...
			outputText("\n\n[Themonster] nods solemnly while " + monster.pronoun3 + " eyes half-cross from pleasure.  You bottom out around " + monster.pronoun3 + " base");
			...
			outputText("\n\nBelow you, [themonster] is moaning out loud and roughly thrusting " + monster.pronoun3 + " hips to meet your every motion, their tip expanding slightly in your mouth as " + monster.pronoun3 + " passion mounts.  You pull back");
