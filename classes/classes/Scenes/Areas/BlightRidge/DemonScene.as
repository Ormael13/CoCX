...
//use namespace CoC;
	...
	public class DemonScene extends BaseContent
	{
		...
		public function lustyPaizuri():void {
			...
			outputText("[pg]\"<i>Such lascivious behavior!  I'll have to make sure you're thoroughly purified,</i>\" you state matter-of-factly with a feigned serious look on your blushing [face].  To put proof to your taunt, you grab the throbbing shaft by the base and aim it straight up, dropping your [chest] down on either side.  The slippery, self-lubricating leather that joins the cups of your sexy, chainmail bra together loops over the top of the " + monster.cockDescriptShort(0) + " to properly restrain it, pinned in the slick, sweaty valley you call your cleavage.  It thrums happily against your [skin] when you compress the jiggly flesh around it, leaning down to let it feel pleasure that rivals any pussy, no matter how wet or skilled.");
        ...
        public function OGRBM_toobig():void {
            ...
            //[lust]
            if (monster.lust > 99) outputText("Ignoring her squeals of pleasure, you force the omnibus onto her back, ogling her perky breasts, indecent cock, and soaked cunt.  She looks up at you hungrily, and you have the feeling that on some level you're still giving her what she wants.  Wary of the demon's wiles, you pull her hands together and use some scraps of cloth to bind them up.  Moaning with helpless desire, the demon grinds her crotch against your [leg], spreading her thighs apart into a near split and giving you a world-class view of her juicy purple cunt.[pg]");
            //[hp]
		...
		public function CowSuccubusEncounter():void {
			...
			if (flags[kFLAGS.CODEX_ENTRY_SUCCUBUS] <= 0) {
				...
				outputText("[pg]<b>New codex entry unlocked: Succubus!</b>")
			}
