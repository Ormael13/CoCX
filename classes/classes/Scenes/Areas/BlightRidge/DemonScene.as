	...
	public class DemonScene extends BaseContent
	{
		...
		public function OmnibusGetsRapedByMale():void {
			...
			if (player.cockArea(x) <= monster.vaginalCapacity()) {
				...
				outputText(cockDescript(x) + ". Omnibus's smooth skin and soft thigh-flesh form a comfortably tight masturbation tube.  Starting slowly, you begin rocking back and forth, sawing your prodigious cock-flesh over her body.  The demoness swivels her hips underneath your [cock], her slippery gash and near-crushed member feverishly rubbing into you.  Though you didn't get to truly violate her, her thighs and unblemished skin are more than good enough to bring you to the brink of orgasm.\n\n");
