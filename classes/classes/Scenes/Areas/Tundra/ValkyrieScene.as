	...
	public class ValkyrieScene extends BaseContent
	{
		...
		public function winAgainstValkyrie():void {
			...
			if (player.lust >= 33 && flags[kFLAGS.SFW_MODE] <= 0) {
				...
				if (uniquuuesexscene.pcCanUseUniqueSexScenev2(true, null) > 0) addButton(13, "U.Sex Scenes", curry(uniquuuesexscene.pcCanUseUniqueSexScenev2, false, [winAgainstValkyrie])).hint("Other non-typical sex scenes.");
