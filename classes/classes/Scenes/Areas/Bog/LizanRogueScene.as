package classes.Scenes.Areas.Bog 
{
	...
	public class LizanRogueScene extends BaseContent
	{
		...
		public function consensualGetFucked():void {
			...
			if (player.hasCock()) {
				outputText("\n\nAs you reach the point of no return both your [vagina] and [cock] begin to tremble.  With [eyes] lifted to the sky you scream a scream of pure unadulterated pleasure as your [vagina] floods while your [cock] explodes.");
