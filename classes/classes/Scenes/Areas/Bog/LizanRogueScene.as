package classes.Scenes.Areas.Bog 
{
	...
	public class LizanRogueScene extends BaseContent
	{
		...
		public function consensualButtfuck():void {
			clearOutput();
			outputText("The lizan watches you disrobe with obvious interest as he asks  \"<i>How do you like to do this?</i>\"");
			...
			if (player.cocks.length == 1) { //One cock
				...
				outputText("\n\nLike a snake his tongue slithers from his lips and begins to encircle your [cockBiggest], the moves on until it has formed at least two coils around each of your cocks.  The surprisingly firm snake like organ massages all of your dicks  in firm rhythmic strokes.  It feels like a family of hot, wet snakes are writhing around [eachCock], squeezing with practiced ease as saliva trickles down your shafts.  ");
			...
			if (player.smallestCockLength() < 7) {
		...
		public function consensualGetFucked():void {
			...
			outputText("\n\nFor a second you lie there [fullChest] against his " + monster.skinTone + " abs. Around the two of you lies the hot glorious mess of your combined sexual fluids.  Both of you are panting, both of you are satisfied.  Then you push yourself off of him and collect your [armor].  He takes it upon himself to clean your [fullChest] and [vagina] with his long tongue and as soon as he is done you pull on your [armor].  Before you leave you reward him with a deep kiss, snaking your [tongue] into his mouth before heading back to camp.");
		...
		public function consensualGetButtFucked():void {
			clearOutput();
			outputText("The lizan watches you disrobe with obvious interest and asks  \"<i>How do you want to do this?</i>\" You tell him you want him to take your back door, which causes a surprised grin to stretch across his face.  He confidently peels off his loincloth, exposing two bumpy purple lizan dicks not lacking in length or girth.");
			if (player.isBiped()) {
		...
		public function consensualDoublePenetration():void {
			clearOutput();
			outputText("The lizan watches you disrobe with obvious interest and asks  \"<i>How do you want to do this?</i>\"  you tell him you're going to ride him until the wheels come off, which causes a surprised grin to stretch across his face.  He confidently peels off his loin cloth, exposing two bumpy purple lizan dicks not lacking in length or girth.");
		...
		public function consensualWatersports():void { //Yay watersports!
			clearOutput();
			outputText("A kinky idea crosses your mind.  You tell him that you'd like to take things a bit further.  \"<i>I get it. Some urine activity,</i>\" he says.  You slowly disrobe and toss your [armor] into a neat pile on one of the nearby trees.  The lizan slowly strips his loincloth off, exposing his wonderful dual reptilian cocks.");
			...
			outputText("\n\nHis urine flows eventually stop and you scoop up some murky water to wash off the urine.  You cuddle with the lizan for a moment before you have to part ways and redress yourself in your [armor].");
