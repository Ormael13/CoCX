...
private function bunbun69():void {
	...
	if(player.cockTotal() > 0) {
		...
		if(isEaster()) {
			...
			if(player.tailType != Tail.RABBIT && !player.hasPerk(PerkLib.TransformationImmunity) && !player.hasPerk(PerkLib.Undeath)) {
				//[No Tail: 
			...
			if(player.ears.type != Ears.BUNNY && !player.hasPerk(PerkLib.TransformationImmunity) && !player.hasPerk(PerkLib.Undeath)) {
