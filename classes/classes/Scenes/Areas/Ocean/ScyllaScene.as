...
public function oceanScyllaWin():void {
	...
	if (player.canSwimUnderwater()) {
		...
		if (player.lust >= 33 && player.gender > 0 && flags[kFLAGS.SFW_MODE] <= 0) {
			...
			if (uniquuuesexscene.pcCanUseUniqueSexScenev2(true, null) > 0) addButton(13, "U.Sex Scenes", curry(uniquuuesexscene.pcCanUseUniqueSexScenev2, false, [oceanScyllaWin])).hint("Other non-typical sex scenes.");
		}
	}
	else {
...
public function oceanScyllaWin3():void {
	...
	if (player.hasCock()) {
		...
		outputText("She tries to insert her other tentacles inside you but you deny her, making it clear that she is on the receiving end and not the other way around. Unable to fuck anything else but herself, she proceed to insert her remaining tentacle in her own pussy, the bubbles rushing out of her mouth only telling her delight at her own ministrations.\n\n");
