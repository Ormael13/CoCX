...
public class FetishCultistScene extends AbstractLakeContent
	{
		...
		public function cultistRapesYou():void
		{
			...
			if (player.isTaur() || player.isNaga()) {
				...
				if (player.lowerBody == LowerBody.HOOFED && player.balls > 0 && player.cockTotal() > 0 && rand(4) < 3) {
		...
		public function cultistDefeated():void{
			...
			if (player.lust >= 33 && player.gender > 0 && flags[kFLAGS.SFW_MODE] <= 0) {
				...
				if (uniquuuesexscene.pcCanUseUniqueSexScenev2(true, null) > 0) addButton(13, "U.Sex Scenes", curry(uniquuuesexscene.pcCanUseUniqueSexScenev2, false, [cultistDefeated])).hint("Other non-typical sex scenes.");
