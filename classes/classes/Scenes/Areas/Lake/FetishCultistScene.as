		...
		public function cultistRapesYou():void
		{
			...
			if (player.isTaur() || player.isNaga()) {
				...
				//Naga
					...
					//boy's surprise
						...
						outputText("your " + multiCockDescriptLight() + " poke out of your pelvic slit, growing to full erectness.  You strain against your bonds, desperate to bring release to ");
						if (player.totalCocks() > 1) outputText("each of ");
			...
			if (rand(2) == 0 && !sexed) {
				...
				if (player.isTaur()) {
					...
					if (player.cockTotal() > 0) outputText("  As you see your " + multiCockDescriptLight() + ", 'incredibly large' is the only qualifier you can think of.");
				}
				outputText("\n\n");
				...
				if (player.vaginas.length > 0 && player.cocks.length > 0) {
					...
					if (player.cocks.length > 2) outputText("The rest of your " + multiCockDescriptLight() + " rubs against her skin pleasantly.  ");
					...
					if (player.cocks.length > 0 && (player.vaginas.length == 0 || rand(2) == 0)) {
						outputText("  You see that your " + player.armorName + " have become a nice looking, if simple, frilled white shirt and bow tie along with black pants and matching shoes.  They make you look like you would be at home in a manor attending the needs of a noble, if it were not for the flaps on the front and back of your pants that give easy access to your " + multiCockDescriptLight());
						...
						outputText("With a cry of joy you lift the front flap on your pants revealing your very erect " + multiCockDescriptLight() + " and lie on the ground ready to please your mistress the best way you can.  You watch your mistress rise off her chair and slowly lower herself onto your " + cockDescript(0) + " moaning in pleasure.  Her interior is so familiar and so wonderful.  ");
						...
						outputText("She starts to rock back and forth, your " + cockDescript(0) + " bringing her to the height of pleasure. ");
						if (player.cocks.length == 2) outputText("Your " + cockDescript(1) + " rubs against her skin pleasantly.  ");
						if (player.cocks.length > 2) outputText("The rest of your " + multiCockDescriptLight() + " rub against her skin pleasantly.  ");
					...
					//(variant 2: maid, requires vagina)
						...
						if (player.cocks.length > 0) outputText(", your " + multiCockDescriptLight() + ",");
						...
						//[if player has a dick]
						if (player.cocks.length > 0) outputText("You feel a desire rising in your erect " + multiCockDescriptLight() + " but you ignore it; that's not what your mistress told you to play with.  ");
			...
			if (monster.armorName == "pervy nun's clothing") {
				...
				if (player.cocks.length > 0 && (player.gender != 3 || rand(2))) {
					...
					if (player.cocks.length > 1) {
						outputText("You thrust once, before using one of your hands to guide the second of your " + multiCockDescriptLight() + " inside her.  You are rather surprised at how easily she seems to accommodate your size");
