...
//Raping the player
		public function zealotLossRape():void
		{
			...
			if (broseph == "dude") {
				...
				if (player.cockTotal() > 0) {
					outputText(", and your " + multiCockDescriptLight() + " start");
			...
			if (broseph == "dude") {
				...
				if (player.gender != 0) {
					...
					if (player.totalCocks() == 1) {
						outputText("You piston your hands on your " + cockDescript(0) + ", ");
					}
					//nope two
					else if (player.totalCocks() == 2) {
						outputText("With one hand on each of your " + multiCockDescriptLight() + ", you piston them like mad, ");
					}
					//oh no, is more than that
					else {
						outputText("Rapidly moving your hands between each rod in your " + multiCockDescriptLight() + ", you manage to piston each of them at an incredible rate, ");
					}
				...
				if (player.gender != 0) {
					...
					if (player.balls > 0) {
						outputText("and move your " + ballsDescriptLight() + " out of the way ");
					}
					...
					if (player.cockTotal() > 0) {
						outputText("You give your " + multiCockDescriptLight() + " a few gentle strokes, wishing he would give that a little attention too, but this is a lesson on how to please a <i>woman</i>.  ");
					}
					outputText("You feel yourself getting close to the edge and tell him to stop.  He looks up at you uncertain for a moment, and you tell him \"<i>It's time for the main event.</i>\"\n\n");
					//prick in the twat
					...
					if (player.cockTotal() > 0) {
						outputText("Your " + multiCockDescriptLight() + " spasms and covers you with a liberal amount of your own fluids.  ");
					}
