...
private function badEndPartTwo():void {
	...
	if(player.tongueType == AppearanceDefs.TONGUE_SNAKE) outputText("  Your snaky forked tongue begins lashing about, flicking at the nipple tip in your mouth while rubbing at the underside of it, urging the tender spot to give up a drop of the heavenly white liquid.");
	//[If PC has demonic/dragon tongue]
	else if(player.tongueType > AppearanceDefs.TONGUE_HUMAN) {
