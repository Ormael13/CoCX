...
//[Beach]
		...
		{
			if (rand(4) == 0 && player.hasStatusEffect(StatusEffects.SlimeCraving) && player.findPerk(PerkLib.SlimeCore) < 0 && player.findPerk(PerkLib.DarkSlimeCore) < 0 && player.isGoo() && player.gooScore() >= 4) {
