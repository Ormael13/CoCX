...
*/	//Hungry for cum?  Grab a snickers.
	...
	if (uniquuuesexscene.pcCanUseUniqueSexScenev2(true, null) > 0) addButton(13, "U.Sex Scenes", curry(uniquuuesexscene.pcCanUseUniqueSexScenev2, false, [postfightoptions])).hint("Other non-typical sex scenes.");
