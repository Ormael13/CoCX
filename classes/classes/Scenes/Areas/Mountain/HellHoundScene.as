...
package classes.Scenes.Areas.Mountain
{
	...
	public class HellHoundScene extends BaseContent
	{
		...
		public function hellhoundRapesPlayer():void
		{
			...
			outputText(" and positions himself behind you. He grips you with his clawed hands on your shoulders and easily holds you in place. The powerful creature is easily able to get past your " + player.armorName + " and you feel one of his rods brush against your " + buttDescript() + ".  A shudder shoots through your body as he brings his two heads down to either side of your own, his hot canine breath blowing past your ears. He stays there for a few moments, completely still... before suddenly pulling his heads back and ");
			if (player.vaginas.length > 0 && player.lowerBody != LOWER_BODY_TYPE_NAGA) outputText("slamming his twin dicks into your " + vaginaDescript(0) + " and your " + assholeDescript() + ".  ");
			...
			if (player.vaginas.length > 0 && player.lowerBody != LOWER_BODY_TYPE_NAGA) {
				...
				if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_WET) outputText("The pause gives your " + vaginaDescript(0) + " time to moisten, ensuring the next thrust won't be quite as rough.  ");
		...
		public function hellHoundPropahRape():void
		{
			...
			//--- ELSE (CORRUPTION >= 20) ---
				...
				if (player.hasCock()) {
					...
					//--- IF ONE PENIS ---
					if (player.totalCocks() == 1) outputText("  Soon your own " + cockDescript(0) + " reacts, quickly growing into a full throbbing erection. You leave your member alone, and it keeps flapping against the hellhound's belly while you ride him.");
					//--- ELSE ---
				...
				//--- IF PC HAS BALLS ---
				if (player.balls > 0) outputText("  Whenever you lower your hips to your mates belly, your " + ballsDescriptLight() + " touches his. The magical flames fill your scrotum with unnatural heat but no pain. You literally feel the cum in your balls boiling upwards, building up immense pressure.");
				outputText("\n\n");
				...
				if (player.totalCocks() > 0) {
					// --- IF ONE PENIS ---
					if (player.cockTotal() == 1) outputText("Your " + cockDescript(0) + " twitches as it ejects its sticky load.");
					//--- ELSE ---
					else outputText("Your " + multiCockDescriptLight() + " twitch as they eject their sticky loads.");
