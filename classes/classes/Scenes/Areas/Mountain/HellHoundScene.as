...
//HELLHOUND MASTER+ BAD ENDZZZZZ
		public function HellHoundMasterEncounter():void
		{
			...
			if (flags[kFLAGS.HELLHOUND_MASTER_PROGRESS] == 0) {
				...
				outputText("As you're wandering the mountains, you once again feel an odd presence in the back of your mind.  You're sure it is the hellhound master once again.  You look at the pink crystal in your possession, and wonder if you should exchange it for the promised hellfire.  Do you let the presence take over and give away the Lethicite?", false);
