...
//Merae's Lethicite
		...
		public function rapeCerberusStyle():void
		{
			...
			if(player.hasMutation(IMutationsLib.AlphaHowlIM) && player.hasMutation(IMutationsLib.HellHoundFireBallsIM) && player.perkv1(IMutationsLib.HellHoundFireBallsIM) > 1 && (player.perkv3(IMutationsLib.HellHoundFireBallsIM) < (player.perkv1(IMutationsLib.HellHoundFireBallsIM) > 3 ? (Math.floor(2.5*player.perkv1(IMutationsLib.AlphaHowlIM))) : player.perkv1(IMutationsLib.AlphaHowlIM)))) {
