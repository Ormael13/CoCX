...
public class InfestedHellhoundScene extends BaseContent
	{
		...
		public function infestedHellhoundLossRape():void
		{
			...
			if (player.cockTotal() > 0 && player.hasStatusEffect(StatusEffects.Infested)) {
				...
				//(HP)
				else outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-sharp teeth easily sink into your [armor] before tearing away the offending armor, exposing your [ass] and [cocks].  A cold mountain breeze blows across your now-exposed [skin.type], reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity. With a brutal lunge it knocks you off your [feet] and onto your back.\n\n");
			...
			//[PLAYER'S COCKS ARE BIG ENOUGH TO BE INFECTED]
				...
				//(HP)
					...
					outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your [armor] before tearing it off, exposing your [ass] and [cocks].  A cold mountain breeze blows across your now exposed [skin.type], reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity.  With a brutal lunge it knocks you off your [feet] and onto your back.\n\n");
				}
			...
			//[HAS PUSSY AND NO DICK BIG ENOUGH TO BE INFECTED]
				...
				//(HP)
					...
					outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your [armor] before tearing it off, exposing your [ass] and " + vaginaDescript(0) + ".  A cold mountain breeze blows across your now exposed [skin.type], reminding you just how utterly exposed you are to the alien lusts of this symbiotic monstrosity.\n\n");
				}
				...
				outputText("Incredible heat radiates from the pair of rods inside you, making your whole body break out in a cold sweat in an attempt to deal with the situation.  You're rocked back and forth as the beast begins fucking you in earnest, slamming its fur-covered hips against your [ass] with animalistic intensity.  Thankfully, the fucking isn't that painful, but the small mercy is ruined by the hot fluid you can feel starting to pour into you.\n\n");
			...
			//[GENDERLESS OR MALE WITH DICK TOO SMALL]
				...
				//(HP)
					...
					outputText("Too wounded to stand, you drop down to on your elbows in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your [armor] before tearing it off, exposing your [ass].  A cold mountain breeze blows across your now exposed [skin.type], reminding you just how utterly exposed you are to the alien lusts of this symbiotic monstrosity.\n\n");
				}
				outputText("The hell-hound rises up, looking nearly humanoid in shape for a moment before it drops down, planting its paws on your shoulders.  ");
				...
				outputText("Incredible heat radiates from the thick black rod inside you, making your whole body break out in a cold sweat in an attempt to deal with the situation.  You're rocked back and forth as the beast begins fucking you in earnest, slamming its fur-covered hips against your [ass] with animalistic intensity.  Thankfully, the fucking isn't that painful, but the small mercy is ruined by the hot fluid you can feel starting to pour into your " + assholeDescript() + " and onto your back.\n\n");
