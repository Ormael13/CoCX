package classes.Scenes.Areas.Forest
{
	...
	public class ErlKingScene extends BaseContent
	{
		...
		protected function repeatWildHuntGivenToTheHounds():void
		{
			...
			outputText("You groan around the Hound’s dick as you feel a pressure against your [asshole].  The beast squeezes your [ass] cheeks as he shoves his foot-long doggie cock into your rear.  You yelp, realizing what’s to come, and try to wriggle away, but, pinned between the two Hounds, there’s no escape.  The Hounds growl in unison and you freeze, cowed by the two powerful males who want their way with your frightened, vulnerable body.\n\n");
		...
		protected function repeatWildHuntAWinnerIsYou():void
		{
			...
			addButton(4, "Question", howDareYou);
		...
		protected function predatoryPrey():void
		{
			...
			else
			{
				...
				if (player.hasVagina() && !player.hasCock())
				{
					...
					outputText("Reaching into his belt pouch, he pulls out a small bottle of salve.  One hand strokes your hair as the other begins to work the cream into your scratched [breasts].  The cream is cool and soothing, and the Erlking is attentive.  You soon fall asleep, your head leaning against his chest.\n\n");
