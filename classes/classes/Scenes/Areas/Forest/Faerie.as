...
private function faerieCaptureHJ():void {
	...
	//Non-taurs
		...
		else if(player.cocks[0].cockType == CockTypesEnum.HORSE) outputText("climbs atop your " + cockDescript(0) + ", hanging onto your ring of prepuce and wrapping her legs as far around your horse-like maleness as she can.  ");
