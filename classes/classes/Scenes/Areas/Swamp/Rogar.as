	...
	//((androgynous or masculine and breasts <= A-cup))
		...
		//(else if Dirt Mc Girt = 2)
			...
			if(player.gender == 2 || player.gender == 0) {
				...
				outputText("  " + SMultiCockDesc() + " gets a caress from him as he explores, arousing it to mild stiffness.  \"<i>" + player.short + ",</i>\" he grunts.  \"<i>Ah hope ah'll be seein' more of ya.</i>\"  Ro'gar breaks the contact and tips back the remains of his drink while you ");
...
private function loseButtGinity():void {
	...
	if(player.ass.analLooseness == 0) {
		...
		//(if player has balls) 
		if(player.balls > 0) outputText("  Ro'gar's dark green cockhead rubs over your " + ballsDescriptLight() + " and coats the plump sack in his musky goo, like an alpha male marking his territory.");
		outputText("\n\n");
		...
		outputText("Your mind races with Ro'gar's words as they seemed to be coming true.  You can't help but focus on the wonderful feeling of Ro'gar's cock throbbing within you.  Maybe this is where you belong?  With your tight ass impaled on Ro'gar's massive tool?  You moan loudly as Ro'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to break in your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your " + multiCockDescriptLight() + " and glaze your belly with pre-cum.");
	...
	//(([Get Anal] Scenario 1b: Get fucked (normal)))
		...
		if((player.thickness >= 75 && player.tone < 33) || player.tone >= 75) {
			...
			if(player.balls > 0) outputText(" and your " + ballsDescriptLight() + " clench tight as you feel your limit reached");
			outputText(".");
			//[(if player has toes)
		...
		//(else)
			...
			//[(If player has balls) 
			if(player.balls > 0) outputText("  You feel your " + ballsDescriptLight() + " pull up tight in your sack as your labored breath comes out in pants.");
...
private function fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim():void {
	...
	//((If cock is between 18 and 4 inches))
		...
		//[(if multiple cock)
		if(player.cockTotal() > 1) outputText("  The other meat rubbing over his olive skin outside adds to the coating of spunk, making a giant mess of Ro'gar's body.  In seconds he resembles a well-paid whore beneath your " + multiCockDescriptLight() + ".");
		outputText("\n\n");
	}
	//end right fit path
...
private function frotWithRogar():void {
	...
	//(If single cock)
		...
		outputText("Your cock presses tight against Ro'gar's fat orc cock. He growls low as he grinds himself over you, his thick, globbing pre-cum drooling onto your " + multiCockDescriptLight() + ".  Muffled groans escape Ro'gar's mouth as you kiss him roughly, tongues locked all the while in writhing combat.  ");
		//[(If player has balls)
		if(player.balls > 0) outputText("Your " + ballsDescriptLight() + " slap audibly against Ro'gar's heavy green sack.  ");
...
private function kinkyWithDaOrc():void {
	...
	outputText("You can't help but focus on the wonderful feeling of Ro'gar's cock throbbing within you.  Maybe this is where you belong?  With your ass impaled on Ro'gar's massive tool?  You moan loudly as Ro'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to pound your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your " + multiCockDescriptLight() + " and glaze your belly with pre-cum.");
	if(player.hasLongTail() > 0 || player.isNaga()) outputText("  Your tail, still gripping Ro'gar's arm, squeezes tight.");
	//(If player has balls) 
