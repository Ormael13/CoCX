...
package classes.Scenes.Areas.HighMountains 
{
	...
	public class MinervaPurification extends BaseContent implements TimeAwareInterface
	{
		...
		public function purificationByMarae():void {
			...
			if (flags[kFLAGS.MINERVA_SPRING_DRUGGED] == 0) outputText("\n\nHearing your excited calls draws Minerva over from her place of rest near the pure spring, her curiosity clear on her face as she wonders what's making you so excited. \"<i>What is it, lover? What's gotten into you?\" she questions you before her eyes widen and she brings a hand to her lips, biting it softly. \"Did you... could it be that you found a way to purify me and purge my body of this disgusting creature?</i>\"");
			...
			outputText("\n\nWhen you hear her request you wonder if it would really work. You could be the father/mother of a whole new race in this world! How many people anywhere can say that?");
		...
		public function purificationByJojoPart2():void {
			...
			outputText("\n\nHe makes a polite bow to the newly purified Siren. \"<i>With my work here done, I must return to... well, I guess it is my home. I do hope that charName will show it to you. It was very nice to see your home.</i>\" Having excused himself, he heads out the door and away through the mountains. You know he'll be back at camp before you are.");
		...
		public function purificationByRathazul():void {
			...
			outputText("When you hear her request you wonder if it would really work. You could be the father/mother of a whole new race in this world; how many people anywhere can say that?");
			awardAchievement("Divine Intervention", kACHIEVEMENTS.GENERAL_MINERVA_PURIFICATION, true, true);
			flags[kFLAGS.MINERVA_PURIFICATION_PROGRESS] = 10; //Complete
		...
		private function minervaBabiesMeet():void {
				...
				//Presents
				Even from here you can tell she is having a fun time with her young siren daughters. The group of young sirens are busy playing together with their mother-father, the siren broodmother doing what seems to come naturally. This time, she's picking peaches from the ever-productive fruit bearing trees around the pure spring. the mother-father and daughters all working  together to get the best peaches at the top to eat. (#sirens = 2 use this: Minerva holds her two daughters up on her shoulders, letting them use her like a ladder:) (#sirens = 4+ Minerva holds one of her daughters up on her shoulder, letting her use her parent like a ladder. The other daughters all work together, forming a \"<i>human</i>\" ladder of young sirens, each standing on another's shoulders as they pick the tasty sweet fruit from the trees.)

				Smiling at the cute sight you approach the sirens. As you get closer you see the ‘tower of sirens falter and drop their peaches, the herms gasping as they reach out, only for you to catch the peaches yourself.  Grinning up at them you take a bite of one and watch their surprised faces. As soon as they see you there is a loud chorus of \"<i>Daddy!/Mommy!/Mommy-Daddy!</i>\" Your gold and white skinned daughters give up being a ladder and fall onto you, knocking you over and piling onto you. Your errant offspring waste no time crawling over you, sitting on you and hugging you. Clearly they are very happy to see you and demand to spend time with their other parent. All the peaches you caught end up falling the mossy ground as your daughters pile on top of you.

				As you ‘struggle' with your errant daughters Minerva snickers at your situation as she kneels down  next to you, letting the siren off her shoulder to join her sisters. \"<i>Well, isn't this adorable. Your daughters really missed you, as you can see.</i>\" She says before leaning down and kissing you. \"<i>And so did I.</i>\" She whispers into your player.Earsdescript before ushering the girls up and off of you so you can get up.  \"<i>Now I do believe you girls had something to give your Daddy/Mommy/Mommy-Daddy</i>\" The siren brood mother says, her words causing the young sirens to gasp and scamper off and find the presents they had gathered for you
		...
		private function pureMinervaAppearance():void {
			...
			if (pregnancy.isPregnant) {
				...
				else if (pregnancy.incubation < 72) ("<b>She looks heavily pregnant. She is about to give birth soon.</b>");
		...
		public function minervaGivesBirth():void {
			...
			outputText(".  You instruct her to get down and spread her legs.  She does as instructed, getting down and spreading her legs for you.  You take her shorts off, exposing her genetalia completely.");
			outputText("\n\nThe clock is ticking. You ask her to take deep breaths. She nods and takes deep breaths as expected, trying to ease the contractions.");
			outputText("\n\nTime goes by. It's been thirty minutes but she shows no sign of water brea... Suddenly, the water breaks!");
			outputText("\n\nPanic spreads throughout Minerva. You quickly assure her that she'll be fine. You ask her to push. \"<i>I'm pushing!</i>\" she yells as she struggles to get the baby out.  The head suddenly comes out of her womb.  You prepare to grab the baby and as soon as the baby comes out, you grab her and place her on her chest. \"<i>That's one! Just one more,</i>\" she says.");
			outputText("\n\nRealization sets in as she tells you that she is going to give birth to the next one shortly.  You ready and after the pushings, the second baby comes out at last!  You place the second baby next to the first. Minerva finally relaxes after the ordeal.");
			outputText("\n\n\"<i>It's so beautiful. Our two little sirens,</i>\" she says. ");
			...
			outputText("You lay down next to her and relax, even taking the time to examine the young sirens.  They look so adorable.  ");
			if (rand(2) == 0) outputText("One of them is definitely a hermaphrodite.  No wonder she will eventually grow up to be virile and fertile to help expand the sirenic population.");
