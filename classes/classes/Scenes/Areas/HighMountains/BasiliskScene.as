...
public class BasiliskScene extends BaseContent
	{
		...
		public function defeatBasilisk():void {
			...
			if(player.lust >= 33 && player.gender > 0 && flags[kFLAGS.SFW_MODE] <= 0) {
				...
				if (player.pcCanUseUniqueSexScene()) addButton(13, "U. Sex Scenes", uniquuuesexscene.pcUniqueSexScenesChoiceMenu, 022).hint("Other non typical sex scenes.");
		...
		private function basiliskAdvantageGoblin():void {
			...
			//Unsexed:
				...
				outputText("Eventually the minotaur's balls swell against your [butt] and with a long, satisfied moo, he reaches his peak, holding you down so his cum jets forth deep inside you.  The sensual high it has already instilled in you amplifies by tenfold as the warm, oozing fluid finds its mark and you moan as you spontaneously orgasm, your anus helplessly milking the creature for all it can get.\n\n");
		...
		private function basiliskAdvantageMinotaur():void {
			...
			outputText("Eventually the minotaur's balls swell against your [butt] and with a long, satisfied moo, it reaches its peak, holding you down so its cum jets forth deep inside you.  ");
