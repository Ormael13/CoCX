...
package classes.Scenes.Areas.HighMountains
{
	...
	public class BasiliskScene extends BaseContent
	{
		...
		private function defeatBasiliskAndAnal():void {
			...
			if(player.hasCock()) {
				...
				if(player.cocks[x].cockLength <= 13) {
					...
					if(player.balls > 0) outputText(" your " + ballsDescriptLight() + " slapping against it,");
				...
				//(More than 13 inches:)
					...
					//[(if balls)
					if(player.balls > 0) outputText("Your " + ballsDescriptLight() + " swing heavily underneath your shaft, swelling as your rhythm picks up.  ");
		...
		private function defaultBasiliskRape():void {
			...
			//Male/Herm: 
			if(player.hasCock()) {
				outputText("With surprising gentleness and deftness, the basilisk rubs your " + cockDescript(0) + " with one palm");
		...
		private function basiliskBadEnd():void {
			...
			if(player.gender == 3) outputText("  You moan through your still throat as you feel blood rushing to your groin, your " + multiCockDescriptLight() + " stiffening and your " + vaginaDescript(0) + " beginning to drip.");
			if(player.gender == 1) outputText("  You moan through your still throat as you feel blood rushing to your groin, your " + multiCockDescriptLight() + " stiffening.");
