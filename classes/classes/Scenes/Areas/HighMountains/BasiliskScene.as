	...
	public class BasiliskScene extends BaseContent
	{
		...
		private function defeatBasiliskAndAnal():void {
			...
			if (player.hasCock()) {
				...
				if (player.cocks[x].cockLength <= 13) {
					outputText("Soon your " + player.hipDescript() + " are clapping a staccato rhythm against its warm, muscly butt,", false);
					if (player.balls > 0) outputText(" your " + player.ballsDescriptLight() + " slapping against it,", false);
		...
		private function defaultBasiliskRape():void {
			...
			if (player.hasCock()) {
				...
				if (player.hasVagina()) outputText(" and sticks some of the smaller fingers of its other hand in your " + player.vaginaDescript(0), false);
				outputText(", thankfully angling its sickle claw away.  You can't do anything against it, and some of its mental compulsion remains; a backwash of erotic images from your past fill your head, and you can't even grit your teeth as the gentle, insistent pressure brushing your prick makes you rock hard.  It stops when you are erect and then, with the very faintest of smiles playing over its cruel mouth, leaves. You're naked, your " + player.cockDescript(0) + " is begging for release; you're utterly helpless... you can only hope that the spell will wear off, and before anything else in the mountain finds you.\n\n", false);
			}
			//Female: 
			else if (player.hasVagina()) {
				outputText("With surprising gentleness and deftness, the basilisk slips the smaller fingers of one hand into your " + player.vaginaDescript(0) + ", and carefully flicks at your " + player.clitDescript() + " with the other, thankfully holding its sickle claws away from you.  You can't do anything against it, and some of its mental compulsion remains; a backwash of erotic images from your past fill your head, and you can't even grit your teeth as the gentle, insistent caresses make you wet.  It stops when you are beading moisture involuntarily onto its hand and then, with the very faintest of smiles playing over its cruel mouth, leaves. You're naked, your " + player.vaginaDescript(0) + " begs to be filled; you're utterly helpless. You can only hope that its spell will wear off, and before anything else in the mountain finds you...\n\n", false);
			}
			//Genderless: 
		...
		private function basiliskHasVagEggStuff():void {
			...
			outputText("The creature suddenly raps something out in its strange, dry tongue, and you feel something - something deep and red - flinch in your mind.  Suddenly, you are wet, wetter than you've ever been, your pussy slavering so badly you can hear the pitter-patter of your juices hitting the ground beneath you.  The basilisk says something else, more softly this time as it slides in close, its long claws reaching around to clutch your " + player.buttDescript() + ".  With a kind of horror you feel your limbs move involuntarily, your arms reaching around the thing's thin, muscled back, your bottom half slackening until you are supported entirely by the wiry strength of the lizard.  You expose your crotch in complete submission as the basilisk walks forward, and you feel the head of its cock teasingly touch your dripping, treasonous cunt.  As soon as your limbs are where it wants them to be, they lock in position again; you heave at them desperately, but once again your ability to do anything with your own body is simply not there.  You are less of a statue and more of a fuck toy, an extension of the basilisk's lust-maddened will.  Your jailer keeps walking until you feel the rough surface of a boulder against your back, and using this support the basilisk pushes itself straight into your " + player.vaginaDescript(0) + ".", false);
