...
//Requires pussy or cock small enough for harpy!
		private function harpyLossLust():void
		{
			...
			if (player.hasVagina() && x < 0) {
				...
				if (player.skinType == SKIN_TYPE_PLAIN) outputText(" and quickly alleviating it by brushing their wings across your hide", false);
				...
				outputText("Suddenly, there's a different feeling altogether. You look down and through the feathered fans, spot one of the harpies with her face between your spread legs. She looks at you, a sultry expression in her black-yellow eyes as her black, stout tongue runs up an down your " + vaginaDescript(0) + ". You close your eyes and focus on that, instead of the maddening sensation of the rolling waves of talons", false);
			...
			//(Reminds me of what my own Succubus does in my novel)
				...
				outputText("Instantly, they drop you on purpose, only to be caught again mid-air by a single one. Using the momentum, your sadistic savior then throws you around like a sling for others to catch, which they do crying with joy, before passing you along again with dizzying speeds and heights. The ground below rushes towards and away from you in rapid succession. After five times, they squabble and two of them nearly pull you apart between them. It is then however, that a third gets an idea. Using the fact that your body is suspended between two others pretty stably, she flies into you and latches on by crossing her legs and arms around your hips and waist. There, high up in the sky and in intimate embrace, the other two harpies still quarreling, she smiles at you while straddling you. In an unknown language in whistles and chirps, she assures you it's going to be alright and reaches underneath her to fondle your cock. With the warmth of her body so near to yours and now armed with wings of your own now in the form of the harpy in top of you, it works. Held between three digits, your " + cockDescript(x) + " assumes its erect shape. It makes the latched harpy give a pleased warble, and with a quick slip, pushes her womanhood against it until you sink into her.\n\n", false);

				outputText("The little slit is a bit dry, but her shaft is silky smooth and pliable. With no effort, she starts to hump you, running her arid canal across your " + cockDescript(x) + " and holds on tight. Within minutes, the efforts of the eager little lithe parachute latched on front your body makes you wheeze. Her entire body bucks and bends frantically on top of yours. Another harpy comes flying up, demands a turn of her own, but cannot find an opening. Instead, she chooses to fly underneath your chafing bodies and starts licking the embracing nethers enthusiastically. ", false);
				...
				outputText("You were just about to climax, when the harpies keeping you airborn decide they want their own turn. Spurned, they let go of you, sending you to plummet back to earth with one of the harpies still fucking on top of you. And this time, the other three don't seem bothered to save you anymore.\n\n", false);
...
//No genderless folks.
		private function harpyDamageLoss():void
		{
			...
			if (player.hasCock() && x >= 0) {
				...
				//[(Male/shemale)
				if (!player.hasVagina()) {
					outputText("The hierarchy is eventually settled, it seems, because two of those heavy-hipped bird babes wrapped their lips around your " + cockDescript(x) + ", sucking and pecking at the hot flesh", false);
					...
					outputText(". The third, estranged harpy leapt at your torso, straddling your navel with her weighty rear, knocking the breath out of you and leaning down, ", false);
					//(If breasts)
				...
				//[(Herm)
					...
					outputText("The hierarchy is settled between the warring bird-girls, and two of them grasped onto your thighs with their clawed hands, those gold-lipped mouths starting to hungrily suckle and taste every inch of your " + cockDescript(x) + ", their squawking, feathered heads occasionally diving down to probe their short, stubby tongues into your " + vaginaDescript(0) + ", sending sharp spikes of pleasure rippling through your body, ", false);
					//(If balls)
			...
			//[(Female) 
				...
				outputText("When the harpy's lips press against yours, your vision starts to swim. She kisses you ferally, fuelled by a primeval lust.  Her short, sharp tongue slaps yours all over your mouth, tickling and scratching across your lips. As you are forced into the crushing, vicious kiss, you notice that the pleasure shooting up and down your body seems somehow sharp, and your lust is began to swell and surge around your mind.  Everywhere their lips have brushed on you feels tingly and pleasurable... those golden lips... they must be drugged! Even as you realise this, it is too late, and your tense muscles collapse in the overwhelming feel of it, your libido burning hot even as your body feels so weary.\n\n", false);
			...
			if (x >= 0 && player.hasCock()) {
				...
				outputText("your " + multiCockDescriptLight() + " shakes and quiveres under the attentions of the merciless bird-girls, releasing a powerful blast of hot, sticky seed to coating the three cruel harpies.  They're still rubbing and probing their pussies with delicate fingers while you cum. You hear some angry squawking and a few syllables of recognizable language before you finally give in to unconsciousness, fading into a warm dream of soft, velvet thighs...\n\n", false);
			}
			...
			fatigue(20);
			cleanupAfterCombat();
			dynStats("str", -1, "tou", -1, "lib", 1, "sen", 2, "lus=", 0);
		}
...
//{New page}
		private function harpyScissorSurprisePtII():void
		{
			...
			outputText("\n\nHer thrashing finally sends you over the edge, your twat spasming uncontrollably and gushing all over hers, which responds in kind.[if (isHerm = true) \"  At the same time, your shaft quakes painfully, before finally realsing it's long pent-up load.  Your cum drenches the space between your bodies, soaking both of your bellies ans well as painting the underside of your breasts a soft, sticky white.\"]  You release her tit, instead pushing your head between her cleavage and crying out as your bodies shake with the force of your violent orgasms.[if (isHerm = true)   Another spurt of cum shoots out of you, accidentally giving you a surprise facial.]  The feeling of your cunts quivering against one another is incredible, it feels as though every nerve ending in your sex is alight and hyper-sensitive.  Your clit stays in contact with hers as you both come, quivering against one another and sending you both into a second orgasm.  The harpy is squealing at this point, her arms still limp above her head, but her face is contorted as she rides out what must be one of the most powerful orgasms she's ever had.  You piston her into you as you finish peaking, trying desperately you can to prolong the pleasure for as long as possible.  Each time her pussy connects with yours, another jolt of ecstasy shoots through you, but it diminishes with every hit.  The harpy cries out weakly with each thrust, her body simply too sensitive to withstand such treatment.");
		...
		private function spoidahsLegEggsInHarpeis():void
		{
			...
			outputText("\n\nAnd you calmly, smoothly remind her that she still hasn't let you know what it is she wants.");
			...
			outputText("\n\nAnd smiling all the while, you slide your stiffening rod into her sopping cunt, piercing all the way to her core, your easy thrust pushing her face up against the stone.");
...
//Fuck a harpy with the players throbbing clit.
		private function clitFuckAHarpy():void
		{
			...
			else outputText("moan struggle to rise, jiggling in the cutest way each time she slumps down, defeated.");
