...
public class NekobakeInn extends BaseContent implements TimeAwareInterface {
	...
	private function dinner():void {
		...
		outputText("\"<i>"+player.mf("Sir","Miss")+", your meal is ready.\"[pg]");
		outputText("You had almost forgotten about it but they indeed brought a platter filled with various delicious foods. \"Call for us at any time you want something, anything.\" Without further ado, you dig in. Each bite is like a dream, you missed such enjoyment so much. Your pawed hands claw at an egg roll mixing it with the sweet sauce and the smell of the combination has your whiskers shaking in excitement. " +
				"The rice and fish are exquisite too. Your tail calmly reflects your contentment as you purr in bliss. This said after such a good meal you sense a familiar warmth build up in your loin, your ");
	...
	private function bath():void {
		...
		outputText("\"<i>Please use the door to your left for the hotspring "+player.mf("mister", "miss")+". You will have the location to yourself for a while, call for us at any time you want something, anything.\"[pg]");
		...
		outputText("You get half way out of the water revealing your lean, still dripping and warm body to check on your things, every item is there, no theft happened while you were bathing. Your furry cat ears twitch in an attempt to pick up any suspicious noise as your eyes focus looking for would be intruder maybe a peeping tom looking to get a glance of your still glistening [if (hasbreasts)\"[breasts]\"|\"D cup breast\"] or your heart shaped ass. " +
				"Your furry tail bobs from one side to another in anger and your claws slide out of your furry paw ready to tear some idiots to shred yet as you fail to find any sign of a peeper you sigh in relief and resume bathing. A few minutes later, you crawl out trying to refresh yourself only to find out you can't. You're warmer than an oven right now and your cunt is practically juicing itself with need. Your[pg]");

		while (player.hasCock()) player.killCocks(0, false);
	...
	private function male2():void {
		...
		outputText("As if on cue, a catgirl with two tails, already naked, steps into the room. Your whiskers twitch in excitement as your nose catches the scent of a female in heat. If memory serves, she was part of the entryway cast. Something feels wrong, but you brush it from the side of the paw, you have a pair of hitch to soothe, yours and hers. " +
				"The catgirl purrs as she does a mock fall into your arms, briefly reaching back to hold onto your face as both of her tails tenderly stroke your side before she bends forward, getting down on all-fours to give you better access to her already dripping cunt.[pg]");
		...
		outputText("The heat deep down within you continues building, the onslaught of your climax reaching nearer. Without any hesitation, you hilt every last inch into her as you empty your balls into the slut, flooding her thirsty canal with your feline seed until your balls can't offer anything else. [if (cumextreme) \"The poor kitten is left mewling helplessly as her stomach inflates from the sheer volume of seed you're pouring into her. It's not long until she's left gasping, barely hanging on for dear life.\"] " +
				"That said, this is hardly enough to satisfy your need alone and perhaps your partner heard your thought before by the time you're finished she simply begs, \"<i>Please do me again.</i>\" and you are most happy to oblige.");
	...
	private function female2(fromSpring:Boolean = false):void {
		...
		outputText("He eases himself into you as you eagerly clutch onto his rod with your inner walls, desperate for more of your hunky lover's presence. You need to feel him... you need every inch of his flesh... you want to be with him more than anything else at this moment.[pg]");
	...
	private function exitCafe():void {
		...
		if (!Tail.hasFelineTail(player.tailType))
