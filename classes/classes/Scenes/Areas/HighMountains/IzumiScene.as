	...
	public class IzumiScene extends BaseContent
	{
		...
		public function touchThatFluffyHorn():void
		{
			...
			if (player.hasCock())
			{
				...
				addButton(3, "RevengeAnal", revengeAnal);
				addButton(4, "RevengeOral", revengeOral);
		...
		protected function letGoAndFuck():void
		{
			...
			outputText("“Well?  Come on already,”  She says, smirking lasciviously.  “You wanted to do me, right? Well then, you’d better hurry up and get started before I get embarrassed...”\n\n");
		...
		protected function sayThatsAPrettyFaceBeAShameIfSomebodyJizzedAllOverIt():void
		{
			...
			outputText("You direct her to kneel down with a growl.  Izumi opens her mouth to argue, then thinks better of it.  “<i>Okay! Okay, look, I’m cooperating.  Ha ha, you sure showed me, boy is my face re-Oh.</i>” She stops, eyes widening a little as you use your free hand to pull out [eachCock], stroking it towards hardness mere inches from her face.  She stares, mesmerized, as your hand rolls up and down your stiffening erection right in front of her.  \n\n");
			...
			if (player.cocks[cockIndex].cockType == CockTypesEnum.EQUINE) outputText("  Visibly unsure of where to put herself, Izumi finally settles for brushing her lips against the exact center of the flared mass that makes up the head of your stallion-prick.");
			...
			outputText("From this angle, you have a much better line of approach to Izumi’s throat, giving you a far deeper maximum thrust - something you happily take advantage of almost immediately in order to fuck Izumi’s mouth in earnest.  [if(player.balls > 0)As an amusing added bonus to your new angle, Izumi’s face actually provides a comfortable little platform for you to rest your [balls] on. You can’t help but smile when she lets out an aggravated little growl as your balls come to rest on her face for the first time, the warm air rushing in and out of her nose as she tries - and fails - not to breathe <i>too</i> deeply, providing a surprisingly pleasant sensation.]\n\n");
			...
			outputText("The sight of the bullish Oni girl reduced to mindlessly humping the air with your cock still buried deep inside her hot, clinging throat is just too much for you, though.  You feel the familiar sense of your orgasm rising and decide to make the most of it, returning your attention to Izumi’s throat and hammering into her with powerful strokes.  You manage to hit with one, two, three juddering impacts before your orgasm finally arrives, with gusto, and you bury yourself in the surprised Oni’s face, spraying your cum down her throat.  [if(player.cumQ > 500) Her surprise only deepens when you simply keep cumming, your prolonged orgasm flooding her mouth faster than she can swallow, forcing her cheeks to bulge out and tiny rivulets of cum to occasionally slip free of the tight seal her lips have formed around your cock.]\n\n");
		...
		protected function tribThatRockyHornGirl():void
		{
			...
			outputText("“<i>I’m taking this,</i>” You announce cheerfully, hefting a small bag of gems in one hand.\n\n");

			outputText("“<i>‘Kay.</i>” Izumi’s approval doesn’t matter to you either way, but your smile widens at her submissive, exhausted tone.  By the time you get back to camp, you’re almost feeling good enough to whistle.\n\n");
