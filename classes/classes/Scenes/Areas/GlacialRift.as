	...
	public class GlacialRift extends BaseContent
	{
		...
		private function FenrirRuinedShrine():void {
			...
			if (flags[kFLAGS.FENRIR_COLLAR] == 1) {
				...
				outputText("As you explore the frigid wasteland at the foot of the icy mountains, you realize that for the last few minutes your steps have been guided by something; not a smell of the kind you've found so vibrantly part of your new lupine awareness, but some sort of call that reaches similarly into you and pulls you onward with the weight of destiny, or doom. You attempt to redirect yourself several times, but somehow the minute your mind wanders again from conscious resisntance you find yourself facing the same way again, and after a time you give up, submitting yourself to the mysterious attraction and whatever awaits you at its source.\n\n");
				outputText("Cresting a small hill, the ice beneath you suddenly cracks, and you tumble down a steep slope; fortunately you come to rest without harm, and when you regain your footing you find yourself at the bottom of a small well in the ice. The air here is clear, cold, and still; you can see the perpetual ice-storm blowing dozens of feet above your head, obscuring your view of the sky and the mountains, but straight ahead you can see clear to the other side of the depression, hundreds of feet. There, standing from the frozen ground in ghastly relief you can see a ruined building. In fact, you can see little else; your eyes are drawn magnetically to it and before you even gather your thoughts you are standing nearly at the threshold, your feet having carried you there on their own. It is a building of gray stone, with cruel, brutal lines, askif the twisted peak of an unclimbable mountain were snapped off by a malevolent giant and placed here in the realm of the earthbound as a mockery, or a warning. A yawning archway, symmetrical and carved with an unfamiliar, harshly angular script opens into darkness, and you step inside.\n\n");
