...
    outputText("Looking down, you see a scale covered slit at her crotch. Bringing a hand down to it, you stroke it gently and feel the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(" twitch beneath you. You slowly open the slit to reveal the moist folds of her pussy. You start to tease her by stroking her netherlips, the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(" moaning in response. You gradually slide your fingers in, moving them inside of her to see just how far her lips can spread. The ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(" continues to pant and moan under your touch, her tail thrashing in the sand.\n\n", false);
    outputText("You decide that you've played with her enough and withdraw your hand, now wet with her juices, from her pussy. A hiss escapes the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	outputText("Soon you feel yourself hit a wall as your body hits the opening of the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText("'s cervix. A stray thought crosses your mind as you think that maybe this is far enough, ", false);
	//(if corrupt)
	...
	outputText("You grab the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText("'s shoulders and thrust yourself down, HARD. The ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(" screams as you push past her cervix and fill her womb with your gooey form. Her entire body writhes as you push more of yourself into her womb, her stomach starting to bulge out at the sheer amount filling her. The screams of the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(" intensify as you push more and more of yourself into her, her stomach swelling enough to look pregnant. You finally stop pushing into her, almost your entire lower half inside of the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(".\n\n", false);
    
	outputText("You pause for a moment, enjoying the sensation of filling someone up with your body, surprised at just how good it feels. Grabbing the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText("'s hips you slowly push yourself in and out of her now full pussy, ", false);
	//(if male)
	if(player.totalCocks() > 0) {
		if(player.cockTotal() == 1) outputText("your " + cockDescript(0), false);
		else outputText("one of your " + multiCockDescriptLight(), false);
		outputText(" hitting the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s pleasure buzzer with each downward thrust.", false);
	} 
	//(if female)
	else if(player.gender == 2) {
		outputText("your clit rubbing against the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s pleasure buzzer with each downward thrust.", false);
	} 
	//(if herm) 
		...
		outputText(" and clit rubbing against the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s pleasure buzzer with each downward thrust.", false);
	}
	//(if genderless)
		...
		outputText("your bare crotch hitting the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s pleasure buzzer with each downward thrust.", false);
	}
	
    outputText("\n\nYou continue to relentlessly push yourself into the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(", stretching her wide.  ", false);
	//(if male)
	if(player.gender == 1) {
		outputText("You let out a yell as ", false);
		//(normal) 
		if (player.cumQ() < 250) {
		outputText("you come all over the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s stomach.", false);
		}
		else if (player.cumQ() < 1000) {
		outputText("you come all over the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s face and stomach.", false);
		}
		//(if THE LEVEYS HAVE BROKE RUN FOR THE HILLS) 
		else {
		outputText("you come violently, covering the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" in a layer of your sperm.", false);
		}
	}
	//(if female)
	else if(player.gender == 2) {
		...
		if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_SLAVERING) {
			outputText(", your girlcum gushing out and pooling on the stomach of the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("", false);
		}
	...
	if(player.gender == 3) {
		...
		if(player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) outputText("leaking out", false);
			...
			outputText("gushing out to form a pool on the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s stomach", false);
		}
		...
		//(lots of jizz)
			...
			outputText(" completely covering the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" in a layer of your spooge.", false);
		}
	}
	//(if genderless)
	if(player.gender == 0) {
		outputText("You cry out and shudder as you feel wave after wave of the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s orgasm rushing over your body, bringing you to a strange orgasmic bliss of your own.", false);
	} 
	outputText("  For a moment you just sit there in post orgasmic bliss, the walls of the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(" convulsing around your gooey half. You decide that the snake woman has had enough and slowly withdraw yourself from her abused love canal. You gather up your things and head back to your camp, leaving the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(" lying in the sands.", false);
	cleanupAfterCombat();
}
...
private function nagaVictoryMale():void {
	...
	if(player.totalCocks() > 0) {
		...
		//Uncorrupted  
			...
			//[If cock too large]
				...
				outputText("You draw away from her lips and return to your upright posture. Relaxed as she is, the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText(" looks nervously at your " + cockDescript(0) + ", fully aware that it won't fit inside her small body. This occurs to you as well, and you begin to formulate a different plan. You move up onto her body so that you're straddling her stomach, fitting your " + cockDescript(0) + " neatly between her ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("small C", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("modest D", false);
				outputText("-cup breasts. You gently coax her hands to her breasts, and she begins to comprehend your intentions. She begins to squeeze your " + cockDescript(0) + " between her two warm mounds of flesh, doing her best to keep it snugly between them. Of her own accord, the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText(" begins to run her tongue across the " + player.cockHead() + ", obviously understanding what you want. She looks up at you with an unsure look, as if asking whether or not she is doing it right. You nod to her, and that's all the encouragement she needs. She begins to stroke your " + cockDescript(0) + " with her breasts as if it came naturally to her, covering as much of your " + player.cockHead() + " as she can with her warm and trembling mouth.\n\n", false);
				outputText("You lean back and sigh with pleasure as the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				...
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText(" removes your " + cockDescript(0) + " from her mouth", false);
				//[lots of cum OR more]
			...
			outputText("\n\nYou slowly untangle yourself from the panting ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	     	}
			...
			if (player.cumQ() > 250) {
				outputText("  Your spooge explodes from the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText("'s abused cunt, flooding the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach", false);
			...
			outputText("When you awaken, the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" is long gone. All that remains of your encounter is a depression in the landscape", false);
			//[lots of jizz] 
			...
			outputText(".\n\n", false);
			outputText("As you retrieve your clothes, you notice red marks around your chest and arms. It seems that while the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" did have the opportunity to kill you while you were unconscious, she preferred to keep you alive.\n\n", false);
		}
	}
	outputText("You think it would be a very good idea to come to the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach", false);
	outputText(" more often.", false);
	player.orgasm();
	cleanupAfterCombat();
	return;
}
...
   			//(Loss by Lust)
			if(monster.lust >= monster.eMaxLust()) {
				...
				outputText("She begins to gently toy with your " + clitDescript() + " using the very end of her tail, flicking it back and forth. You can't help but start moaning softly yourself. You respond by slowly teasing two of your fingers inside her waiting pussy, slowly beginning to move them in and out. As you begin to accelerate the motion of your fingers, the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText(" steps it up as well, sliding the tip of her tail inside your " + vaginaDescript(0) + ".  ", false);
				player.cuntChange(20,true,false,true);
				outputText("You and the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText(" remain entwined like this for what seems like hours; your fingers buried inside her pussy, her tail buried inside yours", false);
				//(If PC is Herm i.e. Has a cock(s)){
		...
		//a) Uncorrupted
		if(player.cor < 50) {
			outputText("The lust within you builds as you view the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" lying slumped on the ground in front of you, her coils twitching and tailtip marking the sand. Stepping forward, you gather her human half into your arms and she moans weakly as your breasts rub against hers. Smiling, you languidly lick her neck, her skin smooth and dry beneath your tongue.  Reaching down, you grab the end of her tail and bring it to your dripping pussy, rubbing it back and forth across your entrance.  Reviving under your caresses, the beautiful snake-lady rises, slowly circling you, winding herself around you again and again as you continue to use her tailtip to stimulate yourself. She comes to a stop, her coils now loosely around half your body, as she once again faces you, her tail twitching hungrily in your grasp.  You lean forward to kiss her, caught up in the moment, not caring of her fangs, as her tail twitches out of your grasp and suddenly spears upwards; you gasp and moan in pleasure as it dives into your moist pussy.  ", false);
			player.cuntChange(20,true,false,true);
			outputText("Once again grinding your body against hers, your stiff nipples rub against one another, eliciting more moans from the both of you.  Her coils tighten slowly, squeezing your body in a tight hug as her tail thrashes wildly inside you, driving you closer and closer to your limit.  With a scream of ecstasy, you climax, your juices spurting out and coating her tail, your arms squeeze her tightly as you continue to cum.  The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" slowly unwinds herself, smiling somewhat shyly at you as you stand there, panting, before slithering off into the sands, your moisture on her scales quickly drying in the arid ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach", false);
			outputText(" heat.\n\n", false);
		}
		//b) Corrupted
			...
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(", you cannot help but feel turned on by it. You step forward, grabbing the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" by the shoulders and forcing her down against the sand, face up. Then, pinning her arms under your knees, you straddle her chest, crushing her modest breasts against her constricted ribcage. You can already see the panic in her face as you " + (player.armorDescript() != "gear" ? "begin to unfasten the lower part of your " + player.armorDescript() : "present your naked body to the snake-woman.") + ". Once your dripping-wet pussy is exposed to the dry ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach", false);
			outputText(" air, you pull up the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s head by her hair and pull it close to your hot snatch. \"<i>C'mon, you horny little snake-tailed slut, what are you waiting for?</i>\" The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" remains frozen in a panic, not sure what to do. As encouragement you tug at her hair, pulling her head even closer to your " + vaginaDescript(0) + ". \"<i>I said LICK IT!</i>\" you shout, rubbing your " + vaginaDescript(0) + " into her face. Finally, the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" gets the message and her thin tongue darts from her mouth, making contact with your hot flesh. You shudder with excitement as the slick surface brushes past your " + clitDescript() + " and along your slit. As one hand manages the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s head, you move your other hand to your breasts, beginning to squeeze and massage them with reckless abandon. As the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			...
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s tongue tickles your insides, your girlcum splashing all over her face and dripping down into the dry sand below. As your climax slowly fades, you finally get up off the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(", which is met by a large gasp of relief. However, you are not done yet. You weren't going to suffocate your new fucktoy, now were you? After recovering from your first of hopefully many orgasms, you move back overtop the girl, this time straddling her face and facing the opposite direction. Your dripping snatch covers her face, situated directly above her mouth. The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			...
			outputText("It doesn't take much; soon your hips are bucking, bashing into the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s face, your " + vaginaDescript(0) + " coating her face with your love juice. Your mission accomplished, you decide to wrap things up. As soon as you recover, you grab the poor ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s tail, and begin shoving it roughly into the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s pussy. She wails in protest with each violent thrust, but at this point she is too weak to resist. You push inch after inch inside her, until you meet a sort of wall, what you can only assume is her cervix.", false);
			//(If str > 50)
			if(player.str > 50) {
				outputText("  You begin to push harder, trying to force your way through into her womb.  With a sudden surge forwards which prompts another loud wail from the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText(", you finally enter her womb. However, you do not stop. You begin to push even more of her tail inside her, forcing so much in that it begins to cause her stomach to distend. Finally, after several feet of tail have disappeared inside her, you ease off. The ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText(" is lying in the sand, bawling her eyes out at the immense discomfort of such an act.", false);
				//(If high corr)
...
private function nagaVictoryGenderless():void {
	...
	if(player.isTaur()) {
		...
		outputText("A hiss of pleasure escapes from the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s mouth as she brings her hands onto your head and grips you tightly. The lower portion of her tail wraps gently around you and she brings the tip of her tail up to your mouth. You shift your attention from her netherlips to start sucking on the tip of it, twirling your tongue around it sensually. After a moment, the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" takes her tongue out of your mouth and slides the now lubricated tail gently into your backside. You let out a slight gasp, but it is cut short as the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" brings your head back down to her pussy. You start licking again as the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		...
		outputText("The tail of the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" slides out of you as she lies back in the sand of the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach", false);
	...
	//a)Uncorrupted
		...
		outputText("You look down at the collapsed ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(", feeling the blood pounding hotly through your veins. You stand above her fallen form and start to take off your pants when you remember that you have nothing down there. A soft curse escapes your lips; this will make things much more difficult, but there WILL be sex one way or another.\n\n", false);
		outputText("You straddle the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(", placing your bare, featureless crotch against the slit of her vagina. Slowly you rock your hips back and forth against her, drawing out a gasp of pleasure from her. Leaning over her you start to massage her breasts.\n\n", false);
        outputText("The ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s pussy starts to grow slick with her juices as you speed up your rocking. Her tail starts to curl around you, slowly inserting it into your ass as you continue to rock against her. You speed up your grinding, going faster and faster until a scream of pleasure erupts from the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" as she bucks her hips in orgasm.\n\n", false);
        outputText("You stand up over her, your crotch now wet from her girl cum. You pick up your things and put your clothes back on, leaving the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
...
        //(If player has no fangs)
		if(player.faceType != FACE_SNAKE_FANGS) {
			outputText("You feel her start to thrust her hips into your face to try to gain more pleasure, but you won't be having ANY of that. You quickly take your tongue out of her and move your way up to her breasts, groping at them and biting at her nipples. The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	        outputText("The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" quickly slithers out from under you with an angry hiss, a hand pressed to her now bleeding breast. You chuckle at this and the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
...
       	{
			...
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" on the sand, your fist soaked in ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
...
public function nagaFUCKSJOOOOOO():void {
	...
	if((player.findPerk(PerkLib.BimboBrains) >= 0 || player.findPerk(PerkLib.FutaFaculties) >= 0) && player.hasVagina()) {
		...
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" then lies flat on the sandy ground, pulling you down with her. She lays you down on her body, face up, with your head resting on her soft breasts. She reaches around your body, placing her soft hands on your own " + player.allBreastsDescript() + ", gently holding you in place as her tail moves closer to your " + vaginaDescript(0) + ". Her now slick tail begins to rub against your clit and as the scaly skin runs along your " + clitDescript() + ", you begin to moan air-headedly. There is no holding it back, this feeling is one of the best you have experienced. Her tail continues to flick and rub your clit as you begin to buck your hips gently. The ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" pokes and rubs at your hard clit for some time, eventually driving you to the first of many coming orgasms. After your breath has become even again and your muscles have relaxed, the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		...
		outputText("  The scaly skin rubs at your soft vaginal walls like nothing else you have experienced, and the feeling begins to drive you mad with pleasure. It only takes a few minutes of this gentle tail-fucking to drive you to another climax. This time, however, the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		...
		outputText("As the tip of her tail finally comes to rest against your cervix, you find yourself succumbing to another orgasm, your slutty wails of pleasure encouraging the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" to continue. As you begin to calm down again, you believe that this is the deepest the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" will go, although your brain works really hard and comes up with a desire for MORE depth...", false);
		//PROPER stretched.
		player.cuntChange((player.vaginalCapacity() + 5),true,true,false);
		outputText("\n\n", false);
		
		outputText("Then, like, your wish totally comes true! The ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	//too)
		...
		outputText("You hear the hiss of the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s laughter as she slithers over to your prone form. Her long tail twists around you and tightens suddenly, pinning your arms to your sides", false);
		//(if centaur)
		if(player.isTaur()) 
		{ 
		...
		outputText("\n\n", false);
		outputText("You close your eyes and ready yourself to meet your fate. Instead, you feel the hand of the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" at your crotch, sliding your " + player.armorName + " down to give her better access to your " + cockDescript(0) + ". A gasp of surprise escapes you as the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" grabs ahold of your " + cockDescript(0) + " and starts to stroke it, licking at the " + player.cockHead() + " with her serpentine tongue. You moan as she quickens her pace, causing a wave of heat to rise through your shaft.\n\n", false);
     
		//(Cock fits)
		if(player.cockArea(0) <= monster.vaginalCapacity()) {
			outputText("She stops suddenly and you look at her, a pleading look in your eyes despite yourself. The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
...
    		outputText("You feel the hands of the snake woman firmly grab your shoulders and watch as she pulls away from you, shouting with pleasure as she thrusts herself down on the full length of your shaft. Unable to move or do anything to help her, you watch helplessly as she manipulates your body, her slick netherlips completely enveloping your " + cockDescript(0) + ".  Again and again she thrusts her hips onto your " + cockDescript(0) + ", her pussy squeezing you almost as tightly as her tail. She continues to impale herself on your " + cockDescript(0) + ", her thrusts becoming more intense by the moment. Finally she gives one last squeeze and tilts her head back with a yell. Unable to hold back, her tight walls begin to convulse, squeezing your " + cockDescript(0) + " tighter than ever before. You can feel a pressure welling up inside as her soaking pussy attempts to milk your " + cockDescript(0) + " of its tasty seed. You try to hold back, but it's no use. As she continues to pump at your " + cockDescript(0) + ", a torrent of warm, sticky cum ", false);
		...
		//(Cock too big)
			...
			outputText("As her tongue continues to slide across the " + player.cockHead() + " of your " + cockDescript(0) + ", her slender tongue wanders ever so closely to the center. You feel a strange sensation as her tongue wanders inside the hole at the tip of your " + cockDescript(0) + ", just barely tickling the inside. You try to pull away, but her tail binds you too tightly to move much. The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" notices your reaction and begins to exploit it as much as she can. She begins to force the rest of her tongue inside of your urethra, her forked tip tickling you from the inside as she pushes deeper. The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(", now that her tongue is completely buried inside your " + cockDescript(0) + ", turns her attentions to the actual shaft, attempting to sandwich it between her modest ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("C", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("D", false);
			outputText("-cup breasts. She begins to stroke them up and down along your " + cockDescript(0) + ", sucking at the " + player.cockHead() + " and tickling your urethra at the same time.\n\n", false);
			outputText("As violated as you are at the moment, you cannot deny the wonderful sensation the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" is creating, and after only a short time of being subjected to this bizarre act do you feel that familiar pressure building up inside your groin. It is only moments before your sticky seed begins to flow forth into her mouth. ", false);
			//OH SHIT MOAR CUM
			//(Normal)
			if (player.cumQ() < 250) {
				outputText("The ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText(" manages to hold the warm cum within her mouth, only causing her cheeks to bulge a little.", false);
			}
			//(Lots of cum)
			else if (player.cumQ() < 1000) {
				outputText("The ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText("'s cheeks balloon as her mouth is filled with your hot, gooey sperm, forced to swallow some of it as her cheeks reach their full capacity.", false);
			}
			//(Cumception, we need to go deeper)
			else {
				outputText("Hot semen blasts from the ", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
				outputText("'s nose as her mouth is completely filled in seconds. Much of your warm cum is forced down her throat and into her stomach, causing it to distend slightly within her thin frame.", false);
			}
			outputText("  The ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
...
    		//(If you've been a bad boy during victory scenes)
	...
	//b) female //http://nekomimichan.org/mg/src/12844585127.jpg
		...
		outputText("Now astride the base of her tail and facing towards her, your eyes are drawn to the place on her scaly pelvis where a vagina should be. With one hand the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" begins gently caressing her nether regions, which begin to swell in her excitement into the outlines of a recognizable reptilian vulva. Her expectations are perfectly clear ", false);
		//(If defeated by lust) 
		if(player.lust >= player.maxLust()) 
		{
		...
		{
			outputText("and you're too weak to resist anyway; you might as well just comply. You attempt to remove your " + player.armorName + " before the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" grabs you in pity and decides to help you with it. Now naked,  she lays you down on her tail and you let her guide you to her awaiting pussy.", false);
		}
		...
		outputText("You continue your loving assault on her love canal as the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s moans gradually become louder. Her hands make their way to your head and she curls her fingers through your " + hairDescript() + " to get a better grip on your head as you bring your mouth up to her pleasure buzzer. You give one final, slow lick up the length of her pussy and twirl your tongue around her now engorged clit. The ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" involuntarily bucks her hips into your face as you start to suck on her pleasure buzzer. As you continue to play with her clit, she begins to lose control, grinding her soaking pussy against your face, and vice-versa. She forces herself onto you so hard, it becomes hard to breathe, and the warm juices of her excited love-slit coat your face. ", false);
...
   		
		...
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" manages to calm herself, her breathing becoming regular and her muscles loosening up, she smiles a genuine grin and hisses something to you. She leans in close, her head only inches from yours and suddenly shifts her tone, adopting a much more seductive one. She pulls you into an upright position, facing her. Your wet pussy rubs against her tail's scaly skin as she moves her own body closer to yours. She wraps the end of her tail around, so that it stands erect between the two of you. The ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		...
		//(If you are a good girl)
			...
			outputText("You do your best to follow the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s example, but you are not sure why she is doing it.  ", false);
		} 
		outputText("Eventually, it appears that the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" is satisfied, and she stops, nudging you to do so as well.\n\n", false);
		
		outputText("Then the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		...
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" pokes and rubs at your " + clitDescript() + " for some time, eventually driving you to the first of many coming orgasms. After your breath has become even again and your muscles have become relaxed, the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		...
		outputText("As the tail begins to penetrate you, you cannot help but let out another passionate moan. The scaly skin rubs at your tender vaginal walls like nothing else you have experienced, and the feeling begins to drive you mad with pleasure. It only takes a few minutes of this gentle tail-fucking to drive you to another climax. This time, however, the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" doesn't wait for your recovery. Instead, she responds by plunging deeper, forcing her ever-thickening tail further into your " + vaginaDescript(0) + ". As she stuffs more and more of her scaly tail inside you, her hands begin to work on your " + biggestBreastSizeDescript() + ", gently caressing and massaging them.", false);
		//(If fuckable nipples)
		if(player.hasFuckableNipples()) {
			outputText("  As her hands rub across your " + biggestBreastSizeDescript() + ", the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
...
    	//(If pregnant)
		if(player.pregnancyIncubation > 0) {
			outputText("  As you finally reach your next climax, the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			...
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" has done something. She pulls away from you and hisses something into your ear. The last thing you can make out is the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" giggling as she continues to play with your breasts before your vision clouds over and your head is filled with fuzzy feelings. You black out, now nothing more than a fuckdoll for the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" to explore. She has her fun with your limp body, and eventually leaves you there, lying on the warm sand, your " + vaginaDescript(0) + " horribly abused by the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText("'s thick tail, and dripping with your own juices.", false);
			}
			...
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" is nowhere to be seen so you simply return to camp, still somewhat tired, but rather happy.", false);
			}
		}
		//(If not pregnant)
		else {
			outputText("  As the tip of her tail finally comes to rest against your cervix, you find yourself succumbing to another orgasm, your wails of pleasure encouraging the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
			outputText(" to continue. As you begin to calm down again, you believe that this is the deepest the ", false);
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
...
     	outputText("A grin stretches across the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("'s face as she slithers over to your collapsed form. She coils her tail tightly around your prone form, squeezing hard enough to make it difficult to breathe. She brings her hand down to the crotch of your " + player.armorName + " and a look of confusion crosses her face before she realizes that there is nothing down there.\n\n", false);
		outputText("After a moment of chuckling, the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" brings your face down to a scaly covering at her crotch and opens it to reveal her awaiting netherlips. ", false);
		...
		outputText("You start to work your tongue around her awaiting clit, the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" moaning at the pleasure. You continue your assault on her pleasure button as her pussy begins to glisten with moisture. You move your tongue to her soft netherlips, licking softly at the moisture that coats them, enjoying the moans of pleasure that erupt from the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(". The ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		...
		outputText("Her tail starts to squeeze you even tighter and you start having trouble breathing, causing you to pull your head back. The ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		...
		outputText("You bring your mouth back to her awaiting hole and redouble your efforts. You can feel that she is nearing her peak as you continue to lick at her pussy. With a final shudder the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" climaxes, squeezing you firmly against her, coating your chin and nose with her thick honey.  As the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" relaxes her grip you slide out from her loosened tail coils.  Exhausted, you lose consciousness, but when you awake, you grab your things and leave the moistened sands behind.", false);
	}
	player.orgasm();
	cleanupAfterCombat();
}
...
public function nagaRapeChoice():void {
	if (monster.HP < 1) {
		outputText("You've defeated the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText("!  ", false);
	}
		...
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
		outputText(" writhes in the sand, masturbating feverishly!  She's completely forgotten about fighting you.  ", false);
	}
	...
	if(player.lust < 33) {
		outputText("You aren't aroused enough to fuck her.", false);
		menu();
...
private function eggUpANagaSpiderLike():void {
	...
	outputText("\n\nJust below where her human skin fades into scales, you uncover the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	outputText("\n\nWith nothing around you but sand for miles, there isn't anything to anchor her to while you tend to the matter of your burgeoning spider half.  Instead, you shuffle your chitinous legs into the sand beneath the two of you before curling them in and up, effectively pinning yourself to the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	outputText("\n\nFinally, muscles deep in your spider half seize and clench, and you shove her back against the sand as you arch your own, saliva dripping from both your mouths.  Your eggs flood through your ovipositor, the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	if(player.gender > 0) {
		...
		outputText(" raining down on the prone ", false);
	...
	outputText("\n\nA while later, you awaken alone in the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach", false);
	outputText(" sand.  Getting your shaky legs under you and stifling a yawn, you head back to camp.  You should come to the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach", false);
...
private function beePositANagaPlease():void {
	...
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	outputText(" winces, giving you a look of extreme betrayal while your venom pours through her defenses unhindered.  You study her face while your stinger works its magic.  The furrows in her eyebrows slowly relax and the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	outputText("\n\nYou gently lower your insectoid abdomen until your egg-tube parts the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	outputText(" you relax against her, two bodies twined into one passionate shape.  The ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	outputText("\n\nPOP!  The first egg exits your tubular psuedo-wang with a gush of honey to lubricate its passage, and like magic, it wicks away into the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon", false);
	...
	if(player.hasVagina()) {
		...
		outputText(" clear femcum over the ", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("Naga", false);
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("Gorgon", false);
	...
	outputText("\n\nYou should definitely come to the ", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert", false);
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach", false);
	outputText(" more often.");
	player.dumpEggs();
