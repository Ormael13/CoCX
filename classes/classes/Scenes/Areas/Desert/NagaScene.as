	...
	if(player.cockTotal() > 0) {
		...
		//Uncorrupted  
			...
			//[If cock too large]
                ...
                outputText("-cup breasts. You gently coax her hands to her breasts, and she begins to comprehend your intentions. She begins to squeeze your [cock] between her two warm mounds of flesh, doing her best to keep it snugly between them. Of her own accord, the " + gorgonOrNaga);
...
public function nagaRapeChoice():void {
	...
	if (player.lust >= 33) {
		...
		if (player.pcCanUseUniqueSexScene()) addButton(13, "U. Sex Scenes", uniquuuesexscene.pcUniqueSexScenesChoiceMenu, 013).hint("Other non typical sex scenes.");
