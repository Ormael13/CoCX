	...
	if(player.lowerBody == LOWER_BODY_TYPE_NAGA) {
		...
		if(player.gender == 1 || (player.gender == 3 && rand(2) == 0)) {
			...
			//[Cock isn't too big]
				...
				outputText("The kiss continues and both of your bodies rub together sensually, your tails continuing to wrap around one another. There is a pulsing in your " + multiCockDescriptLight() + " as ");
				...
				//[player has one dick]
				if(player.totalCocks() == 1) outputText("Gently she starts to stroke the length of your " + cockDescript(0) + " with one hand while circling the tip with the other. ");
...
private function gooNagaRape():void {
	clearOutput();
	player.orgasm();
	outputText("You look over at the prone form of the ");
	...
	if(player.cor > 50) {
		//(if corrupt male)
		if(player.gender == 1) {
			outputText("your " + cockDescript(0) + " growing harder at the thought.");
		}
		//(if corrupt female)
...
    outputText("Looking down, you see a scale covered slit at her crotch. Bringing a hand down to it, you stroke it gently and feel the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText(" twitch beneath you. You slowly open the slit to reveal the moist folds of her pussy. You start to tease her by stroking her netherlips, the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText(" moaning in response. You gradually slide your fingers in, moving them inside of her to see just how far her lips can spread. The ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText(" continues to pant and moan under your touch, her tail thrashing in the sand.\n\n");
    outputText("You decide that you've played with her enough and withdraw your hand, now wet with her juices, from her pussy. A hiss escapes the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	outputText("Soon you feel yourself hit a wall as your body hits the opening of the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	outputText("You grab the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText("'s shoulders and thrust yourself down, HARD. The ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText(" screams as you push past her cervix and fill her womb with your gooey form. Her entire body writhes as you push more of yourself into her womb, her stomach starting to bulge out at the sheer amount filling her. The screams of the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText(" intensify as you push more and more of yourself into her, her stomach swelling enough to look pregnant. You finally stop pushing into her, almost your entire lower half inside of the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText(".\n\n");
    
	outputText("You pause for a moment, enjoying the sensation of filling someone up with your body, surprised at just how good it feels. Grabbing the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	//(if female)
		...
		outputText("your clit rubbing against the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText("'s pleasure buzzer with each downward thrust.");
	} 
	//(if herm) 
		...
		outputText(" and clit rubbing against the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText("'s pleasure buzzer with each downward thrust.");
	}
	//(if genderless)
		...
		outputText("your bare crotch hitting the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText("'s pleasure buzzer with each downward thrust.");
	}
	
    outputText("\n\nYou continue to relentlessly push yourself into the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	if(player.gender == 1) {
		...
		//(normal) 
		if (player.cumQ() < 250) {
		outputText("you come all over the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		outputText("you come violently, covering the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	if(player.gender == 3) {
		...
		if(player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) outputText("leaking out");
			...
			outputText("gushing out to form a pool on the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s stomach");
		}
		...
		//(lots of jizz)
			...
			outputText(" completely covering the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	//(if genderless)
	if(player.gender == 0) {
		outputText("You cry out and shudder as you feel wave after wave of the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText("'s orgasm rushing over your body, bringing you to a strange orgasmic bliss of your own.");
	} 
	outputText("  For a moment you just sit there in post orgasmic bliss, the walls of the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText(" convulsing around your gooey half. You decide that the snake woman has had enough and slowly withdraw yourself from her abused love canal. You gather up your things and head back to your camp, leaving the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
private function nagaVictoryMale():void {
	...
	if(player.totalCocks() > 0) {
		...
		//Uncorrupted  
			...
			if(player.cockArea(0) <= monster.vaginalCapacity()) {
				...
				//[Spermageddon]
				else outputText("your " + cockDescript(0) + " erupting, blasting a violent torrent of semen deep inside her petite frame, filling her up completely as both your voices rise in screams of pleasure.");
			}
			//[If cock too large]
			else {
				outputText("You draw away from her lips and return to your upright posture. Relaxed as she is, the ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
				outputText(" looks nervously at your " + cockDescript(0) + ", fully aware that it won't fit inside her small body. This occurs to you as well, and you begin to formulate a different plan. You move up onto her body so that you're straddling her stomach, fitting your " + cockDescript(0) + " neatly between her ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("small C");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("modest D");
				outputText("-cup breasts. You gently coax her hands to her breasts, and she begins to comprehend your intentions. She begins to squeeze your " + cockDescript(0) + " between her two warm mounds of flesh, doing her best to keep it snugly between them. Of her own accord, the ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
				...
				outputText("You lean back and sigh with pleasure as the ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
				...
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
				outputText(" removes your " + cockDescript(0) + " from her mouth");
				//[lots of cum OR more]
			...
			outputText("\n\nYou slowly untangle yourself from the panting ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	     	}
			...
			if (player.cumQ() > 250) {
				outputText("  Your spooge explodes from the ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
				outputText("'s abused cunt, flooding the ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach");
			...
			outputText("When you awaken, the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			...
			outputText(".\n\n");
			outputText("As you retrieve your clothes, you notice red marks around your chest and arms. It seems that while the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" did have the opportunity to kill you while you were unconscious, she preferred to keep you alive.\n\n");
		}
	}
	outputText("You think it would be a very good idea to come to the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach");
...
   			//(Loss by Lust)
			if(monster.lust >= monster.eMaxLust()) {
				...
				if(player.gender == 3) outputText("  As her tail gently squeezes your body, it draws your own " + multiCockDescriptLight() + " up against your body, her soft underbelly stimulating the sensitive skin.");
				...
				outputText("She begins to gently toy with your " + clitDescript() + " using the very end of her tail, flicking it back and forth. You can't help but start moaning softly yourself. You respond by slowly teasing two of your fingers inside her waiting pussy, slowly beginning to move them in and out. As you begin to accelerate the motion of your fingers, the ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
				...
				//(If PC is Herm i.e. Has a cock(s)){
				if(player.gender == 3) outputText(" and your " + multiCockDescriptLight() + " constantly stimulated by the tail wrapped around your body");
		...
		//a) Uncorrupted
		if(player.cor < 50) {
			outputText("The lust within you builds as you view the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			...
			player.cuntChange(20,true,false,true);
			outputText("Once again grinding your body against hers, your stiff nipples rub against one another, eliciting more moans from the both of you.  Her coils tighten slowly, squeezing your body in a tight hug as her tail thrashes wildly inside you, driving you closer and closer to your limit.  With a scream of ecstasy, you climax, your juices spurting out and coating her tail, your arms squeeze her tightly as you continue to cum.  The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" slowly unwinds herself, smiling somewhat shyly at you as you stand there, panting, before slithering off into the sands, your moisture on her scales quickly drying in the arid ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach");
			outputText(" heat.\n\n");
		}
		//b) Corrupted
			...
			outputText("As you watch the writhing form of the defeated ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(", you cannot help but feel turned on by it. You step forward, grabbing the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" by the shoulders and forcing her down against the sand, face up. Then, pinning her arms under your knees, you straddle her chest, crushing her modest breasts against her constricted ribcage. You can already see the panic in her face as you " + (player.armorDescript() != "gear" ? "begin to unfasten the lower part of your " + player.armorDescript() : "present your naked body to the snake-woman.") + ". Once your dripping-wet pussy is exposed to the dry ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach");
			outputText(" air, you pull up the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s head by her hair and pull it close to your hot snatch. \"<i>C'mon, you horny little snake-tailed slut, what are you waiting for?</i>\" The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" remains frozen in a panic, not sure what to do. As encouragement you tug at her hair, pulling her head even closer to your " + vaginaDescript(0) + ". \"<i>I said LICK IT!</i>\" you shout, rubbing your " + vaginaDescript(0) + " into her face. Finally, the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" gets the message and her thin tongue darts from her mouth, making contact with your hot flesh. You shudder with excitement as the slick surface brushes past your " + clitDescript() + " and along your slit. As one hand manages the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s head, you move your other hand to your breasts, beginning to squeeze and massage them with reckless abandon. As the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			...
			outputText("Her face is beginning to turn red, and her breath is shortening by the second. Yet, you find all this very arousing. Instead of letting up, you force yourself onto her even more, pushing your " + vaginaDescript(0) + " up and grinding it against her face. You continue to moan and play with your breasts in the meantime, your climax drawing closer with every tongue stroke. The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s tongue eventually finds its way inside your " + vaginaDescript(0) + ", its forked tip tickling your soft walls as it advances forwards. All the while the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" is desperately sucking at your " + clitDescript() + ", in an attempt to satisfy you, and possibly save herself. Your eyes roll back in your head and you throw your head back as an orgasm finally takes your body. You yell with delight as the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s tongue tickles your insides, your girlcum splashing all over her face and dripping down into the dry sand below. As your climax slowly fades, you finally get up off the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(", which is met by a large gasp of relief. However, you are not done yet. You weren't going to suffocate your new fucktoy, now were you? After recovering from your first of hopefully many orgasms, you move back overtop the girl, this time straddling her face and facing the opposite direction. Your dripping snatch covers her face, situated directly above her mouth. The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			...
			outputText("As you kneel over her face, you realize that if you bend forward enough, the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s pussy is available to play with. After you manage to get the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			...
			outputText("It doesn't take much; soon your hips are bucking, bashing into the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s face, your " + vaginaDescript(0) + " coating her face with your love juice. Your mission accomplished, you decide to wrap things up. As soon as you recover, you grab the poor ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s tail, and begin shoving it roughly into the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			...
			//(If str > 50)
			if(player.str > 50) {
				outputText("  You begin to push harder, trying to force your way through into her womb.  With a sudden surge forwards which prompts another loud wail from the ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
				outputText(", you finally enter her womb. However, you do not stop. You begin to push even more of her tail inside her, forcing so much in that it begins to cause her stomach to distend. Finally, after several feet of tail have disappeared inside her, you ease off. The ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
private function nagaVictoryGenderless():void {
	...
	if(player.isTaur()) {
		...
		outputText("A hiss of pleasure escapes from the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText("'s mouth as she brings her hands onto your head and grips you tightly. The lower portion of her tail wraps gently around you and she brings the tip of her tail up to your mouth. You shift your attention from her netherlips to start sucking on the tip of it, twirling your tongue around it sensually. After a moment, the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" takes her tongue out of your mouth and slides the now lubricated tail gently into your backside. You let out a slight gasp, but it is cut short as the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" brings your head back down to her pussy. You start licking again as the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		outputText("The tail of the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" slides out of you as she lies back in the sand of the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach");
	...
	//a)Uncorrupted
		...
		outputText("You look down at the collapsed ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
        outputText("The ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText("'s pussy starts to grow slick with her juices as you speed up your rocking. Her tail starts to curl around you, slowly inserting it into your ass as you continue to rock against her. You speed up your grinding, going faster and faster until a scream of pleasure erupts from the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" as she bucks her hips in orgasm.\n\n");
        outputText("You stand up over her, your crotch now wet from her girl cum. You pick up your things and put your clothes back on, leaving the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
        outputText("You thrust yourself on top of her and roughly open the scaly covering at her crotch, revealing her awaiting pussy. You bring your mouth over her opening and thrust your tongue deep inside. A mix between a whimper and a moan escapes the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
        //(If player has no fangs)
		if(player.faceType != FACE_SNAKE_FANGS) {
			outputText("You feel her start to thrust her hips into your face to try to gain more pleasure, but you won't be having ANY of that. You quickly take your tongue out of her and move your way up to her breasts, groping at them and biting at her nipples. The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	        outputText("The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" quickly slithers out from under you with an angry hiss, a hand pressed to her now bleeding breast. You chuckle at this and the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
       	{
			...
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" on the sand, your fist soaked in ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
public function nagaFUCKSJOOOOOO():void {
	...
	if((player.findPerk(PerkLib.BimboBrains) >= 0 || player.findPerk(PerkLib.FutaFaculties) >= 0) && player.hasVagina()) {
		...
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" pokes and rubs at your hard clit for some time, eventually driving you to the first of many coming orgasms. After your breath has become even again and your muscles have relaxed, the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		outputText("  The scaly skin rubs at your soft vaginal walls like nothing else you have experienced, and the feeling begins to drive you mad with pleasure. It only takes a few minutes of this gentle tail-fucking to drive you to another climax. This time, however, the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		outputText("As the tip of her tail finally comes to rest against your cervix, you find yourself succumbing to another orgasm, your slutty wails of pleasure encouraging the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" to continue. As you begin to calm down again, you believe that this is the deepest the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		outputText("Then, like, your wish totally comes true! The ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	//too)
		...
		outputText("You hear the hiss of the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		//(if defeated by lust)
		if(player.lust >= player.maxLust()) outputText("all your resistance seems to do is make your " + cockDescript(0) + " harder.");
		//if defeated by KO)
		...
		if(player.cor > 75) outputText("  The thought somehow makes your " + cockDescript(0) + " throb even more.");
		outputText("\n\n");
		outputText("You close your eyes and ready yourself to meet your fate. Instead, you feel the hand of the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" at your crotch, sliding your " + player.armorName + " down to give her better access to your " + cockDescript(0) + ". A gasp of surprise escapes you as the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
     
		//(Cock fits)
		if(player.cockArea(0) <= monster.vaginalCapacity()) {
			outputText("She stops suddenly and you look at her, a pleading look in your eyes despite yourself. The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
    		outputText("You feel the hands of the snake woman firmly grab your shoulders and watch as she pulls away from you, shouting with pleasure as she thrusts herself down on the full length of your shaft. Unable to move or do anything to help her, you watch helplessly as she manipulates your body, her slick netherlips completely enveloping your " + cockDescript(0) + ".  Again and again she thrusts her hips onto your " + cockDescript(0) + ", her pussy squeezing you almost as tightly as her tail. She continues to impale herself on your " + cockDescript(0) + ", her thrusts becoming more intense by the moment. Finally she gives one last squeeze and tilts her head back with a yell. Unable to hold back, her tight walls begin to convulse, squeezing your " + cockDescript(0) + " tighter than ever before. You can feel a pressure welling up inside as her soaking pussy attempts to milk your " + cockDescript(0) + " of its tasty seed. You try to hold back, but it's no use. As she continues to pump at your " + cockDescript(0) + ", a torrent of warm, sticky cum ");
		...
		//(Cock too big)
			...
			outputText("As she continues to stroke your " + cockDescript(0) + ", her nimble fingers doing their best to wrap around your prodigious girth, she moves her head in closer to wrap her lips around the tip of your " + cockDescript(0) + ". She begins to gently suck at the head of your " + cockDescript(0) + ", her thin, reptilian tongue dancing across the slick surface. ");
			//(if PC has balls)
			if(player.balls > 0) {
				outputText("She shifts one of her hands down from your " + cockDescript(0) + ", to your " + ballsDescriptLight() + ", cupping them in her slick palm.  ");
			}
			outputText("As her tongue continues to slide across the " + player.cockHead() + " of your " + cockDescript(0) + ", her slender tongue wanders ever so closely to the center. You feel a strange sensation as her tongue wanders inside the hole at the tip of your " + cockDescript(0) + ", just barely tickling the inside. You try to pull away, but her tail binds you too tightly to move much. The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" notices your reaction and begins to exploit it as much as she can. She begins to force the rest of her tongue inside of your urethra, her forked tip tickling you from the inside as she pushes deeper. The ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(", now that her tongue is completely buried inside your " + cockDescript(0) + ", turns her attentions to the actual shaft, attempting to sandwich it between her modest ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("C");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("D");
			...
			outputText("As violated as you are at the moment, you cannot deny the wonderful sensation the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			...
			//(Cumception, we need to go deeper)
				...
				outputText("Hot semen blasts from the ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
    		//(If you've been a bad boy during victory scenes)
			if(player.hasStatusEffect(StatusEffects.MeanToNaga)) {
				outputText("As you gulp down a mouthful of your own seed, you notice something strange about it. The taste, there is something about it, it tastes almost like... POISON! You gag, but it's too late. The ");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
				if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	//b) female //http://nekomimichan.org/mg/src/12844585127.jpg
		...
		outputText("Now astride the base of her tail and facing towards her, your eyes are drawn to the place on her scaly pelvis where a vagina should be. With one hand the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		if(player.lust >= player.maxLust()) 
		{
			outputText("and you can feel the need to have sex with her burn inside you. You quickly strip yourself of your " + player.armorName + " and throw yourself on her awaiting pussy.");
		} 
		//(If defeated by KO)
		else 
		{
			outputText("and you're too weak to resist anyway; you might as well just comply. You attempt to remove your " + player.armorName + " before the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
   		
		...
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" manages to calm herself, her breathing becoming regular and her muscles loosening up, she smiles a genuine grin and hisses something to you. She leans in close, her head only inches from yours and suddenly shifts her tone, adopting a much more seductive one. She pulls you into an upright position, facing her. Your wet pussy rubs against her tail's scaly skin as she moves her own body closer to yours. She wraps the end of her tail around, so that it stands erect between the two of you. The ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		//(If you are a good girl)
			...
			outputText("You do your best to follow the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText("'s example, but you are not sure why she is doing it.  ");
		} 
		outputText("Eventually, it appears that the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" pokes and rubs at your " + clitDescript() + " for some time, eventually driving you to the first of many coming orgasms. After your breath has become even again and your muscles have become relaxed, the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		if(player.hasFuckableNipples()) {
			outputText("  As her hands rub across your " + biggestBreastSizeDescript() + ", the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		if(player.biggestLactation() > 1) { 
			outputText("  Your warm milk is leaking from your " + nippleDescript(0) + " the entire time, coating your " + player.skinDesc + " and soaking her hands. At one point, she withdraws a hand and licks the milk from it. You can only assume that she liked it, as she begins to focus even more on your breasts.");
		}
		outputText("\n\n");
...
    	//(If pregnant)
		if(player.pregnancyIncubation > 0) {
			outputText("  As you finally reach your next climax, the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			...
			if(player.hasStatusEffect(StatusEffects.MeanToNaga))
			{
				outputText("  Down this slippery rope, she drops only a few drops of her potent poison, which completely bypass your gag reflex and drop straight down your throat. You hardly notice, too busy bucking your hips against the massive tail buried within your " + vaginaDescript(0) + ". It's only as your vision fades that you realize that the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" has done something. She pulls away from you and hisses something into your ear. The last thing you can make out is the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" giggling as she continues to play with your breasts before your vision clouds over and your head is filled with fuzzy feelings. You black out, now nothing more than a fuckdoll for the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" to explore. She has her fun with your limp body, and eventually leaves you there, lying on the warm sand, your " + vaginaDescript(0) + " horribly abused by the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		//(If not pregnant)
			...
			outputText("  As the tip of her tail finally comes to rest against your cervix, you find yourself succumbing to another orgasm, your wails of pleasure encouraging the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
			outputText(" to continue. As you begin to calm down again, you believe that this is the deepest the ");
			if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
...
     	outputText("A grin stretches across the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		outputText("After a moment of chuckling, the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		outputText("You start to work your tongue around her awaiting clit, the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" moaning at the pleasure. You continue your assault on her pleasure button as her pussy begins to glisten with moisture. You move your tongue to her soft netherlips, licking softly at the moisture that coats them, enjoying the moans of pleasure that erupt from the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(". The ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		...
		outputText("Her tail starts to squeeze you even tighter and you start having trouble breathing, causing you to pull your head back. The ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		...
		outputText("You bring your mouth back to her awaiting hole and redouble your efforts. You can feel that she is nearing her peak as you continue to lick at her pussy. With a final shudder the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText(" climaxes, squeezing you firmly against her, coating your chin and nose with her thick honey.  As the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
...
public function nagaRapeChoice():void {
	if (monster.HP < 1) {
		outputText("You've defeated the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
		outputText("!  ");
	}
...
private function eggUpANagaSpiderLike():void {
	...
	outputText("\n\nJust below where her human skin fades into scales, you uncover the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	outputText("\n\nWith nothing around you but sand for miles, there isn't anything to anchor her to while you tend to the matter of your burgeoning spider half.  Instead, you shuffle your chitinous legs into the sand beneath the two of you before curling them in and up, effectively pinning yourself to the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	outputText("\n\nFinally, muscles deep in your spider half seize and clench, and you shove her back against the sand as you arch your own, saliva dripping from both your mouths.  Your eggs flood through your ovipositor, the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	if(player.gender > 0) {
		...
		outputText(" raining down on the prone ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	}
	...
	outputText("\n\nA while later, you awaken alone in the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach");
	outputText(" sand.  Getting your shaky legs under you and stifling a yawn, you head back to camp.  You should come to the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach");
	outputText(" more often.");
	player.dumpEggs();
...
private function beePositANagaPlease():void {
	...
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	outputText(" winces, giving you a look of extreme betrayal while your venom pours through her defenses unhindered.  You study her face while your stinger works its magic.  The furrows in her eyebrows slowly relax and the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	outputText("\n\nYou gently lower your insectoid abdomen until your egg-tube parts the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	outputText(" you relax against her, two bodies twined into one passionate shape.  The ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	outputText("\n\nPOP!  The first egg exits your tubular psuedo-wang with a gush of honey to lubricate its passage, and like magic, it wicks away into the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("naga");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("gorgon");
	...
	if(player.hasVagina()) {
		...
		outputText(" clear femcum over the ");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("Naga");
		if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("Gorgon");
	...
	outputText("\n\nYou should definitely come to the ");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 1) outputText("desert");
	if (flags[kFLAGS.NAGA_OR_GORGON] == 2) outputText("beach");
	outputText(" more often.");
	player.dumpEggs();
