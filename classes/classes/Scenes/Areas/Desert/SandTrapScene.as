...
public function sandtrapmentLoss(clear:Boolean = false):void {
	...
	if (sceneHunter.uniHerms) {
		sceneHunter.selectLossMenu([
				[0, "Dick", dickwieldersLoseToSandTarps, "Req. a cock.", player.hasCock()],
...
private function dickwieldersLoseToSandTarps():void {
	...
	if(player.analCapacity() < 40) outputText("  Although the oil that coats your thoughts and reflexes with sensual supplication makes things easier, the feeling is still incredibly intense, and you grit your teeth as something round travels down the creature's ovipositor and stretches your tight hole wide.");
...
private function genderlessLoss():void {
	...
	if(player.analCapacity() < 30) outputText("Although the oil that coats your thoughts and reflexes with sensual supplication makes things easier, the feeling is still incredibly intense, and you grit your teeth as something round travels down the creature's ovipositor and stretches your tight ass wide.");
...
private function useSandTarpsHands():void {
    ...
    //==================================================================================================
    function dickF():void {
		//find longest cocks, prepare for tags
        var x1:Array = [];
        ...
        case 1:
            ...
            break;
        case 2:
            outputText("  As the sandtrap begins to pump you faster, your disregarded [cock "+x1[1]+"] bobs in hard, eager concert with your [cock "+x1[0]+"].  You gasp as the trap slows down momentarily to grasp your second sex.  It is clumsy at first as it moves its lubricated palms in tandem, then with increasing confidence as it finds a position and rhythm that suits it, until it is jerking you off furiously, clutching your butt cheeks so tightly you hazily realize the indents of its slender digits will be with you for hours afterwards.");
            outputText("\n\nThe warm, oily double sensation is unbearably good and although you try to hold on to savor it as long as possible, it isn't long before you reach a toe-curling peak and, with a wordless bark, spurt out line after line of jizz.  The trap flinches slightly when your first cumshots hit it in the face and chest, but then goes back to gently rubbing you, guiding you up and down your warm, slippery orgasm.");
            break;
        case 3:
            outputText("\n\nAs the sandtrap begins to pump you faster, your two other, disregarded cocks bob in hard, eager concert with your [cock "+x1[0]+"].  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as  one of its hands clutching your ass releases and snakes back around to take hold of your [cock "+x1[2]+"].  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking all three of your cocks in rhythm.");
            if(player.hasBalls()) outputText("  It grins up at you shyly and, with its final hand, cups your [balls].  ]You laugh with an almost hysterical edge to the sky at how mindboggling getting a triple handjob feels, and the trap giggles slightly as well despite itself.");
    ...
    function hermF():void {
        ...
        case 4:
            ...
            break;
        default:
            outputText("\n\nAs the sandtrap begins to pump you faster, your many other, disregarded cocks begin to harden in eager concert with your [cock "+x1[0]+"].  You gasp as the trap slows down momentarily to reach both of its hands clutching your ass back around to take hold of your [cock "+x1[1]+"] and [cock "+x1[2]+"].  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking three of your cocks whilst fingering you in rhythm.  You laugh into the sky with an almost hysterical edge at how mindbogglingly good getting a quadruple handjob feels, and the trap giggles slightly as well despite itself.  Hazily you wonder if it is too much to wish that this creature, with its excellent wrist action, had just one or two more hands to its name.");
...
private function stickWangInSandgina():void {
    ...
    function scene(x:int):void {
        ...
        if(player.hasBalls()) outputText("balls ache and your ");
...
private function nagaThreesomeWithSandTrap():void {
	...
	function dickF():void {
		...
		//14 inches or more: 
			...
			if(player.hasBalls()) outputText("your [balls] swinging heavily in front of the sandtrap's nose, ");
		...
		outputText("  Mindlessly, the sandtrap's four arms clutch and stroke the warm scales that swaddle its upper body as the two of you continue to fuck it.");
