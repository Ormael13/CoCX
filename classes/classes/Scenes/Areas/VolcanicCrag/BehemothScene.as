...
public class BehemothScene extends BaseContent
	{
		...
		public function winAgainstBehemoth():void {
			...
			if (uniquuuesexscene.pcCanUseUniqueSexScenev2(true, null) > 0) addButton(13, "U.Sex Scenes", curry(uniquuuesexscene.pcCanUseUniqueSexScenev2, false, [winAgainstBehemoth])).hint("Other non-typical sex scenes.");
