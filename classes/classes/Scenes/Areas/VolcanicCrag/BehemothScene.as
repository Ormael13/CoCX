package classes.Scenes.Areas.VolcanicCrag 
{
	...
	public class BehemothScene extends BaseContent
	{
		...
		private function vagCatchBehemoth():void {
			...
			outputText("\n\nThe behemoth guides you to his bed and instructs you to lay on the bed, which you follows obediently. You spread your [legs] to expose your womanhood" + (player.hasCock() ? " and manhood": "") + ". The behemoth gives you a smile and slowly slides his cock into your [vagina].");
			...
			outputText("\n\nThe behemoth starts to piston inside and out of your [vagina] and picks up the pace gradually. ");
			...
			outputText("\n\nHis cock feels great in your [vagina]! You continue to moan and groan in pleasure as the behemoth continues to pound away with abandon. Your eyes widen as the behemoth announces, \"<i>Got to cum!</i>\" and unleashes his full torrents of cum right into your womb. By Marae, how much is he cumming? You're already stuffed with your belly bulging forwards and all the excessive cum spills out of your [pussy]. ");
			if (player.hasCock()) outputText("Your [cock] shoots ropes of jism at the behemoth.");
			outputText("\n\nSpent, the behemoth lays next to you and says, \"<i>I love you, " + player.mf("dude", "chick") + ".</i>\" You smile at him and fall into a nice nap.");
			outputText("\n\n<b>Some time later...</b>");
