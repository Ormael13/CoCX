	...
	public class FrostGiantScene extends BaseContent
	{
		...
		public function winAgainstGiant():void {
			...
			if (player.lust >= 33 && flags[kFLAGS.SFW_MODE] <= 0) {
				...
				if (uniquuuesexscene.pcCanUseUniqueSexScenev2(true, null) > 0) addButton(13, "U.Sex Scenes", curry(uniquuuesexscene.pcCanUseUniqueSexScenev2, false, [winAgainstGiant])).hint("Other non-typical sex scenes.");
		...
		public function winAgainstYoungGiant():void {
			...
			if (player.lust >= 33 && flags[kFLAGS.SFW_MODE] <= 0) {
				...
				addButton(2, "Ride Anally", rideAnally);
				//if (player.pcCanUseUniqueSexScene()) addButton(13, "U. Sex Scenes", uniquuuesexscene.pcUniqueSexScenesChoiceMenu).hint("Other non typical sex scenes.");
				if (uniquuuesexscene.pcCanUseUniqueSexScenev2(true, null) > 0) addButton(13, "U.Sex Scenes", curry(uniquuuesexscene.pcCanUseUniqueSexScenev2, false, [winAgainstYoungGiant])).hint("Other non-typical sex scenes.");
				addButton(14, "Leave", cleanupAfterCombat);
			}
			else {
				cleanupAfterCombat();
