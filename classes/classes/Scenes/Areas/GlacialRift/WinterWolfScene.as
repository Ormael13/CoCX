	...
	public class WinterWolfScene extends BaseContent 
	{
		...
		public function winAgainstWinterWolf():void {
			...
			if (player.lust >= 33) {
				...
				if (uniquuuesexscene.pcCanUseUniqueSexScenev2(true, null) > 0) addButton(13, "U.Sex Scenes", curry(uniquuuesexscene.pcCanUseUniqueSexScenev2, false, [winAgainstWinterWolf])).hint("Other non-typical sex scenes.");
