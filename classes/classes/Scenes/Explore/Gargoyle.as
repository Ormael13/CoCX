...
private function ritualGargoyle():void {
	...
	if(player.hasStatusAffect(StatusAffects.Infested) || player.hasStatusAffect(StatusAffects.Exgartuan)) addButton(2,"Banish",banishmentGargoyleRitual);
	addButton(4,"Leave",returnToCathedral);
}
...
private function banishmentGargoyleRitual():void {
	...
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("a hitchhiker");
	...
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("this bastard");
	...
	//with Exgartuan:
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("  Booming from within you, you hear the demon's voice: \"<i>Hey!  What the shit is this!?  What're you doing? Fucking stop, you ingrate!</i>\"");
	//with Worms: 
	...
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("creature within you has");
	...
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("possessed");
	...
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) player.removeStatusAffect(StatusAffects.Exgartuan);
...
private function gargoyleKinkyRituals():void {
	...
	if(player.hasStatusAffect(StatusAffects.Exgartuan) || player.hasStatusAffect(StatusAffects.Infested)) addButton(2,"Banish",banishPervRitual);
	addButton(4,"Leave",returnToCathedral);
}
...
private function banishPervRitual():void {
	...
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("it");
	...
	//If PC has Worms: 
	if(!player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("  You can feel her cock ram against your prostate, and shudder as the writhing mass of worms begin to panic as her cock pushes against them, obviously causing the creatures great pain.");
	...
	//(If PC has Exgartuan: 
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("  You can hear the demonic voice of Exgartuan inside your mind, yelling and cursing as he is rapidly drained from your body and sealed into the holy rod within you.");
	...
	if(player.hasCock()) {
		...
		if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText("Exgartuan is");
	...
	if(player.hasStatusAffect(StatusAffects.Exgartuan)) outputText(" within you has");
...
private function gargoyleHistoryC():void {
	...
	else if(player.hasStatusAffect(StatusAffects.CampMarble)) {
