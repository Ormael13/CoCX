...
private function approachBazaarGuard():void {
	...
	outputText("</i>\"", false);
	if(player.cor < 33 - player.corruptionTolerance() && flags[kFLAGS.MEANINGLESS_CORRUPTION] <= 0) simpleChoices("FIGHT!",initiateFightGuard,"",0,"",0,"",0,"Leave",camp.returnToCampUseOneHour);
