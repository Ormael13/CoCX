    ...
    public function golemmerchant():void {
        ...
        var hasSoulKing:Boolean = player.hasPerk(PerkLib.SoulKing);
         function Tier0():void{
            ...
            menu();
             addButton(0, "LowSFRPill", buyItem2,consumables.LG_SFRP, sayLine1(consumables.LG_SFRP,"It's a useful item for any soul cultivator, this little pill can help you restore some of your soulforce. Unless you don't have a soul.")).hint("Low-grade Soulforce Recovery Pill.");
