    ...
    public function golemmerchant():void {
        ...
        var hasSoulKing:Boolean = player.hasPerk(PerkLib.SoulKing);
         function Tier0():void{
            ...
            menu();
             addButton(0, "LowSFRPill", buyItem1,consumables.LG_SFRP, sayLine1(consumables.LG_SFRP,"It's a useful item for any soul cultivator, this little pill can help you restore some of your soulforce. Unless you don't have a soul.")).hint("Low-grade Soulforce Recovery Pill.");
             ...
             addButton(5, "LowSFRBotl", buyItem1,consumables.LGSFRPB, sayLine2(consumables.LGSFRPB,"It's a useful item for any soul cultivator, the pills in this bottle can help you restore some of your soulforce. Unless you don't have a soul.")).hint("Bottle of Low-grade Soulforce Recovery Pills.")
