...
public function soularena():void {
	...
	public function mrsShigureLecturesFirst():void {
		...
		if (player.hasPerk(PerkLib.HistoryCultivator) || (player.hasPerk(PerkLib.PastLifeCultivator) && player.hasPerk(PerkLib.JobSoulCultivator))) {
			...
			outputText("\"<i>Greeting everyone. Humble me would be today in care of today lecture.</i>\" Mrs. Shigure warmly greets everyone before proceeding to the lecture.\n\n");
		}
...
=======
		...
		outputText("\"<i>Let get to the last part of today's lecture.</i>\" Shigure claps her hands, waiting for a moment as the students focus back on her. She gives a few Kitsune in the crowd small glances, her tails flicking as she burns her gaze in, licking her lips hungrily before moving to the next.\n\n");
>>>>>>> 3444d44216252721c8a4619e90d8dbd4af7bdaf2
...
=======
		outputText("\"<i>Greeting everyone. Another meeting with so many of you. Soon i would remeber each of you, right?</i>\" Shigure cracks a small joke at the start to loosen up the atmosphere.\n\n");
...
=======
		outputText("\"<i>Greeting everyone. The Head Elder again decided i should come here today. Not that i felt it would be a waste of time.... or would it?</i>\" Shigure cracks a small joke at the start to loosen up the atmosphere.\n\n");
...
=======
		outputText("\"<i>Greeting everyone. Is it me or there is very lighted up atmospehre today. Like each of you been hit by the thunder recently?</i>\" Shigure cracks a small joke at the start to loosen up the atmosphere.\n\n");
