...
public function soularena():void {
	...
	public function mrsShigureLecturesSecond():void {
		clearOutput();
		flags[kFLAGS.SPIRIT_STONES] -= 10;
		outputText("You are greeted by a lovely-looking lady.\n\n");
	...
	public function mrsShigureLecturesThird():void {
		...
		outputText("\"<i>Hmmmm...</i>\" she pause as she smiles, \"<i>yes i do fighted against tribulation i faces few times... and i not felt it was bad to do it.</i>\" She continues the lecture, describing what could cultivators preapre for this event. Various formation to support or defend from tribulation lightnings.\n\n");
