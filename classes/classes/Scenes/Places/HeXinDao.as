...
public class HeXinDao extends BaseContent
{
    ...
    public function golemmerchant():void {
		...
		function TierII():void {
			...
			addButton(10, "FOL Rank 2", curry(buyItem1,consumables.FOLLMAN), sayLine1(consumables.FOLLMAN,"It's a manual for Flames of Love (Rankless), this simple technique allows you to convert excess lust into flames."), "\n\nIt seems like some sort of art to deal with needless lust by changing it into another....more deadly form.  But what does 'low rank' mean?  Is there a higher rank for this soulskill?\n").hint("Flames of Love (Low Rank) Manual.");
			addButton(11, "IOL Rank 2", curry(buyItem1,consumables.IOLLMAN), sayLine1(consumables.IOLLMAN,"It's a manual for Icicles of Love (Rankless), this simple technique allows you to covert excess lust into icicles."), "\n\nIt seems like some sort of art to deal with needless lust by changing it into another....more deadly form.  But what does 'low rank' mean?  Is there a higher rank for this soulskill?\n").hint("Icicles of Love (Low Rank) Manual.");
			addButton(12, "SOS Rank 2", curry(buyItem1,consumables.SOSLMAN), sayLine1(consumables.SOSLMAN,"It's a manual for Storm of Sisterhood (Rankless), this simple technique allows you to convert excess wrath into lightning."), "\n\nIt seems like some sort of art to deal with needless wrath by changing it into another....more deadly form.  But what does 'low rank' mean?  Is there a higher rank for this soulskill?\n").hint("Storm of Sisterhood (Low Rank) Manual.");
			addButton(13, "NOB Rank 2", curry(buyItem1,consumables.NOBLMAN), sayLine1(consumables.NOBLMAN,"It's a manual for Night of Brotherhood (Rankless), this simple technique allows you to covert excess wrath into darkness."), "\n\nIt seems like some sort of art to deal with needless wrath by changing it into another....more deadly form.  But what does 'low rank' mean?  Is there a higher rank for this soulskill?\n").hint("Night of Brotherhood (Low Rank) Manual.");
			addButton(14, "Back", golemmerchant);
            statScreenRefresh();
		}
