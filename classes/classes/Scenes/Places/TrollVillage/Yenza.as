...
public class Yenza extends TrollVillageAbstractContent{
    ...
    public function YenzaHome():void{
        clearOutput();
        if (TrollVillage.ZenjiFollowing){
            outputText("Zenji clutches your wrist, pulling you back to him gently, \"[name]... Let’s not do dat. Sound good? Yeah, okay, let’s leave.\"\n" +
                    "\n" +
            ...
            if (player.hasBreasts() || player.femininity > 30){
                ...
                outputText("You knock on the door. It doesn’t take long until you hear footsteps approach and Yenza opens the door.\n" +
                        "\n" +
                        "Yenza speaks softly with a sultry tone, \"[name], it’s you again, come in…\"\n" +
                        "\n" +
    ...
    private function YenzaAppearance():void{
        ...
        outputText("Yenza is a female troll, the pinnacle of femininity. In fact, she’s the only troll you’ve seen with such a perfect figure and incredibly feminine features.\n" +
                ...
                "\n" +
                "She speaks up, \"Are you just going to stare? I’m not just an object you know. I wonder how long until you realize you’re the only toy here.\"\n");
        YenzaTalkOptions();
    }
    ...
    private function YenzaTitjob():void{
        ...
        outputText("\"Lie down, my little plaything…\" She instructs once she’s ready\n" +
                ...
                "\n" +
                "She gives you a sultry wink as she crawls up on your body, \"Let’s start with a little foreplay, pet. Let me introduce you to the girls...\"\n" +
                "\n" +
                ...
                "\n" +
                "\"Bad boy! We got at my speed. Naughty boys don’t get to cum.\"\n" +
                "\n" +
                ...
                "\n" +
                "She cups the underside of her breasts as she presses them together, covering your length with her bust. She works up and down your length with slow ministrations.\n" +
                "\n" +
                "You can feel your shaft twitch beneath her, ready for release.\n" +
                "\n" +
                "She squeezes her breasts on you tighter, \"That’s a good boy… cum for me.\"\n" +
                "\n" +
                "You moan in pleasure as your orgasm hits, cumming all over her full breasts.\n" +
                "\n" +
                "She drags a finger to her cum coated breasts, licking up the residue. \"I’ve had better… Now you better lick me clean.\"\n" +
                "\n" +
                "She crawls over your body, bringing her breasts closer to your face. You lean up to get closer to her, licking up your cum and cleaning her off.\n" +
                "\n" +
                "\"This is your reward for being a good boy this time. Go along now, I need not waste any more time with you for now…\"\n" +
                "\n" +
    ...
    private function YenzaCowgirl():void{
        outputText("You tell her that you’re ready, after all, that’s why you’re here.\n" +
                ...
                "\n" +
                "She pushes you back down, \"Now, now, naughty boys must wait for their turn.\"\n" +
                ...
                "\n" +
                "\"Does my toy want my hips? Perhaps if you’re a good boy I’ll let you touch me…\" She mutters as she continues grinding against you.\n" +
                "\n" +
                ...
                "\n" +
                "\"Not the best... I can tell you’re not from around here… Ah, well, perhaps I’ll just need to train my pet a little more.\" She says with a snicker.\n" +
                "\n" +
    ...
    private function YenzaSubmit():void{
        ...
        if (ZenjiScenes.ZenjiMarried){
            outputText("You hear the door to her bedroom burst open, Zenji stands at the frame infuriated. \n" +
                    "\n" +
                    "\"YOU! GET AWAY FROM [PC]! NOW!\" He shouts\n" +
                    "\n" +
                    "\"Oh, if it isn’t one of my pets coming back to me?\" Yenza replies as she dismounts you.\n" +
                    "\n" +
                    "\"I am not your pet, neither is he.\" Zenji states, gesturing toward you\n" +
                    "\n" +
                    "Yenza stands at the side of the bed, arms folded over her breasts. \"Just give in, Zenji. [name] already has. Make things easier on yourself, you know you want to.\"\n" +
                    "\n" +
                    ...
                    "\n" +
                    "He speaks softly, gently caressing your face, \"[name]... Are you okay..?\"\n" +
                    "\n" +
                    "Zenji shakes his head before you can respond\n" +
                    "\n" +
                    "\"Please, [name]... I can’t lose you, I figured wit all de time ya spent away from me dat it could only be one ting. Besides, word travels fast in de village, it was only a matta of time before I heard de news.\"\n" +
                    "\n" +
                    "\"You’re going to take a break from de village for now. I’ll make sure of it.\"\n");
            ...
            outputText("Your length aches, throbbing desperately from between her plush backside. She grinds softly against you, pressing your shaft against her backdoor. She slowly slides against you, coaxing more pre to emerge from your length.\n" +
                    "\n" +
                    "\"That’s a good boy,\" She croons, \"I think maybe it’s about time I gave you some… proper treatment.\"\n" +
                    "\n" +
