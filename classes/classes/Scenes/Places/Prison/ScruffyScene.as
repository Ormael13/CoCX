...
package classes.Scenes.Places.Prison 
{
	...
	public class ScruffyScene extends BaseContent
	{
		...
		public function prisonCaptorRandomEventJizzJanitor():Boolean
		{
			...
			if(player.hunger < 20)
			{
				outputText("You look absolutely famished ");
			}
			else
			{
				outputText("I know good meals can be few and far between in this place ");
			}
		...
		public function prisonCaptorRandomEventJizzJanitorRefuse():void
		{
			...
			{
				outputText("While you'd like to preserve a bit of your dignity and politely turn down the offer, you simply don't have the willpower to resist Scruffy's advances right now. ");
		...
		public function prisonCaptorRandomEventJizzJanitorReject():void
		{
			...
			{
				outputText("While you'd love nothing more than to outright reject the humiliating offer, you simply don't have the willpower to resist Scruffy's advances right now. ");
				if(rand(player.esteem * 3) > player.obey + player.lust + player.cor)
				{
		...
		public function prisonCaptorRandomEventJizzJanitorPerform():void
		{
			...
			if(freeitemslots > 1)
			{
				outputText(" I think that quality of performance deserves extra rewards. Now be a good little cum-dumpster and be sure to eat it all -- it'll help make your body more pleasing to old Scruffy the next time I come around.");
			}
			else
			{
				outputText(" I'd be inclined to give you something extra if you didn't have such a stash of goodies saved up already. Be sure to eat what I have given you you, though -- it'll help make your body more pleasing to old Scruffy the next time I come around.");
			}
			outputText("</i>\"");
			player.slimeFeed();
			player.changeStatusValue(StatusEffects.PrisonRestraints,2,0);
