	...
	public function prisonCaptorBillieStatusText() : void
      {
         ...
         var happiness:* = this.prisonCaptorBillieHappiness();
      ...
      public function prisonCaptorBillieOptedOut() : Boolean
      {
         ...
         if(this.player.hasStatusAffect("prisonCaptorEllyBillie") < 0)
         {
            this.player.createStatusAffect("prisonCaptorEllyBillie",0,0,0,0);
         }
         testVal = this.player.statusAffectv1("prisonCaptorEllyBillie");
         if(testVal < 0)
         {
            return true;
         }
      ...
      public function prisonCaptorBillieMet() : Number
      {
         ...
         return this.player.statusAffectv1("prisonCaptorEllyBillie");
      }
      ...
      public function prisonCaptorBillieMetSet(newVal:Number) : void
      {
         ...
         this.player.changeStatusValue("prisonCaptorEllyBillie",1,newVal);
      }
      ...
      public function prisonCaptorBillieMetChange(changeVal:Number) : void
      {
         ...
         newVal = this.player.statusAffectv1("prisonCaptorEllyBillie") + changeVal;
         if(newVal < 0)
         {
            newVal = 0;
         }
      ...
      public function prisonCaptorBillieHappiness() : Number
      {
         ...
         return this.player.statusAffectv2("prisonCaptorEllyBillie");
      }
      ...
      public function prisonCaptorBillieHappinessSet(newVal:Number) : void
      {
         ...
         this.player.changeStatusValue("prisonCaptorEllyBillie",2,newVal);
      }
      ...
      public function prisonCaptorBillieHappinessChange(changeVal:Number) : void
      {
         ...
         newVal = this.player.statusAffectv2("prisonCaptorEllyBillie") + changeVal;
         this.player.changeStatusValue("prisonCaptorEllyBillie",2,newVal);
      }
      ...
      public function prisonCaptorBillieEvent() : Number
      {
         ...
         return this.player.statusAffectv3("prisonCaptorEllyBillie");
      }
      ...
      public function prisonCaptorBillieEventSet(newVal:Number) : void
      {
         ...
         this.player.changeStatusValue("prisonCaptorEllyBillie",3,newVal);
      }
      ...
      public function prisonCaptorBillieEventChange(changeVal:Number) : void
      {
         ...
         newVal = this.player.statusAffectv3("prisonCaptorEllyBillie") + changeVal;
         if(newVal < 0)
         {
            newVal = 0;
         }
      ...
      public function prisonCaptorBillieScratch() : Number
      {
         ...
         return this.player.statusAffectv4("prisonCaptorEllyBillie");
      }
      ...
      public function prisonCaptorBillieScratchSet(newVal:Number) : void
      {
         ...
         this.player.changeStatusValue("prisonCaptorEllyBillie",4,newVal);
      }
      ...
      public function prisonCaptorBillieScratchChange(changeVal:Number) : void
      {
         ...
         newVal = this.player.statusAffectv4("prisonCaptorEllyBillie") + changeVal;
         if(newVal < 0)
         {
            newVal = 0;
         }
      ...
      public function prisonCaptorBilliePityFuck(branchChoice:String = "choose") : void
      {
         ...
         if(branchChoice == "choose")
         {
            ...
            if(this.prisonRestraintMouthLevel() > 0 && !(this.prisonRestraintMouthLevel() == 4))
            {
            ...
            if(this.prisonRestraintMouthLevel() == 4)
            {
         ...
         if(branchChoice == "1")
         {
            ...
            if(this.rand(2) == 1)
            {
               this.outputText("(Placeholder) You cannot help but moan loadly as she pounds you, and before long the door opens and Mistress Elly enters the room. Billie immediately freezes and begs her forgiveness for her actions. Mistress Elly says she understands why Billie tried to help you, but they will have to have a stern talk when they get back to her cell. In the meantime, though, she directs Billie to finish what she started. Billie is effusive in her gratitude, and begs your Mistress to let her start apologizing how. She sits back on her legs, picks you up and sets you in her lap facing her, hugs you tightly, and begins to fuck your [vagOrAss] again. She then gives your Mistress a look of longing and begins to kiss you deeply.\n\n");
            ...
            this.stats(0,0,0,0,0,0,-100,0);
         }
         else if(branchChoice == "2")
         {
            this.outputText("(Placeholder) Billie is suprised, but proud of you. She assumes that you have decided to take responsibility for your actions and learn from your lesson, and so she gives you a wet kiss on the cheek and leaves you be.\n\n");
            this.prisonCaptorBillieHappinessSet(0);
      ...
      public function prisonCaptorBilliePunishmentFuck(branchChoice:String = "choose") : void
      {
         if(branchChoice == "choose")
         {
            ...
            this.outputText("\n\n");
            this.outputText("\n\n");
            this.simpleChoices("Happy",50153,"Sad",50154,"",0,"",0,"",0);
            return;
         }
         ...
         else if(branchChoice == "sad")
         {
            ...
            this.buttChange(24,true,true,false);
         }
