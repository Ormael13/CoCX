...
public class IngnamFarm extends BaseContent
	{
		...
		public function workAtFarm():void { //Job at the farm.
			...
			if (chooser == 0) {
				...
				outputText("\n\n\"<i>I'll take care of these from there. Thank you for helping me. You've taken some of the load off my burden. Here's your payment,</i>\" she says. She hands you ten gems.");
				fatigue(10);
			}
			else if (chooser == 1) {
				outputText("\n\n\"<i>Great! I could use a hand harvesting crops,</i>\" she says, \"<i>We need ten full baskets of crops.</i>\"");
				outputText("\n\nShe escorts you to the field where the crops grow. She hands you the basket so you can collect the crops. \"<i>We'll harvest the crops. You only need to fill ten, I'll take care of the rest,</i>\" she says.");
				outputText("\n\nYou pick the corn from the plant one by one and put them into basket. This continues until the basket gets full after which you switch to another empty basket. You get back to harvesting and repeat until all the baskets are full. The farmer comes to see that you've filled all the baskets. \"<i>Good work! I'll take care of things from there. Here's your payment,</i>\" she says. She hands you the ten gems.");
				fatigue(10);
			}
			else {
				...
				player.HP += 50;
				outputText("\n\nAfter a few minutes of chatting, the break is over and you help her with hauling the buckets to her farmhouse, four at a time. After three trips, she gives you a final task of filling the milk bottles. You carefully pour the milk through a funnel into the bottle and when you manage to fill it, you move on to the next bottle. You repeat the process until the buckets are empty. \"<i>Good work! You have finished your work! Here's your payment,</i>\" she says as she hands you the ten gems you deserve.");
			}
			if (rand(2) == 0) {
