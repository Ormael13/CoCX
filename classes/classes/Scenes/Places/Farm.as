...
public function getMilked():void {
	...
	//Repeat
		...
		if (player.findStatusEffect(StatusEffects.LactationReduction) >= 0 && player.totalCocks() == 0) outputText("  Your " + nippleDescript(0) + "s are engorged and ready to be taken care of.", false);
		//If cocks
