package classes.Scenes.Places.Farm
{
	...
	public class FarmCorruption extends AbstractFarmContent
	{
		...
		public function whitneyDomRide():void
		{
			...
			// MMM note: Remind whoever wrote the damn functions they should eat the same indexes
			...
			else if (player.cockArea(cockI-1) < (whitneyVagCapacity() * 1.33) && player.cockArea(cockI-1) > (whitneyVagCapacity() * 0.66))
			{
