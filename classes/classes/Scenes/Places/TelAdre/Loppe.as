...
private function boobjobLoppe():void {
	...
	if((player.str < 50 && !player.isTaur()) || (player.str < 30 && player.isTaur())) {
		...
		if(player.tongueType > AppearanceDefs.TONGUE_HUMAN) outputText("looping your inhuman tongue around it and stroking for extra stimulus even while ");
...
private function teaseLoppeNSuck():void {
	...
	if(player.tongueType > AppearanceDefs.TONGUE_HUMAN) outputText(", inhumanly long tongue looping out to coil wetly around the length");
