...
public function approachFrosty():void {
	...
	if(flags[kFLAGS.MET_FROSTY] == 0)
	{
		...
		outputText("You approach the pink girl and as she sees you walking towards her, she immediately makes a beeline for you. Before you know it, the girl is right in front of you, jamming one of her fliers right in your face and speaking fast and hyperactivity to you. <i>“Hello " + player.mf("sir","madam") + ", would like to come to “Frosty Cake’s Cupcake stand?” I’m Frosty-Nice to meet you - I recently opened a sweets-stand and can’t wait to have loyal customers such as you coming to my stand every day and buying all kinds of super delicious cupcakes!” You have to a step back to process everything she just blurted out; you also take the flyer from her just so she stops pushing it against your face. “So do you wanna come to my stand, do ya-do ya-do ya!?”</i> You answer her with an uncertain “yes”, still wondering what she just said.");
		outputText("\n\nBut, you can’t think for long as she grabs you by the hand to lead and whisk you out the front door of the bakery and to her food-stand that is just outside. It’s a tiny little booth, decorated in bright happy colors and streamers. A sign on the front reads:\n\n<i>“Frosty Cake’s Cupcake Stand!!!!”</i> in a bubbly rainbow colored chalk writing. She positions you right in front of it and jumps over the counter to the cashier side of it. “<i>Hello Customer, How may I help you? My first customer!</i>” The last part comes out as a whispered squeel that doesn't do much to hide her excitement.");
		outputText("\n\nYou both share and moment of silence, her big pink eyes looking at you with a hopeful smile, then she looks down at the counter and sees its empty, letting out a little “eep” she quickly ducks down under the counter, coming back up with a bunch of silver, platter displays with glass lids, so you can see the tasty cupcakes on the inside, and in a blur the displays are organized right in front of you. All sorts of cupcakes are displayed with various frostings, toppings, colorful wrappings and all different kinds of flavors. Your mouth is just watering as your eyes wander across this colorful display of cupcakes but quickly dries up as your gaze comes to rest upon the pricing for these delicacies.");
...
public function frostyMainMenu():void
{
	...
	else addButton(8,"Specials",frostySpecialsMenu);
...
public function frostysSpecialMenu():void
{
	clearOutput();
...
public function frostysHandsAreColdHolyShitWhyDontYouWarmTHoseMitsUp():void
{
	...
	outputText("\n\n“<i>Ooooh, your ");
	if(player.biggestCockLength() < 7) output("little");
	else output("big");
...
public function frostyForHerms():void
{
	...
	if(player.balls > 0) output("your [balls]");
	else output("your pussy lips");
	...
	if(player.hasPerk("Bimbo Brains") >= 0) output("the bimbo you are");
	else output("a bimbo");
...
public function useFrostysMouth():void
{
	...
	if(player.hasCock() && !player.hasVagina())
	{
		...
		outputText("\n\nYou hear her nomming on something and a “blah” of disgust out. “<i>I hate black licorice... ahhh...</i>” You hear her mutter, then she pops back up to set herself on display in less than a second. The customer pushes you aside and asks about “<i>getting some of what you got.</i>”\n\n “<i>Well, all you have to do is sign here and you’ll get a free sample of my services...</i>”");
	...
	else
	{
		...
		outputText("\n\nJust before Frosty starts her mouth sex, she raises a finger like she’s remembering something and quickly crawls around to the back of the booth, wiggling her tooshie in the air. You hear her rummaging under the counter and then she’s suddenly back in front of you, did she even crawl back around? In her hands is a yellow bottle shaped like a bee-girl and a thin black rope. She plops back down on her ass with her boobs doing a little jiggle when she lands. She holds the black rope up and tells you what it’s for.");
		...
		outputText("\n\nShe a takes a deep swig of the bee-girl bottle , pooling up the honey in both her cheeks. She swishes it around in there and then gulps down a portion of the, though you can tell there’s still some of it left. Now she’s putting both hands behind her back, one with the black rope in it. Her hands fiddle around there, one of her eyes is closed and her tongue sticks out between her lips as she tries to figure out how to tie herself up, but like the polar opposite of Houdini, she’s able to entrap herself in the most impossible way. “<i>See, nice and tight, just like my little pink pussy.</i>” She does a little side-turn to show you her work. Both hands are tightly bound to each other with a complicated knot holding them there. If you hadn’t seen it, you wouldn’t believe she did this to herself.");
		outputText("\n\n“<i>Now let’s get this party started!</i>”");
...
public function genderlessCatchAllForFrosty():void
{
	...
	if(9999 == 0)
	{
		...
		outputText("\n\nYou give Frosty a dirty look but she just shrugs her shoulders like this new rule she just made is out of her power “<i>Sorry customer, thems the rules. But Hey, you can still choose a few other options... very few other options!!!</i>” You let out an irritated sigh and go back to looking at the specials menu.");
	}
...
public function cunnilingateFrosty():void 
{
	...
	outputText("\n\nShe holds a finger up to the nozzle’s tip and you hear it make a spraying sound as a fluffy white substance is dispensed on her fingertip. She holds the fingers down to you, expecting you to suck the stuff off her finger. Maybe it is the heat of the moment or something else but you latch your mouth around that finger and have your tongue explore as much as it could. The white stuff is sweet and fluffy, Immediately turning into a flat surgery liquid when it makes contract with your spit. You continue sucking on her finger, Frosty looking at you with delight, until the taste of the sweet stuff is gone. She pulls her finger for your craving mouth, a trail of saliva following and breaking as she takes it back.");
	outputText("\n\n“<i>You really like my cream don’t ya, well guess where you can get more?</i>”");

	outputText("\n\nShe uncrosses her legs, spreads them and undoes the strings holding that tiny piece of bikini cloth against her pussy. The covering falls off her pink cunt and hang over the edge of the counter, you see her pink pussy is all wet and excited to see you. The nymph shakes the can, her breast jiggling a little, and places the nozzle over her hard clit, spraying  a little swirl of the sweet stuff on it. Its cold fluffy texture makes her coo a little. She beckons you with her finger to dig-in.");
	outputText("\n\nYou quickly bring your mouth to her pussy with a loud slurp as you entire mouth covers her moist mound, sucking and licking the sex hole just to taste that little bit of sweet sweet cream. She gasps in surprise on how savagely you are tongue fucking her, her legs and toes curling up and leaning back on her arm for support. Only when you stop tasting the stuff do you calm down.  Pulling your mouth off the her now puffed up cunt, her pussy lips looking quite a bit fuller now than they did before. Frosty catches her breath before shaking the can once more and spraying large amount of the cream over her clit and vulva, almost looking like white fluffy snow covering a pink mound. You hold back, watching her spray on more cream. Only when her pussy is completely covered and then some, does she leans back on the counter, both arms bracing her up, legs spread wider than they were before and making a quick sharp whistle, giving you the signal to dig-in once more.");

	outputText("\n\nYour mouth first laps up a huge glob of just the cream, not getting in contract her skin skin just yet. You swish the stuff in your mouth, it’s sweet flavor rolling over your tongue and sticks to the walls of your cheeks. Only when the cream becomes an unbearable sweet liquid do you swallow it down and lick your lips. You take another glob of the stuff off her cunt, this time you lips brushing against her soft pink skin, her anticipation is melting droplet of the cream down her thighs as you got closer and closer to her treasure. You keep on taking large chunks of the cream off her nympho pussy, until it’s looking painted with cream residue. Her cunt is sticky as the moistness caused the white cream to dissolve into syrupy like ooze  all over and into her pussy. She has been making little moans here and there, you never really touching skin throughout that whole ordeal, but her tender skin and the delicious white cream are almost one amd the same now.");

	outputText("\n\nYou lick your lips again, you’re full-bellied and a bit exhausted but you just want more of that cream. Especially the bits around her moist fuck-hole, the cream dampens with the liquid lust of a nymph has more of a kick to it. You stick your tongue out and circle around her cream-gusher, gathering as much as you can and giving each lip the attentive lickings they deserve, giving her clit a flick whenever you feel like it.");
	outputText("\n\nThe excitement built from the licking though the pile of cream shows greatly as Frosty moans and coos with every lick you make. You spread her lips apart to get at the sweet stickiness that seeped in. Her breathing becomes heavier as you maneuver your tongue over her sweet spot. Licking up with what little creamy residue that resides on her. Frosty becomes wetter with every lick, you bring her closer to orgasim but not able to come full circle.");
	outputText("\n\nYou’re getting tired of the cream now, too much of a good thing as they say. You need something to wash it down, some nymph cum would make the perfect drink. You go back to what you did when you first tasted this sweet treat off this delicious body and cover your entire mouth over the puffy pink pussy, causing her to go curl her legs and toes as you pleasure her entire sex bit with you hot wet mouth. Your slimy muscle rolls over her two lips and moves around her clit.");
