...
private function acceptDominikasKnowledge():void {
	...
	if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00155] == 0) {
		...
		if(player.spellCountWhiteBlack() == 13) {
...
private function dominikaBlowjobs2():void {
	...
	if(flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00157] == 1 || flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00157] == 4) outputText("At the same time, you get the sense that perhaps it's for the best you did so.");
