...
public function getSuckedOffByAHamSandwich():void {
	...
	//[If the player has a cock equal to or over 13']
		...
		outputText("She gasps as you lift your " + cockDescript(x) + " and slap her face. \"<i>It's... wow, " + player.short + "!</i>\" You grin before poking her pudgy cheek with the tip of your ");
...
private function fuckElleInsteadOfThatFatSlutFirstTime():void {
	...
	else outputText("uses all four of her hands to handle your " + multiCockDescriptLight() + ", jerking each one with ease");
