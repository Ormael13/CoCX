...
public function benoitPreggers():Boolean
{
	...
	return flags[kFLAGS.FEMOIT_EGGS] > 0;
...
{
	if (flags[kFLAGS.BENOIT_STATUS] == 0) return false;
	return flags[kFLAGS.FEMOIT_EGGS] >= 1 && flags[kFLAGS.FEMOIT_EGGS] <= 4;
...
{
	if (flags[kFLAGS.BENOIT_STATUS] == 0) return false;
	return flags[kFLAGS.FEMOIT_EGGS] >= 5 && flags[kFLAGS.FEMOIT_EGGS] <= 8;
...
{
	if (flags[kFLAGS.BENOIT_STATUS] == 0) return false;
	return flags[kFLAGS.FEMOIT_EGGS] >= 9 && flags[kFLAGS.FEMOIT_EGGS] <= 12;
...
{
	if (flags[kFLAGS.BENOIT_STATUS] == 0) return false;
	return flags[kFLAGS.FEMOIT_EGGS] >= 13;
...
private function benoitSellTransact(slot:int, sellMod:int):void {
	...
	else outputText("Following a painstaking examination of what you've given " + benoitMF("him", "her") + " with " + benoitMF("his","her") + " hands and nose, Benoit grudgingly accepts it and carefully counts out your reward.");
...
private function benoitSellAllTransact(totalItems:int, sellMod:int):void {
	...
	else outputText("Following a painstaking examination of the items you've given " + benoitMF("him","her") + " with " + benoitMF("his","her") + " hands and nose, Benoit grudgingly accepts them and carefully counts out your " + num2Text(itemValue) + " gem reward.");
...
private function talkToBenoit():void {
	...
	//First time Talk:
		...
		outputText("You take a moment to look the strange merchant over.  Although blind, " + benoitMF("he","she") + " doesn't seem very old - " + benoitMF("he","she") + " retains the tight, thin muscular frame of other basilisks you've seen, but looks to be slightly shorter and for all " + benoitMF("his","her") + " proud, cruel profile seems slightly shabby around the edges.  In what is presumably a nod towards civilized manners, " + benoitMF("he","she") + " is wearing a pair of denim long johns as well as " + benoitMF("his","her") + " fez, perched upon one of " + benoitMF("his","her") + " head spines.  You introduce yourself, and then decide to ask " + benoitMF("him","her") + " about basilisks.");

		outputText("\n\n\"<i>We were a proud race once,</i>\" sighs Benoit.  \"<i>A noble race, who carried our 'eads 'igh, and...</i>\" the blind basilisk bursts into throaty laughter, which eventually subsides into a coughing fit.  You watch, bemused.  \"<i>Hahaha!  Aha.  Sorry.  No, we were always a race of egg-thieving bastards.  The lizans,</i>\" " + benoitMF("he","she") + " flicks " + benoitMF("his","her") + " snout in the general direction of the bonfire with disdain, \"<i>absolutely 'ate us.  Zey drove us to live in ze mountains, far away from zeir precious clutches, to live like savages.  'Ze family with ze evil eye over it', zat's what zey call us.  Eh... in basilisk it's more snappy.</i>\"  Benoit pauses, running " + benoitMF("his","her") + " fingers over the counter ruminatively.  \"<i>But it wasn't so bad, up zair.  We kept ze harpies under control, and we collected scrap, sold it to zose who were brave enough to trade blindfolded.  We've always been good at zat.  Zen ze demons came to ze mountains.</i>\"");

		outputText("\n\nHe shrugs. \"<i>What were we going to do?  Go down and throw ourselves on the mercy of the races 'oo despise us?  Ze demons offered to set us high in zeir service, augment our natural abilities if we agreed to help zem.  I suppose zey did, at zat.</i>\"  Benoit scratches a long groove in " + benoitMF("his","her") + " counter, trembling with anger.  \"<i>By making us all male zey made sure we are always fixated on finding egg bearers, on keeping ze harpies down, and bringing scrap and statues to zem so zey don't do anysing worse to us.  We are just a brainless natural defence to zem now, in zeir mountain hideaways.  Don't go up ze mountain or ze evil basilisks will get you!  Bastards.  Bastards.</i>\"  Benoit finishes mutilating the wood in front of " + benoitMF("him","her") + " and sighs.  \"<i>But zat is by ze by.  Are you going to buy sumsing or not?</i>\"");
	}
	...
	//Subsequent Talk
		...
		//(Randomly generated.  Added to normal talk options after PC has had sex with Benoit two times or more regardless of womb quest.)
			...
			outputText("You ask Benoit if " + benoitMF("he","she") + " can suggest anything to help you fight " + benoitMF("his","her") + " brethren in the high mountains.");
...
private function eggySuggest():void {
	...
	if(player.isTaur()) {
		...
		outputText("\n\nThe scent of your arousal is in the air and as " + benoitMF("Benoit","Benoite") + " breathes it in " + benoitMF("his","her") + " own breath comes heavier.  " + benoitMF("His","Her") + " erection bulges in " + benoitMF("his","her") + " long johns and you decide it's time for you to take charge; you back up, butting " + benoitMF("him","her") + " insistently with your powerful body until you have " + benoitMF("him","her") + " pinned against a space upon the opposite wall.  You watch " + benoitMF("him","her") + " over your shoulder as " + benoitMF("he","she") + " unbuckles " + benoitMF("himself","herself") + " and lets " + benoitMF("his","her") + " trousers fall.  Stoked by the pheromones simmering off your body, " + benoitMF("his","her") + " long, thin purple erection is straining and " + benoitMF("he","she") + " arches " + benoitMF("his","her") + " back and opens " + benoitMF("his","her") + " mouth as you flare your [butt] and press yourself against it.  You know just from looking at " + benoitMF("his","her") + " intense arousal you're going to have to go slow to stop " + benoitMF("him","her") + " from shooting " + benoitMF("his","her") + " bolt straight away; with a wicked smile your partner can't see, you suppose such is your effect on " + benoitMF("him","her") + " it may not even matter if " + benoitMF("he","she") + " does.  Still, as " + benoitMF("he","she") + " lays " + benoitMF("his","her") + " hands upon your flanks, and you lean back with a sigh and slowly slide " + benoitMF("his","her") + " length into your moistened [vagina] as gently as you can.");
		player.cuntChange(12,true,true,false);
		outputText("\n\nBenoit's dick is incredibly smooth and you move down onto it with incredible, slick ease.  Rather than burying yourself onto it straight away you stop with only a third of it in your wet depths and slowly bring it out of you, dipping yourself slowly.  You stop with " + benoitMF("his","her") + " sensitive head just inside and work your [hips] around deliberately, sighing as it rotates slowly around your slick walls.  " + benoitMF("Benoit","Benoite") + " moans dryly and you feel " + benoitMF("his","her") + " body tense; immediately you stop your movements and wait, only gradually beginning to gyrate and thrust again when " + benoitMF("he","she") + " has calmed down.  You slide more of " + benoitMF("him","her") + " into you when you bend forwards again, this time leaving only " + benoitMF("his","her") + " base outside of you; you sigh as you feel " + benoitMF("him","her") + " creeping further into your moist depths.  " + benoitMF("He","She") + " makes a bestial noise and tries to thrust " + benoitMF("himself","herself") + " into you and upon you; tutting mockingly, you pull yourself away from " + benoitMF("him","her") + " and stop moving until, with what is evidently a huge force of will, the basilisk calms " + benoitMF("himself","herself") + ", backs against the wall and allows you to work " + benoitMF("him","her") + ".");
	...
	//[Demon:
		...
		outputText("\n\nBenoit's dick is incredibly smooth and you move down onto it with slick ease.  Rather than burying yourself onto it straight away, you stop with only a third of it in your wet depths and bring it out of you, dipping yourself slowly.  You stop with " + benoitMF("his","her") + " sensitive head just inside and work your thighs around deliberately, sighing as it rotates around your slick walls.  " + benoitMF("Benoit","Benoite") + " moans and you feel " + benoitMF("his","her") + " body tense; immediately you halt your movements and wait, only gradually beginning to gyrate and thrust again when " + benoitMF("he","she") + " has calmed down.  You slide more inside when you bend forwards again, this time leaving only " + benoitMF("his","her") + " base outside of you; a sigh rolls from you as you feel " + benoitMF("him","her") + " creeping further into your moist depths.  " + benoitMF("He","She") + " makes a bestial noise and tries to thrust " + benoitMF("himself","herself") + " into you and upon you; tutting mockingly, you pull yourself away from " + benoitMF("him","her") + " and stop moving until, with what is evidently a huge force of will, the basilisk calms " + benoitMF("himself","herself") + ", backs against the wall and allows you to work " + benoitMF("him","her") + ".");
...
private function repeatSexWithBenoitLetHim():void {
	clearOutput();
	if(player.isTaur()) {
		outputText("For the moment you don't do anything; you simply stand back and let " + benoitMF("his","her") + " hands slowly move across your frame.  One of " + benoitMF("his","her") + " hands comes to rest upon your [nipples]; as " + benoitMF("he","she") + " gently teases and kneads the soft, sensitive flesh " + benoitMF("his","her") + " other hand drifts downwards, across your belly, around your waist and down your velvety back.  Although " + benoitMF("he","she") + " is familiar with your frame by now " + benoitMF("Benoit","Benoite") + " never seems to stop being enthralled by your body; there is an unconscious frown of concentration on " + benoitMF("his","her") + " face as " + benoitMF("his","her") + " smooth hands move across your warm skin, as if " + benoitMF("he","she") + " were mapping you in " + benoitMF("his","her") + " mind's eye.");
		outputText("\n\nThis slow, gentle pressure is all very well, but you can't help but wonder if you can't awaken something a bit more bestial in the timid basilisk.  The thought of making " + benoitMF("him","her") + " lose " + benoitMF("his","her") + " self-control over you makes you grin, and tenderly but firmly you put your hands on " + benoitMF("his","her") + " claws and tell " + benoitMF("him","her") + " to stop.  " + benoitMF("He","She") + " looks at you in puzzlement.  Smiling, you begin to give " + benoitMF("him","her") + " some of " + benoitMF("his","her") + " own treatment; your hands drift softly over " + benoitMF("his","her") + " tight, smooth flesh, working down " + benoitMF("his","her") + " flat stomach until they reach " + benoitMF("his","her") + " long johns.  You slowly unbuckle them and let them fall, releasing " + benoitMF("his","her") + " long, thin erection.  With one hand you circle the base gently; even touching this least sensitive part of " + benoitMF("his","her") + " dick makes " + benoitMF("him","her") + " grunt with need, the thump of " + benoitMF("his","her") + " heart reverberating through " + benoitMF("his","her") + " scales, and " + benoitMF("he","she") + " involuntarily thrusts forwards, trying to get more of your hand upon " + benoitMF("him","her") + ".  Again, you tell " + benoitMF("him","her") + " to be still.  You continue to almost-masturbate " + benoitMF("him","her") + ", your one hand rubbing the very base of " + benoitMF("his","her") + " cock and the slit from which it thrusts, whilst you very gently sway your powerful back hips, your [vagina] beginning to moisten at the sight of the basilisk's intense arousal.  The scent of your sex is in the air and the fact you cannot reach back and do anything about it only intensifies your excitement.  " + benoitMF("Benoit","Benoite") + " is clenching " + benoitMF("his","her") + " pointed teeth, trembling slightly like a pipe about to burst, " + benoitMF("his","her") + " tail thrashes fitfully as you ponderously turn and lead your rump into " + benoitMF("him","her") + ", smearing your essence over " + benoitMF("his","her") + " incredibly receptive nostrils.  All " + benoitMF("he","she") + " can smell is your own arousal as you begin to talk huskily, saying you've been a naughty girl playing in the mountains, you've teased and mocked and run from every creature you've found but now a big bad basilisk has got you cornered, and what is the big bad basilisk going to do now it's got this naughty girl all to itself...?");

		outputText("\n\nBenoit surges forward, grasps you by the [butt], turns and pinions you to the wall.  Your laughs turn to gasps as with an almost pained growl, " + benoitMF("Benoit","Benoite") + " thrusts " + benoitMF("himself","herself") + " straight into your moist twat.  You can only clutch at the wall of the wagon as " + benoitMF("he","she") + " begins to fuck you with complete abandon, pitching your humanoid front half forwards as " + benoitMF("he","she") + " levers your [hips] upwards with each thrust.  " + benoitMF("He","She") + " is clumsy with lust as well as blind, uncaring of anything but the need to clench your body and hilt " + benoitMF("himself","herself") + " in your depths, unable to take hold of " + benoitMF("himself","herself") + " with your pussy juices coating " + benoitMF("his","her") + " nose and burning an unstoppable path to " + benoitMF("his","her") + " brain.  " + benoitMF("His","Her") + " pheromone-driven callousness and the discomfort of the wood against your hands ");
		...
		outputText("\n\nWhen " + benoitMF("he","she") + " slides into you " + benoitMF("he","she") + " does so with virtually no resistance whatsoever; the two of you have turned your pussy into an inviting, gooey sleeve.  ");
		if(player.vaginalCapacity() < 30) outputText("You don't mind; your tight sex is a perfect fit for " + benoitMF("his","her") + " smooth, thin dick, and you work with " + benoitMF("him","her") + " as " + benoitMF("he","she") + " thrusts, pulling and pushing your walls in time with " + benoitMF("his","her") + " length, your lubrication allowing " + benoitMF("him","her") + " to quickly increase the tempo until the two of you are once again bucking against each other gleefully, your fluids spattering against each other.");
		else outputText("Although " + benoitMF("he","she") + " is long, " + benoitMF("he","she") + " barely even touches the sides of your encompassing twat.  The sensation isn't great for you until " + benoitMF("he","she") + " really starts to go to town, ramming into you with all " + benoitMF("he","she") + "'s got, beating a wet staccato against your [butt].  You send a hand roaming back around and begin to finger your [clit] as " + benoitMF("he","she") + " sheaths " + benoitMF("himself","herself") + " in you, " + benoitMF("his","her") + " fluids running down your fingers as you work your slick, bulging pleasure button with increasing delight.");
		player.cuntChange(10,true,true,false);
		outputText("  The difference in the position makes " + benoitMF("his","her") + " dick bend into you at an angle, stroking a neglected spot which soon has you gasping with need.  " + benoitMF("Benoit","Benoite") + " is not as maddened as " + benoitMF("he","she") + " was the first time, and " + benoitMF("he","she") + " has the composure to draw " + benoitMF("himself","herself") + " out; " + benoitMF("he","she") + " slows " + benoitMF("himself","herself") + " down and then back up again, fucking you magisterially, withdrawing " + benoitMF("himself","herself") + " almost completely before slamming firmly back in, stopping whilst hilted in you until you beg and moan for " + benoitMF("him","her") + " to continue.  You give yourself up to the dominant rut you've awoken in " + benoitMF("him","her") + ", thrusting back into " + benoitMF("him","her") + " as you are fucked up to a second ecstatic height and then a third; everything disappearing underneath a timeless red haze, of being on your hands and knees with your [butt] in the air and being given what a female animal needs.");
...
private function repeatBenoitFuckTakeCharge():void {
	clearOutput();
	if(player.isTaur()) {
		outputText("\n\nFor the moment you don't do anything; you simply stand back and let " + benoitMF("his","her") + " hands slowly move across your frame.  One of " + benoitMF("his","her") + " hands comes to rest upon your [nipple]; as " + benoitMF("he","she") + " gently teases and kneads the soft, sensitive flesh " + benoitMF("his","her") + " other hand drifts downwards, across your belly, then slowly back along your vast equine frame.  Although " + benoitMF("he","she") + " is familiar with your frame by now " + benoitMF("Benoit","Benoite") + " never seems to stop being enthralled by your body; there is an unconscious frown of concentration on " + benoitMF("his","her") + " face as " + benoitMF("his","her") + " smooth hands move across your warm skin, as if " + benoitMF("he","she") + " were mapping you in " + benoitMF("his","her") + " mind's eye.");
		...
		outputText("For the moment you don't do anything; you simply stand back and let " + benoitMF("his","her") + " hands slowly move across your frame.  One of " + benoitMF("his","her") + " hands comes to rest upon your " + nippleDescript(0) + "; as " + benoitMF("he","she") + " gently teases and kneads the soft, sensitive flesh " + benoitMF("his","her") + " other hand drifts downwards, across your belly, around over the crack of your [butt] then down to cup your behind.  Although " + benoitMF("he","she") + " is familiar with your frame by now " + benoitMF("Benoit","Benoite") + " never seems to stop being enthralled by your body; there is an unconscious frown of concentration on " + benoitMF("his","her") + " face as " + benoitMF("his","her") + " smooth hands move across your warm skin, as if " + benoitMF("he","she") + " were mapping you in " + benoitMF("his","her") + " mind's eye.");
...
private function suggestSexAfterBasiWombed(later:Boolean = true):void {
	...
	if(!player.isTaur()) {
		...
		if(player.hasCock()) outputText("  " + benoitMF("He","She") + " deliberately rubs " + benoitMF("himself","herself") + " up and down your body, and the [cock] trapped between your warm bodies quickly hardens against the warm, smooth friction.");
		outputText("  Despite " + benoitMF("his","her") + " blindness, " + benoitMF("he","she") + " slides straight into your moist depths, making you coo as " + benoitMF("his","her") + " hard, smooth spur glides across your sensitive walls, slowly bringing " + benoitMF("himself","herself") + " out before thrusting " + benoitMF("himself","herself") + " in again, working more and more of " + benoitMF("his","her") + " length into you.  Never quite able to control " + benoitMF("himself","herself") + " around your body, it's obvious in the strain in " + benoitMF("his","her") + " face and the raggedness of " + benoitMF("his","her") + " breath against your skin that " + benoitMF("he","she") + " is exercising every restraint " + benoitMF("he","she") + " has not to fuck you into the ground; " + benoitMF("he","she") + " pushes " + benoitMF("his","her") + " dick upwards with each return thrust to bump deliberately against your [clit], sending irresistible spasms of pleasure chiming through you.  Pushed inexorably upwards you curl an arm around " + benoitMF("his","her") + " neck, kiss " + benoitMF("his","her") + " nose and grit your teeth, then whisper into " + benoitMF("his","her") + " ear to stop holding back.  " + benoitMF("Benoit","Benoite") + " pauses for a moment to gather " + benoitMF("his","her") + " breath, hilted entirely in your wet cunt, then hooks " + benoitMF("his","her") + " hips around yours, entrapping you around " + benoitMF("his","her") + " body, before beginning to fuck your softened, ripe body like a jackhammer.  " + benoitMF("He","She") + " pounds into you with everything " + benoitMF("he","she") + "'s got, clenching you as your gushing [vagina] deliriously spatters fluids across your entwined bodies.  Lost in rut now, " + benoitMF("Benoit","Benoite") + " licks your face with " + benoitMF("his","her") + " long tongue, the soft, sticky pressure against your reddened cheeks only seeming to make the contrasting sensation of " + benoitMF("his","her") + " long prick taking you deep even more overwhelming.");
		player.cuntChange(14,true,true,false);

		outputText("\n\nYou cannot stop yourself from screaming as your orgasm hits, your pussy clenching and wringing " + benoitMF("Benoit","Benoite") + "'s smooth dick as " + benoitMF("he","she") + " continues to slam " + benoitMF("himself","herself") + " into you until " + benoitMF("he","she") + " can take your milking no longer and cums in sympathy, clutching you as " + benoitMF("he","she") + " fountains thick, warm cum into your fertile depths.  Having your lower body held in place like this makes your orgasm all the more overpowering; you wriggle futilely against the basilisk's strong legs, unable to thrash away the unbearable pleasure.");
		...
		outputText("You haul your lizard boy into the cramped space of the backroom before gently setting " + benoitMF("him","her") + " down.  Now that your gut has settled, you feel imbued with an odd, ripe sensation; your horse belly bulges ever so slightly with unfertilized eggs and you feel red, soft and ready.  You begin to shrug your clothes off eagerly; having recovered " + benoitMF("himself","herself") + " slightly " + benoitMF("Benoit","Benoite") + " shrugs out of " + benoitMF("his","her") + " trousers, reaching out to you before stopping, blushing furiously.  Grinning kindly at the emasculated basilisk, you lower yourself onto the floor, flare your [hips] casually and then ask if " + benoitMF("he","she") + " see... smells anything interesting.");
