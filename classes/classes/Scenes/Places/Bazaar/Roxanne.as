...
private function roxanneGivesABlowjob():void {
	...
	outputText("You open the lower portion of your " + player.armorName + " and, pulling it back, hang out your " + multiCockDescriptLight() + "; ");
	...
	if(player.balls > 0) outputText("A set of warm, long-nailed fingers squeeze your " + ballsDescriptLight() + ", dragging sharp nail-tips along the underside of your sack to tease the poor, cum-packed orbs.  ");
	...
	outputText(".  \"<i>Jeeze, pent up much?</i>\" she laughs, struggling to stand while giggling at her own supposed cleverness.  Happy with how the contest worked out, you slip " + sMultiCockDesc() + " into your " + player.armorName + " and wobble off back to camp.");
	//(-100 lust, -1 int)
	player.orgasm();
	dynStats("int", -1);
...
private function roxanneReamsYouNormal():void {
	...
	if(player.tailType > TAIL_TYPE_NONE) outputText("tail-hole");
...
private function roxanneFucksYourAssOHGODITSHUGE():void {
	...
	outputText("Oh gods, Roxanne's right.  She finished getting you naked while she was talking, and you're completely exposed.  Her hands grab your arm and pull, rolling you onto your front and letting your " + player.legs() + " hang off the side of her bed toward the floor.  It's such a silly pose that you nearly forget how perfect a target it makes your " + buttDescript() + "!  The now-confident lizan gives your butt-cheek a slap, giggling when you start in surprise.  ");
	if(player.tailType > TAIL_TYPE_NONE) outputText("She lifts your tail ");
	...
	if(player.skinType == SKIN_TYPE_PLAIN) outputText(", leaving red lines in your unblemished skin");
	...
	if(player.skinType == SKIN_TYPE_SCALES) outputText("a roughly-scratched 'X' on your scales");
