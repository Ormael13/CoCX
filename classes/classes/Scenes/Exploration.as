...
public class Exploration extends BaseContent implements SaveableState
	{
		...
		public function doExplore():void {
			...
			if (player.hasStatusEffect(StatusEffects.MeetXuviel)) {
				...
				//if (player.statusEffectv1(StatusEffects.MeetXuviel) == 3) addButton(11, "X-Canndies", SceneLib.demonicLair.questProgressScenes).hint("Uncle X have candies for naughty girl like you.");
			}
