...
public class Exploration extends BaseContent implements SaveableState
	{
		...
		public function doExplore():void {
			...
			if (player.hasStatusEffect(StatusEffects.MeetXuviel) && player.statusEffectv1(StatusEffects.MeetXuviel) < 4) {
				...
				if (player.statusEffectv1(StatusEffects.MeetXuviel) == 3 && player.statusEffectv2(StatusEffects.MeetXuviel) == 0 && player.cor >= 100 && SceneLib.dungeons.checkFactoryClear()) addButton(11, "CumX", SceneLib.demonicLair.questProgressScenes).hint("Naughty girls like you not run away from Uncle X.");
			}
