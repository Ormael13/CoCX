			...
			if (player.explored > 1) {
				...
				*/
				...
				if (choosey == 0) {
					...
					outputText("\n\nAfterward, you're left alone.  You wander around, checking a few places of interest before you decide it's time to return to your camp.  With the guide in your hands, you're sure you'll find this place again with ease if you need to.");
