package classes.Scenes.Camp 
{
	...
	public class CabinProgress extends BaseContent {
		...
		private function doCabinWork1():void {
			...
			if (player.hasStatusAffect(StatusAffects.CampRathazul)) outputText("\"<i>My, my. What are you building?</i>\" Rathazul asks. \n\n");
			if (player.hasStatusAffect(StatusAffects.PureCampJojo)) outputText("\"<i>You're building something?</i>\" Jojo asks. \n\n");
