...
public class CampMakeWinions extends BaseContent
	{
		...
		public function playerAlreadyHaveAnyTamedMonster():Boolean {
			return player.hasStatusEffect(StatusEffects.TamedMonster01) || player.hasStatusEffect(StatusEffects.TamedMonster02) || player.hasStatusEffect(StatusEffects.TamedMonster03)
		...
		private function currentTamedMonstersCount():Number {
			...
			if (player.hasStatusEffect(StatusEffects.TamedMonster09)) cTMC += 1;
			if (player.hasStatusEffect(StatusEffects.TamedMonster10)) cTMC += 1;
			if (player.hasStatusEffect(StatusEffects.TamedMonster11)) cTMC += 1;
			if (player.hasStatusEffect(StatusEffects.TamedMonster12)) cTMC += 1;
			if (player.hasStatusEffect(StatusEffects.TamedMonster13)) cTMC += 1;
		...
		public function currentTamedMonstersIncludingGroupsCount():Number {
			...
			if (player.statusEffectv4(StatusEffects.TamedMonster06) > 0) cTMIGC += player.statusEffectv4(StatusEffects.TamedMonster06);
			if (player.statusEffectv4(StatusEffects.TamedMonster07) > 0) cTMIGC += player.statusEffectv4(StatusEffects.TamedMonster07);
			if (player.statusEffectv4(StatusEffects.TamedMonster08) > 0) cTMIGC += player.statusEffectv4(StatusEffects.TamedMonster08);
			if (player.statusEffectv4(StatusEffects.TamedMonster09) > 0) cTMIGC += player.statusEffectv4(StatusEffects.TamedMonster09);
			if (player.statusEffectv4(StatusEffects.TamedMonster10) > 0) cTMIGC += player.statusEffectv4(StatusEffects.TamedMonster10);
			if (player.statusEffectv4(StatusEffects.TamedMonster11) > 0) cTMIGC += player.statusEffectv4(StatusEffects.TamedMonster11);
			if (player.statusEffectv4(StatusEffects.TamedMonster12) > 0) cTMIGC += player.statusEffectv4(StatusEffects.TamedMonster12);
			return cTMIGC;
		}
		...
		private function currentGroupSizeCap():Number {
			...
			if (player.hasPerk(PerkLib.ApesTogetherStrongSu)) cGC += 2;
			if (player.hasPerk(PerkLib.ApesTogetherStronger)) cGC += 1;
			if (player.hasPerk(PerkLib.ApesTogetherStrongerEx)) cGC += 1;
			if (player.hasPerk(PerkLib.ApesTogetherStrongest)) cGC += 2;
		...
		private function currentGroupCountCap():Number {
			var cGCC:Number = 1;
			if (player.hasPerk(PerkLib.ApesTogetherStrongEx)) cGCC += 1;
			if (player.hasPerk(PerkLib.ApesTogetherStronger)) cGCC += 1;
			if (player.hasPerk(PerkLib.ApesTogetherStrongerEx)) cGCC += 1;
			if (player.hasPerk(PerkLib.ApesTogetherStrongest)) cGCC += 2;
			if (player.hasPerk(PerkLib.WhereAreYouGettingAllTheseApesFrom)) cGCC += 1;
			if (player.hasPerk(PerkLib.ThatsEnoughApes)) cGCC += 2;
			return cGCC;
		}
		...
		public function monsterBaseStatsMultiplier(group:Number = 0):Number {
			...
			if (player.hasPerk(PerkLib.ApesTogetherStrongerEx)) mBSM += 0.5;
			if (player.hasPerk(PerkLib.ApesTogetherStrongest)) mBSM += 2;
			...
			if (group == 5 && player.statusEffectv4(StatusEffects.TamedMonster05) > 0) mBSM *= mGBSM;
			if (group == 6 && player.statusEffectv4(StatusEffects.TamedMonster06) > 0) mBSM *= mGBSM;
			if (group == 7 && player.statusEffectv4(StatusEffects.TamedMonster07) > 0) mBSM *= mGBSM;
			if (group == 8 && player.statusEffectv4(StatusEffects.TamedMonster08) > 0) mBSM *= mGBSM;
			if (group == 9 && player.statusEffectv4(StatusEffects.TamedMonster09) > 0) mBSM *= mGBSM;
			if (group == 10 && player.statusEffectv4(StatusEffects.TamedMonster10) > 0) mBSM *= mGBSM;
		...
		public function accessTamedWinionsMainMenu(page:int = 1):void {
			...
			if (player.hasStatusEffect(StatusEffects.TamedMonster01)) {
				outputText(flags[kFLAGS.TAMED_01_NAME] + (player.statusEffectv4(StatusEffects.TamedMonster01)>0?" ("+(player.statusEffectv4(StatusEffects.TamedMonster01)+1)+"x)":"") + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster01)*monsterBaseStatsMultiplier(1)) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster01a)*monsterBaseStatsMultiplier(1)) + ", ");
				outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster01a)*monsterBaseStatsMultiplier(1)) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster01a)*monsterBaseStatsMultiplier(1)) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster01b)*monsterBaseStatsMultiplier(1)) + ", ");
				outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster01b)*monsterBaseStatsMultiplier(1)) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster01b)*monsterBaseStatsMultiplier(1)) + ")\n");
				outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster01) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster01) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster01a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster01a) + "":"") + ")");
			}
			...
			if (player.hasPerk(PerkLib.Beast02)) {
				...
				if (player.hasStatusEffect(StatusEffects.TamedMonster02)) {
					outputText(flags[kFLAGS.TAMED_02_NAME] + (player.statusEffectv4(StatusEffects.TamedMonster02)>0?" ("+(player.statusEffectv4(StatusEffects.TamedMonster02)+1)+"x)":"") + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster02)*monsterBaseStatsMultiplier(2)) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster02a)*monsterBaseStatsMultiplier(2)) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster02a)*monsterBaseStatsMultiplier(2)) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster02a)*monsterBaseStatsMultiplier(2)) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster02b)*monsterBaseStatsMultiplier(2)) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster02b)*monsterBaseStatsMultiplier(2)) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster02b)*monsterBaseStatsMultiplier(2)) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster02) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster02) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster02a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster02a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.ThreeTimesATame)) {
				...
				if (player.hasStatusEffect(StatusEffects.TamedMonster03)) {
					outputText(flags[kFLAGS.TAMED_03_NAME] + (player.statusEffectv4(StatusEffects.TamedMonster03)>0?" ("+(player.statusEffectv4(StatusEffects.TamedMonster03)+1)+"x)":"") + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster03)*monsterBaseStatsMultiplier(3)) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster03a)*monsterBaseStatsMultiplier(3)) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster03a)*monsterBaseStatsMultiplier(3)) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster03a)*monsterBaseStatsMultiplier(3)) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster03b)*monsterBaseStatsMultiplier(3)) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster03b)*monsterBaseStatsMultiplier(3)) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster03b)*monsterBaseStatsMultiplier(3)) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster03) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster03) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster03a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster03a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.FourthTamerOfTheApocalypse)) {
				...
				if (player.hasStatusEffect(StatusEffects.TamedMonster04)) {
					outputText(flags[kFLAGS.TAMED_04_NAME] + (player.statusEffectv4(StatusEffects.TamedMonster04)>0?" ("+(player.statusEffectv4(StatusEffects.TamedMonster04)+1)+"x)":"") + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster04)*monsterBaseStatsMultiplier(4)) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster04a)*monsterBaseStatsMultiplier(4)) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster04a)*monsterBaseStatsMultiplier(4)) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster04a)*monsterBaseStatsMultiplier(4)) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster04b)*monsterBaseStatsMultiplier(4)) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster04b)*monsterBaseStatsMultiplier(4)) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster04b)*monsterBaseStatsMultiplier(4)) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster04) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster04) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster04a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster04a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.FifthTamed)) {
				...
				if (player.hasStatusEffect(StatusEffects.TamedMonster05)) {
					outputText(flags[kFLAGS.TAMED_05_NAME] + (player.statusEffectv4(StatusEffects.TamedMonster05)>0?" ("+(player.statusEffectv4(StatusEffects.TamedMonster05)+1)+"x)":"") + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster05)*monsterBaseStatsMultiplier(5)) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster05a)*monsterBaseStatsMultiplier(5)) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster05a)*monsterBaseStatsMultiplier(5)) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster05a)*monsterBaseStatsMultiplier(5)) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster05b)*monsterBaseStatsMultiplier(5)) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster05b)*monsterBaseStatsMultiplier(5)) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster05b)*monsterBaseStatsMultiplier(5)) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster05) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster05) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster05a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster05a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.SicEmSix)) {
				...
				if (player.hasStatusEffect(StatusEffects.TamedMonster06)) {
					outputText(flags[kFLAGS.TAMED_06_NAME] + (player.statusEffectv4(StatusEffects.TamedMonster06)>0?" ("+(player.statusEffectv4(StatusEffects.TamedMonster06)+1)+"x)":"") + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster06)*monsterBaseStatsMultiplier(6)) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster06a)*monsterBaseStatsMultiplier(6)) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster06a)*monsterBaseStatsMultiplier(6)) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster06a)*monsterBaseStatsMultiplier(6)) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster06b)*monsterBaseStatsMultiplier(6)) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster06b)*monsterBaseStatsMultiplier(6)) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster06b)*monsterBaseStatsMultiplier(6)) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster06) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster06) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster06a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster06a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.LuckyNumberTamer)) {
				...
				if (player.hasStatusEffect(StatusEffects.TamedMonster07)) {
					outputText(flags[kFLAGS.TAMED_07_NAME] + (player.statusEffectv4(StatusEffects.TamedMonster07)>0?" ("+(player.statusEffectv4(StatusEffects.TamedMonster07)+1)+"x)":"") + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster07)*monsterBaseStatsMultiplier()) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster07a)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster07a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster07a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster07b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster07b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster07b)*monsterBaseStatsMultiplier()) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster07) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster07) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster07a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster07a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.KaijuNo8)) {
				...
				if (player.hasStatusEffect(StatusEffects.TamedMonster08)) {
					outputText(flags[kFLAGS.TAMED_08_NAME] + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster08)*monsterBaseStatsMultiplier()) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster08a)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster08a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster08a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster08b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster08b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster08b)*monsterBaseStatsMultiplier()) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster08) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster08) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster08a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster08a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.CloudNumber9)) {
				outputText("\n<b>Tamed Monster No.9:</b> ");
				if (player.hasStatusEffect(StatusEffects.TamedMonster09)) {
					outputText(flags[kFLAGS.TAMED_09_NAME] + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster09)*monsterBaseStatsMultiplier()) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster09a)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster09a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster09a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster09b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster09b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster09b)*monsterBaseStatsMultiplier()) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster09) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster09) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster09a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster09a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.ThereIs10TypesOfTamedMonsters)) {
				outputText("\n<b>Tamed Monster No.10:</b> ");
				if (player.hasStatusEffect(StatusEffects.TamedMonster10)) {
					outputText(flags[kFLAGS.TAMED_10_NAME] + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster10)*monsterBaseStatsMultiplier()) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster10a)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster10a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster10a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster10b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster10b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster10b)*monsterBaseStatsMultiplier()) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster10) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster10) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster10a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster10a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.UpToEleven)) {
				outputText("\n<b>Tamed Monster No.11:</b> ");
				if (player.hasStatusEffect(StatusEffects.TamedMonster11)) {
					outputText(flags[kFLAGS.TAMED_11_NAME] + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster11)*monsterBaseStatsMultiplier()) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster11a)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster11a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster11a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster11b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster11b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster11b)*monsterBaseStatsMultiplier()) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster11) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster11) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster11a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster11a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.DirtyDozen)) {
				outputText("\n<b>Tamed Monster No.12:</b> ");
				if (player.hasStatusEffect(StatusEffects.TamedMonster12)) {
					outputText(flags[kFLAGS.TAMED_12_NAME] + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster12)*monsterBaseStatsMultiplier()) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster12a)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster12a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster12a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster12b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster12b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster12b)*monsterBaseStatsMultiplier()) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster12) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster12) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster12a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster12a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.Friday13th)) {
				outputText("\n<b>Tamed Monster No.13:</b> ");
				if (player.hasStatusEffect(StatusEffects.TamedMonster13)) {
					outputText(flags[kFLAGS.TAMED_13_NAME] + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster13)*monsterBaseStatsMultiplier()) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster13a)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster13a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster13a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster13b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster13b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster13b)*monsterBaseStatsMultiplier()) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster13) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster13) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster13a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster13a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.Lucky14)) {
				outputText("\n<b>Tamed Monster No.14:</b> ");
				if (player.hasStatusEffect(StatusEffects.TamedMonster14)) {
					outputText(flags[kFLAGS.TAMED_14_NAME] + "\n(Atk: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster14)*monsterBaseStatsMultiplier()) + ", Str: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster14a)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster14a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster14a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster14b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster14b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster14b)*monsterBaseStatsMultiplier()) + ")\n");
			...
			if (player.hasPerk(PerkLib.)) {
				...
				if (player.hasStatusEffect(StatusEffects.TamedMonster15)) {
					...
					outputText("Tou: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster15a)*monsterBaseStatsMultiplier()) + ", Spe: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster15a)*monsterBaseStatsMultiplier()) + ", Int: " + Math.round(player.statusEffectv1(StatusEffects.TamedMonster15b)*monsterBaseStatsMultiplier()) + ", ");
					outputText("Wis: " + Math.round(player.statusEffectv2(StatusEffects.TamedMonster15b)*monsterBaseStatsMultiplier()) + ", Lib: " + Math.round(player.statusEffectv3(StatusEffects.TamedMonster15b)*monsterBaseStatsMultiplier()) + ")\n");
					outputText("(Spellcaster: " + (player.statusEffectv2(StatusEffects.TamedMonster15) > 0?"Yes":"No") + ", Flyer: " + (player.statusEffectv3(StatusEffects.TamedMonster15) > 0?"Yes":"No") + "" + (player.statusEffectv4(StatusEffects.TamedMonster15a) > 0?", Multiattack: " + player.statusEffectv4(StatusEffects.TamedMonster15a) + "":"") + ")");
				}
				else outputText("None");
			}
			if (player.hasPerk(PerkLib.)) {
			...
			if (page == 1) {
				...
				if (player.hasPerk(PerkLib.CloudNumber9)) addButtonIfTrue(9, "No.9", curry(tamingAttemptRelease, 9, true), "You do not have Monster No.9 tamed", player.hasStatusEffect(StatusEffects.TamedMonster09), "Release Monster No.9");
				addButton(10, "Next", accessTamedWinionsMainMenu, page + 1);
				addButton(11, "Prev", accessTamedWinionsMainMenu, page + 2);
			}
			if (page == 2) {
				if (player.hasPerk(PerkLib.ThereIs10TypesOfTamedMonsters)) addButtonIfTrue(0, "No.10", curry(tamingAttemptRelease, 10, true), "You do not have Monster No.10 tamed", player.hasStatusEffect(StatusEffects.TamedMonster10), "Release Monster No.10");
				if (player.hasPerk(PerkLib.UpToEleven)) addButtonIfTrue(1, "No.11", curry(tamingAttemptRelease, 11, true), "You do not have Monster No.11 tamed", player.hasStatusEffect(StatusEffects.TamedMonster11), "Release Monster No.11");
		...
		public function tamingAttempt2(page:int = 1):void {
			...
			if (page == 1) {
				...
				if (player.hasPerk(PerkLib.Beast02)) addButtonIfTrue(2, "Release 02", curry(tamingAttemptRelease, 2), "You do not have any tamed monster No.2", player.hasStatusEffect(StatusEffects.TamedMonster02), "Release Monster No.2");
				if (player.hasPerk(PerkLib.ThreeTimesATame)) addButtonIfTrue(3, "Release 03", curry(tamingAttemptRelease, 3), "You do not have any tamed monster No.3", player.hasStatusEffect(StatusEffects.TamedMonster03), "Release Monster No.3");
				if (player.hasPerk(PerkLib.FourthTamerOfTheApocalypse)) addButtonIfTrue(4, "Release 04", curry(tamingAttemptRelease, 4), "You do not have any tamed monster No.4", player.hasStatusEffect(StatusEffects.TamedMonster04), "Release Monster No.4");
				if (player.hasPerk(PerkLib.FifthTamed)) addButtonIfTrue(5, "Release 05", curry(tamingAttemptRelease, 5), "You do not have any tamed monster No.5", player.hasStatusEffect(StatusEffects.TamedMonster05), "Release Monster No.5");
				if (player.hasPerk(PerkLib.SicEmSix)) addButtonIfTrue(6, "Release 06", curry(tamingAttemptRelease, 6), "You do not have any tamed monster No.6", player.hasStatusEffect(StatusEffects.TamedMonster06), "Release Monster No.6");
				if (player.hasPerk(PerkLib.LuckyNumberTamer)) addButtonIfTrue(7, "Release 07", curry(tamingAttemptRelease, 7), "You do not have any tamed monster No.7", player.hasStatusEffect(StatusEffects.TamedMonster07), "Release Monster No.7");
				if (player.hasPerk(PerkLib.KaijuNo8)) addButtonIfTrue(8, "Release 08", curry(tamingAttemptRelease, 8), "You do not have any tamed monster No.8", player.hasStatusEffect(StatusEffects.TamedMonster08), "Release Monster No.8");
			...
			if (page == 2) {
				if (player.hasPerk(PerkLib.ThereIs10TypesOfTamedMonsters)) addButtonIfTrue(0, "Release 10", curry(tamingAttemptRelease, 10), "You do not have any tamed monster No.10", player.hasStatusEffect(StatusEffects.TamedMonster10), "Release Monster No.10");
				if (player.hasPerk(PerkLib.UpToEleven)) addButtonIfTrue(1, "Release 11", curry(tamingAttemptRelease, 11), "You do not have any tamed monster No.11", player.hasStatusEffect(StatusEffects.TamedMonster11), "Release Monster No.11");
			...
			if (page == 3) {
				...
				addButton(13, "Next", tamingAttempt2, page - 2);
				addButton(14, "Prev", tamingAttempt2, page - 1);
			}
		}
		public function tamingAttemptYes():void {
			...
			if (playerWisdomCheck() > monsterWisdomCheck()) {
				...
				if (!player.hasStatusEffect(StatusEffects.TamedMonster12) && !onlyOneTamingAtTime && (currentTamedMonstersCount() < currentTamingCap())) {
					flags[kFLAGS.TAMED_12_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster12, monster.weaponAttack, 0, 0, 0);
					player.createStatusEffect(StatusEffects.TamedMonster12a, monster.strStat.core.value, monster.touStat.core.value, monster.speStat.core.value, 0);
				...
				if (!player.hasStatusEffect(StatusEffects.TamedMonster13) && !onlyOneTamingAtTime && (currentTamedMonstersCount() < currentTamingCap())) {
					flags[kFLAGS.TAMED_13_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster13, monster.weaponAttack, 0, 0, 0);
					player.createStatusEffect(StatusEffects.TamedMonster13a, monster.strStat.core.value, monster.touStat.core.value, monster.speStat.core.value, 0);
					player.createStatusEffect(StatusEffects.TamedMonster13b, monster.intStat.core.value, monster.wisStat.core.value, monster.libStat.core.value, 0);
					if (monster.magicuser) player.addStatusValue(StatusEffects.TamedMonster13, 2, 1);
					if (monster.flyer) player.addStatusValue(StatusEffects.TamedMonster13, 3, 1);
					if (monster.meleemultiatks > 1) player.addStatusValue(StatusEffects.TamedMonster13a, 4, monster.meleemultiatks);
					onlyOneTamingAtTime = true;
				}
				if (!player.hasStatusEffect(StatusEffects.TamedMonster14) && !onlyOneTamingAtTime && (currentTamedMonstersCount() < currentTamingCap())) {
					flags[kFLAGS.TAMED_14_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster14, monster.weaponAttack, 0, 0, 0);
					player.createStatusEffect(StatusEffects.TamedMonster14a, monster.strStat.core.value, monster.touStat.core.value, monster.speStat.core.value, 0);
					player.createStatusEffect(StatusEffects.TamedMonster14b, monster.intStat.core.value, monster.wisStat.core.value, monster.libStat.core.value, 0);
					if (monster.magicuser) player.addStatusValue(StatusEffects.TamedMonster14, 2, 1);
					if (monster.flyer) player.addStatusValue(StatusEffects.TamedMonster14, 3, 1);
					if (monster.meleemultiatks > 1) player.addStatusValue(StatusEffects.TamedMonster14a, 4, monster.meleemultiatks);
					onlyOneTamingAtTime = true;
				}
				if (!player.hasStatusEffect(StatusEffects.TamedMonster15) && !onlyOneTamingAtTime && (currentTamedMonstersCount() < currentTamingCap())) {
					flags[kFLAGS.TAMED_15_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster15, monster.weaponAttack, 0, 0, 0);
					player.createStatusEffect(StatusEffects.TamedMonster15a, monster.strStat.core.value, monster.touStat.core.value, monster.speStat.core.value, 0);
					player.createStatusEffect(StatusEffects.TamedMonster15b, monster.intStat.core.value, monster.wisStat.core.value, monster.libStat.core.value, 0);
					if (monster.magicuser) player.addStatusValue(StatusEffects.TamedMonster15, 2, 1);
					if (monster.flyer) player.addStatusValue(StatusEffects.TamedMonster15, 3, 1);
					if (monster.meleemultiatks > 1) player.addStatusValue(StatusEffects.TamedMonster15a, 4, monster.meleemultiatks);
					onlyOneTamingAtTime = true;
				}
				if (!player.hasStatusEffect(StatusEffects.TamedMonster16) && !onlyOneTamingAtTime && (currentTamedMonstersCount() < currentTamingCap())) {
					flags[kFLAGS.TAMED_16_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster16, monster.weaponAttack, 0, 0, 0);
					player.createStatusEffect(StatusEffects.TamedMonster16a, monster.strStat.core.value, monster.touStat.core.value, monster.speStat.core.value, 0);
					player.createStatusEffect(StatusEffects.TamedMonster16b, monster.intStat.core.value, monster.wisStat.core.value, monster.libStat.core.value, 0);
					if (monster.magicuser) player.addStatusValue(StatusEffects.TamedMonster16, 2, 1);
					if (monster.flyer) player.addStatusValue(StatusEffects.TamedMonster16, 3, 1);
				...
				if (!player.hasStatusEffect(StatusEffects.TamedMonster52) && !onlyOneTamingAtTime) {
					flags[kFLAGS.TAMED_A2_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster52, 0, 0, 0, 0);
					onlyOneTamingAtTime = true;
				}
				if (!player.hasStatusEffect(StatusEffects.TamedMonster53) && !onlyOneTamingAtTime) {
					flags[kFLAGS.TAMED_A3_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster53, 0, 0, 0, 0);
					onlyOneTamingAtTime = true;
				}
				if (!player.hasStatusEffect(StatusEffects.TamedMonster54) && !onlyOneTamingAtTime) {
					flags[kFLAGS.TAMED_A4_NAME] = monster.short;
				...
				if (!player.hasStatusEffect(StatusEffects.TamedMonster57) && !onlyOneTamingAtTime) {
					flags[kFLAGS.TAMED_A7_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster57, 0, 0, 0, 0);
					onlyOneTamingAtTime = true;
				}
				if (!player.hasStatusEffect(StatusEffects.TamedMonster58) && !onlyOneTamingAtTime) {
					flags[kFLAGS.TAMED_A8_NAME] = monster.short;
					player.createStatusEffect(StatusEffects.TamedMonster58, 0, 0, 0, 0);
					onlyOneTamingAtTime = true;
				}
				if (!player.hasStatusEffect(StatusEffects.TamedMonster59) && !onlyOneTamingAtTime) {
					flags[kFLAGS.TAMED_A9_NAME] = monster.short;
		...
		public function moveTamedMonsters(page:int = 1):void {
			clearOutput();
			outputText("Which one tamed monsters you decide to move from main roster to reserve roster?\n\n");
			menu();
			if (page == 1) {
		...
		public function groupUpTamedMonsters(page:int = 1):void {
			...
			outputText("Group 1: "+(player.statusEffectv4(StatusEffects.TamedMonster01)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 1) outputText("Group 2: "+(player.statusEffectv4(StatusEffects.TamedMonster02)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 2) outputText("Group 3: "+(player.statusEffectv4(StatusEffects.TamedMonster03)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 3) outputText("Group 4: "+(player.statusEffectv4(StatusEffects.TamedMonster04)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 4) outputText("Group 5: "+(player.statusEffectv4(StatusEffects.TamedMonster05)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 5) outputText("Group 6: "+(player.statusEffectv4(StatusEffects.TamedMonster06)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 6) outputText("Group 7: "+(player.statusEffectv4(StatusEffects.TamedMonster07)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 7) outputText("Group 8: "+(player.statusEffectv4(StatusEffects.TamedMonster08)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 8) outputText("Group 9: "+(player.statusEffectv4(StatusEffects.TamedMonster09)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 9) outputText("Group 10: "+(player.statusEffectv4(StatusEffects.TamedMonster10)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 10) outputText("Group 11: "+(player.statusEffectv4(StatusEffects.TamedMonster11)+1)+" / "+currentGroupSizeCap()+"\n");
			if (currentGroupCountCap() > 11) outputText("Group 12: "+(player.statusEffectv4(StatusEffects.TamedMonster12)+1)+" / "+currentGroupSizeCap()+"\n");
			menu();
			if (page == 1) {
		...
		public function groupUpTamedMonsters2(tameMon:Number, page:Number):void {
			menu();
			if (tameMon == 01) {
				//0 for ring of taming monster
				...
				addButtonIfTrue(6, "-7-",  curry(groupUpTamedMonsters3, 1, 7, flags[kFLAGS.TAMED_01_NAME], flags[kFLAGS.TAMED_07_NAME]), "You do not have Monster No.7 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster07) && player.statusEffectv4(StatusEffects.TamedMonster07) == 0), "Add to Group No.1 monster from slot 7.");
				addButtonIfTrue(7, "-8-",  curry(groupUpTamedMonsters3, 1, 8, flags[kFLAGS.TAMED_01_NAME], flags[kFLAGS.TAMED_08_NAME]), "You do not have Monster No.8 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster08) && player.statusEffectv4(StatusEffects.TamedMonster08) == 0), "Add to Group No.1 monster from slot 8.");
			...
			if (tameMon == 02) {
				...
				addButtonIfTrue(3, "-A4-",  curry(groupUpTamedMonsters3, 1, 54, flags[kFLAGS.TAMED_01_NAME], flags[kFLAGS.TAMED_A4_NAME]), "You do not have Monster No.A4 tamed", player.hasStatusEffect(StatusEffects.TamedMonster54), "Add to Group No.1 monster from slot A4.");
				addButtonIfTrue(4, "-A5-",  curry(groupUpTamedMonsters3, 1, 55, flags[kFLAGS.TAMED_01_NAME], flags[kFLAGS.TAMED_A5_NAME]), "You do not have Monster No.A5 tamed", player.hasStatusEffect(StatusEffects.TamedMonster55), "Add to Group No.1 monster from slot A5.");
				addButtonIfTrue(5, "-A6-",  curry(groupUpTamedMonsters3, 1, 56, flags[kFLAGS.TAMED_01_NAME], flags[kFLAGS.TAMED_A6_NAME]), "You do not have Monster No.A6 tamed", player.hasStatusEffect(StatusEffects.TamedMonster56), "Add to Group No.1 monster from slot A6.");
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 1, 57, flags[kFLAGS.TAMED_01_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.1 monster from slot A7.");
			...
			if (tameMon == 03) {
				...
				addButtonIfTrue(6, "-7-",  curry(groupUpTamedMonsters3, 2, 7, flags[kFLAGS.TAMED_02_NAME], flags[kFLAGS.TAMED_07_NAME]), "You do not have Monster No.7 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster07) && player.statusEffectv4(StatusEffects.TamedMonster07) == 0), "Add to Group No.2 monster from slot 7.");
				addButtonIfTrue(7, "-8-",  curry(groupUpTamedMonsters3, 2, 8, flags[kFLAGS.TAMED_02_NAME], flags[kFLAGS.TAMED_08_NAME]), "You do not have Monster No.8 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster08) && player.statusEffectv4(StatusEffects.TamedMonster08) == 0), "Add to Group No.2 monster from slot 8.");
			...
			if (tameMon == 04) {
				...
				addButtonIfTrue(3, "-A4-",  curry(groupUpTamedMonsters3, 2, 54, flags[kFLAGS.TAMED_02_NAME], flags[kFLAGS.TAMED_A4_NAME]), "You do not have Monster No.A4 tamed", player.hasStatusEffect(StatusEffects.TamedMonster54), "Add to Group No.2 monster from slot A4.");
				addButtonIfTrue(4, "-A5-",  curry(groupUpTamedMonsters3, 2, 55, flags[kFLAGS.TAMED_02_NAME], flags[kFLAGS.TAMED_A5_NAME]), "You do not have Monster No.A5 tamed", player.hasStatusEffect(StatusEffects.TamedMonster55), "Add to Group No.2 monster from slot A5.");
				addButtonIfTrue(5, "-A6-",  curry(groupUpTamedMonsters3, 2, 56, flags[kFLAGS.TAMED_02_NAME], flags[kFLAGS.TAMED_A6_NAME]), "You do not have Monster No.A6 tamed", player.hasStatusEffect(StatusEffects.TamedMonster56), "Add to Group No.2 monster from slot A6.");
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 2, 57, flags[kFLAGS.TAMED_02_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.2 monster from slot A7.");
			...
			if (tameMon == 05) {
				...
				addButtonIfTrue(3, "-4-",  curry(groupUpTamedMonsters3, 3, 4, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_04_NAME]), "You do not have Monster No.4 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster04) && player.statusEffectv4(StatusEffects.TamedMonster04) == 0), "Add to Group No.3 monster from slot 4.");
				addButtonIfTrue(4, "-5-",  curry(groupUpTamedMonsters3, 3, 5, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_05_NAME]), "You do not have Monster No.5 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster05) && player.statusEffectv4(StatusEffects.TamedMonster05) == 0), "Add to Group No.3 monster from slot 5.");
				addButtonIfTrue(5, "-6-",  curry(groupUpTamedMonsters3, 3, 6, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_06_NAME]), "You do not have Monster No.6 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster06) && player.statusEffectv4(StatusEffects.TamedMonster06) == 0), "Add to Group No.3 monster from slot 6.");
				addButtonIfTrue(6, "-7-",  curry(groupUpTamedMonsters3, 3, 7, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_07_NAME]), "You do not have Monster No.7 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster07) && player.statusEffectv4(StatusEffects.TamedMonster07) == 0), "Add to Group No.3 monster from slot 7.");
				addButtonIfTrue(7, "-8-",  curry(groupUpTamedMonsters3, 3, 8, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_08_NAME]), "You do not have Monster No.8 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster08) && player.statusEffectv4(StatusEffects.TamedMonster08) == 0), "Add to Group No.3 monster from slot 8.");
			...
			if (tameMon == 06) {
				...
				addButtonIfTrue(3, "-A4-",  curry(groupUpTamedMonsters3, 3, 54, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_A4_NAME]), "You do not have Monster No.A4 tamed", player.hasStatusEffect(StatusEffects.TamedMonster54), "Add to Group No.3 monster from slot A4.");
				addButtonIfTrue(4, "-A5-",  curry(groupUpTamedMonsters3, 3, 55, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_A5_NAME]), "You do not have Monster No.A5 tamed", player.hasStatusEffect(StatusEffects.TamedMonster55), "Add to Group No.3 monster from slot A5.");
				addButtonIfTrue(5, "-A6-",  curry(groupUpTamedMonsters3, 3, 56, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_A6_NAME]), "You do not have Monster No.A6 tamed", player.hasStatusEffect(StatusEffects.TamedMonster56), "Add to Group No.3 monster from slot A6.");
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 3, 57, flags[kFLAGS.TAMED_03_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.3 monster from slot A7.");
			...
			if (tameMon == 07) {
				...
				addButtonIfTrue(3, "-3-",  curry(groupUpTamedMonsters3, 4, 3, flags[kFLAGS.TAMED_04_NAME], flags[kFLAGS.TAMED_03_NAME]), "You do not have Monster No.3 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster03) && player.statusEffectv4(StatusEffects.TamedMonster03) == 0), "Add to Group No.4 monster from slot 3.");
				addButtonIfTrue(4, "-5-",  curry(groupUpTamedMonsters3, 4, 5, flags[kFLAGS.TAMED_04_NAME], flags[kFLAGS.TAMED_05_NAME]), "You do not have Monster No.5 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster05) && player.statusEffectv4(StatusEffects.TamedMonster05) == 0), "Add to Group No.4 monster from slot 5.");
				addButtonIfTrue(5, "-6-",  curry(groupUpTamedMonsters3, 4, 6, flags[kFLAGS.TAMED_04_NAME], flags[kFLAGS.TAMED_06_NAME]), "You do not have Monster No.6 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster06) && player.statusEffectv4(StatusEffects.TamedMonster06) == 0), "Add to Group No.4 monster from slot 6.");
				addButtonIfTrue(6, "-7-",  curry(groupUpTamedMonsters3, 4, 7, flags[kFLAGS.TAMED_04_NAME], flags[kFLAGS.TAMED_07_NAME]), "You do not have Monster No.7 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster07) && player.statusEffectv4(StatusEffects.TamedMonster07) == 0), "Add to Group No.4 monster from slot 7.");
				addButtonIfTrue(7, "-8-",  curry(groupUpTamedMonsters3, 4, 8, flags[kFLAGS.TAMED_04_NAME], flags[kFLAGS.TAMED_08_NAME]), "You do not have Monster No.8 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster08) && player.statusEffectv4(StatusEffects.TamedMonster08) == 0), "Add to Group No.4 monster from slot 8.");
			...
			if (tameMon == 08) {
				...
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 4, 57, flags[kFLAGS.TAMED_04_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.4 monster from slot A7.");
			...
			if (tameMon == 09) {
				...
				addButtonIfTrue(4, "-4-",  curry(groupUpTamedMonsters3, 5, 4, flags[kFLAGS.TAMED_05_NAME], flags[kFLAGS.TAMED_04_NAME]), "You do not have Monster No.4 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster04) && player.statusEffectv4(StatusEffects.TamedMonster04) == 0), "Add to Group No.5 monster from slot 4.");
				...
				addButtonIfTrue(6, "-7-",  curry(groupUpTamedMonsters3, 5, 7, flags[kFLAGS.TAMED_05_NAME], flags[kFLAGS.TAMED_07_NAME]), "You do not have Monster No.7 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster07) && player.statusEffectv4(StatusEffects.TamedMonster07) == 0), "Add to Group No.5 monster from slot 7.");
				addButtonIfTrue(7, "-8-",  curry(groupUpTamedMonsters3, 5, 8, flags[kFLAGS.TAMED_05_NAME], flags[kFLAGS.TAMED_08_NAME]), "You do not have Monster No.8 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster08) && player.statusEffectv4(StatusEffects.TamedMonster08) == 0), "Add to Group No.5 monster from slot 8.");
			...
			if (tameMon == 10) {
				...
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 5, 57, flags[kFLAGS.TAMED_05_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.5 monster from slot A7.");
			...
			if (tameMon == 11) {
				...
				addButtonIfTrue(3, "-3-",  curry(groupUpTamedMonsters3, 6, 3, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_03_NAME]), "You do not have Monster No.3 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster03) && player.statusEffectv4(StatusEffects.TamedMonster03) == 0), "Add to Group No.6 monster from slot 3.");
				addButtonIfTrue(4, "-4-",  curry(groupUpTamedMonsters3, 6, 4, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_04_NAME]), "You do not have Monster No.4 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster04) && player.statusEffectv4(StatusEffects.TamedMonster04) == 0), "Add to Group No.6 monster from slot 4.");
				addButtonIfTrue(5, "-5-",  curry(groupUpTamedMonsters3, 6, 5, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_05_NAME]), "You do not have Monster No.5 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster05) && player.statusEffectv4(StatusEffects.TamedMonster05) == 0), "Add to Group No.6 monster from slot 5.");
				addButtonIfTrue(6, "-7-",  curry(groupUpTamedMonsters3, 6, 7, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_07_NAME]), "You do not have Monster No.7 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster07) && player.statusEffectv4(StatusEffects.TamedMonster07) == 0), "Add to Group No.6 monster from slot 7.");
				addButtonIfTrue(7, "-8-",  curry(groupUpTamedMonsters3, 6, 8, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_08_NAME]), "You do not have Monster No.8 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster08) && player.statusEffectv4(StatusEffects.TamedMonster08) == 0), "Add to Group No.6 monster from slot 8.");
			...
			if (tameMon == 12) {
				...
				addButtonIfTrue(3, "-A4-",  curry(groupUpTamedMonsters3, 6, 54, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_A4_NAME]), "You do not have Monster No.A4 tamed", player.hasStatusEffect(StatusEffects.TamedMonster54), "Add to Group No.6 monster from slot A4.");
				addButtonIfTrue(4, "-A5-",  curry(groupUpTamedMonsters3, 6, 55, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_A5_NAME]), "You do not have Monster No.A5 tamed", player.hasStatusEffect(StatusEffects.TamedMonster55), "Add to Group No.6 monster from slot A5.");
				addButtonIfTrue(5, "-A6-",  curry(groupUpTamedMonsters3, 6, 56, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_A6_NAME]), "You do not have Monster No.A6 tamed", player.hasStatusEffect(StatusEffects.TamedMonster56), "Add to Group No.6 monster from slot A6.");
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 6, 57, flags[kFLAGS.TAMED_06_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.6 monster from slot A7.");
			...
			if (tameMon == 13) {
				...
				addButtonIfTrue(3, "-3-",  curry(groupUpTamedMonsters3, 7, 3, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_03_NAME]), "You do not have Monster No.3 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster03) && player.statusEffectv4(StatusEffects.TamedMonster03) == 0), "Add to Group No.7 monster from slot 3.");
				addButtonIfTrue(4, "-4-",  curry(groupUpTamedMonsters3, 7, 4, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_04_NAME]), "You do not have Monster No.4 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster04) && player.statusEffectv4(StatusEffects.TamedMonster04) == 0), "Add to Group No.7 monster from slot 4.");
				addButtonIfTrue(5, "-5-",  curry(groupUpTamedMonsters3, 7, 5, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_05_NAME]), "You do not have Monster No.5 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster05) && player.statusEffectv4(StatusEffects.TamedMonster05) == 0), "Add to Group No.7 monster from slot 5.");
				addButtonIfTrue(6, "-6-",  curry(groupUpTamedMonsters3, 7, 6, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_06_NAME]), "You do not have Monster No.6 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster06) && player.statusEffectv4(StatusEffects.TamedMonster06) == 0), "Add to Group No.7 monster from slot 6.");
				addButtonIfTrue(7, "-8-",  curry(groupUpTamedMonsters3, 7, 8, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_08_NAME]), "You do not have Monster No.8 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster08) && player.statusEffectv4(StatusEffects.TamedMonster08) == 0), "Add to Group No.7 monster from slot 8.");
			...
			if (tameMon == 14) {
				...
				addButtonIfTrue(3, "-A4-",  curry(groupUpTamedMonsters3, 7, 54, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_A4_NAME]), "You do not have Monster No.A4 tamed", player.hasStatusEffect(StatusEffects.TamedMonster54), "Add to Group No.7 monster from slot A4.");
				addButtonIfTrue(4, "-A5-",  curry(groupUpTamedMonsters3, 7, 55, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_A5_NAME]), "You do not have Monster No.A5 tamed", player.hasStatusEffect(StatusEffects.TamedMonster55), "Add to Group No.7 monster from slot A5.");
				addButtonIfTrue(5, "-A6-",  curry(groupUpTamedMonsters3, 7, 56, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_A6_NAME]), "You do not have Monster No.A6 tamed", player.hasStatusEffect(StatusEffects.TamedMonster56), "Add to Group No.7 monster from slot A6.");
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 7, 57, flags[kFLAGS.TAMED_07_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.7 monster from slot A7.");
			...
			if (tameMon == 15) {
				...
				addButtonIfTrue(3, "-3-",  curry(groupUpTamedMonsters3, 8, 3, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_03_NAME]), "You do not have Monster No.3 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster03) && player.statusEffectv4(StatusEffects.TamedMonster03) == 0), "Add to Group No.8 monster from slot 3.");
				addButtonIfTrue(4, "-4-",  curry(groupUpTamedMonsters3, 8, 4, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_04_NAME]), "You do not have Monster No.4 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster04) && player.statusEffectv4(StatusEffects.TamedMonster04) == 0), "Add to Group No.8 monster from slot 4.");
				addButtonIfTrue(5, "-5-",  curry(groupUpTamedMonsters3, 8, 5, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_05_NAME]), "You do not have Monster No.5 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster05) && player.statusEffectv4(StatusEffects.TamedMonster05) == 0), "Add to Group No.8 monster from slot 5.");
				addButtonIfTrue(6, "-6-",  curry(groupUpTamedMonsters3, 8, 6, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_06_NAME]), "You do not have Monster No.6 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster06) && player.statusEffectv4(StatusEffects.TamedMonster06) == 0), "Add to Group No.8 monster from slot 6.");
				addButtonIfTrue(7, "-7-",  curry(groupUpTamedMonsters3, 8, 7, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_07_NAME]), "You do not have Monster No.7 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster07) && player.statusEffectv4(StatusEffects.TamedMonster07) == 0), "Add to Group No.8 monster from slot 7.");
			...
			if (tameMon == 16) {
				...
				addButtonIfTrue(3, "-A4-",  curry(groupUpTamedMonsters3, 8, 54, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_A4_NAME]), "You do not have Monster No.A4 tamed", player.hasStatusEffect(StatusEffects.TamedMonster54), "Add to Group No.8 monster from slot A4.");
				addButtonIfTrue(4, "-A5-",  curry(groupUpTamedMonsters3, 8, 55, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_A5_NAME]), "You do not have Monster No.A5 tamed", player.hasStatusEffect(StatusEffects.TamedMonster55), "Add to Group No.8 monster from slot A5.");
				addButtonIfTrue(5, "-A6-",  curry(groupUpTamedMonsters3, 8, 56, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_A6_NAME]), "You do not have Monster No.A6 tamed", player.hasStatusEffect(StatusEffects.TamedMonster56), "Add to Group No.8 monster from slot A6.");
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 8, 57, flags[kFLAGS.TAMED_08_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.8 monster from slot A7.");
			...
			if (tameMon == 17) {
				...
				addButtonIfTrue(3, "-3-",  curry(groupUpTamedMonsters3, 9, 3, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_03_NAME]), "You do not have Monster No.3 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster03) && player.statusEffectv4(StatusEffects.TamedMonster03) == 0), "Add to Group No.9 monster from slot 3.");
				addButtonIfTrue(4, "-4-",  curry(groupUpTamedMonsters3, 9, 4, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_04_NAME]), "You do not have Monster No.4 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster04) && player.statusEffectv4(StatusEffects.TamedMonster04) == 0), "Add to Group No.9 monster from slot 4.");
				addButtonIfTrue(5, "-5-",  curry(groupUpTamedMonsters3, 9, 5, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_05_NAME]), "You do not have Monster No.5 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster05) && player.statusEffectv4(StatusEffects.TamedMonster05) == 0), "Add to Group No.9 monster from slot 5.");
				addButtonIfTrue(6, "-6-",  curry(groupUpTamedMonsters3, 9, 6, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_06_NAME]), "You do not have Monster No.6 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster06) && player.statusEffectv4(StatusEffects.TamedMonster06) == 0), "Add to Group No.9 monster from slot 6.");
				addButtonIfTrue(7, "-7-",  curry(groupUpTamedMonsters3, 9, 7, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_07_NAME]), "You do not have Monster No.7 tamed or it's not single monster in that slot", (player.hasStatusEffect(StatusEffects.TamedMonster07) && player.statusEffectv4(StatusEffects.TamedMonster07) == 0), "Add to Group No.9 monster from slot 7.");
			...
			if (tameMon == 18) {
				...
				addButtonIfTrue(3, "-A4-",  curry(groupUpTamedMonsters3, 9, 54, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_A4_NAME]), "You do not have Monster No.A4 tamed", player.hasStatusEffect(StatusEffects.TamedMonster54), "Add to Group No.9 monster from slot A4.");
				addButtonIfTrue(4, "-A5-",  curry(groupUpTamedMonsters3, 9, 55, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_A5_NAME]), "You do not have Monster No.A5 tamed", player.hasStatusEffect(StatusEffects.TamedMonster55), "Add to Group No.9 monster from slot A5.");
				addButtonIfTrue(5, "-A6-",  curry(groupUpTamedMonsters3, 9, 56, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_A6_NAME]), "You do not have Monster No.A6 tamed", player.hasStatusEffect(StatusEffects.TamedMonster56), "Add to Group No.9 monster from slot A6.");
				addButtonIfTrue(6, "-A7-",  curry(groupUpTamedMonsters3, 9, 57, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_A7_NAME]), "You do not have Monster No.A7 tamed", player.hasStatusEffect(StatusEffects.TamedMonster57), "Add to Group No.9 monster from slot A7.");
				addButtonIfTrue(7, "-A8-",  curry(groupUpTamedMonsters3, 9, 58, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_A8_NAME]), "You do not have Monster No.A8 tamed", player.hasStatusEffect(StatusEffects.TamedMonster58), "Add to Group No.9 monster from slot A8.");
				addButtonIfTrue(8, "-A9-",  curry(groupUpTamedMonsters3, 9, 59, flags[kFLAGS.TAMED_09_NAME], flags[kFLAGS.TAMED_A9_NAME]), "You do not have Monster No.A9 tamed", player.hasStatusEffect(StatusEffects.TamedMonster59), "Add to Group No.9 monster from slot A9.");
			}
			addButton(14, "Back", curry(groupUpTamedMonsters, page));
		}
		...
		public function groupUpTamedMonstersSuccess(tameMonA:Number, tameMonB:Number):void {
			...
			if (tameMonA == 8) player.addStatusValue(StatusEffects.TamedMonster08, 4, 1);
			if (tameMonA == 9) player.addStatusValue(StatusEffects.TamedMonster09, 4, 1);
			if (tameMonA == 10) player.addStatusValue(StatusEffects.TamedMonster10, 4, 1);
			if (tameMonA == 11) player.addStatusValue(StatusEffects.TamedMonster11, 4, 1);
			if (tameMonA == 12) player.addStatusValue(StatusEffects.TamedMonster12, 4, 1);
			clearingTamedMonsterSlot(tameMonB);
		...
		private function clearingTamedMonsterSlot(tameMon:Number, textOn:Boolean = false):void {
			...
			if (tameMon == 9) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_09_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster09);
				player.removeStatusEffect(StatusEffects.TamedMonster09a);
				player.removeStatusEffect(StatusEffects.TamedMonster09b);
				flags[kFLAGS.TAMED_09_NAME] = "";
			}
			if (tameMon == 10) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_10_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster10);
				player.removeStatusEffect(StatusEffects.TamedMonster10a);
				player.removeStatusEffect(StatusEffects.TamedMonster10b);
				flags[kFLAGS.TAMED_10_NAME] = "";
			}
			if (tameMon == 11) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_11_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster11);
				player.removeStatusEffect(StatusEffects.TamedMonster11a);
				player.removeStatusEffect(StatusEffects.TamedMonster11b);
				flags[kFLAGS.TAMED_11_NAME] = "";
			}
			if (tameMon == 12) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_12_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster12);
				player.removeStatusEffect(StatusEffects.TamedMonster12a);
				player.removeStatusEffect(StatusEffects.TamedMonster12b);
				flags[kFLAGS.TAMED_12_NAME] = "";
			}
			if (tameMon == 13) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_13_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster13);
				player.removeStatusEffect(StatusEffects.TamedMonster13a);
				player.removeStatusEffect(StatusEffects.TamedMonster13b);
				flags[kFLAGS.TAMED_13_NAME] = "";
			}
			if (tameMon == 14) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_14_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster14);
				player.removeStatusEffect(StatusEffects.TamedMonster14a);
				player.removeStatusEffect(StatusEffects.TamedMonster14b);
				flags[kFLAGS.TAMED_14_NAME] = "";
			}
			if (tameMon == 15) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_15_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster15);
				player.removeStatusEffect(StatusEffects.TamedMonster15a);
				player.removeStatusEffect(StatusEffects.TamedMonster15b);
				flags[kFLAGS.TAMED_15_NAME] = "";
			}
			if (tameMon == 16) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_16_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster16);
			...
			if (tameMon == 51) {
				...
				player.removeStatusEffect(StatusEffects.TamedMonster51);
				flags[kFLAGS.TAMED_A1_NAME] = "";
			}
			if (tameMon == 52) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_A2_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster52);
				flags[kFLAGS.TAMED_A2_NAME] = "";
			}
			if (tameMon == 53) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_A3_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster53);
				flags[kFLAGS.TAMED_A3_NAME] = "";
			}
			if (tameMon == 54) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_A4_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster54);
				flags[kFLAGS.TAMED_A4_NAME] = "";
			}
			if (tameMon == 55) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_A5_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster55);
				flags[kFLAGS.TAMED_A5_NAME] = "";
			}
			if (tameMon == 56) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_A6_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster56);
				flags[kFLAGS.TAMED_A6_NAME] = "";
			}
			if (tameMon == 57) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_A7_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster57);
				flags[kFLAGS.TAMED_A7_NAME] = "";
			}
			if (tameMon == 58) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_A8_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster58);
				flags[kFLAGS.TAMED_A8_NAME] = "";
			}
			if (tameMon == 59) {
				if (textOn) outputText(""+flags[kFLAGS.TAMED_A9_NAME]+"");
				player.removeStatusEffect(StatusEffects.TamedMonster59);
				flags[kFLAGS.TAMED_A9_NAME] = "";
			}
		}
