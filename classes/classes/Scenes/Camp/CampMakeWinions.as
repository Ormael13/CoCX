...
package classes.Scenes.Camp 
{
	...
	public class CampMakeWinions extends BaseContent
	{
		...
		private function rankUpSubmenu1st():void {
			...
			if (player.statusEffectv2(StatusEffects.SummonedElementalsWood) == 1) addButton(5, "Lightning", rankUpElementalWood);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsMetal) == 1) addButton(6, "Darkness", rankUpElementalMetal);
		...
		private function rankUpSubmenu2nd():void {
			...
			if (player.statusEffectv2(StatusEffects.SummonedElementalsWood) == 2) addButton(5, "Lightning", rankUpElementalWood);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsMetal) == 2) addButton(6, "Darkness", rankUpElementalMetal);
		...
		private function rankUpSubmenu3rd():void {
			...
			if (player.statusEffectv2(StatusEffects.SummonedElementalsWood) == 3) addButton(5, "Lightning", rankUpElementalWood);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsMetal) == 3) addButton(6, "Darkness", rankUpElementalMetal);
		...
		private function rankUpSubmenu4th():void {
			...
			if (player.statusEffectv2(StatusEffects.SummonedElementalsWood) == 4) addButton(5, "Lightning", rankUpElementalWood);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsMetal) == 4) addButton(6, "Darkness", rankUpElementalMetal);
		...
		private function rankUpSubmenu5th():void {
			...
			if (player.statusEffectv2(StatusEffects.SummonedElementalsWood) == 5) addButton(5, "Lightning", rankUpElementalWood);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsMetal) == 5) addButton(6, "Darkness", rankUpElementalMetal);
		...
		private function rankUpSubmenu6th():void {
			...
			if (player.statusEffectv2(StatusEffects.SummonedElementalsWood) == 6) addButton(5, "Lightning", rankUpElementalWood);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsMetal) == 6) addButton(6, "Darkness", rankUpElementalMetal);
		...
		private function rankUpSubmenu7th():void {
			...
			if (player.statusEffectv2(StatusEffects.SummonedElementalsEther) == 1) addButton(4, "Ether", rankUpElementalEther);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsWood) == 7) addButton(5, "Lightning", rankUpElementalWood);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsMetal) == 7) addButton(6, "Darkness", rankUpElementalMetal);
		...
		private function rankUpSubmenu8th():void {
			...
			if (player.statusEffectv2(StatusEffects.SummonedElementalsWood) == 8) addButton(5, "Lightning", rankUpElementalWood);
			if (player.statusEffectv2(StatusEffects.SummonedElementalsMetal) == 8) addButton(6, "Darkness", rankUpElementalMetal);
