...
public class Holidays extends BaseContent {
    ...
    public static function checkDays():Boolean {
        return useRealDate() || flags[kFLAGS.DAYS_PER_YEAR] == 365;
    }
    ...
    public function pumpkinFuckEncounter():void {
        ...
        function pumpkinMountingLevelII():void {
            ...
            outputText(".  <i>\"There's never too much of a good thing.  Of course, my champion must have the proper train of thought...\"</i>"
                ...
                + "\n\nMeanwhile, you feel a penis sliding into your pussy.  Just as it fills you, a second shaft, slides into your folds, trailing the first until it nestles up against it, both leaking their pre-cum out the first's tip.  Stranger still, a third rod breaches your entrance, slithering past your folds to join its brothers, and that's only the beginning.  A seemingly endless array of penises nestle within your pussy and pulsate inside with twenty different textures, all of them as hard and strong as steel.  Your pussy may as well have died and gone to heaven, for it joins the rest of you in bliss."
    ...
    public function poniesYN():Boolean {
        ...
        function approachPonies():void {
            ...
            outputText(".\n\n"
                ...
                + "To be fair, you tell them, you haven't seen anyone who IS a pony.  The pink one, now slightly calmer, interjects herself into the conversation \"<i>Ponies, not ponies, whatever!  We have a new friend, and I say PARTY!!!</i>\"\n\n"
    ...
    public function DLCPrompt(dlcName:String, dlcPitch:String, dlcPrice:String, nextFunc:Function = null):void {
        ...
        else addButton(1, "No", EventParser.playerMenu);
        ...
        function buyDLCPrompt(dlcName:String, dlcPrice:String, nextFunc:Function = null):void {
            ...
            addButton(3, "COMING SOON!", EngineCore.doNothing);
            addButton(4, "COMING SOON!", EngineCore.doNothing);
        ...
        function reallyCheckout():void {
            ...
            clearOutput();
            outputText(CoC.instance.images.showImage("monster-troll"));
    ...
    public function datTurkeyRumpMeeting():void {
        ...
        function turkeyGirlTwoTheTurkeningBySavinWhatADickInAButt():void {
            ...
            outputText("As you're wandering through camp, your mind wanders back to the old harvest festival your village would hold about this time of year.  The days have come slowly since your arrival in this corrupted demon realm, but you can't help but think back to your family, to the friends you left behind.  Right about now they're probably sitting around the table, saying a prayer to the gods in thanks for the bountiful harvest.  Maybe they're saying one for you."
                ...
                + "\n\nYou jump to your feet, readying your [weapon] for battle as you scan the perimeter.   A moment later, and you see a ponderous figure step out of the shadows behind a large rock.   At first glance, it looks like a normal girl dressed in a simple moccasin poncho, her bright red hair falling past her shoulders to rest on a pair of absolutely massive breasts.   Timidly, she steps forward, giving you a good look at her less human attributes: a pair of avian legs stick out beneath the hem of her clothes, and a large plume of feathers sticks up from her big bubble-butt, each red feather nearly reaching the back of her head.   And her breasts...  each is easily the size of a goblin, so massive that it seems she can barely wobble along."
                + "\n\n\"<i>G-gobble?</i>\"  she asks quietly, her big blue eyes pleading at you.");
        ...
        function helloAgain():void {
            ...
            if (player.biggestCockArea() <= 60) outputText("and down to the base");
        ...
        function turkeyDesertBitches():void {
            clearOutput();
            outputText("\"<i>G-gobble!?</i>\" Gobbles whines at your moment of hesitation, wiggling her upraised botty at you enticingly, hot flesh jiggling just close enough to brush your [cocks] with her lust-coated cheeks."
    ...
    public function pigSlutRoastingGreet():void {
        ...
        function getARoastPiggueOinkOinkOinkMotherfucker():void {
            clearOutput();
            player.gems -= 1;
            outputText("You quickly approach the gooey bucket and toss a single, shiny gem inside. Another waitress winks at you, almost equally busty, nodding her head in the direction of the back rooms."
        ...
        function spankEpilogueColonYoureAHorriblePersonForAbusingADumbPigGirl():void {
            ...
            outputText("Eventually you stop your ceaseless romping of her rear, the piggy whore blubbering into the now thoroughly torn pillow from her biting and tearing. Several strips of flesh from her reddened ass look practically raw from your activities. You lay an experimental finger on the tortured flesh, the blazing heat radiating from it telling you all you need to know."
                + "\n\nYou grab a handy bottle of <i>Booty Balm</i> and squirt a generous amount on your palm and on each of her butt cheeks, working it in gently and easing at least some of the pain from her juicy rump."
    ...
    public function crazyVDayShenanigansByVenithil():void {
        ...
        outputText("Moving through the streets of Tel'Adre, you turn your steps towards the Wet Bitch, only to find that there's some odd event going on nearby.  Deciding the town is a safe enough place to let yourself be led astray by curiosity, you decide to investigate a bit closer."
            ...
            + "\n\nAbby just points to the stall, explaining.  \"<i>Suck-a-lot claimed that there'd be some sort of celebration regarding lovey-dovey stuff where she's from sometime around today.  She decided to make it known and popular here in Tel'Adre and try to get'em to celebrate said holiday as well.  Hence this little farce.  I and Pastie are helping her, and surprisingly some people were even interested.</i>\""
        ...
        function helpValentinesDayII():void {
            ...
            if (!SceneLib.urta.urtaLove()) outputText("  The bearer of it seems to just come here to look uncomfortably but, perhaps, longingly at the stall for a few moments, before practically leaping back into the Wet Bitch.");
            else outputText("  You see a flash of said fur as the person with said characteristic moves away from the stall, clearly carrying a confection or two and some other pink, red, or heart-shaped things into the Wet Bitch.");
        ...
        function goVisitAbby():void {
            ...
            outputText("\"<i>You... you're kidding, right?  That fatty's words messing with yah head?  I always figured you were somewhat less... messed up in the head than Suck-a-Lot and Always-Drunk.  Was I wrong?</i>\""
                ...
                + "\n\nNodding, you go in and make yourself at home, before Abylon tugs at your hand and seemingly continues to remove her dress, showing herself to you naked, in all of her small, a couple of feet tall \"<i>glory</i>\". \"<i>W-well, time for you to show what you're made of, champ,</i>\" she says, bending around a small table, wiggling her posh bottom at you with a look of certain hunger and restlessness to her eyes.");
            menu();
            if (player.hasCock()) {
        ...
        function pleasureAbbyVDay():void {
            ...
            outputText("Quite willing to comply in her desires in ways probably no one else has before, you approach Abylon from behind, wrapping your arms around her waist as you run them along her body.  She's certainly sensitive, shuddering and sighing a bit as your fingers take a dip down her abdomen and towards her female hole.  It spreads eagerly for them, and Abby sighs again.  \"<i>What's wrong?  Well, it's nice that you're preparing me, but...</i>\" you start moving your fingers faster and playing with her clit, as you kiss her neck as well, and she mewls, melting in your arms.  Her vagina is getting increasingly wetter, and you pleasure her skillfully, the little goblin writhing in your arms.  \"<i>Hah... like this... could make me cum, you dumbass!  What, you're suddenly in suck-a-lot's camp?  Where's my... UGHHH!</i>\"  That last sound makes it seem that she's lying a bit, and you prove it by starting to plunge your way about her cunt, stroking both her clit and her insides with your fingers.  She seems to resist continuously but it's definitely not easy on her...  So, rather than continue teasing, you pull away a bit, and she sighs, \"<i>Finally, let's get started,</i>\" before she feels you breathe out onto her wet goblin pussy.  \"<i>Wh...whawhat? You've got issues, come on, you can't eat me out nooaaaghghhH!</i>\""
                ...
                + "\n\nAfter a while of doing this, you're pretty sure Abylon starts approaching her second orgasm, and you intend to fill her as much as you can for the occasion.");
            //([Naga tongue]
    ...
    public function xmasBitchEncounter():void {
        ...
        outputText("The elf says, \"<i>Hiya [name]!  I brought you a");
        ...
        function dickXmasElfGo_fits():void {
            ...
            if (player.cumQ() >= 250) outputText("  The spunk quickly fills her womb and flows back out her entrance, frothing and bubbling as it drips over your " + Appearance.hipDescription(player) + ".  ");
        ...
        function xmasFuckFollowup():void {
            hideUpDown();
            clearOutput();
            outputText("You awaken in the morning, sore and exhausted, but more satisfied than you've ever felt before.  Your body feels INCREDIBLY sensitive from head to toe, but particularly on your well-used [cock].  In spite of the traumatic lovemaking, you feel remarkably clear-headed.\n\n"
                + "Did you enjoy being able to cum so much");
            if (!player.hasPerk(PerkLib.ElvenBounty)) outputText(" <b>again</b>");
            outputText("?");
            //[Yes][No] – yes awards (+250 mls cum volume), no awards +15 intellect
            doYesNo(Utils.curry(xmasPerkM, true), xmasSmart);
            //(-5 corruption)
        ...
        function xmasFuckFollowupFems():void {
            ...
            doYesNo(Utils.curry(xmasPerkM, false), xmasSmart);
            //(-5 corruption)
            player.dynStats("cor", -5);
            //(+20 sens unless it would bring you over 80 sens, then +5 sens)
            if (player.sens + 20 > 80) player.dynStats("sen", 5);
    ...
    public function gatsSpectacularRouter():void {
        ...
        function encounterQuoteUnquoteAngel():void {
            ...
            if (!isChristmas()) {
                ...
                outputText("  She beams a toothless grin, popping one into her mouth and blowing out a stream of candy-scented smoke.  Suddenly, you're glad you didn't take any."
                    + "\n\n\"<i>Once upon a time, upon this very mountain, two lovers had run to escape the corruption of the world.  A single spirit, more beautiful than any mortal woman, and a man she had created from tin.  Her brave soldier.</i>\""
        ...
        function findTheWindUpKey():void {
            ...
            outputText("Upon reaching the base of the mountain, you set off on your quest for the grief-stricken giantess.  A sunken grotto hidden around the mountain's base, you recall.  In all your treks over this bump in the land, you've never noticed anything even vaguely resembling the little shelter she described.  However, \"sunken\" gives you a vital hint to help begin your quest in the right direction.  You remember a steep valley, flooded and forgotten in its tiny alcove amidst the towering earth.  It takes little time at all until you've worked your way around to the unremarkable crater, pushing your way past the dense growth and through the humid mist surrounding it."
                ...
                + "\n\nA sturdy grip and a measured tug propels you up the wall, with extra care taken not to brush your bare body against whatever lies on the multicolored wall.  Though there is more to the cave than you initially anticipated, it doesn't amount to much more than an illuminated little dome.");
            //[if (tallness > 60)
        ...
        function fuckTheAngelBadEnd():void {
            ...
            else outputText(Appearance.vaginaDescript(player, 0));
            ...
            } else outputText(Appearance.vaginaDescript(player, 0) + " throbs");
    ...
    public function processJackFrostEvent():void {
        ...
        //less than 5!
            ...
            if (!SceneLib.amilyScene.amilyCorrupt()) {
                outputText("Amily is warily prowling across the icy surface, occasionally glancing all around as if trying to spot an ambush.  Other times, she suddenly leaps up in a flurry, whirling around in midair as something catches her over-large ears.  All in all, it's quite obvious she's scared."
            ...
            //Corrupt
                ...
                outputText("Out in the outskirts where your favorite cum-slut lives, you spot her slowly rubbing the snow over her erect nipples, the cold making her shiver in pleasure."
                    ...
                    + "\n\nLooking up to you and kneeling obediently as her spaded mouse-tail waves lazily behind her, she smiles.  \"<i>Very much, [master].  I haven't seen snow ever since I was a little baby girl.  So seeing all this snow is such a turn-on for me, [master].</i>\""
        ...
        //Tainted Ember
            ...
            outputText("The dragon is wandering your camp in open fascination.  \"<i>What is this weird white stuff?  It's cold and wet... but soft and fluffy, too,</i>\" " + SceneLib.emberScene.emberMF("he", "she") + " says, gently catching a snowflake."
        ...
        //if she ain't a follower and is a lover, just have her visit.
            ...
            outputText("\"<i>Hey, champ, what's going on here?</i>\"  Helia calls as she sees you approach.  Gentle trails of steam are wafting from the salamander's body as her own internal heat melts any snow that builds up on her."
                ...
                + "\n\nYou explain to her that it's just having fun in the snow... something you used to do a lot as a child.  You'd build snowmen, make snow angels, have a snowball fight-"
        ...
        function kihaXmasFuck():void {
            ...
            if (x < 0) x = player.smallestCockIndex();
            outputText("Stripping off your [armor], you tell the dragon-girl that a good workout is all she needs to get nice and warm.  She snorts in dismissal, but the way she's looking at you is a pretty good indication she's willing to try it.  \"<i>So, what do you have in mind?</i>\" she blusters.  You stroke your quickly erecting [cocks] and, smirking, ask her if your intentions aren't obvious?"
        ...
        function penetradePureMouseWaifu():void {
            clearOutput();
            outputText("Stripping down your [armor] and indicating Amily should do the same... you tell her that you were hoping for some good old-fashioned sex between a horny " + player.mf("man", "herm") + " and [his] lovely mousette.  You playfully ask Amily if she has any objections?"
            ...
            if (flags[kFLAGS.AMILY_WANG_LENGTH] > 0) outputText(", her own " + SceneLib.amilyScene.amilyCock() + " jutting out in anticipation");
            outputText(", wriggling into your arms and angling her pussy over your " + player.cockDescript(CoC.instance.x) + ".  With the ease of long practice, she slides smoothly down its length, her warm, wet depths greedily inhaling your masculinity.  \"<i>Ah, nothing like a nice hard cock in your cunt to make you feel warmer,</i>\" she coos."
        ...
        function makeOutWithPureMouseWaifu():void {
            ...
            outputText("You strip down your [armor] and suggest Amily should do the same.  \"<i>Well, it's a little counterproductive to take your clothes off if you want to get warm,</i>\" Amily notes.  Despite her words, she's stripping off without the slightest hesitation.  \"<i>So, what's on your mind, lover-" + player.mf("boy", "girl") + "?</i>\" she asks."
                + "\n\nYou say that with all that's been going on lately, the two of you just haven't been able to catch a break... so today, you'd like to just forget about everything and spend some quality time with her... not by having sex... though you don't mind doing it either, but... you'd just like to sit back and enjoy your pretty mousette, mother of your children, properly.  You ask if she's getting what you're saying?"
    ...
    public function approachKamiTheChristmasRoo():void {
        ...
        if (flags[kFLAGS.KAMI_ENCOUNTER] == 1) {
            ...
            else addButtonDisabled(0, "Give Anal", "Req. cock with area smaller than 70");
            ...
            else addButtonDisabled(3, "Doube-Fuck", "Req. 2 cocks with area smaller than 70");
        } else {
        ...
        function chooseLetsGoKami():void {
            ...
            menu();
            addButton(0, "Give Anal", giveKamiTheChristmasRooAnal)
                .disableIf(!player.cockThatFits(70) < 0, "Req. a cock fitting 70 area.");
            addButton(1, "Receive Anal", takeItRooButtStyle);
            addButton(2, "Give BJ", KamiBlowJob);
            addButton(3, "DoubleFuck", KamiDoubleDickFuck)
                .disableIf(!player.countCocks(-1, 70) < 2, "Req. 2 cocks fitting 70 area.");
        }
    ...
    public function getWinterPudding():void {
        ...
        menu();
        addButton(0, "Eat", CoC.instance.mutations.winterPudding, player, true, null, "Eat the delicious Winter Pudding.");
        addButton(1, "Take", SceneLib.inventory.takeItem, consumables.W_PDDNG, SceneLib.telAdre.bakeryScene.bakeryuuuuuu, null, "Bring the pudding with you.");
    ...
    public function nieveCampDescs():void {
        //6:00
        if (CoC.instance.model.time.hours == 6) outputText("Nieve is sitting cross-legged in the snowdrift, munching on what looks to be icicles.  As you watch, " + nieveMF("he", "she") + " reaches down into the glittering powder surrounding " + nieveMF("him", "her") + " and produces another one.");
        //7:00
        else if (CoC.instance.model.time.hours == 7) outputText("Nieve is giggling and laughing as a fresh flurry flutters down on " + nieveMF("him", "her") + ".  You wonder idly if " + nieveMF("he", "she") + "'s causing it to happen.");
        //8:00
        else if (CoC.instance.model.time.hours == 8) outputText("Nieve is sitting in the white wintery wonderland, carefully constructing a snowman.  It strikes you as strange, and almost masturbatory in a way.  " + nieveMF("He", "She") + " spots you and gives you a wave and a smile.  For a moment, you think the snowman has too, but you eventually conclude it's your imagination.");
        //9:00
        else if (CoC.instance.model.time.hours == 9) outputText("Nieve is sprawled out in the icy field, creating a series of snow angels without a care in the world.  When " + nieveMF("he", "she") + " catches sight of you, she gives a friendly wave, then dives back into the snow.");
        //10:00
        else if (CoC.instance.model.time.hours == 10) outputText("Nieve, the ice spirit, sits quietly at the edge of the snowdrift, looking out at the landscape beyond.  When " + nieveMF("he", "she") + " sees you looking, " + nieveMF("he", "she") + " gives a somber wave.");
        //11:00
        else if (CoC.instance.model.time.hours == 11) outputText("Nieve is in your camp, poking around your supplies and water barrels. You notice " + nieveMF("he", "she") + " seems a little uncomfortable to be away from " + nieveMF("his", "her") + " snowdrift.");
        //12:00
        else if (CoC.instance.model.time.hours == 12) outputText("Nieve is carefully compressing snowballs in " + nieveMF("his", "her") + " little camp.  To your surprise, " + nieveMF("he", "she") + " picks one up and begins eating it like you would an apple.  When " + nieveMF("he", "she") + " catches you looking mid-bite, " + nieveMF("he", "she") + " gives you a grin with her mouth full, " + nieveMF("his", "her") + " cheeks puffed out.");
        //13:00
        else if (CoC.instance.model.time.hours == 13) outputText("Nieve is sitting cross-legged, in the middle of what appears to be an argument with a snowman " + nieveMF("he", "she") + "'s just made.");
        //14:00
        else if (CoC.instance.model.time.hours == 14) outputText("Nieve is in " + nieveMF("his", "her") + " usual spot, seemingly deep in concentration.  Around " + nieveMF("him", "her") + " snow begins to fall slowly, then quicker and quicker, whipping " + nieveMF("his", "her") + " hair around wildly.  Although strangely, the air is still where you are.");
        //15:00
        else if (CoC.instance.model.time.hours == 15) outputText("\n\nNieve the ice spirit is whirling around " + nieveMF("his", "her") + " area, practicing with what appears to be a translucent blue spear.  " + nieveMF("He", "She") + " jabs and thrusts, spins and swipes.  " + nieveMF("He", "She") + " may be new to Mareth, but you've got to hand it to " + nieveMF("him", "her") + ", it looks like " + nieveMF("he", "she") + " could take care of " + nieveMF("him", "her") + "self.");
        //16:00
        else if (CoC.instance.model.time.hours == 16) outputText("\n\nNieve is at first nowhere to be seen.  Then you see " + nieveMF("his", "her") + " head pop out of a snowdrift.  " + nieveMF("He", "She") + " looks around quickly, then leaps into the air, diving head first into another pile of the powdery stuff.");
        //17:00
        else if (CoC.instance.model.time.hours == 17) outputText("\n\nNieve appears to have constructed a firepit constructed from translucent blue logs and rocks.  A vivid blue flame roars in the pit, over which Nieve appears to be roasting... marshmallows?  As you watch " + nieveMF("he", "she") + " peels the burnt black skin off a marshmallow, gobbles it down, and begins roasting the rest.");
        //18:00
        else if (CoC.instance.model.time.hours == 18) outputText("\n\nNieve seems to be working on a spear, sharpening it with a jagged piece of ice.  When " + nieveMF("he", "she") + " catches sight of you " + nieveMF("he", "she") + " waves and gives a friendly smile.");
        //19:00
        else if (CoC.instance.model.time.hours == 19) outputText("\n\nNieve is sitting at the edge of " + nieveMF("his", "her") + " icy expanse, staring off at the distant mountains.  You wonder if " + nieveMF("he", "she") + "'s looking for home.");
        //20:00
        else if (CoC.instance.model.time.hours == 20) outputText("\n\nNieve is, surprisingly, outside of " + nieveMF("his", "her") + " cold camp.  " + nieveMF("He", "She") + "'s dancing along the battered, parched ground, calling down snow.  Wherever a flake hits, it's immediately devoured by the thirsty earth.  Is Nieve perhaps trying to... water the ground?");
        //21:00
    ...
    public function approachNieve():void {
        ...
        function nieveSexMenu():void {
            ...
            if (player.lust >= 33) {
                ...
                if (flags[kFLAGS.NIEVE_GENDER] == 2) {
                    if ((player.cockThatFits(130) >= 0 || player.hasVagina() && player.clitLength >= 3.5))
                        addButton(1, "Fuck Her", fuckNieve_router);
                    else
                        addButtonDisabled(1, "Fuck Her", "Req dick area < 130 or clit length > 3.5");
                }
                //Get Fucked by Gurumash
                //Male Nieve
                //Any Gender
                //Nieve's cock is 9x1.5
                if (flags[kFLAGS.NIEVE_GENDER] == 1) addButton(1, "Get Fucked", nieveFucksYou);
            }
            addButton(14, "Back", SceneLib.camp.campLoversMenu);
            ...
            function fuckNieve_router():void {
                ...
                //hascock
                if (x >= 0)
                    addButton(0, "Dick", Utils.curry(fuckNieve, x));
                else
                    addButtonDisabled(0, "Dick", "Req. dick area < 130");
                //clit
                if (player.hasVagina() && player.clitLength >= 3.5)
                    addButton(1, "Clit", Utils.curry(fuckNieve, -1));
                else
                    addButtonDisabled(1, "Clit", "Req. vagina and clit length > 3.5'");
            }
            ...
            function fuckNieve(x:int):void {
                ...
                //((Clitfucking?)
                if (x < 0) outputText("  Your [clit] suddenly feels warm, like every nerve ending inside were on fire. It aches and pulses with the rest of your body, as though it were a little cock longing to cum.");
                else {
            ...
            function nieveFucksYou():void {
                ...
                function takeNieveAnal():void {
                    ...
                    //[if (hasVagina = true)
                    else if (player.hasVagina()) outputText("  As Nieve continues to pound away, he places one hand on your sopping wet cunt and begins to finger you in time with his assault, making you lust-drunk with the stimulation as he fingerbangs you.");
                ...
                function takeNieveVaginal():void {
                    ...
                    //if (corruption > 50)
                    else outputText("\n\nYou ask your toy if he's playing coy, to which he merely gives you another sidelong glance.  You then grab him by the chin and force him to look into your eyes, barely an inch away from each other's faces.  You whisper that he's going to empty those pretty blue balls of his directly into your womb, and he'd better get started.  Right.  Now.");
    ...
    public function returnOfNieve():void {
        clearOutput();
        outputText("As you awake you find yourself shivering slightly.  A cool breeze sweeps over your camp, while in the distance jingling bells can be heard.  How odd.  You haven't heard bells like that since..."
