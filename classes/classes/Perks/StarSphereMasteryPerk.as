...
package classes.Perks 
{
	...
	public class StarSphereMasteryPerk extends PerkType
	{
		...
		{
			if (player.hasPerk(MutationsLib.KitsuneThyroidGlandFinalForm)) return "Regenerate " + params.value1 + " fatigue, " + (params.value1 * 2) + " soulforce and " + (params.value1 * 2) + " mana every round. Increase Fox Fire damage by " + (params.value1 * 5) + "%. (Rank: " + params.value1 + ")";
