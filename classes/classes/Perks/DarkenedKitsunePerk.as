...
public class DarkenedKitsunePerk extends PerkType
	{
		...
		{
			return "The corruption has taken over your star sphere, driving you "+((player.cor >=90)?"completely":(player.cor >=75)?"moderately":(player.cor >= 50)?"mildly":"")+" insane. The higher the corruption, the higher the chance you may do an extra, randomly decided attack. Foes are also terrified of you, and do less damage.";
		}
