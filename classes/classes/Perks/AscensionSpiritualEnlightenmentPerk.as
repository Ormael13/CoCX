...
package classes.Perks 
{
	...
	public class AscensionSpiritualEnlightenmentPerk extends PerkType
	{
		...
		{
			return "(Rank: " + params.value1 + "/" + kGAMECLASS.charCreation.MAX_SPIRITUALENLIGHTENMENT_LEVEL + ") Increases soulskill effect multiplier by " + params.value1 * 10 + "% multiplicatively.";
		}
