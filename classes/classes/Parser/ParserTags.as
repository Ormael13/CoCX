...
public class ParserTags {
    ...
    internal static var singleArgConverters:Object = {
        ...
        "font-fire"             : function ():* { return '<font color="'+"#e48a00"+'">'; },
        "font-cold"             : function ():* { return '<font color="'+"#73bfff"+'">'; },
        "font-lightning"        : function ():* { return '<font color="'+"#e3dc00"+'">'; },
        "font-dark"             : function ():* { return '<font color="'+"#8000a9"+'">'; },
        "font-water"            : function ():* { return '<font color="'+"#0000ff"+'">'; },
        "font-wind"             : function ():* { return '<font color="'+"#00ffc9"+'">'; },
        "font-earth"            : function ():* { return '<font color="'+"#673b00"+'">'; },
        "font-poison"           : function ():* { return '<font color="'+"#00980e"+'">'; },
        "font-true"             : function ():* { return '<font color="'+"#ffffff"+'">'; },
