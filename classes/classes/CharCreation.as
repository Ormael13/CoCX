...
//		private var boxNames:ComboBox;
		...
		//Replaced by flag	CoC.instance.beeProgress = 0;
			...
			if (player.hasKeyItem("Ascension") >= 0) {
				for each(var flag:int in [kFLAGS.NEW_GAME_PLUS_LEVEL, kFLAGS.NEW_GAME_PLUS_BONUS_UNLOCKED_HERM, kFLAGS.HUNGER_ENABLED, kFLAGS.HARDCORE_MODE, kFLAGS.HARDCORE_SLOT, kFLAGS.GAME_DIFFICULTY, kFLAGS.EASY_MODE_ENABLE_FLAG, kFLAGS.SFW_MODE, kFLAGS.NO_GORE_MODE, kFLAGS.WISDOM_SCALLING, kFLAGS.INTELLIGENCE_SCALLING, kFLAGS.SPELLS_COOLDOWNS,
