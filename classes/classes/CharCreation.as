...
//		private var boxNames:ComboBox;
		...
		//Replaced by flag	CoC.instance.beeProgress = 0;
			...
			if (player.hasKeyItem("Ascension") >= 0) {
				...
				kFLAGS.WATERSPORTS_ENABLED, kFLAGS.SILLY_MODE_ENABLE_FLAG, kFLAGS.LOW_STANDARDS_FOR_ALL, kFLAGS.HYPER_HAPPY, kFLAGS.STAT_GAIN_MODE, kFLAGS.SFW_MODE, kFLAGS.NEW_GAME_PLUS_BONUS_UNLOCKED_HERM]) {
