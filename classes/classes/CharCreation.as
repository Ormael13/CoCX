...
//		private var boxNames:ComboBox;
		...
		*/
		...
		private function reincarnate():void {
			...
			player.XP = 0;
			player.setArmor(armors.C_CLOTH, false, true);
			player.setWeapon(WeaponLib.FISTS, false, true);
			if (flags[kFLAGS.AETHER_DEXTER_TWIN_AT_CAMP] == 1) flags[kFLAGS.AETHER_DEXTER_TWIN_AT_CAMP] = 0;
			player.unequipWeaponRange(false, true);
			player.setShield(ShieldLib.NOTHING, false, true);
			if (flags[kFLAGS.AETHER_SINISTER_TWIN_AT_CAMP] == 1) flags[kFLAGS.AETHER_SINISTER_TWIN_AT_CAMP] = 0;
