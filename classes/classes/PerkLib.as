	...
	//			"Your Demonic bloodline appears strongly within you. (+2 to  score)", null, true);
		...
		*/public static const GazerEye:PerkType = mk("Gazer Eye", "Gazer Eye",
		...
		public static const LikeAnAsuraBoss:PerkType = mk("Like A-sura Boss", "Like A-sura Boss",
				"Adds to toggle starting in Asura Form at combat start, unlocking access specials usable only in asura form, increase to physical might rise to 80%/60%/40% of core str/tou/spe. (+10% of OverMax Wrath)");
