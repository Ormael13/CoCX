...
*/
	...
	//			"Your Demonic bloodline appears strongly within you. (+2 to  score)", null, true);
		...
		public static const FuriousStrikes:PerkType = mk("Furious strikes", "Furious strikes",
				"Wrath generated by base melee/range attacks and abilities increases by 200%.",
				"You've chosen the 'Furious strikes' perk, wrath generated by base melee/range attacks and abilities increases by 200%.");
		...
		public static const TooAngryToDie:PerkType = mk("Too Angry to Die", "Too Angry to Die",
				"When you under berserk-like state it will prevent HP defeat as long it last. Additionaly increase limit of negative HP you can reach by amount of max wrath.",
				"You've chosen the 'Too Angry to Die' perk. When you under berserk-like state it will prevent HP defeat as long it last. Additionaly increase limit of negative HP you can reach by amount of max wrath.")
		...
		public static const UnlimitedRage:PerkType = mk("Unlimited rage", "Unlimited rage",
				"Wrath generated by base melee/range attacks and abilities increases by 200%.",
				"You've chosen the 'Unlimited rage' perk, wrath generated by base melee/range attacks and abilities increases by 200%.");
		...
		*/
		...
		public static const Anger:PerkType = mk("Anger", "Anger",
				"For every 1% of missing HP (up to 100%) you gain 1% bonus damage, 2% bonus crit damage. When: below 50/100% max HP grants 1/2 more attack(s) with large/massive weapons when under berserker/lustzerker state.",
				"You've chosen the 'Anger' perk, increasing damage based on your missing HP. For every 1% of missing HP (up to 100%) you gain 1% bonus damage, 2% bonus crit damage. When: below 50/100% max HP grants 1/2 more attack(s) with large/massive weapons when under berserker/lustzerker state.")
		...
		public static const FuelForTheFire:PerkType = mk("Fuel for the Fire", "Fuel for the Fire",
				"Increase two times wrath gains from getting hit. +1 attack per turn when wielding any large or massive weapon under berserker/lustzerker state.",
				"You've chosen the 'Fuel for the Fire' perk, increasing gained wrath after taking damage. Also user under berserker/lustzerker state attack 1 more time per turn with large/massive weapons.")
		...
		public static const Rage:PerkType = mk("Rage", "Rage",
				"Increasing crit chance by up to 70% & crit dmg by up to 175% in berserk state that would reset after succesful crit attack. Adds Diehard effect up to 5% of max HP.",
				"You've chosen the 'Rage' perk, increasing crit chance by up to 70% & crit dmg by up to 175% in berserk state until next crit attack. Adds Diehard effect up to 5% of max HP.")
