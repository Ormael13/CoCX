...
*/
		...
		*/
		...
		public static const AsuraStrength:PerkType = mk("Asura Strength", "Asura Strength",
				"Gain Asura Strength, Asura Form increase to physical might raise to 120%/60%/40% of core str/tou/spe and generate one additional pair of semi-transparent arms. (+10% of OverMax Wrath/Base STR Cap)");
		...
		public static const GreySageIntelligence:PerkType = mk("Grey Sage Intelligence", "Grey Sage Intelligence",
				"Gain Grey Sage Intelligence. When using Mana Shield during Defend command it woulkd fully absorb attacks no matter how strong. (+10% of OverMax Mana/Base INT Cap)");
		...
		public static const GreySageWisdom:PerkType = mk("Grey Sage Wisdom", "Grey Sage Wisdom",
				"X th Grey Sage super perk. (+10% of OverMax Mana, , +10% Base WIS Cap)");
