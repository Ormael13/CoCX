	...
	//			"You've chosen the 'Skeleton Emperor / Monarch / Sovereign' perk. You may now control additional 30 normal and 4 large skeletons of each type. Allows you to levitate all skeletons.");
		...
		*/
		...
		public static const EyesOfTheHunterSu:PerkType = mk("Eyes of the Hunter (Su)", "Eyes of the Hunter (Su)",
				"Allowing you to increase critical chance and overall damage dealt to enemies (all with specific type that eyes of hunter allows you to recognize) based on how high is sensitivity. (+5% crit chance multiplier/+2% damage per 5 sensitivity up to 475%/190% bonus). +1 exploration reveal.",
				"You've chosen the 'Eyes of the Hunter (Su)' perk, allowing you to increase critical chance and overall damage dealt to enemies (all with specific type that eyes of hunter allows you to recognize) based on how high is sensitivity. (+5% crit chance multiplier/+2% damage per 5 sensitivity up to 475%/190% bonus). +1 exploration reveal.");
...
//dodać także typy perków dla poszczególnych ras przeciwników tak, ze bedą mogły one mieć jakieś korzyści też (np. jak ma Dragon nature to bonusy jak PC miałby dragon score > 6))
    ...
    //                .requireTou(150);
            ...
            Friday13th.requireLevel(72)
                    .requirePerk(DirtyDozen)
                    .requireWis(325);
